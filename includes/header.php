...
<?php endif; ?>
  ...
  <style>
    ...
    .brand-logo img { width: 48px; height: 48px; aspect-ratio: 1/1; }
  </style>

  <!-- CSS Stylesheet (Minified for Fast FCP/LCP) -->
