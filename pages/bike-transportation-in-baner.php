...
$page_keywords = "bike transportation in baner, best bike transportation in baner, affordable bike transportation in baner, packers and movers, top bike transportation in baner company, household shifting bike transportation in baner, doorstep bike transportation in baner, verified bike transportation in baner services, shree ashirwad bike transportation in baner";
...
<main class="site-main">
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            BIKE TRANSPORTATION BANER PUNE RELOCATION SPECIALISTS
          </span>
          <h1 style="font-size: 2.7rem; font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #ffffff;">
            Professional <span style="color: #f59e0b;">Bike Transportation in Baner Pune</span>
          </h1>
        ...
        <div class="hero-form-card" style="background: rgba(255, 255, 255, 0.05); backdrop-filter: blur(10px); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
          ...
          <form action="#" method="POST" onsubmit="sendHeroWhatsAppLead(event, this);">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 14px;">
              <input type="text" name="move_from" class="form-control" value="Baner, Pune" required style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.3); color: #fff;">
  ...
  <!-- Section 3: Comprehensive Bike Shifting Services in Baner -->
    ...
    <div class="container">
      <div style="text-align: center; max-width: 800px; margin: 0 auto 50px;">
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin-bottom: 15px;">
          Premium Two-Wheeler Logistics Services in <span style="color: #f59e0b;">Baner (Pune)</span>
        </h2>
        <p style="font-size: 1rem; color: #94a3b8; line-height: 1.7;">
          Shree Ashirwad Packers and Movers delivers specialized end-to-end bike relocation from Baner, Pune to all major Indian cities. We protect your motorcycle with multi-tier packaging and dedicated covered carrier transport via NH-48.
        </p>
      </div>
      ...
      <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 30px;">
        ...
        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 14px; padding: 30px; transition: transform 0.3s ease;">
          ...
          <p style="font-size: 0.95rem; color: #94a3b8; line-height: 1.6;">
            Our team collects your bike straight from your home/apartment in Baner and delivers it right to your destination address anywhere across India.
          </p>
        </div>
        ...
        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 14px; padding: 30px; transition: transform 0.3s ease;">
          ...
          <p style="font-size: 0.95rem; color: #94a3b8; line-height: 1.6;">
            Stay informed with continuous WhatsApp location updates and SMS alerts from dispatch at Baner to final delivery.
          </p>
        </div>
    ...
    <div class="container">
      <div style="text-align: center; max-width: 800px; margin: 0 auto 40px;">
        <h2 style="font-size: 2rem; font-weight: 800; color: #ffffff; margin-bottom: 12px;">
          Estimated Bike Transportation Charges from <span style="color: #f59e0b;">Baner (Pune)</span>
        </h2>
        ...
        <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 0.95rem;">
          ...
          <tbody style="color: #cbd5e1;">
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
              <td style="padding: 16px 20px; font-weight: 600; color: #fff;">Within 300 km (Mumbai/Nashik)</td>
            ...
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
              <td style="padding: 16px 20px; font-weight: 600; color: #fff;">300 km - 800 km (Goa/Indore)</td>
            ...
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
              <td style="padding: 16px 20px; font-weight: 600; color: #fff;">800 km - 1500 km (Bangalore/Delhi)</td>
              <td style="padding: 16px 20px;">₹4,500 - ₹6,500</td>
              <td style="padding: 16px 20px;">₹5,200 - ₹7,500</td>
            ...
            <tr>
              ...
              <td style="padding: 16px 20px;">₹6,000 - ₹8,200</td>
              <td style="padding: 16px 20px;">₹7,000 - ₹9,500</td>
              <td style="padding: 16px 20px;">₹10,000 - ₹14,500</td>
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #ffffff;">
    <div class="container">
      <div style="text-align: center; max-width: 800px; margin: 0 auto 40px;">
        <h2 style="font-size: 2rem; font-weight: 800; color: #ffffff; margin-bottom: 12px;">
          Required Documents for Bike Transport from Baner
        </h2>
        <p style="font-size: 0.95rem; color: #94a3b8;">
      ...
      <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px;">
        <div style="background: rgba(255,255,255,0.03); padding: 25px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.05); text-align: center;">
          ...
          <p style="font-size: 0.85rem; color: #94a3b8;">Photocopy or digital MParivahan copy of Registration Certificate (MH-12).</p>
        </div>
        <div style="background: rgba(255,255,255,0.03); padding: 25px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.05); text-align: center;">
  ...
  <!-- Section 8: Route Network from Baner -->
  <section style="padding: 60px 0; background: #0f172a; color: #ffffff;">
    <div class="container">
      <div style="text-align: center; max-width: 800px; margin: 0 auto 40px;">
        <h2 style="font-size: 2rem; font-weight: 800; color: #ffffff; margin-bottom: 12px;">
          Popular Bike Shifting Routes from <span style="color: #f59e0b;">Baner (Pune)</span>
        </h2>
        <p style="font-size: 0.95rem; color: #94a3b8;">
          Daily scheduled container trucks connecting Baner, Pune to top Indian cities via NH-48.
        </p>
      </div>
      ...
      <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 15px; font-size: 0.9rem;">
        <div style="background: rgba(255,255,255,0.03); padding: 14px 18px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); color: #cbd5e1;">
          <i class="fas fa-truck-moving" style="color: #f59e0b; margin-right: 8px;"></i> Baner to Bangalore
        </div>
        <div style="background: rgba(255,255,255,0.03); padding: 14px 18px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); color: #cbd5e1;">
          <i class="fas fa-truck-moving" style="color: #f59e0b; margin-right: 8px;"></i> Baner to Mumbai
        </div>
        <div style="background: rgba(255,255,255,0.03); padding: 14px 18px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); color: #cbd5e1;">
          <i class="fas fa-truck-moving" style="color: #f59e0b; margin-right: 8px;"></i> Baner to Delhi NCR
        </div>
        <div style="background: rgba(255,255,255,0.03); padding: 14px 18px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); color: #cbd5e1;">
          <i class="fas fa-truck-moving" style="color: #f59e0b; margin-right: 8px;"></i> Baner to Hyderabad
        </div>
        <div style="background: rgba(255,255,255,0.03); padding: 14px 18px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); color: #cbd5e1;">
          <i class="fas fa-truck-moving" style="color: #f59e0b; margin-right: 8px;"></i> Baner to Chennai
        </div>
        <div style="background: rgba(255,255,255,0.03); padding: 14px 18px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); color: #cbd5e1;">
          <i class="fas fa-truck-moving" style="color: #f59e0b; margin-right: 8px;"></i> Baner to Ahmedabad
        </div>
        <div style="background: rgba(255,255,255,0.03); padding: 14px 18px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); color: #cbd5e1;">
          <i class="fas fa-truck-moving" style="color: #f59e0b; margin-right: 8px;"></i> Baner to Kolkata
        </div>
        <div style="background: rgba(255,255,255,0.03); padding: 14px 18px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); color: #cbd5e1;">
          <i class="fas fa-truck-moving" style="color: #f59e0b; margin-right: 8px;"></i> Baner to Goa
        </div>
      </div>
    </div>
  </section>
        ...
        <div style="display: flex; gap: 20px; align-items: flex-start;">
          ...
          <div>
            <h3 style="font-size: 1.4rem; font-weight: 700; color: #ffffff; margin-bottom: 12px;">
              Beware of Fake & Unregistered Bike Movers in Baner Pune
            </h3>
  ...
  $faqs = [
    [
      "question" => "How much does bike transportation in Baner Pune cost?",
      "answer" => "Bike transportation charges in Baner range from ₹2,000 to ₹3,800 for regional relocations (Mumbai, Nashik) and ₹4,500 to ₹9,500 for long-distance interstate shifting depending on bike model and destination."
    ],
    [
      "question" => "What documents are required for motorcycle shifting from Baner?",
    ...
    [
      "question" => "Is my bike insured during transit from Baner Pune?",
    ...
    [
      "question" => "How many days will it take to deliver my bike from Baner to Bangalore or Delhi?",
      "answer" => "Deliveries to Bangalore or Delhi take 3 to 5 days, while Mumbai relocations take 24 to 48 hours."
    ],
    [
      "question" => "Do you provide door-to-door pickup in Baner Pune?",
      "answer" => "Yes, our team provides complete doorstep pickup from your society/apartment in Baner and doorstep delivery at your destination address."
    ]
  ];
  ?>
  ...
  <section style="padding: 60px 0; background: #0f172a; color: #ffffff;">
    <div class="container">
      <div style="text-align: center; max-width: 800px; margin: 0 auto 40px;">
        ...
        <p style="font-size: 0.95rem; color: #94a3b8;">
          Clear answers regarding two-wheeler transport services in Baner Pune.
        </p>
      </div>
  ...
  <section style="padding: 60px 0; background: linear-gradient(135deg, #1c2541 0%, #0b132b 100%); text-align: center; color: #ffffff; border-top: 1px solid rgba(245, 158, 11, 0.3);">
    <div class="container">
      <h2 style="font-size: 2.4rem; font-weight: 800; margin-bottom: 15px;">
        Book Safe Bike Transportation in <span style="color: #f59e0b;">Baner Pune Today</span>
      </h2>
      <p style="font-size: 1.1rem; color: #94a3b8; max-width: 700px; margin: 0 auto 30px;">
        Protect your motorcycle with Pune's most trusted logistics partner. Get free doorstep inspection and instant cost estimate.
      </p>
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers & Movers,\n\nI would like to request a Bike Shipping Quote for Baner Pune:\n- Name: " + name + "\n- Phone: " + phone + "\n- Pickup Location: " + moveFrom + "\n- Moving To: " + moveTo;
