...
$faq_list = [
    ...
    [
        'q' => 'How are relocation charges calculated for Bike Transportation in Salaya | Secure Shifting Devbhumi Dwarka?',
...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  ...
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Due to the enclosed nature of enclosed carriers, there is minimal risk of vandalism or theft during transportation. Your bike will be securely locked and protected within the container, reducing the chances of any unauthorized access.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Visual Appeal:</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Enclosed carriers often provide a more visually appealing option for transporting bikes, as they offer a clean and organized appearance compared to the exposed nature of open trailers.</p>
  </div>
</div>
	<h3>Open Trailers
	
		Weather Protection: While open trailers do offer some protection, they are not as effective as enclosed carriers in shielding your bike from harsh weather conditions, such as rain, wind, and dust.
		Risk of Damage: Open trailers expose your bike to the risk of flying stones and debris from the road, potentially causing scratches, dents, or other damages during transportation.
		Visual Appeal: Open trailers can leave your bike exposed and vulnerable, resulting in a less appealing appearance compared to enclosed carriers.
	
	Comparison: Enclosed Carriers vs. Open Trailers</h3>
	<p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>In terms of overall protection, enclosed carriers outperform open trailers significantly. Enclosed carriers ensure complete shielding from external factors, while open trailers offer limited protection. Additionally, enclosed carriers provide enhanced security against theft and vandalism compared to open trailers.</p>
	...
	<p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>When it comes to bike transportation in Salaya, both enclosed carriers and open trailers can be utilized depending on your specific needs and preferences.</p>
	...
	<p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>If you require bike transportation services in Mulund, the comparison between enclosed carriers and open trailers remains relevant.</p>
