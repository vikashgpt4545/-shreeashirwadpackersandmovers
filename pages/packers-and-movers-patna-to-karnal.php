...
$page_keywords = "packers and movers patna to karnal, patna to karnal household shifting, patna to karnal car transport, packers and movers patna to haryana, shree ashirwad packers patna to karnal";
...
<main class="site-main">
  ...
  <div class="breadcrumb-wrapper">
    <div class="container">
      <div class="breadcrumb-list">
        ...
        <span class="breadcrumb-separator">/</span>
        <span class="breadcrumb-item active">Patna to Karnal</span>
      </div>
    </div>
  </div>
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            PATNA TO KARNAL INTERSTATE RELOCATION EXPERTS
          </span>
          <h1 style="font-size: 2.7rem; font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #ffffff;">
            Reliable <span style="color: #f59e0b;">Packers and Movers Patna to Karnal</span>
          </h1>
          <p style="font-size: 1.12rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Relocate seamlessly from Patna to Karnal with Shree Ashirwad Packers and Movers. Benefit from 7-layer safety packaging, dedicated container logistics, live GPS tracking, and complete transit insurance coverage across Model Town, Sector 6, 7 & 13, GT Road, and Kunjpura Road.
          </p>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20need%20a%20quote%20for%20Patna%20to%20Karnal%20shifting." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
        ...
        <div class="hero-form-card" style="background: rgba(255, 255, 255, 0.05); backdrop-filter: blur(10px); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
          <h2 style="font-size: 1.4rem; color: #ffffff; margin-bottom: 8px; font-weight: 700; text-align: center;">Get Instant Patna to Karnal Quote</h2>
          ...
          <form action="#" method="POST" onsubmit="sendHeroWhatsAppLead(event, this);">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 14px;">
              ...
              <input type="text" name="move_to" class="form-control" value="Karnal" required style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.3); color: #fff;">
            </div>
    ...
    <div class="container">
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 25px; text-align: center;">
        ...
        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); padding: 25px; border-radius: 12px;">
          ...
          <div style="font-size: 0.95rem; color: #94a3b8;">Patna to Karnal Moves</div>
        </div>
    ...
    <div class="container">
      <div style="max-width: 900px; margin: 0 auto;">
        <h2 style="font-size: 2.2rem; font-weight: 700; color: #ffffff; margin-bottom: 20px; text-align: center;">
          Patna to Karnal Interstate Highway Route & Logistics
        </h2>
        <p style="font-size: 1.05rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px; text-align: center;">
          Moving household items ~1,150 km from Patna to Karnal requires dedicated long-distance container trucks. Our fleets route via NH 19 and NH 44 through Varanasi, Kanpur, Delhi Bypass, and Panipat directly into Karnal.
        </p>
        ...
        <div style="background: rgba(15, 23, 42, 0.6); border: 1px solid rgba(245, 158, 11, 0.2); border-radius: 12px; padding: 25px; margin-top: 30px;">
          ...
          <ul style="list-style: none; padding: 0; margin: 0; color: #cbd5e1; line-height: 2;">
            <li><i class="fas fa-check-circle" style="color: #10b981; margin-right: 10px;"></i> <strong>Primary Corridor:</strong> Patna &rarr; Varanasi &rarr; Kanpur &rarr; Delhi Bypass &rarr; Panipat &rarr; Karnal</li>
  ...
  <section style="padding: 60px 0; background: #0f172a; color: #ffffff;">
    <div class="container">
      <h2 style="font-size: 2.2rem; font-weight: 700; color: #ffffff; text-align: center; margin-bottom: 40px;">
        Relocation Services for Patna to Karnal
      </h2>
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 30px;">
        ...
        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); padding: 30px; border-radius: 12px;">
          ...
          <p style="color: #94a3b8; line-height: 1.6; font-size: 0.95rem;">Safe car shipping using enclosed hydraulic car trailers with door pickup in Patna and delivery in Karnal.</p>
        </div>
        ...
        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); padding: 30px; border-radius: 12px;">
          <div style="font-size: 2rem; color: #ec4899; margin-bottom: 15px;"><i class="fas fa-seedling"></i></div>
          <h3 style="font-size: 1.3rem; color: #ffffff; margin-bottom: 10px;">Agricultural & Institutional Logistics</h3>
          <p style="color: #94a3b8; line-height: 1.6; font-size: 0.95rem;">Specialized shifting for research personnel, agricultural equipment, and institutional inventory to Karnal hubs.</p>
        </div>
  ...
  <section style="padding: 60px 0; background: #1e293b; color: #ffffff;">
    <div class="container">
      <h2 style="font-size: 2.2rem; font-weight: 700; color: #ffffff; text-align: center; margin-bottom: 15px;">
        Patna to Karnal Estimated Tariff Chart
      </h2>
        ...
        <table style="width: 100%; border-collapse: collapse; background: rgba(15, 23, 42, 0.8); border-radius: 12px; overflow: hidden;">
          ...
          <tbody style="color: #cbd5e1;">
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.08);">
              ...
              <td style="padding: 16px 20px; color: #10b981; font-weight: 700;">₹12,200 - ₹16,800</td>
            </tr>
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.08);">
              ...
              <td style="padding: 16px 20px; color: #10b981; font-weight: 700;">₹18,800 - ₹25,000</td>
            </tr>
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.08);">
              ...
              <td style="padding: 16px 20px; color: #10b981; font-weight: 700;">₹25,000 - ₹35,000</td>
            </tr>
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.08);">
              ...
              <td style="padding: 16px 20px; color: #10b981; font-weight: 700;">₹10,000 - ₹15,500</td>
            </tr>
            <tr>
              ...
              <td style="padding: 16px 20px; color: #10b981; font-weight: 700;">₹4,300 - ₹7,200</td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  <section style="padding: 60px 0; background: #1e293b; color: #ffffff;">
    <div class="container">
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px;">
        ...
        <div style="background: rgba(15, 23, 42, 0.6); padding: 25px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.08);">
          <h3 style="color: #10b981; font-size: 1.2rem; margin-bottom: 15px;"><i class="fas fa-map-marker-alt"></i> Karnal Delivery Areas</h3>
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.8;">
            Model Town, Sector 6, 7 & 13, GT Road, Kunjpura Road, NDRI Area, Kalram, and Sector 14.
          </p>
        </div>
  ...
  <section style="padding: 50px 0; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); color: #ffffff; text-align: center;">
    <div class="container">
      <h2 style="font-size: 2.3rem; font-weight: 800; margin-bottom: 15px;">Plan Your Patna to Karnal Move Today!</h2>
      ...
      <div style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20to%20book%20Patna%20to%20Karnal%20shifting." target="_blank" style="padding: 14px 32px; background: #10b981; color: #ffffff; border-radius: 50px; font-weight: 800; text-decoration: none; box-shadow: 0 4px 15px rgba(0,0,0,0.2);">
          WhatsApp Inquiry
        </a>
      </div>
    </div>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "MovingCompany",
  "name": "Shree Ashirwad Packers and Movers Patna to Karnal",
  "url": "https://shreeashirwadpackersandmovers.com/pages/packers-and-movers-patna-to-karnal.php",
  "logo": "https://shreeashirwadpackersandmovers.com/assets/images/logo.png",
  "telephone": "+91-8409531615",
  "priceRange": "₹12200 - ₹35000",
  "description": "Certified packers and movers from Patna to Karnal. 7-layer protective packaging, dedicated sealed container trucks, car/bike carrier, and 100% transit insurance.",
  "address": {
    "@type": "PostalAddress",
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers & Movers,\n\nI would like to request a Shifting Quote from Patna to Karnal:\n- Name: " + name + "\n- Phone: " + phone + "\n- Moving From: " + moveFrom + "\n- Moving To: " + moveTo;
