  ...
  <section style="padding: 50px 0; background: #f8fafc;">
    <div class="container">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 15px;">
        ...
        <a href="<?php echo SITE_URL; ?>packers-and-movers-jamshedpur-to-sambalpur" title="Jamshedpur to Sambalpur" style="background: #fff; padding: 14px; border-radius: 6px; border: 1px solid #e2e8f0; color: #0b132b; text-decoration: none; font-weight: 600; text-align: center; display: block;"><i class="fas fa-truck-moving"></i> Jamshedpur to Sambalpur</a>
        <a href="<?php echo SITE_URL; ?>packers-and-movers-jamshedpur-to-jharsuguda" title="Jamshedpur to Jharsuguda" style="background: #fff; padding: 14px; border-radius: 6px; border: 1px solid #e2e8f0; color: #0b132b; text-decoration: none; font-weight: 600; text-align: center; display: block;"><i class="fas fa-truck-moving"></i> Jamshedpur to Jharsuguda</a>
      </div>
    </div>
  </section>
