...
$page_title = "Packers and Movers in Agwanpur Patna | Safe House & Office Shifting";
$page_desc = "Top-rated packers and movers in Agwanpur, Patna. Professional household shifting, office relocation, bike & car transportation with 100% IBA-approved GST billing.";
$page_keywords = "packers and movers in agwanpur patna, best packers and movers agwanpur, movers and packers agwanpur patna, local shifting agwanpur, house shifting services agwanpur";
$canonical_url = "https://shreeashirwadpackersandmovers.com/pages/packers-and-movers-in-agwanpur-patna.php";

$page_city = "Agwanpur, Patna, Bihar";

$faq_list = [
    [
        'q' => 'How are local house shifting services charged in Agwanpur, Patna?',
        'a' => 'Local shifting in Agwanpur and nearby areas like Barh, Bakhtiyarpur, or Futwah ranges from ₹2,500–₹5,500 for 1BHK/2BHK apartments, and ₹6,500–₹12,500 for 3BHK/independent houses including packing, loading, transport, and unloading.'
    ],
    [
        'q' => 'Which sub-localities around Agwanpur do you cover for doorstep packing & pickup?',
        'a' => 'We cover all residential sectors in and around Agwanpur including Barh, Bakhtiyarpur, Mokama corridor, and Patna East sub-localities.'
    ],
    [
        'q' => 'What packing materials are used for household items during local Agwanpur shifting?',
    ...
    [
        'q' => 'Can you handle same-day urgent house shifting in Agwanpur?',
    ...
    [
        'q' => 'How do you navigate highway access along the NH-31 corridor near Agwanpur?',
        'a' => 'Our experienced transport drivers and packing staff ensure smooth highway logistics and scheduled vehicle dispatch.'
    ],
    [
        'q' => 'Is vehicle transportation (bike/car) available alongside household shifting from Agwanpur?',
        'a' => 'Yes, we provide integrated vehicle shipping using specialized enclosed car carriers and two-wheeler hydraulic ramps for moves from Agwanpur to anywhere in India.'
    ],
    [
    ...
    [
        'q' => 'How can I book Packers and Movers in Agwanpur Patna?',
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            PACKERS AND MOVERS AGWANPUR PATNA
          </span>
          <h1 style="font-size: 2.7rem; font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #ffffff;">
            Reliable <span style="color: #f59e0b;">Packers and Movers in Agwanpur Patna</span>
          </h1>
          <p style="font-size: 1.12rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Shree Ashirwad Packers and Movers provides top-rated household shifting, office relocation, and vehicle transport in Agwanpur, Patna. Serving Barh, Bakhtiyarpur, and Patna East corridor with 100% IBA-compliant GST billing.
          </p>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20a%20shifting%20quote%20for%20Agwanpur%20Patna." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
        ...
        <div class="hero-form-card" style="background: rgba(255, 255, 255, 0.05); backdrop-filter: blur(10px); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
          <h2 style="font-size: 1.4rem; color: #ffffff; margin-bottom: 8px; font-weight: 700; text-align: center;">Get Agwanpur Quote</h2>
          ...
          <form action="#" method="POST" onsubmit="sendHeroWhatsAppLead(event, this);">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 14px;">
              <input type="text" name="move_from" class="form-control" value="Agwanpur, Patna" required style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.3); color: #fff;">
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #e2e8f0; line-height: 1.8;">
    <div class="container" style="max-width: 1000px;">
      ...
      <span class="section-tag" style="color: #f59e0b; text-transform: uppercase; font-weight: 700; font-size: 0.85rem; letter-spacing: 1px;">
        AGWANPUR NEIGHBORHOOD LOGISTICS
      </span>
      <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">
        Doorstep House & Office Relocation in <span style="color: #f59e0b;">Agwanpur, Patna</span>
      </h2>
      
      <p style="font-size: 1.05rem; color: #cbd5e1; margin-bottom: 25px;">
        Agwanpur is an important eastern sub-locality in Patna district. Shree Ashirwad Packers and Movers deploys trained packing crews and specialized transport fleets across Barh, Bakhtiyarpur, and surrounding residential areas with complete peace of mind.
      </p>

      <!-- Rate Matrix Table -->
      <div style="overflow-x: auto; margin: 40px 0;">
        <h3 style="font-size: 1.5rem; color: #ffffff; font-weight: 700; margin-bottom: 15px;">
          Estimated Relocation Rates for Agwanpur, Patna
        </h3>
        <table style="width: 100%; border-collapse: collapse; background: #172a54; border-radius: 10px; overflow: hidden; border: 1px solid rgba(245, 158, 11, 0.3);">
          <thead>
            <tr style="background: #1e3a8a; color: #f59e0b; text-align: left;">
              ...
              <th style="padding: 14px 16px;">Local Within Patna (Agwanpur)</th>
  ...
  <section class="faq-section" style="padding: 60px 0; background: #070d1e; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      <div style="text-align: center; margin-bottom: 40px;">
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff;">Frequently Asked Questions (Agwanpur Patna)</h2>
      </div>
...
<script type="application/ld+json">
{
  ...
  "description": "Top-rated packers and movers in Agwanpur, Patna with doorstep pickup and transit insurance.",
  "url": "<?php echo $canonical_url; ?>",
  "telephone": "<?php echo SITE_PHONE_RAW; ?>",
  "address": {
    "@type": "PostalAddress",
    "addressLocality": "Agwanpur, Patna",
    "addressRegion": "Bihar",
    "addressCountry": "IN"
  },
  "areaServed": "Agwanpur, Patna, Bihar",
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers,\n\nI would like a Shifting Quote for Agwanpur Patna:\n- Name: " + name + "\n- Phone: " + phone + "\n- Moving From: " + moveFrom + "\n- Moving To: " + moveTo;
