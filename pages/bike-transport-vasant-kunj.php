...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    ...
    01
    Protocol 01</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Inspect the vehicle thoroughly in daylight conditions to ensure all visible damages, defects, or modifications are documented.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Check for signs of wear and tear, scratches, dents, dings, and any other damage that may have occurred during transportation.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 03</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Verify the vehicle&#039;s overall condition against the provided pickup photos to ensure consistency.</p>
  </div>
</div>

	<h3>Odometer Verification
	
		Ask the recipient to operate the motorcycle or two-wheeler to check the odometer reading.
		Compare the recorded odometer reading with the one mentioned in the LR (Loading &amp; Unloading) Bill of Lading.
		If there is a discrepancy, clarify the situation with the recipient and the transport company to ensure accuracy.


	Signed Condition Sign-off
	
		Ask the recipient to sign and acknowledge the condition report, providing their approval on the vehicle&amp;#039;s condition at the time of delivery.
		Include a detailed description of the vehicle&amp;#039;s condition, mentioning all observed damages or defects.
		Ask the recipient to cross-check the condition report with the vehicle&amp;#039;s exterior and interior, ensuring they are satisfied with the condition.
		Collect a signed copy of the condition report from the recipient, which will serve as a proof of their approval during the delivery process.


	Importance of Daylight Condition Re-inspection</h3>
	<p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Conducting a daylight condition re-inspection is essential for accurate documentation and verification of the vehicle&#039;s condition.</p>
	<ul style="list-style: none; padding-left: 0; margin: 18px 0;">
	...
	<h3>Steps for Odometer Verification</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Steps for Odometer Verification ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
