    ...
    <div class="container" style="max-width: 950px;">
      ...
      <div style="display: grid; grid-template-columns: 1fr; gap: 20px; margin-top: 30px;">
        ...
        <div style="background: #172a54; padding: 24px; border-radius: 12px; border-left: 4px solid #f59e0b;">
          <h3 style="font-size: 1.2rem; color: #f59e0b; font-weight: 700; margin-bottom: 10px;">ðŸ“… 4 Weeks Before Moving Day: Sorting &amp; Mover Finalization</h3>
        ...
        <div style="background: #172a54; padding: 24px; border-radius: 12px; border-left: 4px solid #f59e0b;">
          <h3 style="font-size: 1.2rem; color: #f59e0b; font-weight: 700; margin-bottom: 10px;">ðŸ“… 2 Weeks Before Moving Day: Utility &amp; Address Updates</h3>
          <ul style="color: #cbd5e1; font-size: 0.95rem; margin: 0; padding-left: 20px; line-height: 1.8;">
        ...
        <div style="background: #172a54; padding: 24px; border-radius: 12px; border-left: 4px solid #f59e0b;">
          <h3 style="font-size: 1.2rem; color: #f59e0b; font-weight: 700; margin-bottom: 10px;">ðŸ“… 1 Day Before Moving Day: Final Preparation</h3>
          <ul style="color: #cbd5e1; font-size: 0.95rem; margin: 0; padding-left: 20px; line-height: 1.8;">
        ...
        <div style="background: #172a54; padding: 24px; border-radius: 12px; border-left: 4px solid #f59e0b;">
          <h3 style="font-size: 1.2rem; color: #f59e0b; font-weight: 700; margin-bottom: 10px;">ðŸ“… Moving Day &amp; Doorstep Delivery Execution</h3>
          <ul style="color: #cbd5e1; font-size: 0.95rem; margin: 0; padding-left: 20px; line-height: 1.8;">
