...
$faq_list = [
    [
        'q' => 'Why choose Shree Ashirwad Packers and Movers in Kasiadih Chatra?',
        'a' => 'We offer 15+ years of verified relocation expertise, 7-layer protective packaging, GPS-enabled container trucks, 100% IBA GST claimable billing, and affordable tariffs for Kasiadih Chatra residents.'
    ],
    [
        'q' => 'What is the estimated house shifting cost in Kasiadih Chatra?',
        'a' => 'Local house shifting in Kasiadih locality ranges from ₹3,000 to ₹5,500 for 1BHK, ₹5,500 to ₹9,500 for 2BHK, and ₹9,500 to ₹15,000 for 3BHK homes. Intercity moving rates depend on route distance and volume.'
    ],
    [
        'q' => 'Do you provide IBA-approved moving bills for employee reimbursement in Kasiadih Chatra?',
    ...
    [
        'q' => 'How are household items protected during road transport from Kasiadih Chatra?',
    ...
    [
        'q' => 'Can I transport my motorcycle or car from Kasiadih Chatra to another state?',
        'a' => 'Yes, we provide 5-layer two-wheeler wrapping and covered hydraulic car carrier transport from Kasiadih Chatra to any city across India.'
    ],
    [
        'q' => 'How far in advance should I book my move in Kasiadih Chatra?',
    ...
    [
        'q' => 'What packaging materials are used for fragile items in Kasiadih Chatra?',
    ...
    [
        'q' => 'Do you serve all residential quarters and sub-villages in Kasiadih Chatra?',
        'a' => 'Yes, our packing teams provide complete doorstep pickup and delivery services across Kasiadih locality, Sikid, Kolebira, and connecting state routes.'
    ],
    [
        'q' => 'How do I obtain a free written quotation for my move in Kasiadih Chatra?',
    ...
    [
        'q' => 'Are warehouse storage options available near Kasiadih Chatra?',
    ...
    [
        'q' => 'How are heavy beds, wardrobes, and furniture handled in Kasiadih Chatra?',
    ...
    [
        'q' => 'Is transit insurance available for long-distance shifting from Kasiadih Chatra?',
    ...
    [
        'q' => 'Can you handle commercial office and shop relocation in Kasiadih Chatra?',
    ...
    [
        'q' => 'What vehicle documents are required for auto transport from Kasiadih Chatra?',
        'a' => 'You need a copy of the Vehicle Registration Certificate (RC), valid insurance policy, PUC certificate, and owner ID proof.'
    ],
    [
        'q' => 'How do your workers handle loading in houses along narrow access lanes of Kasiadih Chatra?',
    ...
    [
        'q' => 'Can I track my moving truck live while it is in transit from Kasiadih Chatra?',
    ...
    [
        'q' => 'What payment modes are accepted for Kasiadih Chatra shifting services?',
        'a' => 'We accept UPI, online bank transfers (NEFT/RTGS), credit/debit cards, and cash upon partial or final delivery.'
    ],
    [
        'q' => 'Will there be any unexpected extra charges added on moving day in Kasiadih Chatra?',
        'a' => 'No, we strictly honor our signed written quotation. There are zero hidden fees after loading.'
    ],
    [
        'q' => 'Do you provide partial container loading for small household shipments in Kasiadih Chatra?',
        'a' => 'Yes, we offer cost-effective part-load container options for single furniture items or small household shipments.'
    ],
    [
        'q' => 'How can I book Shree Ashirwad Packers for a move in Kasiadih Chatra?',
