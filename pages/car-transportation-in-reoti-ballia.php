...
<h3>Daylight Condition Re-inspection
    ...
    01
    Protocol 01</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Upon arrival at the recipient&#039;s location, conduct a thorough inspection of the vehicle in daylight conditions.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Check for any visible signs of damage, scratches, dents, or other imperfections that may not be noticeable during the initial pickup.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 03</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Ensure that the vehicle&#039;s exterior, interior, and undercarriage are in the same condition as documented during the pickup.</p>
  </div>
</div>

<h3>Pickup Photos and Documentation

	Before the delivery, review and compare the pickup photos provided by the sender with the current condition of the vehicle.
	Take additional photos to document any discrepancies or damages found during the daylight re-inspection.
	Create a detailed report summarizing the initial pickup condition and any new findings.


Odometer Verification

	Verify the vehicle&amp;#039;s odometer reading against the information provided in the Landing Record (LR) bill of lading.
	Ask the recipient to confirm the odometer reading before signing the LR document.
	If the reading differs significantly from the provided information, discuss the issue with the recipient and obtain their consent before proceeding with the handover.


Signed Condition Sign-off

	Request the recipient to witness the re-inspection process and provide their signature on the LR bill of lading to confirm the vehicle&amp;#039;s condition.
	Include the recipient&amp;#039;s name, contact information, and handover date on the document.
	Once the recipient signs the LR, you can proceed with the vehicle handover.


By closely following these steps, both the sender and recipient can ensure a transparent and accurate record of the vehicle&amp;#039;s condition during delivery.

Daylight Re-inspection Steps:</h4><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Pickup Photos and Documentation
...
Daylight Re-inspection Steps: ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
