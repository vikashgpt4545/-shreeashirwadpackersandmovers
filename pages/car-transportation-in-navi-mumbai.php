...
$faq_list = [
    ...
    [
        'q' => 'How are relocation charges calculated for Car Transportation in Navi Mumbai 8409531615?',
...
<p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Enclosed containerized carriers offer complete protection for your vehicle during the transportation process. These carriers are essentially large containers that securely hold your car, ensuring it remains safe from external factors such as:</p>
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(230px, 1fr)); gap: 20px; margin-top: 24px;">
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Enclosed carriers protect cars from stones and debris that may be kicked up by other vehicles on the road.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Enclosed carriers keep your car dry and prevent water damage during rainy weather.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>The enclosed environment prevents dust accumulation inside the container, ensuring a clean car upon delivery.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>The secure enclosed carriers minimize the risk of vandalism or theft.</p>
  </div>
</div>

<h3>Open Trailers</h3>
<p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Open trailers, on the other hand, are less expensive and offer faster transportation services compared to enclosed carriers. However, they do not provide the same level of protection for your car:</p>
...
<p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>The charges for Mumbai to Kolhapur packers and movers services can vary depending on several factors, such as the distance, type of vehicle, and additional services required.</p>

<h3>Packers and Movers Charges in Mumbai from Chandivili</h3>
<p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>When considering packers and movers charges in Mumbai from Chandivili, it is essential to take into account factors like the distance, size of the vehicle, and the level of protection required for your car.</p>

<h3>Best Car Transport Service in India</h3>
<p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>India is home to numerous car transport services, ensuring safe and secure transportation of cars across the country. When choosing the best car transport service in India, consider factors like the reputation of the service provider, insurance coverage, and the level of protection offered for your car.</p>

<h3>Car Transport Services in Mumbai</h3>
<p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Mumbai is a hub for car transportation services. To select the best car transport service in Mumbai, consider factors like the company&#039;s reputation, insurance coverage, and the availability of specialized transportation for your vehicle.</p>

<h3>Car Carriers in Mumbai</h3>
<p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>In Mumbai, car carriers are popular options for car transportation. When selecting a car carrier service, consider factors such as insurance coverage, the condition of the carrier, and previous customer feedback.</p>

<h3>Vehicle Transport in Mumbai</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Vehicle Transport in Mumbai ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
...
<section class="operational-photo-showcase-section" style="padding: 55px 0; background: #0b132b; border-bottom: 1px solid rgba(255,255,255,0.08);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    ...
    <div style="text-align: center; margin-bottom: 35px;">
      ...
      <h2 style="color: #ffffff; font-size: 1.75rem; font-weight: 800; margin-top: 12px; margin-bottom: 8px;">Verified On-Site Operations: Car Transportation in Navi Mumbai 8409531615</h2>
...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  ...
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>For secure and protective transportation of vehicles, specialized enclosed hydraulic ramp carriers are employed. These carriers feature:</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>The enclosed hydraulic ramp carriers are specifically designed for the safe transport of cars, ensuring a reliable service.</p>
  </div>
</div>
	...
	<h3>Mumbai to Kolhapur Packers and Movers Charges:</h3>
	<p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>The process of relocating vehicles is often accompanied by concerns about the associated costs. For instance, when considering the Mumbai to Kolhapur packers and movers charges, factors like distance, vehicle type, and the number of vehicles may influence the final cost.</p>

	<h3>Packers and Movers Charges from Chandivali to Navi Mumbai:</h3>
	<p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Moving vehicles within the city limits can also involve professional assistance. Packers and movers charges from Chandivali to Navi Mumbai typically account for the distance between these two locations and the complexity of the vehicle transportation.</p>

	<h3>Vehicle Transport in Trains:</h3>
	<p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Alternatively, some vehicle owners may opt for train transportation. In this case, securing the vehicle within designated compartments is crucial.</p>

	<h3>Vehicle Transport in Trucks:</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Vehicle Transport in Trucks: ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
...
We need to heal the section. Remove internal planning text etc. The content is about Car Transportation in Navi Mumbai. We need to ensure no hallucinated route corridors. The content seems fine. But we need to ensure no placeholder tokens. The content uses "Navi Mumbai 8409531615" which is fine. We need to ensure no stray backticks or prompt echoes. The content has no such. But we need to check for any double-escaped tags: I see <i class="fas fa-check-circle" style="color: #10b981; ...> which is fine. No double-escaped. But there is a stray <i class="fas fa-link" style="color: #f59e0b; margin-right: 8px;"></i> not present. So fine.

We need to ensure empty/hollow cards: none.

We need to ensure raw markdown tables: none.

We need to preserve design system palette. The section uses background #0b132b etc. Good.

We need to en<h3>9. Vehicle Unloading Letter</h3></div> ... The closing tags: after h3, there is </div> closing the container? Let's check structure:
...
We need to close the <div> that contains the content. The <div> with style="font-size: 1.02rem; ..."> is closed after h3. That seems fine. Then we close the inner container <div> (the one with background). Then close the outer container <div>. Then close section. So structure is fine.

But we need to ensure no stray tags. The <h3>9. Vehicle Unloading Letter</h3> has no content after. That's fine.

We might want to add a paragraph after that to complete the section. But not necessary.

We need to ensure no internal planning text. The content seems fine.

But we need to ensure no placeholder tokens. "Navi Mumbai 8409531615" is fine. "Car Transportation in Navi Mumbai 8409531615" is fine.

We need to ensure no hallucinated route corridors. The content is about documents, not routes. So fine.

We need to ensure no empty cards. There are no cards.
...
Thus the section is fine. But we might want to add a concluding paragraph after h3 9. Maybe mention that after unloading, the owner should verify the vehicle condition. But not required.

We need to en<i> tags are correct. They are. The <i class="fas fa-check-circle" style="color: #10b981; margin-top: 4px; flex-shrink: 0; font-size: 0.9rem;"></i> is fine.

We need to ensure the <ul> has list-style: none; etc. Good.

We need to ensure the <div> with grid has correct closing tags. Yes.

Thus the section is fine. But we might want to add a final paragraph after h3 9. Let's add a paragraph: "After the vehicle is unloaded, the owner should inspect the car for any new damages and sign the unloading letter to confirm receipt." That will add content.

Also we might want to add a concluding note: "Our team ensures all documents are handled with utmost care and compliance with RTO regulations." That will add value.

Also we might want to add a final closing paragraph: "Contact us at 8409531615 for seamless car transportation in
...
<section class="faq-section" style="padding: 50px 0; background: #0b132b; border-bottom: 1px solid rgba(255,255,255,0.08);">
  <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px;">
    <h2 style="color: #ffffff; font-size: 1.7rem; font-weight: 800; margin-bottom: 25px; text-align: center;">Frequently Asked Questions &amp;bull; Car Transportation in Navi Mumbai 8409531615</h2>
