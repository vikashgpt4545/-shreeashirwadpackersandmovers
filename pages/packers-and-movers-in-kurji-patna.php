...
$page_title = "Packers and Movers in Kurji Patna | Local House Shifting";
$page_desc = "Hire verified packers and movers in Kurji Patna. Shree Ashirwad Packers offers safe household shifting, hospital staff moving near Kurji Holy Family Hospital & Digha Road with IBA GST bill.";
$page_keywords = "packers and movers in kurji patna, best packers and movers in kurji patna, house shifting kurji patna, room moving kurji patna, local shifting kurji patna, shree ashirwad packers kurji";
$canonical_url = "https://shreeashirwadpackersandmovers.com/pages/packers-and-movers-in-kurji-patna.php";

$faq_list = [
  [
    "q" => "What are the home shifting rates in Kurji Patna?",
    "a" => "Local household shifting charges in Kurji range from Rs 3,500 for 1 BHK, Rs 6,500 - 10,500 for 2 BHK, and Rs 10,500 - 16,000 for 3 BHK independent houses or apartment complexes."
  ],
  [
    "q" => "Which nearby areas along Danapur-Bankipore Road around Kurji are covered?",
    "a" => "We cover Kurji, Digha, Patliputra Colony, Sadaqat Ashram, LCT Ghat, Alpana Market, and surrounding north Patna sectors."
  ],
  [
  ...
  [
    "q" => "What packing materials are used for household items and furniture?",
    "a" => "We use 80-GSM bubble wraps, 5-layer corrugated boxes, waterproof stretch film, corner protectors, and heavy plastic covers."
  ],
  [
    "q" => "How do moving trucks navigate traffic near Kurji Holy Family Hospital?",
    "a" => "We schedule loading/unloading during off-peak hours and deploy compact pickup trucks (Tata Ace / Bolero Pickup) for dense residential streets."
  ],
  [
    "q" => "Is vehicle transport (car/bike) provided from Kurji Patna?",
    "a" => "Yes, we provide secure bike and car transport using specialized enclosed vehicle carriers with door-to-door pickup."
  ],
  [
    "q" => "Can you handle hospital staff and doctor relocations in Kurji?",
    "a" => "Yes, we provide fast, priority home shifting for medical professionals and hospital staff in Kurji with customized setup."
  ],
  [
  ...
  [
    "q" => "How can I book Packers and Movers in Kurji Patna?",
...
<main class="site-main">
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            PACKERS AND MOVERS KURJI PATNA
          </span>
          <h1 style="font-size: 2.7rem; font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #ffffff;">
            Professional <span style="color: #f59e0b;">Packers and Movers in Kurji Patna</span>
          </h1>
          <p style="font-size: 1.12rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Shree Ashirwad Packers and Movers provides top-tier home shifting, office relocation, and bike/car shipping in Kurji, Patna. Serving Kurji, Patliputra Colony, and Digha with 100% IBA-approved GST billing.
          </p>
        ...
        <div class="hero-form-card" style="background: rgba(255, 255, 255, 0.05); backdrop-filter: blur(10px); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
          <h2 style="font-size: 1.4rem; color: #ffffff; margin-bottom: 8px; font-weight: 700; text-align: center;">Get Kurji Quote</h2>
          ...
          <form action="#" method="POST" onsubmit="sendHeroWhatsAppLead(event, this);">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 14px;">
              <input type="text" name="move_from" class="form-control" value="Kurji Patna" required style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.3); color: #fff;">
  ...
  <section style="padding: 60px 0; background: #ffffff;">
    <div class="container">
      <div style="text-align: center; margin-bottom: 40px;">
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #0f172a;">Kurji Patna Shifting Price Matrix</h2>
        <p style="color: #64748b;">Transparent estimates for local home and office relocation in Kurji Patna</p>
      </div>
      ...
      <div style="overflow-x: auto;">
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px; border: 1px solid #e2e8f0;">
          ...
          <tbody>
            ...
            <tr style="background: #f8fafc;">
              <td style="padding: 12px; border: 1px solid #e2e8f0;"><strong>Hospital Staff / Commercial Move</strong></td>
  ...
  <section style="padding: 60px 0; background: #f8fafc;">
    <div class="container">
      <div style="text-align: center; margin-bottom: 40px;">
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #0f172a;">Why Choose Shree Ashirwad in Kurji Patna</h2>
      ...
      <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 25px;">
        ...
        <div style="background: #ffffff; padding: 25px; border-radius: 12px; border: 1px solid #e2e8f0; box-shadow: 0 4px 6px rgba(0,0,0,0.03);">
          <div style="font-size: 2rem; color: #f59e0b; margin-bottom: 15px;"><i class="fas fa-user-md"></i></div>
          <h3 style="font-size: 1.2rem; font-weight: 700; color: #0f172a; margin-bottom: 10px;">Hospital Staff Priority</h3>
          <p style="color: #64748b; font-size: 0.95rem; line-height: 1.6;">Express priority shifting for doctors and medical personnel near Kurji Holy Family Hospital.</p>
        </div>
        ...
        <div style="background: #ffffff; padding: 25px; border-radius: 12px; border: 1px solid #e2e8f0; box-shadow: 0 4px 6px rgba(0,0,0,0.03);">
          ...
          <p style="color: #64748b; font-size: 0.95rem; line-height: 1.6;">Punctual pickup and prompt delivery across Kurji Patna with zero unnecessary delays.</p>
        </div>
  ...
  <section style="padding: 60px 0; background: #ffffff;">
    <div class="container">
      <div style="text-align: center; margin-bottom: 40px;">
        ...
        <p style="color: #64748b;">Common queries regarding packers and movers services in Kurji Patna</p>
      </div>
  ...
  <section style="background: linear-gradient(135deg, #0b132b 0%, #1c2541 100%); padding: 50px 0; color: #ffffff; text-align: center;">
    <div class="container">
      <h2 style="font-size: 2.2rem; font-weight: 800; margin-bottom: 15px;">Ready for a Seamless Move in Kurji Patna?</h2>
      ...
      <div style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20need%20moving%20help%20in%20Kurji%20Patna." target="_blank" style="padding: 14px 32px; background: #10b981; color: #ffffff; border-radius: 50px; font-weight: 700; text-decoration: none;">
...
<script type="application/ld+json">
{
  ...
  "@type": "MovingCompany",
  "name": "Shree Ashirwad Packers and Movers Kurji Patna",
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers,\n\nI would like a Shifting Quote for Kurji Patna:\n- Name: " + name + "\n- Phone: " + phone + "\n- Moving From: " + moveFrom + "\n- Moving To: " + moveTo;
