...
<main class="site-main dark-theme-override">
    ...
    <div class="container">
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 25px; text-align: center;">
        <div style="background: rgba(255,255,255,0.03); padding: 25px 15px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
          <div style="font-size: 2.2rem; font-weight: 800; color: #f59e0b; margin-bottom: 5px;">2,750+</div>
          <div style="font-size: 0.9rem; color: #cbd5e1;">Bikes Transported to/from Amadalavalasa</div>
        </div>
        <div style="background: rgba(255,255,255,0.03); padding: 25px 15px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
  ...
  <section style="background: #0b132b; padding: 60px 0; color: #ffffff;">
    <div class="container">
      <div style="text-align: center; max-width: 750px; margin: 0 auto 45px;">
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff;">Why Choose Our <span style="color: #f59e0b;">Bike Transportation in Amadalavalasa</span>?</h2>
        <p style="color: #cbd5e1; font-size: 1rem; margin-top: 10px;">We deliver seamless, secure two-wheeler relocation across Amadalavalasa, Srikakulam, and nationwide destinations.</p>
      </div>
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px;">
        ...
        <div style="background: #1c2541; padding: 30px; border-radius: 12px; border-left: 4px solid #f59e0b;">
          ...
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.6;">Hassle-free collection from Srikakulam Road Railway Station, Main Market, RTC Complex, and direct delivery to your destination.</p>
        </div>
        <div style="background: #1c2541; padding: 30px; border-radius: 12px; border-left: 4px solid #f59e0b;">
        ...
        <table style="width: 100%; border-collapse: collapse; background: #0b132b; border-radius: 10px; overflow: hidden; text-align: left; font-size: 0.95rem;">
          ...
          <tbody>
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
              <td style="padding: 15px 20px; color: #ffffff; font-weight: 600;">Amadalavalasa to Vizag / Vijayawada</td>
              <td style="padding: 15px 20px; color: #cbd5e1;">~120 km</td>
              <td style="padding: 15px 20px; color: #f59e0b; font-weight: 700;">₹2,500 - ₹3,500</td>
              <td style="padding: 15px 20px; color: #f59e0b; font-weight: 700;">₹3,000 - ₹4,200</td>
              <td style="padding: 15px 20px; color: #f59e0b; font-weight: 700;">₹4,200 - ₹5,500</td>
            </tr>
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
              <td style="padding: 15px 20px; color: #ffffff; font-weight: 600;">Amadalavalasa to Hyderabad</td>
              <td style="padding: 15px 20px; color: #cbd5e1;">~720 km</td>
              ...
              <td style="padding: 15px 20px; color: #f59e0b; font-weight: 700;">₹6,200 - ₹8,200</td>
            </tr>
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
              <td style="padding: 15px 20px; color: #ffffff; font-weight: 600;">Amadalavalasa to Bangalore / Chennai</td>
              <td style="padding: 15px 20px; color: #cbd5e1;">~1,050 km</td>
              <td style="padding: 15px 20px; color: #f59e0b; font-weight: 700;">₹4,800 - ₹6,500</td>
            ...
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
              <td style="padding: 15px 20px; color: #ffffff; font-weight: 600;">Amadalavalasa to Kolkata</td>
              <td style="padding: 15px 20px; color: #cbd5e1;">~780 km</td>
              <td style="padding: 15px 20px; color: #f59e0b; font-weight: 700;">₹4,500 - ₹6,000</td>
              <td style="padding: 15px 20px; color: #f59e0b; font-weight: 700;">₹5,000 - ₹6,800</td>
  ...
  <section style="background: #0b132b; padding: 60px 0; color: #ffffff;">
    <div class="container">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px;">
        <div>
          <h3 style="font-size: 1.5rem; font-weight: 700; color: #f59e0b; margin-bottom: 20px;">Pickup Coverage in Amadalavalasa</h3>
          <ul style="list-style: none; padding: 0; display: grid; grid-template-columns: 1fr 1fr; gap: 12px; color: #cbd5e1; font-size: 0.95rem;">
            ...
            <li style="background: #1c2541; padding: 10px 15px; border-radius: 6px;">✔ Main Market & RTC Complex</li>
            <li style="background: #1c2541; padding: 10px 15px; border-radius: 6px;">✔ Srikakulam Highway Junction</li>
            <li style="background: #1c2541; padding: 10px 15px; border-radius: 6px;">✔ Industrial Estate Area</li>
          </ul>
        </div>
        <div>
          <h3 style="font-size: 1.5rem; font-weight: 700; color: #f59e0b; margin-bottom: 20px;">Intercity Route Connections</h3>
          <ul style="list-style: none; padding: 0; display: grid; grid-template-columns: 1fr 1fr; gap: 12px; color: #cbd5e1; font-size: 0.95rem;">
            <li style="background: #1c2541; padding: 10px 15px; border-radius: 6px;">✔ Amadalavalasa to Vizag</li>
            <li style="background: #1c2541; padding: 10px 15px; border-radius: 6px;">✔ Amadalavalasa to Hyderabad</li>
            <li style="background: #1c2541; padding: 10px 15px; border-radius: 6px;">✔ Amadalavalasa to Kolkata</li>
            <li style="background: #1c2541; padding: 10px 15px; border-radius: 6px;">✔ Amadalavalasa to Bangalore</li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section style="background: #0b132b; padding: 60px 0; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      <div style="text-align: center; margin-bottom: 40px;">
        ...
        <p style="color: #cbd5e1; font-size: 0.95rem; margin-top: 8px;">Got questions about bike shipping in Amadalavalasa? Here are quick answers.</p>
      </div>

      <div style="display: flex; flex-direction: column; gap: 20px;">
        <div style="background: #1c2541; padding: 25px; border-radius: 10px; border-left: 4px solid #f59e0b;">
          <h3 style="font-size: 1.15rem; color: #ffffff; margin-bottom: 10px;">How is my bike packed for shipping from Amadalavalasa?</h3>
        ...
        <div style="background: #1c2541; padding: 25px; border-radius: 10px; border-left: 4px solid #f59e0b;">
          <h3 style="font-size: 1.15rem; color: #ffffff; margin-bottom: 10px;">What documents are required for bike transport in Amadalavalasa?</h3>
        ...
        <div style="background: #1c2541; padding: 25px; border-radius: 10px; border-left: 4px solid #f59e0b;">
          <h3 style="font-size: 1.15rem; color: #ffffff; margin-bottom: 10px;">Is door-to-door bike pickup available across Amadalavalasa?</h3>
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.6;">Yes, we offer doorstep pickup from all major areas in Amadalavalasa including Railway Station Road, RTC Complex, and Srikakulam Highway directly to your destination address.</p>
        </div>
        <div style="background: #1c2541; padding: 25px; border-radius: 10px; border-left: 4px solid #f59e0b;">
  ...
  <section style="background: linear-gradient(135deg, #1c2541 0%, #0b132b 100%); padding: 60px 0; text-align: center; color: #ffffff; border-top: 1px solid rgba(245,158,11,0.3);">
    <div class="container" style="max-width: 800px;">
      <h2 style="font-size: 2.2rem; font-weight: 800; margin-bottom: 15px;">Ready to Transport Your Bike Safely from Amadalavalasa?</h2>
      ...
      <div style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20a%20bike%20shifting%20quote%20for%20Amadalavalasa." target="_blank" style="padding: 15px 35px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #fff; border-radius: 50px; font-weight: 700; font-size: 1.05rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16,185,129,0.4);">
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How is my bike packed for shipping from Amadalavalasa?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "What documents are required for bike transport in Amadalavalasa?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is door-to-door bike pickup available across Amadalavalasa?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, we offer doorstep pickup from all major areas in Amadalavalasa including Railway Station Road, RTC Complex, and Srikakulam Highway directly to your destination address."
      }
    },
    {
      "@type": "Question",
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers & Movers,\n\nI would like to request a Bike Transport Quote from Amadalavalasa:\n- Name: " + name + "\n- Phone: " + phone + "\n- Moving From: " + moveFrom + "\n- Moving To: " + moveTo;
