    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For a seamless and stress-free relocation from Butibori to Destination Hub, we recommend taking the National Highway Arterial Corridors and Multi-Axle Express Freight Highways. This route traverses through the Maharashtra border checkpost at Phanda, followed by a smooth drive through the National Highway 44 and 63 corridors. Our logistics team will ensure that your shipment is processed through the automated e-Way bill clearance process at these checkposts, facilitating a rapid and efficient transit. With speed-governed container transit, you can expect your goods to arrive at the Destination Hub within 2 to 3 working days, minimizing downtime and ensuring timely delivery.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">To ensure the safety and security of your household items or vehicles during transit, our packing and loading services are specifically designed for this corridor. We employ a team of skilled technicians who carefully wrap and secure your belongings using high-quality packing materials. Our specialized loading techniques guarantee that your shipment is properly balanced and secured, minimizing the risk of damage during transit. Our transit protection services include regular transit checks, GPS tracking, and real-time monitoring to ensure that your goods arrive at the Destination Hub in pristine condition. By choosing Shree Ashirwad Packers and Movers, you can trust that your relocation is in capable hands.</p>
        </div>
      </div>
    </div>
  </section>
