...
$page_keywords = "bike transportation in kannur, bike transport kannur kerala, motorcycle shipping mangalore bangalore, bike parcel cochi chennai";
...
<main class="site-main">
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            BIKE TRANSPORTATION KANNUR (KERALA)
          </span>
          <h1 style="font-size: 2.7rem; font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #ffffff;">
            Professional <span style="color: #f59e0b;">Bike Transportation in Kannur</span>
          </h1>
          <p style="font-size: 1.12rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Shree Ashirwad Packers and Movers provides safe, insured, and doorstep motorcycle transport across Kannur, NH-66 coastal highway corridor, and national routes. Complete with 7-layer bubble wrapping and IBA-approved GST bills.
          </p>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20a%20bike%20transport%20quote%20for%20Kannur." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
        ...
        <div class="hero-form-card" style="background: rgba(255, 255, 255, 0.05); backdrop-filter: blur(10px); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
          <h2 style="font-size: 1.4rem; color: #ffffff; margin-bottom: 8px; font-weight: 700; text-align: center;">Get Kannur Bike Quote</h2>
          ...
          <form action="#" method="POST" onsubmit="sendHeroWhatsAppLead(event, this);">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 14px;">
              <input type="text" name="move_from" class="form-control" value="Kannur, Kerala" required style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.3); color: #fff;">
  ...
  <section style="background: #070d1e; padding: 30px 0; border-bottom: 1px solid rgba(255,255,255,0.08);">
    <div class="container">
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; text-align: center;">
        ...
        <div style="background: #101c40; padding: 20px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
          <div style="font-size: 2rem; font-weight: 800; color: #f59e0b;">KL-13 RTO</div>
          <div style="font-size: 0.88rem; color: #cbd5e1; margin-top: 5px;">Kannur Kerala Network</div>
        </div>
        <div style="background: #101c40; padding: 20px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #ffffff;">
    <div class="container">
      <div style="text-align: center; max-width: 700px; margin: 0 auto 40px auto;">
        <span style="color: #f59e0b; font-weight: 700; text-transform: uppercase; font-size: 0.85rem;">WHY CHOOSE US IN KANNUR</span>
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 25px;">
        <div style="background: #101c40; padding: 25px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.08);">
          ...
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.6;">Weatherproof covered container trucks shielding your motorcycle from heavy coastal rains and highway dust.</p>
        </div>
        <div style="background: #101c40; padding: 25px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.08);">
        ...
        <div style="background: #101c40; padding: 25px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.08);">
          ...
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.6;">Door-to-door pickup across Thana, Payyambalam, Caltex Junction, South Bazar, and Cantonment.</p>
        </div>
        <div style="background: #101c40; padding: 25px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.08);">
  ...
  <section style="padding: 60px 0; background: #070d1e; color: #ffffff;">
    <div class="container">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px;">
        ...
        <div style="background: #101c40; padding: 20px; border-radius: 10px; border-left: 4px solid #f59e0b;">
          <h4 style="font-size: 1.1rem; color: #ffffff; margin-bottom: 8px;">Kannur-Bangalore-Mumbai Route</h4>
          <p style="color: #cbd5e1; font-size: 0.9rem;">Fast-track vehicle shipping connecting Kannur directly to Mangalore, Bangalore, Chennai, & Mumbai.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section style="padding: 60px 0; background: #070d1e; color: #ffffff;">
    <div class="container">
      <div style="text-align: center; margin-bottom: 30px;">
        <h2 style="font-size: 2rem; font-weight: 800;">Kannur Doorstep Pickup Localities</h2>
        <p style="color: #cbd5e1; font-size: 0.95rem;">Free doorstep pickup across Kannur city & district</p>
      </div>
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 15px; text-align: center;">
        <div style="background: #101c40; padding: 15px; border-radius: 8px; color: #cbd5e1;">Thana Area</div>
        <div style="background: #101c40; padding: 15px; border-radius: 8px; color: #cbd5e1;">Payyambalam Road</div>
        <div style="background: #101c40; padding: 15px; border-radius: 8px; color: #cbd5e1;">Caltex Junction</div>
        <div style="background: #101c40; padding: 15px; border-radius: 8px; color: #cbd5e1;">South Bazar Hub</div>
        <div style="background: #101c40; padding: 15px; border-radius: 8px; color: #cbd5e1;">Cantonment Area</div>
        <div style="background: #101c40; padding: 15px; border-radius: 8px; color: #cbd5e1;">Kizhuthalli Sector</div>
        <div style="background: #101c40; padding: 15px; border-radius: 8px; color: #cbd5e1;">NH-66 Bypass Hub</div>
        <div style="background: #101c40; padding: 15px; border-radius: 8px; color: #cbd5e1;">Mattannur Road</div>
      </div>
    </div>
  </section>
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #ffffff;">
    <div class="container">
      <div style="text-align: center; margin-bottom: 30px;">
        <h2 style="font-size: 2rem; font-weight: 800;">Popular Intercity Routes from Kannur</h2>
      </div>
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 15px; text-align: center;">
        <a href="<?php echo SITE_URL; ?>/pages/bike-transport-from-kerala-to-bangalore.php" style="background: #101c40; padding: 15px; border-radius: 8px; color: #f59e0b; text-decoration: none; font-weight: 600;">Kannur → Bangalore</a>
        <a href="<?php echo SITE_URL; ?>/pages/bike-transport-from-chennai-to-bangalore.php" style="background: #101c40; padding: 15px; border-radius: 8px; color: #f59e0b; text-decoration: none; font-weight: 600;">Kannur → Chennai</a>
        <a href="<?php echo SITE_URL; ?>/pages/bike-transport-from-mumbai-to-bangalore.php" style="background: #101c40; padding: 15px; border-radius: 8px; color: #f59e0b; text-decoration: none; font-weight: 600;">Kannur → Mumbai</a>
        <a href="<?php echo SITE_URL; ?>/pages/bike-transport-from-delhi-to-bangalore.php" style="background: #101c40; padding: 15px; border-radius: 8px; color: #f59e0b; text-decoration: none; font-weight: 600;">Kannur → Delhi</a>
      </div>
    </div>
  </section>
  ...
  <section class="faq-section" style="padding: 60px 0; background: #0b132b; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      <div style="text-align: center; margin-bottom: 40px;">
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff;">Frequently Asked Questions (Bike Transport Kannur Kerala)</h2>
      </div>
  ...
  <section style="padding: 60px 0; background: linear-gradient(135deg, #1e3a8a 0%, #0b132b 100%); color: #ffffff; text-align: center;">
    <div class="container" style="max-width: 800px;">
      <h2 style="font-size: 2.3rem; font-weight: 800; margin-bottom: 15px;">Ready to Transport Your Bike from Kannur?</h2>
      ...
      <div style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20a%20bike%20transport%20quote%20for%20Kannur." target="_blank" style="padding: 15px 35px; background: #10b981; color: #fff; border-radius: 50px; font-weight: 700; text-decoration: none; font-size: 1.1rem;">
          WhatsApp Us Now
        </a>
      </div>
    </div>
...
<script type="application/ld+json">
{
  ...
  "description": "Professional bike transportation in Kannur, Kerala with doorstep pickup and transit insurance.",
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers,\n\nI would like a Bike Transport Quote for Kannur Kerala:\n- Name: " + name + "\n- Phone: " + phone + "\n- Moving From: " + moveFrom + "\n- Moving To: " + moveTo;
