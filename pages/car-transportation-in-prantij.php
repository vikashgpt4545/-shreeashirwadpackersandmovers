...
<section class="content-ui-section" style="padding: 55px 0; background: #070d1e; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    <div style="background: rgba(15, 23, 42, 0.65); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 16px; padding: 36px 32px; box-shadow: 0 12px 30px rgba(0,0,0,0.35);">
      ...
      <div style="font-size: 1.02rem; line-height: 1.8; color: #cbd5e1;"><p>Before a vehicle departs for car transport in Prantij, a meticulous pre-loading protocol ensures safety, compliance, and customer satisfaction. Whether working with car packers and movers or a professional vehicle transport service, these systematic verification steps guarantee a secure journey from pickup to final delivery.</p>
<ul style="list-style: none; padding-left: 0; margin: 18px 0;">
  <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;"><i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i><span><strong>360-Degree Digital Condition Audit:</strong> High-resolution digital photography captures every exterior panel, undercarriage area, glass, and bumper to establish an indisputable condition baseline before departure.</span></li>
  <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;"><i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i><span><strong>Battery Terminal Inspection:</strong> Technicians inspect terminals for corrosion, disconnect auxiliary electronics to prevent parasitic battery drain during transit, and secure connections with calibrated torque.</span></li>
  <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;"><i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i><span><strong>Fuel Level Regulation:</strong> In compliance with carrier safety standards, the fuel tank is maintained at one-quarter capacity to reduce flammable load weight while enabling smooth ramp maneuvers.</span></li>
  <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;"><i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i><span><strong>FASTag & Toll Security:</strong> Active toll tags and windshield transponders are documented or shielded to prevent accidental electronic toll deductions while the vehicle is carried on trailer decks.</span></li>
</ul></div>
    </div>
  </div>
</section>
