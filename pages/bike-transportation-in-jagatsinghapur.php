...
<section class="content-ui-section" style="padding: 55px 0; background: #070d1e; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    ...
    01
    Protocol 01</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Protect bikes from external elements such as weather conditions and potential damages during transit.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Provide a secure environment for bikes, minimizing the risk of theft or tampering.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 03</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Ensure complete privacy for the bike owners, preventing unauthorized access during transportation.</p>
  </div>
</div>

	<h3>Hydraulic Ramp System:
	
		Allows easy loading and unloading of bikes, minimizing physical effort required by the users.
		Precision-engineered ramps ensure safe and gradual descent of bikes onto the carriers.
		Prevents potential damage to the bike&amp;#039;s suspension system or wheels during loading and unloading operations.</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>To prevent any movement or misalignment of bikes during transit, specialized wheel-lock chocks are employed. These chocks consist of:</p>

	<h3>Steel Construction:
	
		Rigid and durable material ensures long-lasting performance and resistance to wear and tear.
		Provides a secure grip on the bike&amp;#039;s wheels, ensuring stability during transportation.
	

	Steel Wheel-Lock Chocks:
	
		Designed to securely fit around the bike&amp;#039;s wheels.
		Precision-engineered to prevent any movement or misalignment of the wheels during transit.
		Ensures a safe and stable transportation environment for bikes.</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>To further secure the bikes during transportation, high-tensile ratchet lashing is employed. This innovative lashing system helps maintain stability and prevents any unwanted movement:</p>

	<h3>High-Tensile Strength:
	
		Made from durable high-tensile steel ensures maximum strength and reliability.
		Bears heavy loads without breaking or losing effectiveness.
	

	Adjustable Ratchet Lashing:
	
		Allows precise adjustment of tension to securely fasten the bike to the carriers.
		Ensures even distribution of tension across the bike, preventing any damage or displacement.</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>In Jagatsinghapur, various components and services contribute to the seamless transportation of bikes:</p>

	<h3>Enclosures:</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Enclosures: ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
