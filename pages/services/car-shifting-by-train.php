...
$page_title = "Car Shifting By Train | Shree Ashirwad Packers & Movers";
...
$page_keywords = "two wheeler transport by train, train bike transport, how to book train for bike transport, rk cargo packers and movers thane, best courier & cargo company in faridabad, harayana raipur cargo movers, packers and movers in faridabad charges, packers and movers in thane charges, iba approved packers and movers in bhopal, packers and movers bill, nigdi transport nagar super safe packers and movers, safe speed packers movers gurgaon, industrial packers and movers in new delhi, vision packers and movers pune reviews";
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello+Shree+Ashirwad+Packers+%26+Movers%2C+I+would+like+to+request+a+quotation+for+Car+Shifting+By+Train+from+Origin+City+to+Major+Indian+City." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="text-align: center; margin-bottom: 40px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; margin-top: 8px;">
          Car Shifting By Train <span style="color: #f59e0b;">Cost Matrix &amp; Tariffs</span>
        </h2>
    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">The user wants two authoritative, detailed paragraphs of 150-220 words total (combined) about two-wheeler transport by train and household shifting for the specified route. The route is not explicitly named; but it says &quot;Origin City (City Centre, Railway Station Road, Industrial Area) to Major Indian City (City Centre, Railway Station Road, Industrial Area)&quot;. It is basically a generic origin city to a major Indian city. The user wants to avoid generic placeholders; they likely want actual city names? The prompt says &quot;Origin City&quot; and &quot;Major Indian City&quot;. That&#039;s ambiguous. We can possibly use &quot;Lucknow&quot; or &quot;Patna&quot;? The user wants the content not generic placeholders. However the instructions: &quot;Do not use generic placeholders.&quot; Means we should use actual city names, like &quot;Patna&quot; and &quot;Delhi&quot;? Or we could treat &quot;Origin City&quot; as a placeholder replaced with something like &quot;Agra&quot; and &quot;Major Indian City&quot; as &quot;Mumbai&quot;? However the request: &quot;Route: Origin City (City Centre, Railway Station Road, Industrial Area) to Major Indian City (City Centre, Railway Station Road, Industrial Area)&quot;. This suggests we can treat them as generic but mention &quot;Origin City&quot; and &quot;Major Indian City&quot;? However the &quot;</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px;">
      <div style="text-align: center; margin-bottom: 45px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin-top: 10px;">
          Frequently Asked Questions About <span style="color: #f59e0b;">Car Shifting By Train</span>
        </h2>
      </div>
  ...
  <section style="padding: 60px 0; background: linear-gradient(135deg, #172a54 0%, #0b132b 100%); border-top: 1.5px solid rgba(245, 158, 11, 0.4); color: #ffffff;">
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px; text-align: center;">
      <h2 style="font-size: 2.3rem; font-weight: 800; margin-bottom: 16px;">
        Book Your <span style="color: #f59e0b;">Car Shifting By Train</span> Today!
      </h2>
      ...
      <div style="display: flex; gap: 16px; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="https://wa.me/918409531615?text=Hello+Shree+Ashirwad+Packers+%26+Movers%2C+I+would+like+to+request+a+quotation+for+Car+Shifting+By+Train+from+Origin+City+to+Major+Indian+City." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 15px 32px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1.05rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
          <i class="fab fa-whatsapp" style="margin-right: 8px;"></i> Chat on WhatsApp
        </a>
      </div>
    </div>
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers & Movers,\n\nI would like to request a shifting estimate for Car Shifting By Train:\n- Name: " + name + "\n- Phone: " + phone + "\n- Pickup Location: " + moveFrom + "\n- Destination Location: " + moveTo;
  ...
  "@graph": [
    {
      ...
      "knowsAbout": ["two wheeler transport by train","train bike transport","how to book train for bike transport","rk cargo packers and movers thane","best courier & cargo company in faridabad","harayana raipur cargo movers","packers and movers in faridabad charges","packers and movers in thane charges","iba approved packers and movers in bhopal","packers and movers bill","nigdi transport nagar super safe packers and movers","safe speed packers movers gurgaon","industrial packers and movers in new delhi","vision packers and movers pune reviews"],
