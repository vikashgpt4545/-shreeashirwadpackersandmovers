...
$page_title = "Index | Shree Ashirwad Packers & Movers";
$page_desc = "Get transparent, IBA-approved Index with Shree Ashirwad Packers and Movers. ~850 km via National Highway Arterial Corridors & Multi-Axle Express Freight Highways. 100% safe multi-layer packing, transit insurance, dedicated GPS container carriers, and doorstep delivery across Origin City and Major Indian City.";
$page_keywords = "household items transportation in yelahanka, luggage transfer by road in raipur cg service ex, house shifting under 1km 2bhk charges in secunderabad, cost of packers and movers in mumbai, top movers and packers in gst road, movers packers bill in chennai, safe express packers and movers gurgaon, courier packing dwarka, packers and movers in vishrantwadi, parcel from delhi to bangalore";
$canonical_url = "https://shreeashirwadpackersandmovers.com/services/index";
$page_keyword_tags = array (
  0 => 'household items transportation in yelahanka',
  1 => 'luggage transfer by road in raipur cg service ex',
  2 => 'house shifting under 1km 2bhk charges in secunderabad',
  3 => 'cost of packers and movers in mumbai',
  4 => 'top movers and packers in gst road',
  5 => 'movers packers bill in chennai',
  6 => 'safe express packers and movers gurgaon',
  7 => 'courier packing dwarka',
  8 => 'packers and movers in vishrantwadi',
  9 => 'parcel from delhi to bangalore',
);
...
$faq_list = array (
  ...
  2 => 
  array (
    'q' => 'How are relocation charges calculated for Index?',
  ...
  5 => 
  array (
    'q' => 'How many days in advance should I confirm my booking for Index?',
    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="text-align: center; margin-bottom: 40px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; margin-top: 8px;">
          Index <span style="color: #f59e0b;">Cost Matrix &amp; Tariffs</span>
        </h2>
    ...
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px;">
      <div style="text-align: center; margin-bottom: 45px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin-top: 10px;">
          Frequently Asked Questions About <span style="color: #f59e0b;">Index</span>
        </h2>
      </div>
  ...
  <section style="padding: 60px 0; background: linear-gradient(135deg, #172a54 0%, #0b132b 100%); border-top: 1.5px solid rgba(245, 158, 11, 0.4); color: #ffffff;">
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px; text-align: center;">
      <h2 style="font-size: 2.3rem; font-weight: 800; margin-bottom: 16px;">
        Book Your <span style="color: #f59e0b;">Index</span> Today!
      </h2>
  ...
  "@graph": [
    {
      ...
      "knowsAbout": ["household items transportation in yelahanka","luggage transfer by road in raipur cg service ex","house shifting under 1km 2bhk charges in secunderabad","cost of packers and movers in mumbai","top movers and packers in gst road","movers packers bill in chennai","safe express packers and movers gurgaon","courier packing dwarka","packers and movers in vishrantwadi","parcel from delhi to bangalore"],
