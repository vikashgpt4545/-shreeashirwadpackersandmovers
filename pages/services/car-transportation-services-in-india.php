...
$page_title = "Car Transportation Services In India | Shree Ashirwad Packers & Movers";
...
$page_keywords = "premium packers and movers in india, cost of moving household goods in india, transporting washing machine across state india, real cargo packers and movers bangalore review, orange cargo carriers hyderabad telangana, prakash cargo raipur contact details, bangalore local packer mover charges, packers and movers from vizag to hyderabad price, gst applicable in shifting of household goods or not, gst for movers and packers, safe express movers and packers gurgaon, safe packers and movers pvt ltd new delhi delhi, speed movers indore, packers and movers hyderabad ecil";
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello+Shree+Ashirwad+Packers+%26+Movers%2C+I+would+like+to+request+a+quotation+for+Car+Transportation+Services+In+India+from+India+to+Destination+Hub." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="text-align: center; margin-bottom: 40px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; margin-top: 8px;">
          Car Transportation Services In India <span style="color: #f59e0b;">Cost Matrix &amp; Tariffs</span>
        </h2>
    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">We need to write 2 paragraphs, 150-220 words total. Provide details: exact freight highway route, interstate border checkposts, e-Way bill clearance, speed-governed container transit. Also specific packing, loading, damage-free transit protection tailored for household items or vehicles on this corridor. Target keyword: premium packers and movers in india. Use authoritative tone, fact-grounded. Avoid placeholders. Provide precise route: from City Centre, Railway Station Road, Industrial Area (maybe a specific city like Mumbai?). Destination Hub same. Let&#039;s assume route between Delhi and Bangalore? Actually 850 km. Could be between Pune and Jaipur? 850 km is approx. Let&#039;s pick route: from &quot;City Centre, Railway Station Road, Industrial Area&quot; in Mumbai to same in Bangalore? Mumbai to Bangalore is about 980 km. 850 km could be between Nagpur and Jaipur? Let&#039;s pick a realistic route: from &quot;City Centre, Railway Station Road, Industrial Area&quot; in Nagpur to &quot;City Centre, Railway Station Road, Industrial Area&quot; in Jaipur. That&#039;s about 850 km. Provide route via NH44 (Nagpur to Jabalpur, then NH44 to Jaipur). Provide border checkposts: Nagpur to Jabalpur border of Maharashtra to Madhya Pradesh</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px;">
      <div style="text-align: center; margin-bottom: 45px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin-top: 10px;">
          Frequently Asked Questions About <span style="color: #f59e0b;">Car Transportation Services In India</span>
        </h2>
      </div>
  ...
  <section style="padding: 60px 0; background: linear-gradient(135deg, #172a54 0%, #0b132b 100%); border-top: 1.5px solid rgba(245, 158, 11, 0.4); color: #ffffff;">
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px; text-align: center;">
      <h2 style="font-size: 2.3rem; font-weight: 800; margin-bottom: 16px;">
        Book Your <span style="color: #f59e0b;">Car Transportation Services In India</span> Today!
      </h2>
      ...
      <div style="display: flex; gap: 16px; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="https://wa.me/918409531615?text=Hello+Shree+Ashirwad+Packers+%26+Movers%2C+I+would+like+to+request+a+quotation+for+Car+Transportation+Services+In+India+from+India+to+Destination+Hub." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 15px 32px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1.05rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
          <i class="fab fa-whatsapp" style="margin-right: 8px;"></i> Chat on WhatsApp
        </a>
      </div>
    </div>
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers & Movers,\n\nI would like to request a shifting estimate for Car Transportation Services In India:\n- Name: " + name + "\n- Phone: " + phone + "\n- Pickup Location: " + moveFrom + "\n- Destination Location: " + moveTo;
  ...
  "@graph": [
    {
      ...
      "knowsAbout": ["premium packers and movers in india","cost of moving household goods in india","transporting washing machine across state india","real cargo packers and movers bangalore review","orange cargo carriers hyderabad telangana","prakash cargo raipur contact details","bangalore local packer mover charges","packers and movers from vizag to hyderabad price","gst applicable in shifting of household goods or not","gst for movers and packers","safe express movers and packers gurgaon","safe packers and movers pvt ltd new delhi delhi","speed movers indore","packers and movers hyderabad ecil"],
