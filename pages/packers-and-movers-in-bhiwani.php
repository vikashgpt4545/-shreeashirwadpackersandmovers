    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For relocation from Bhiwani to the Destination Hub, we recommend utilizing the National Highway Arterial Corridors &amp; Multi-Axle Express Freight Highways to minimize transit duration. The most efficient route would be via NHAI NH-352A and NH-8, bordering the interstate checkpost at Hisar. Effective e-Way bill clearance ensures streamlined customs clearance, ensuring a smooth journey. With a speed-governed container transit, our team can guarantee a safe and efficient journey, typically spanning 2-3 working days.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">To ensure secure transit, we employ specialized packing solutions tailored for household items and vehicles. Our expert packers utilize specialized crates and boxes to protect delicate items during transit. To safeguard against accidents, we maintain a 1:1 driver-to-vehicle ratio, equipped with GPS tracking to monitor every movement. Each shipment is assigned a dedicated tracking code, enabling real-time updates on transit status. Our comprehensive insurance coverage protects against unforeseen events during transit. With Shree Ashirwad Packers and Movers, you can rely on our expert logistics services, dedicated to providing a hassle-free relocation experience.</p>
        </div>
      </div>
    </div>
  </section>
