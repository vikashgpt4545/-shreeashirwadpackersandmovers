...
$page_title = "Top Movers And Packers In Patna | Shree Ashirwad Packers & Movers";
...
$page_keywords = "top movers and packers in patna, packers and movers mehdipatnam hyderabad, best packers & movers patna, iba approved packers and movers in patna, transport furniture delhi chandigarh, house hold material shift from noida to hyderabd, transport from hyderabad to bangalore courier charges, courier rates from mumbai to bangalore for 30kgs, iba approved packers and movers in ludhiana, best and verified packers and movers, nj prosafe movers, safe india packers and movers, pashirvad ackers and movers in miyapur, sapphire packers and movers lucknow uttar pradesh";
$canonical_url = "https://shreeashirwadpackersandmovers.com/top-movers-and-packers-in-patna";
$page_keyword_tags = array (
  0 => 'top movers and packers in patna',
  1 => 'packers and movers mehdipatnam hyderabad',
  2 => 'best packers & movers patna',
  3 => 'iba approved packers and movers in patna',
  4 => 'transport furniture delhi chandigarh',
  5 => 'house hold material shift from noida to hyderabd',
  6 => 'transport from hyderabad to bangalore courier charges',
  7 => 'courier rates from mumbai to bangalore for 30kgs',
  8 => 'iba approved packers and movers in ludhiana',
  9 => 'best and verified packers and movers',
  10 => 'nj prosafe movers',
  11 => 'safe india packers and movers',
  12 => 'pashirvad ackers and movers in miyapur',
  13 => 'sapphire packers and movers lucknow uttar pradesh',
);
...
$faq_list = array (
  ...
  2 => 
  array (
    'q' => 'How are relocation charges calculated for Top Movers And Packers In Patna?',
  ...
  5 => 
  array (
    'q' => 'How many days in advance should I confirm my booking for Top Movers And Packers In Patna?',
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          ...
          <h1 style="font-size: 2.6rem; font-weight: 800; line-height: 1.25; margin-bottom: 20px; color: #ffffff;">
            Top Movers And Packers In Patna
          </h1>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello+Shree+Ashirwad+Packers+%26+Movers%2C+I+would+like+to+request+a+quotation+for+Top+Movers+And+Packers+In+Patna+from+Patna+to+Destination+Hub." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="text-align: center; margin-bottom: 40px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; margin-top: 8px;">
          Top Movers And Packers In Patna <span style="color: #f59e0b;">Cost Matrix &amp; Tariffs</span>
        </h2>
    ...
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px;">
      <div style="text-align: center; margin-bottom: 45px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin-top: 10px;">
          Frequently Asked Questions About <span style="color: #f59e0b;">Top Movers And Packers In Patna</span>
        </h2>
      </div>
  ...
  <section style="padding: 60px 0; background: linear-gradient(135deg, #172a54 0%, #0b132b 100%); border-top: 1.5px solid rgba(245, 158, 11, 0.4); color: #ffffff;">
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px; text-align: center;">
      <h2 style="font-size: 2.3rem; font-weight: 800; margin-bottom: 16px;">
        Book Your <span style="color: #f59e0b;">Top Movers And Packers In Patna</span> Today!
      </h2>
      ...
      <div style="display: flex; gap: 16px; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="https://wa.me/918409531615?text=Hello+Shree+Ashirwad+Packers+%26+Movers%2C+I+would+like+to+request+a+quotation+for+Top+Movers+And+Packers+In+Patna+from+Patna+to+Destination+Hub." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 15px 32px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1.05rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
          <i class="fab fa-whatsapp" style="margin-right: 8px;"></i> Chat on WhatsApp
        </a>
      </div>
    </div>
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers & Movers,\n\nI would like to request a shifting estimate for Top Movers And Packers In Patna:\n- Name: " + name + "\n- Phone: " + phone + "\n- Pickup Location: " + moveFrom + "\n- Destination Location: " + moveTo;
