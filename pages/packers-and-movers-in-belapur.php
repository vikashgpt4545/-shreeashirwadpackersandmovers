    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">As a senior logistics coordinator for Shree Ashirwad Packers and Movers, I can assure you that our expertise in transporting household items and vehicles from Belapur to the Destination Hub is unparalleled. For this route, we utilize the most efficient National Highway Arterial Corridors and Multi-Axle Express Freight Highways, spanning approximately 850 km. Our dedicated team ensures that all freight is cleared at interstate border checkposts, using automated e-Way bill systems for seamless compliance. Furthermore, we utilize speed-governed container transit to minimize transit duration, typically taking 2 to 3 working days.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">To ensure the safe and secure transportation of your household items or vehicles, we employ a customized packing and loading strategy, tailored to your specific needs. Our skilled technicians utilize specialized equipment and materials to protect your belongings from damage, while adhering to the highest standards of industry excellence. We also offer optional protection against accidental damage or loss during transit, providing you with added peace of mind. With Shree Ashirwad Packers and Movers, you can trust that your valuable possessions will be handled with care, and delivered to their destination on time. Our competitive rates for packer and mover in Belapur ensure that you receive the best value for your money.</p>
        </div>
      </div>
    </div>
  </section>
