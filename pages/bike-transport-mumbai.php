...
$faq_list = [
    ...
    [
        'q' => 'How are relocation charges calculated for Bike Transport in Mumbai | Safe Two-Wheeler Shifting?',
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px; margin-top: 24px;">
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Enclosed hydraulic ramp carriers are designed to protect bikes during transit. These carriers provide a fully enclosed space, ensuring your bike remains safe from external elements, such as weather conditions and potential theft.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Equipped with hydraulic ramps, these carriers make it easy to load and unload your bike, ensuring minimal physical strain on you or the transport crew.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 03</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>The enclosed structure also helps to prevent any damage to your bike&#039;s paintwork or components during transportation.</p>
  </div>
</div>
...
<h3>Transportation Modes and Services

Interstate Transport: Bike Transport Mumbai offers specialized services for interstate transportation. These services ensure that your bike reaches its destination safely and securely, regardless of the distance involved.
Transport by Train: For those who prefer using trains, Bike Transport Mumbai provides secure bike transport solutions within the train. The use of enclosed carriers and individual wheel-lock chocks ensures a safe journey by rail.
Parcel Services: Bike Transport Mumbai offers bike parcel services for those who require door-to-door delivery. With the help of enclosed carriers, wheel-lock chocks, and high-tensile ratchet lashing, your bike will be securely transported at each stage of the journey.


Additional Services</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Transportation Modes and Services
