...
$page_keywords = "car transport from pondicherry to delhi, car transport service, vehicle transport services, car shipping cost, car shifting services, auto transport, four wheeler transport, car movers and packers";
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            PONDICHERRY TO DELHI CAR SHIFTING SPECIALISTS
          </span>
          <h1 style="font-size: 2.5rem; font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #ffffff;">
            Professional <span style="color: #f59e0b;">Car Transport from Pondicherry to Delhi</span>
          </h1>
          <p style="font-size: 1.1rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Relocating your vehicle across ~2,400 km from Pondicherry (Puducherry UT) to Delhi NCR? Trust Shree Ashirwad Packers and Movers for express 6-8 day transit via NH44 North-South national highway corridor. Enclosed multi-car trailers with 100% all-risk insurance and live GPS tracking.
          </p>
        ...
        <div class="hero-form-card" style="background: rgba(255, 255, 255, 0.05); backdrop-filter: blur(10px); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
          <h2 style="font-size: 1.4rem; color: #ffffff; margin-bottom: 8px; font-weight: 700; text-align: center;">Get Pondicherry to Delhi Quote</h2>
          ...
          <form action="#" method="POST" onsubmit="sendHeroWhatsAppLead(event, this);">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 14px;">
              <input type="text" name="move_from" class="form-control" value="Pondicherry" required style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.3); color: #fff;">
      ...
      <div style="background: #0f172a; border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 35px 30px; margin-bottom: 40px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
        ...
        <div style="display: flex; flex-wrap: wrap; justify-content: space-between; align-items: center; gap: 15px; margin-bottom: 20px;">
          <span style="background: rgba(245, 158, 11, 0.1); color: #f59e0b; border: 1.5px solid rgba(245, 158, 11, 0.3); padding: 6px 20px; border-radius: 30px; font-size: 0.8rem; font-weight: 700; text-transform: uppercase; letter-spacing: 1px;">
            MASTER GUIDE &bull; PONDICHERRY TO DELHI CAR TRANSPORT
          </span>
        ...
        <h2 style="font-size: 2.1rem; font-weight: 800; color: #ffffff; line-height: 1.35; margin-bottom: 18px;">
          Complete Guide: Car Transport from Pondicherry to Delhi
        </h2>

        <p style="font-size: 1.05rem; color: #cbd5e1; line-height: 1.75; margin: 0;">
          Shipping a car ~2,400 km from <strong>Pondicherry (Puducherry UT)</strong> to <strong>Delhi NCR</strong> requires direct highway routing through Chennai, Nellore, Vijayawada, Nagpur, Jhansi, and Agra via NH44, 25-point pre-pickup condition reporting, and complete transit insurance. Shree Ashirwad Packers and Movers delivers rapid 6-8 day door-to-door vehicle transport backed by reliable <strong>car transport service</strong> and <strong>car movers and packers</strong> expertise.
        </p>
        ...
        <div style="background: rgba(245, 158, 11, 0.08); border-left: 4px solid #f59e0b; border-radius: 8px; padding: 20px 22px; margin-top: 25px;">
          ...
          <ul style="margin: 0; padding-left: 20px; color: #cbd5e1; font-size: 0.93rem; line-height: 1.75;">
            <li>Express 6 to 8 day transit via NH44 North-South national highway corridor.</li>
            ...
            <li>Full assistance with Puducherry UT to Delhi interstate RTO documents &amp; e-Way Bills.</li>
          </ul>
        </div>
      ...
      <div style="background: #0f172a; border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 16px; padding: 40px 35px; line-height: 1.8; color: #cbd5e1; font-size: 1rem; box-shadow: 0 10px 30px rgba(0,0,0,0.3);">
        ...
        <section style="margin-bottom: 35px;">
          <h2 style="font-size: 1.6rem; font-weight: 800; color: #ffffff; margin-bottom: 16px; padding-bottom: 10px; border-bottom: 2px solid rgba(245, 158, 11, 0.4);">
            1. Pondicherry to Delhi Route Logistics &amp; Transit Time
          </h2>
          <p>
            The major national highway corridor connecting Pondicherry to Delhi covers approximately 2,400 kilometers passing through Chennai, Nellore, Vijayawada, Hyderabad bypass, Nagpur, Jhansi, and Agra via NH44. Estimated <strong>four wheeler transport</strong> transit duration is <strong>6 to 8 business days</strong>.
          </p>
          <p style="margin-top: 12px;">
            Our dedicated <strong>auto transport</strong> carrier collects vehicles from across Pondicherry (White Town, Heritage Town, Lawspet, Muthialpet, Rainbow Nagar, Reddiarpalayam, Oulgaret, Villianur, Ariyankuppam, Kurumbapet) and delivers directly across Delhi NCR (South Delhi, Vasant Kunj, Saket, Hauz Khas, Greater Kailash, Dwarka, Rohini, Connaught Place, Janakpuri, Lajpat Nagar, Noida, Gurgaon).
          </p>
        </section>
        ...
        <section style="margin-bottom: 35px;">
          <h2 style="font-size: 1.6rem; font-weight: 800; color: #ffffff; margin-bottom: 16px; padding-bottom: 10px; border-bottom: 2px solid rgba(245, 158, 11, 0.4);">
            2. Estimated Car Shifting Cost Table: Pondicherry to Delhi
          </h2>
          <p>
            Below is the standard <strong>car shipping cost</strong> tariff matrix for shipping cars from Pondicherry to Delhi across open multi-car trailers and enclosed container carriers:
          </p>
            ...
            <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 0.9rem; color: #cbd5e1;">
              ...
              <tbody>
                ...
                <tr style="background: rgba(255,255,255,0.02);">
                  ...
                  <td style="padding: 12px; border: 1px solid rgba(255,255,255,0.1);">₹24,000 – ₹29,500</td>
                  <td style="padding: 12px; border: 1px solid rgba(255,255,255,0.1);">6 – 8 Days</td>
                </tr>
                <tr>
                  ...
                  <td style="padding: 12px; border: 1px solid rgba(255,255,255,0.1);">₹28,500 – ₹35,000</td>
                  <td style="padding: 12px; border: 1px solid rgba(255,255,255,0.1);">6 – 8 Days</td>
                </tr>
                <tr style="background: rgba(255,255,255,0.02);">
                  ...
                  <td style="padding: 12px; border: 1px solid rgba(255,255,255,0.1);">₹38,000 – ₹48,000</td>
                  <td style="padding: 12px; border: 1px solid rgba(255,255,255,0.1);">6 Days</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section style="margin-bottom: 35px;">
          ...
          <p>
            Transporting a vehicle interstate from Puducherry UT into Delhi NCR requires standard statutory documentation:
          </p>
        ...
        <section style="margin-bottom: 20px;">
          <h2 style="font-size: 1.6rem; font-weight: 800; color: #ffffff; margin-bottom: 16px; padding-bottom: 10px; border-bottom: 2px solid rgba(245, 158, 11, 0.4);">
            5. Why Choose Shree Ashirwad for Pondicherry to Delhi Car Shifting?
          </h2>
          <div style="background: #070d19; border: 1.5px solid rgba(245, 158, 11, 0.4); border-radius: 14px; padding: 25px;">
            <ul style="padding-left: 20px; margin: 0; line-height: 1.85; color: #cbd5e1;">
              ...
              <li><strong>Express 6-8 Day Delivery:</strong> Direct corridor highway transport via NH44 North-South corridor.</li>
              <li><strong>100% Insurance Protection:</strong> All-risk transit insurance protecting against damage or highway incidents.</li>
              <li><strong>Door-to-Door Service:</strong> Pickup directly from your residence in Pondicherry and delivery at your doorstep in Delhi.</li>
            </ul>
          </div>
        </section>
  ...
  <script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the cost of car transport from Pondicherry to Delhi?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Car transport charges from Pondicherry to Delhi range from ₹16,500 to ₹26,000 for hatchbacks and sedans, and ₹22,000 to ₹48,000 for SUVs and luxury vehicles in enclosed containers."
      }
    },
    {
      "@type": "Question",
      "name": "How long does car shipping take from Pondicherry to Delhi?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Car transport from Pondicherry to Delhi takes 6 to 8 business days via NH44 North-South national highway corridor."
      }
    },
    {
      "@type": "Question",
      "name": "Do you pickup cars across White Town and Lawspet in Pondicherry?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, we provide door-to-door pickup across all Pondicherry areas including White Town, Heritage Town, Lawspet, Muthialpet, Rainbow Nagar, and Reddiarpalayam."
      }
    },
    {
      "@type": "Question",
      "name": "What documents are required to transport a car from Pondicherry to Delhi?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    <div class="container" style="max-width: 980px; margin: 0 auto; padding: 0 15px;">
      ...
      <div style="text-align: center; margin-bottom: 35px;">
        ...
        <h2 style="font-size: 2.05rem; font-weight: 800; color: #ffffff; margin-top: 14px;">
          Questions About <span style="color: #f59e0b;">Pondicherry to Delhi Car Transport</span>
        </h2>
      </div>
      ...
      <div style="display: flex; flex-direction: column; gap: 14px;">
        ...
        <details style="background: #0f172a; border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 12px; overflow: hidden;">
          <summary style="padding: 18px 22px; color: #ffffff; font-weight: 700; font-size: 1rem; cursor: pointer; display: flex; justify-content: space-between; align-items: center;">
            <span><strong style="color: #f59e0b; margin-right: 8px;">Q1.</strong> What is the cost of car transport from Pondicherry to Delhi?</span>
          ...
          <div style="padding: 15px 22px 20px 22px; color: #cbd5e1; font-size: 0.93rem; line-height: 1.7; border-top: 1px solid rgba(255,255,255,0.08);">
            Car transport charges from Pondicherry to Delhi range from ₹16,500 to ₹26,000 for hatchbacks and sedans, and ₹22,000 to ₹48,000 for SUVs and luxury vehicles in enclosed containers.
          </div>
        </details>

        <details style="background: #0f172a; border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 12px; overflow: hidden;">
          <summary style="padding: 18px 22px; color: #ffffff; font-weight: 700; font-size: 1rem; cursor: pointer; display: flex; justify-content: space-between; align-items: center;">
            <span><strong style="color: #f59e0b; margin-right: 8px;">Q2.</strong> How long does car shipping take from Pondicherry to Delhi?</span>
            <span style="color: #f59e0b; font-size: 1.2rem; font-weight: 800;">&#43;</span>
          </summary>
          <div style="padding: 15px 22px 20px 22px; color: #cbd5e1; font-size: 0.93rem; line-height: 1.7; border-top: 1px solid rgba(255,255,255,0.08);">
            Car transport from Pondicherry to Delhi takes 6 to 8 business days via NH44 North-South national highway corridor.
          </div>
        </details>

        <details style="background: #0f172a; border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 12px; overflow: hidden;">
          <summary style="padding: 18px 22px; color: #ffffff; font-weight: 700; font-size: 1rem; cursor: pointer; display: flex; justify-content: space-between; align-items: center;">
            <span><strong style="color: #f59e0b; margin-right: 8px;">Q3.</strong> Do you pickup cars across White Town and Lawspet in Pondicherry?</span>
            <span style="color: #f59e0b; font-size: 1.2rem; font-weight: 800;">&#43;</span>
          </summary>
          <div style="padding: 15px 22px 20px 22px; color: #cbd5e1; font-size: 0.93rem; line-height: 1.7; border-top: 1px solid rgba(255,255,255,0.08);">
            Yes, we provide door-to-door pickup across all Pondicherry areas including White Town, Heritage Town, Lawspet, Muthialpet, Rainbow Nagar, and Reddiarpalayam.
          </div>
        </details>

        <details style="background: #0f172a; border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 12px; overflow: hidden;">
          <summary style="padding: 18px 22px; color: #ffffff; font-weight: 700; font-size: 1rem; cursor: pointer; display: flex; justify-content: space-between; align-items: center;">
            <span><strong style="color: #f59e0b; margin-right: 8px;">Q4.</strong> What documents are required to transport a car from Pondicherry to Delhi?</span>
            <span style="color: #f59e0b; font-size: 1.2rem; font-weight: 800;">&#43;</span>
          </summary>
          <div style="padding: 15px 22px 20px 22px; color: #cbd5e1; font-size: 0.93rem; line-height: 1.7; border-top: 1px solid rgba(255,255,255,0.08);">
    ...
    <div class="container" style="max-width: 980px; margin: 0 auto; padding: 0 15px;">
      ...
      <div style="background: linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #070d19 100%); border: 1.5px solid rgba(245, 158, 11, 0.4); border-radius: 20px; padding: 45px 30px; text-align: center; box-shadow: 0 20px 40px rgba(0,0,0,0.5);">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin-bottom: 18px; line-height: 1.3;">
          Book <span style="color: #f59e0b;">Car Transport from Pondicherry to Delhi</span> Today!
        </h2>
        ...
        <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 15px; margin-bottom: 30px;">
          ...
          <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad,%20I%20want%20to%20book%20car%20transport%20from%20Pondicherry%20to%20Delhi." title="Chat on WhatsApp" target="_blank" style="padding: 14px 28px; background: #25D366; color: #ffffff; border-radius: 30px; font-weight: 700; font-size: 1rem; text-decoration: none; display: inline-flex; align-items: center; gap: 8px; box-shadow: 0 6px 20px rgba(37, 211, 102, 0.4);">
