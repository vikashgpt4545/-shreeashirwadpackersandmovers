...
$page_title = "Packers And Movers In Patna | Shree Ashirwad Packers & Movers";
$page_desc = "Get transparent, IBA-approved Packers And Movers In Patna with Shree Ashirwad Packers and Movers. ~850 km via National Highway Arterial Corridors & Multi-Axle Express Freight Highways. 100% safe multi-layer packing, transit insurance, dedicated GPS container carriers, and doorstep delivery across Patna and Destination Hub.";
$page_keywords = "packers and movers patna, bharat packers & movers patna bihar, just dial packers and movers in patna, contact us muskan packers and movers services in patna, reetu home packers & movers, house shifting services from chennai to hyderabad, gujarat cost of relocation, goods shifting charges, packers and movers gst hsn code, packers and movers in gst road, safe india packers and movers chennai review, packing and loading movers, packers and movers in noida to bangalore, local packers and movers vadodara, top packers and movers in patna";
$canonical_url = "https://shreeashirwadpackersandmovers.com/packers-and-movers-in-patna";
$page_keyword_tags = array (
  0 => 'packers and movers patna',
  1 => 'bharat packers & movers patna bihar',
  2 => 'just dial packers and movers in patna',
  3 => 'contact us muskan packers and movers services in patna',
  4 => 'reetu home packers & movers',
  5 => 'house shifting services from chennai to hyderabad',
  6 => 'gujarat cost of relocation',
  7 => 'goods shifting charges',
  8 => 'packers and movers gst hsn code',
  9 => 'packers and movers in gst road',
  10 => 'safe india packers and movers chennai review',
  11 => 'packing and loading movers',
  12 => 'packers and movers in noida to bangalore',
  13 => 'local packers and movers vadodara',
  14 => 'top packers and movers in patna',
);

$faq_list = array (
  0 => 
  array (
    'q' => 'How are relocation charges calculated for Packers And Movers In Patna?',
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello+Shree+Ashirwad+Packers+%26+Movers%2C+I+would+like+to+request+a+quotation+for+Packers+And+Movers+In+Patna+from+Patna+to+Destination+Hub." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="text-align: center; margin-bottom: 40px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; margin-top: 8px;">
          Packers And Movers In Patna <span style="color: #f59e0b;">Cost Matrix &amp; Tariffs</span>
        </h2>
    ...
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px;">
      <div style="text-align: center; margin-bottom: 45px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin-top: 10px;">
          Frequently Asked Questions About <span style="color: #f59e0b;">Packers And Movers In Patna</span>
        </h2>
      </div>
  ...
  <section style="padding: 60px 0; background: linear-gradient(135deg, #172a54 0%, #0b132b 100%); border-top: 1.5px solid rgba(245, 158, 11, 0.4); color: #ffffff;">
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px; text-align: center;">
      <h2 style="font-size: 2.3rem; font-weight: 800; margin-bottom: 16px;">
        Book Your <span style="color: #f59e0b;">Packers And Movers In Patna</span> Today!
      </h2>
      ...
      <div style="display: flex; gap: 16px; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="https://wa.me/918409531615?text=Hello+Shree+Ashirwad+Packers+%26+Movers%2C+I+would+like+to+request+a+quotation+for+Packers+And+Movers+In+Patna+from+Patna+to+Destination+Hub." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 15px 32px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1.05rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
          <i class="fab fa-whatsapp" style="margin-right: 8px;"></i> Chat on WhatsApp
        </a>
      </div>
    </div>
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers & Movers,\n\nI would like to request a shifting estimate for Packers And Movers In Patna:\n- Name: " + name + "\n- Phone: " + phone + "\n- Pickup Location: " + moveFrom + "\n- Destination Location: " + moveTo;
  ...
  "@graph": [
    {
      ...
      "knowsAbout": ["packers and movers patna","bharat packers & movers patna bihar","just dial packers and movers in patna","contact us muskan packers and movers services in patna","reetu home packers & movers","house shifting services from chennai to hyderabad","gujarat cost of relocation","goods shifting charges","packers and movers gst hsn code","packers and movers in gst road","safe india packers and movers chennai review","packing and loading movers","packers and movers in noida to bangalore","local packers and movers vadodara","top packers and movers in patna"],
