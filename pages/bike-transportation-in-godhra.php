...
"The destination delivery handover for two‑wheelers and motorcycles is9 a10 meticulous process designed to14 preserve asset integrity and ensure customer confidence.21 It22 begins with a25 daylight condition re‑inspection that compares the vehicle’s32 present state against the original pickup photographs.39 This visual audit confirms that no45 new damage has occurred during transit and that the bike’s55 cosmetic and mechanical features remain unchanged.</div>
    </div>
  </div>
</section>
  ...
  <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 15px;">
    <div style="background: #0f172a; border-radius: 12px; overflow: hidden; border: 1px solid rgba(245, 158, 11, 0.3); box-shadow: 0 10px 30px rgba(0,0,0,0.3);">
      ...
      <div style="width: 100%; height: 380px; position: relative;">
        <iframe width="100%" height="380" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?q=Godhra+to+Panchmahal+Highway&t=&z=12&ie=UTF&iwloc=&output=embed" loading="lazy" style="border:0; width:100%; height:100%; display:block;"></iframe>
      </div>
    </div>
  </div>
</section>
