    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For a seamless relocation from Chandanagar to Hyderabad&#039;s industrial area, our expert logistics team has carefully mapped out the optimal route. The journey will commence from Chandanagar, traversing the National Highway Arterial Corridors and Multi-Axle Express Freight Highways, which are specifically designed for high-speed, damage-free transit. The route will be closely monitored at regular intervals to ensure the vehicle adheres to speed limits, thereby minimizing transit duration to 2 to 3 working days. Moreover, automated e-Way bill clearance system will be utilized to expedite the customs clearance process, reducing potential delays.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">To ensure the safe and secure transportation of your household items or vehicles, our team will employ a customized packing and loading strategy. Each item will be carefully wrapped, labeled, and secured to prevent damage during transit. We will also provide specialized protection for fragile or high-value items, such as artwork, electronics, or antique furniture. Our experienced packers will also ensure that your vehicle is properly loaded on a well-maintained trailer, equipped with safety features to prevent accidents or damage. With our expert team and optimized logistics, we guarantee a stress-free relocation experience for our clients, ensuring a quick and hassle-free move from Chandanagar to Hyderabad&#039;s industrial area.</p>
        </div>
      </div>
    </div>
  </section>
