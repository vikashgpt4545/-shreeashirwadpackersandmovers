    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For a reliable and efficient relocation from Bhayander to any destination, we recommend adhering to the National Highway Arterial Corridors and Multi-Axle Express Freight Highways. The most convenient route would be to begin at the Bhayander Railway Station Road, proceeding eastwards towards the National Highway 8. The interstate border checkpost to be cleared is the Ghaziabad checkpost, followed by the toll plazas at Gurgaon and Chandigarh. For seamless e-way bill clearance, ensure that all necessary documents are readily available, including the commercial invoice, invoice of goods, and payment receipt. Furthermore, to expedite the journey, consider utilizing speed-governed containers, which guarantee a faster transit time.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For household shifting and relocation, we employ a meticulous packing and loading process to ensure the safety and security of your belongings. Our expert packers utilize high-quality packing materials to protect your items from damage during transit. To guarantee damage-free transit, we use specialized equipment such as bubble wrap, foam sheets, and corner protectors to prevent any accidental scratches or cracks. Our containers are also equipped with GPS tracking, which allows us to monitor their movement in real-time, giving you complete peace of mind throughout the journey. We work closely with our experienced logistics team to</p>
        </div>
      </div>
    </div>
  </section>
