  ...
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    <div style="background: rgba(15, 23, 42, 0.65); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 16px; padding: 36px 32px; box-shadow: 0 12px 30px rgba(0,0,0,0.35);">
      ...
      <div style="font-size: 1.02rem; line-height: 1.8; color: #cbd5e1;">
        <p>When transporting your motorcycle to Warud, several important documents and certificates are required. Ensuring the completion and availability of these documents guarantees a smooth, secure, and fully insured relocation.</p>
        ...
        <ul style="list-style: none; padding-left: 0; margin: 18px 0;">
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            ...
            <span>A self‑attested photocopy of your Registration Certificate (RC) proves ownership and is mandatory for bike transportation.</span>
          </li>
        </ul>

        <h3>2. Current PUC Certificate</h3>
        <ul style="list-style: none; padding-left: 0; margin: 18px 0;">
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>Provide a valid Pollution Under Control (PUC) certificate to confirm the bike meets environmental standards.</span>
          </li>
        </ul>
        ...
        <ul style="list-style: none; padding-left: 0; margin: 18px 0;">
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>The bike must have a current insurance policy; this covers any accidental damage during transit.</span>
          </li>
        </ul>
        ...
        <ul style="list-style: none; padding-left: 0; margin: 18px 0;">
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>This contract, approved by the Indian Bicycle Association, records the bike’s condition, specifications, and the terms of carriage.</span>
          </li>
        </ul>

        <h3>5. Marine Transit Insurance (100 % Declared Value)</h3>
        <ul style="list-style: none; padding-left: 0; margin: 18px 0;">
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>Opt for a 100 % declared‑value marine transit insurance. It guarantees full compensation for loss or damage while the bike is in transit.</span>
          </li>
        </ul>
        ...
        <ul style="list-style: none; padding-left: 0; margin: 18px 0;">
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>Valid identity proof (Driving License, Passport, or Voter ID).</span>
          </li>
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>Proof of address (Ration Card, Electricity Bill, or Aadhaar‑linked passport‑size photograph).</span>
          </li>
        </ul>
        ...
        <ul style="list-style: none; padding-left: 0; margin: 18px 0;">
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>Ensure the bike is in good mechanical condition, with a valid PUC and insurance before handover.</span>
          </li>
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>Document the bike’s current state with clear photographs; note any scratches, dents, or accessories.</span>
          </li>
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>Remove personal belongings and securely pack loose accessories (helmets, mirrors, etc.) to prevent loss.</span>
          </li>
        </ul>

        <h3>Why Marine Transit Insurance Matters</h3>
        <ul style="list-style: none; padding-left: 0; margin: 18px 0;">
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>The policy shields you from unforeseen damages, ensuring you receive full compensation aligned with the declared value.</span>
          </li>
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>It provides peace of mind, allowing you to focus on the relocation rather than potential financial loss.</span>
          </li>
        </ul>
      </div>
    </div>
