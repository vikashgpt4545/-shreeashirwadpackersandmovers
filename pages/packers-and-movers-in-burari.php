    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For a smooth and efficient relocation from Burari to Destination Hub, our expert team at Shree Ashirwad Packers and Movers will adhere to the following freight highway route. The most preferred route for this journey is via National Highway Arterial Corridors &amp; Multi-Axle Express Freight Highways. Prior to embarking on the journey, all necessary documents, including the e-Way bill, will be generated and cleared at the respective checkposts to avoid any delays. Additionally, our vehicles are equipped with speed-governed containers, ensuring a safe and secure transit of your belongings.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">To ensure the safe and secure relocation of your household items or vehicle, our team will use specialized packing materials and techniques. We offer customized packing solutions designed specifically for this corridor, including the use of reinforced boxes and specialized padding to protect fragile items. Our transit protection measures include regular checks during transportation and careful loading of the vehicle to prevent any movement during transit. Our experienced team will also monitor the transit duration and ensure that your belongings arrive at the destination hub within the agreed-upon timeframe. With our expertise and specialized knowledge, you can trust that your relocation will be executed with utmost care and efficiency.</p>
        </div>
      </div>
    </div>
  </section>
