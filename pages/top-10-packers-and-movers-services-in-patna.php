...
$page_title = "Top 10 Packers And Movers Services In Patna | Shree Ashirwad Packers & Movers";
$page_desc = "Get transparent, IBA-approved Top 10 Packers And Movers Services In Patna with Shree Ashirwad Packers and Movers. ~850 km via National Highway Arterial Corridors & Multi-Axle Express Freight Highways. 100% safe multi-layer packing, transit insurance, dedicated GPS container carriers, and doorstep delivery across Patna and Destination Hub.";
$page_keywords = "top 10 packers and movers services in patna, packers and moversin patna, agrawal packers&movers patna office phone no, haryana packers and movers patna branch phone no, luggage transport services from bangalore to hyderabad, intercity home relocation from faridabad, packers and movers gst tax rate, packers and movers charges from ahmedabad to delhi, packers and movers hazaribagh, gst on shifting of household goods, safe secure packers & movers banglore, safe packers and movers secunderabad, packers and movers from.hsr to whitefield, most reliable movers and packers";
$canonical_url = "https://shreeashirwadpackersandmovers.com/top-10-packers-and-movers-services-in-patna";
$page_keyword_tags = array (
  0 => 'top 10 packers and movers services in patna',
  1 => 'packers and moversin patna',
  2 => 'agrawal packers&movers patna office phone no',
  3 => 'haryana packers and movers patna branch phone no',
  4 => 'luggage transport services from bangalore to hyderabad',
  5 => 'intercity home relocation from faridabad',
  6 => 'packers and movers gst tax rate',
  7 => 'packers and movers charges from ahmedabad to delhi',
  ...
  13 => 'most reliable movers and packers',
);
...
$faq_list = array (
  ...
  1 => 
  array (
    'q' => 'How are relocation charges calculated for Top 10 Packers And Movers Services In Patna?',
  ...
  array (
    ...
    'a' => 'Yes. Upon vehicle dispatch from Patna, you receive a private GPS tracking portal link and automated WhatsApp transit checkpoints as our truck clears interstate toll plazas and border checkposts en route to Destination Hub.',
  ),
  4 => 
  array (
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          ...
          <h1 style="font-size: 2.6rem; font-weight: 800; line-height: 1.25; margin-bottom: 20px; color: #ffffff;">
            Top 10 Packers And Movers Services In Patna
          </h1>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello+Shree+Ashirwad+Packers+%26+Movers%2C+I+would+like+to+request+a+quotation+for+Top+10+Packers+And+Movers+Services+In+Patna+from+Patna+to+Destination+Hub." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="text-align: center; margin-bottom: 40px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; margin-top: 8px;">
          Top 10 Packers And Movers Services In Patna <span style="color: #f59e0b;">Cost Matrix &amp; Tariffs</span>
        </h2>
    ...
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px;">
      <div style="text-align: center; margin-bottom: 45px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin-top: 10px;">
          Frequently Asked Questions About <span style="color: #f59e0b;">Top 10 Packers And Movers Services In Patna</span>
        </h2>
      </div>
  ...
  <section style="padding: 60px 0; background: linear-gradient(135deg, #172a54 0%, #0b132b 100%); border-top: 1.5px solid rgba(245, 158, 11, 0.4); color: #ffffff;">
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px; text-align: center;">
      <h2 style="font-size: 2.3rem; font-weight: 800; margin-bottom: 16px;">
        Book Your <span style="color: #f59e0b;">Top 10 Packers And Movers Services In Patna</span> Today!
      </h2>
      ...
      <div style="display: flex; gap: 16px; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="https://wa.me/918409531615?text=Hello+Shree+Ashirwad+Packers+%26+Movers%2C+I+would+like+to+request+a+quotation+for+Top+10+Packers+And+Movers+Services+In+Patna+from+Patna+to+Destination+Hub." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 15px 32px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1.05rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
          <i class="fab fa-whatsapp" style="margin-right: 8px;"></i> Chat on WhatsApp
        </a>
      </div>
    </div>
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers & Movers,\n\nI would like to request a shifting estimate for Top 10 Packers And Movers Services In Patna:\n- Name: " + name + "\n- Phone: " + phone + "\n- Pickup Location: " + moveFrom + "\n- Destination Location: " + moveTo;
  ...
  "@graph": [
    {
      ...
      "knowsAbout": ["top 10 packers and movers services in patna","packers and moversin patna","agrawal packers&movers patna office phone no","haryana packers and movers patna branch phone no","luggage transport services from bangalore to hyderabad","intercity home relocation from faridabad","packers and movers gst tax rate","packers and movers charges from ahmedabad to delhi","packers and movers hazaribagh","gst on shifting of household goods","safe secure packers & movers banglore","safe packers and movers secunderabad","packers and movers from.hsr to whitefield","most reliable movers and packers"],
