...
<main class="site-main">
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          ...
          <h1 style="font-size: 2.7rem; font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #ffffff;">
            Professional <span style="color: #f59e0b;">Bike Transportation in Bagaha Bihar</span>
          </h1>
    ...
    <div class="container">
      <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px; text-align: center;">
        <div style="padding: 20px; background: rgba(255,255,255,0.03); border-radius: 12px; border: 1px solid rgba(255,255,255,0.05);">
          <div style="font-size: 2.2rem; font-weight: 800; color: #f59e0b; margin-bottom: 5px;">9,500+</div>
  ...
  <!-- Section 3: Comprehensive Bike Shifting Services in Bagaha -->
    ...
    <div class="container">
      <div style="text-align: center; max-width: 800px; margin: 0 auto 50px;">
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin-bottom: 15px;">
          Premium Two-Wheeler Logistics Services in <span style="color: #f59e0b;">Bagaha (West Champaran)</span>
        </h2>
        <p style="font-size: 1rem; color: #94a3b8; line-height: 1.7;">
          Shree Ashirwad Packers and Movers delivers specialized end-to-end bike relocation from Bagaha, Bihar to all major Indian cities. We protect your motorcycle with multi-tier packaging and dedicated covered carrier transport.
        </p>
      </div>
      ...
      <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 30px;">
        ...
        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 14px; padding: 30px; transition: transform 0.3s ease;">
          ...
          <p style="font-size: 0.95rem; color: #94a3b8; line-height: 1.6;">
            Our team collects your bike straight from your home in Bagaha and delivers it right to your destination address anywhere across India.
          </p>
        </div>
        ...
        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 14px; padding: 30px; transition: transform 0.3s ease;">
          ...
          <p style="font-size: 0.95rem; color: #94a3b8; line-height: 1.6;">
            Stay informed with continuous WhatsApp location updates and SMS alerts from dispatch at Bagaha to final delivery.
          </p>
        </div>
    ...
    <div class="container">
      <div style="text-align: center; max-width: 800px; margin: 0 auto 40px;">
        <h2 style="font-size: 2rem; font-weight: 800; color: #ffffff; margin-bottom: 12px;">
          Estimated Bike Transportation Charges from <span style="color: #f59e0b;">Bagaha</span>
        </h2>
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #ffffff;">
    <div class="container">
      <div style="text-align: center; max-width: 800px; margin: 0 auto 40px;">
        <h2 style="font-size: 2rem; font-weight: 800; color: #ffffff; margin-bottom: 12px;">
          Required Documents for Bike Transport from Bagaha
        </h2>
        <p style="font-size: 0.95rem; color: #94a3b8;">
  ...
  <!-- Section 8: Route Network from Bagaha -->
  <section style="padding: 60px 0; background: #0f172a; color: #ffffff;">
    <div class="container">
      <div style="text-align: center; max-width: 800px; margin: 0 auto 40px;">
        <h2 style="font-size: 2rem; font-weight: 800; color: #ffffff; margin-bottom: 12px;">
          Popular Bike Shifting Routes from <span style="color: #f59e0b;">Bagaha (Bihar)</span>
        </h2>
        <p style="font-size: 0.95rem; color: #94a3b8;">
          Daily scheduled container trucks connecting Bagaha to top metropolitan hubs.
        </p>
      </div>
      ...
      <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 15px; font-size: 0.9rem;">
        <div style="background: rgba(255,255,255,0.03); padding: 14px 18px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); color: #cbd5e1;">
          <i class="fas fa-truck-moving" style="color: #f59e0b; margin-right: 8px;"></i> Bagaha to Patna
        </div>
        <div style="background: rgba(255,255,255,0.03); padding: 14px 18px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); color: #cbd5e1;">
          <i class="fas fa-truck-moving" style="color: #f59e0b; margin-right: 8px;"></i> Bagaha to Bettiah
        </div>
        <div style="background: rgba(255,255,255,0.03); padding: 14px 18px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); color: #cbd5e1;">
          <i class="fas fa-truck-moving" style="color: #f59e0b; margin-right: 8px;"></i> Bagaha to Gorakhpur
        </div>
        <div style="background: rgba(255,255,255,0.03); padding: 14px 18px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); color: #cbd5e1;">
          <i class="fas fa-truck-moving" style="color: #f59e0b; margin-right: 8px;"></i> Bagaha to Delhi NCR
        </div>
        <div style="background: rgba(255,255,255,0.03); padding: 14px 18px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); color: #cbd5e1;">
          <i class="fas fa-truck-moving" style="color: #f59e0b; margin-right: 8px;"></i> Bagaha to Kolkata
        </div>
        <div style="background: rgba(255,255,255,0.03); padding: 14px 18px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); color: #cbd5e1;">
          <i class="fas fa-truck-moving" style="color: #f59e0b; margin-right: 8px;"></i> Bagaha to Ranchi
        </div>
        <div style="background: rgba(255,255,255,0.03); padding: 14px 18px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); color: #cbd5e1;">
          <i class="fas fa-truck-moving" style="color: #f59e0b; margin-right: 8px;"></i> Bagaha to Lucknow
        </div>
        <div style="background: rgba(255,255,255,0.03); padding: 14px 18px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); color: #cbd5e1;">
          <i class="fas fa-truck-moving" style="color: #f59e0b; margin-right: 8px;"></i> Bagaha to Mumbai
        </div>
      </div>
    </div>
  </section>
        ...
        <div style="display: flex; gap: 20px; align-items: flex-start;">
          ...
          <div>
            <h3 style="font-size: 1.4rem; font-weight: 700; color: #ffffff; margin-bottom: 12px;">
              Beware of Fake & Unregistered Bike Movers in Bagaha
            </h3>
  ...
  $faqs = [
    [
      "question" => "How much does bike transportation in Bagaha cost?",
      "answer" => "Bike transportation charges in Bagaha range from ₹2,200 to ₹4,500 for regional relocations (under 400 km) and ₹4,800 to ₹9,500 for long-distance interstate shifting depending on bike model and destination."
    ],
    [
      "question" => "What documents are required for motorcycle shifting from Bagaha?",
    ...
    [
      "question" => "Is my bike insured during transit from Bagaha?",
    ...
    [
      "question" => "How many days will it take to deliver my bike from Bagaha?",
    ...
    [
      "question" => "Do you provide door-to-door pickup in Bagaha?",
      "answer" => "Yes, our team provides complete doorstep pickup from your home in Bagaha and doorstep delivery at your destination address."
    ]
  ];
  ?>
  ...
  <section style="padding: 60px 0; background: #0f172a; color: #ffffff;">
    <div class="container">
      <div style="text-align: center; max-width: 800px; margin: 0 auto 40px;">
        ...
        <p style="font-size: 0.95rem; color: #94a3b8;">
          Clear answers regarding two-wheeler transport services in Bagaha.
        </p>
      </div>
  ...
  <section style="padding: 60px 0; background: linear-gradient(135deg, #1c2541 0%, #0b132b 100%); text-align: center; color: #ffffff; border-top: 1px solid rgba(245, 158, 11, 0.3);">
    <div class="container">
      <h2 style="font-size: 2.4rem; font-weight: 800; margin-bottom: 15px;">
        Book Safe Bike Transportation in <span style="color: #f59e0b;">Bagaha Today</span>
      </h2>
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers & Movers,\n\nI would like to request a Bike Shipping Quote for Bagaha:\n- Name: " + name + "\n- Phone: " + phone + "\n- Pickup Location: " + moveFrom + "\n- Moving To: " + moveTo;
