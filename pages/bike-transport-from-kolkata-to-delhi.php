...
$page_keywords = "bike transport from kolkata to delhi, bike shipping kolkata to delhi, motorcycle transport kolkata to delhi charges, bike courier service kolkata delhi, two wheeler relocation kolkata delhi ncr";
...
<main class="site-main" style="background-color: #0b132b; color: #cbd5e1; font-family: 'Inter', sans-serif;">
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            KOLKATA TO DELHI BIKE RELOCATION
          </span>
          ...
          <p style="font-size: 1.05rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Relocate your motorcycle safely from Kolkata to Delhi NCR (1,500+ km) with 100% door-to-door protection. Multi-layer bubble wrapping, enclosed container trucks, GPS tracking, and comprehensive transit insurance included.
          </p>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20need%20a%20quote%20for%20bike%20transport%20from%20Kolkata%20to%20Delhi." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
        ...
        <div class="hero-form-card" style="background: rgba(255, 255, 255, 0.04); backdrop-filter: blur(10px); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
          <h2 style="font-size: 1.3rem; color: #ffffff; margin-bottom: 8px; font-weight: 700; text-align: center;">Get Kolkata → Delhi Quote</h2>
    ...
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 25px; text-align: center;">
        <div style="background: rgba(255,255,255,0.03); padding: 20px; border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <div style="font-size: 2.2rem; font-weight: 800; color: #f59e0b;">6,100+</div>
        ...
        <div style="background: rgba(255,255,255,0.03); padding: 20px; border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          ...
          <div style="font-size: 0.9rem; color: #94a3b8;">NH19 Grand Trunk Road Corridor</div>
        </div>
        <div style="background: rgba(255,255,255,0.03); padding: 20px; border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
  ...
  <section style="padding: 60px 0; background: #0b132b;">
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 15px;">
      <h2 style="font-size: 2rem; font-weight: 800; text-align: center; color: #ffffff; margin-bottom: 15px;">
        Why Choose Our <span style="color: #f59e0b;">Kolkata to Delhi</span> Bike Transport?
      </h2>
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 25px;">
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border-left: 4px solid #f59e0b;">
          ...
          <p style="font-size: 0.9rem; color: #94a3b8; line-height: 1.6;">Weatherproof covered container vehicles shield your vehicle against highway dust, rain, and vibrations along NH19 (Grand Trunk Road).</p>
        </div>
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border-left: 4px solid #f59e0b;">
        ...
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border-left: 4px solid #f59e0b;">
          ...
          <p style="font-size: 0.9rem; color: #94a3b8; line-height: 1.6;">Direct delivery across Delhi NCR including Gurgaon, Noida, Greater Noida, Ghaziabad, and Faridabad.</p>
        </div>
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border-left: 4px solid #f59e0b;">
  ...
  <section style="padding: 60px 0; background: #1c2541; border-top: 1px solid rgba(255, 255, 255, 0.05);">
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 15px;">
      <h2 style="font-size: 2rem; font-weight: 800; text-align: center; color: #ffffff; margin-bottom: 15px;">
        Estimated <span style="color: #f59e0b;">Kolkata to Delhi</span> Bike Shifting Charges
      </h2>
      <p style="text-align: center; color: #94a3b8; max-width: 700px; margin: 0 auto 40px auto; font-size: 0.95rem;">
        ...
        <table style="width: 100%; border-collapse: collapse; text-align: left; color: #cbd5e1; font-size: 0.95rem;">
          ...
          <tbody>
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
              ...
              <td style="padding: 16px; border-right: 1px solid rgba(255,255,255,0.05);">₹ 4,200 - ₹ 5,500</td>
              <td style="padding: 16px; border-right: 1px solid rgba(255,255,255,0.05); color: #f59e0b;">₹ 5,500 - ₹ 7,000</td>
            ...
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
              ...
              <td style="padding: 16px; border-right: 1px solid rgba(255,255,255,0.05);">₹ 5,500 - ₹ 7,200</td>
              <td style="padding: 16px; border-right: 1px solid rgba(255,255,255,0.05); color: #f59e0b;">₹ 7,200 - ₹ 8,800</td>
              <td style="padding: 16px;">3 - 5 Days</td>
            </tr>
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
              ...
              <td style="padding: 16px; border-right: 1px solid rgba(255,255,255,0.05);">₹ 7,200 - ₹ 9,000</td>
              <td style="padding: 16px; border-right: 1px solid rgba(255,255,255,0.05); color: #f59e0b;">₹ 9,000 - ₹ 11,000</td>
              <td style="padding: 16px;">3 - 5 Days</td>
            </tr>
            <tr>
              ...
              <td style="padding: 16px; border-right: 1px solid rgba(255,255,255,0.05);">₹ 11,000 - ₹ 14,000</td>
              <td style="padding: 16px; border-right: 1px solid rgba(255,255,255,0.05); color: #f59e0b;">₹ 14,000 - ₹ 17,500</td>
              <td style="padding: 16px;">3 - 5 Days</td>
            </tr>
          </tbody>
        </table>
  ...
  <section style="padding: 60px 0; background: #0b132b; border-top: 1px solid rgba(255,255,255,0.05);">
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px;">
      <h2 style="font-size: 2rem; font-weight: 800; text-align: center; color: #ffffff; margin-bottom: 30px;">
        Frequently Asked Questions — <span style="color: #f59e0b;">Kolkata to Delhi</span>
      </h2>

      <div style="display: flex; flex-direction: column; gap: 20px;">
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
          <h3 style="font-size: 1.1rem; color: #ffffff; margin-bottom: 10px;">What is the cost of bike transport from Kolkata to Delhi?</h3>
          <p style="font-size: 0.9rem; color: #94a3b8; line-height: 1.6;">The cost generally ranges between ₹4,200 and ₹9,000 depending on bike model, engine capacity, and packaging selection.</p>
        </div>
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
          <h3 style="font-size: 1.1rem; color: #ffffff; margin-bottom: 10px;">How long does it take to deliver a bike from Kolkata to Delhi?</h3>
          <p style="font-size: 0.9rem; color: #94a3b8; line-height: 1.6;">Transit time is usually 3 to 5 days via express covered container trucks along NH19 Grand Trunk Road.</p>
        </div>
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
        ...
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
          <h3 style="font-size: 1.1rem; color: #ffffff; margin-bottom: 10px;">Is door-to-door delivery available across Delhi NCR?</h3>
          <p style="font-size: 0.9rem; color: #94a3b8; line-height: 1.6;">Yes, we pick up directly from Kolkata and deliver anywhere across Delhi NCR including Gurgaon, Noida, Ghaziabad, and Faridabad.</p>
        </div>
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
  ...
  <section style="padding: 60px 0; background: linear-gradient(135deg, #1c2541 0%, #0b132b 100%); text-align: center; border-top: 1px solid rgba(245, 158, 11, 0.3);">
    <div class="container" style="max-width: 900px; margin: 0 auto; padding: 0 15px;">
      <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin-bottom: 15px;">Book Your Kolkata to Delhi Bike Transport Today!</h2>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the cost of bike transport from Kolkata to Delhi?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The cost generally ranges between ₹4,200 and ₹9,000 depending on bike model, engine capacity, and packaging selection."
      }
    },
    {
      "@type": "Question",
      "name": "How long does it take to deliver a bike from Kolkata to Delhi?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Transit time is usually 3 to 5 days via express covered container trucks along NH19 Grand Trunk Road."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "Is door-to-door delivery available across Delhi NCR?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, we pick up directly from Kolkata and deliver anywhere across Delhi NCR including Gurgaon, Noida, Ghaziabad, and Faridabad."
      }
    },
    {
      "@type": "Question",
