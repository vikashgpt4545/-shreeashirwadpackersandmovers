    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For a seamless and efficient relocation from Chandigarh to any destination hub, our team at Shree Ashirwad Packers and Movers meticulously plans the exact freight highway route. This route spans across National Highway Arterial Corridors and Multi-Axle Express Freight Highways, totaling approximately 850 km. Strategically, we adhere to interstate border checkposts, ensuring timely compliance with regulations. Moreover, we utilize automated e-Way bill clearance to expedite the clearance process, significantly reducing transit time. With a focus on speed-governed container transit, our team ensures a smooth, fast, and safe journey for your household items or vehicles.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">To ensure damage-free transit protection, our packing and loading team is well-versed in tailoring specific solutions for household items. We utilize sturdy, specially designed packing materials to safeguard your belongings during transit. Additionally, our expert drivers expertly load and secure the containers to prevent any movement during transit, thereby guaranteeing the integrity of your belongings. We maintain a meticulous record of the entire relocation process, allowing us to track and verify the transit of your items in real-time. By leveraging our expertise and equipment, we provide a worry-free relocation experience, ensuring your household items or vehicles arrive safely at your destination hub.</p>
        </div>
      </div>
    </div>
  </section>
