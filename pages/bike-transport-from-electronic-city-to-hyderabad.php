...
$faq_list = [
    ...
    [
        'q' => 'How long does shipment transit take from Electronic City to Hyderabad?',
    ...
    [
        'q' => 'How are relocation charges calculated for Bike Transport from Electronic City to Hyderabad | Two-Wheeler Shifting Charges?',
        'a' => 'Our moving estimates between Electronic City and Hyderabad are calculated using transparent parameters: total consignment volume (cft), distance (~650 km), packaging material grade (7-layer corrugated and bubble sheets), dedicated enclosed container capacity, and insurance declaration. We provide 100% itemized, fixed-price quotations with zero moving-day surcharges.'
    ],
    [
        'q' => 'Do you offer temporary warehousing if my new residence in Hyderabad is not ready?',
    ...
    [
        ...
        'a' => 'Yes. Upon vehicle dispatch from Electronic City, you receive a private GPS tracking portal link and automated WhatsApp transit checkpoints as our truck clears interstate toll plazas and border checkposts en route to Hyderabad.'
    ],
    [
        'q' => 'How many days in advance should I confirm my booking for Bike Transport from Electronic City to Hyderabad | Two-Wheeler Shifting Charges?',
        'a' => 'For regional moves within Electronic City, booking 2 to 3 days prior is recommended. For intercity transit to Hyderabad, we advise confirming 4 to 7 days ahead to reserve dedicated weatherproof container trucks and preferred morning departure slots.'
    ],
];
...
We need to produce a healed HTML section. The user provided a defective section. We must produce a new section with correct content. The instructions: "Return ONLY the healed, complete, valid HTML <section>...</section> code block. Absolutely NO markdown code fences (```html), NO conversational replies."

We must incorporate the content guidelines: 280-340 words, using <ul style="list-style: none; padding-left: 0; margin: 18px 0;"> and <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;"><i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i><span>.

Also we must preserve design system: dark navy palette (#0b132b or rgba(15,23,42,0.75)), color #ffffff / #cbd5e1, badges, Verified Shree Ashirwad Standard tags. We need to include packaging tiers badge? The original had a badge. We can keep that.

Also we need to remove AI thought leaks, etc. So we need to produce a clean section.

We need to incorporate the content: packaging material specifications & labor cost optimization for bike transport from Electronic City to Hyderabad. Provide 280-340 words. Use list items.

We also need to include the phrase "packers and movers near hitech city hyderabad" maybe. The user didn't explicitly ask to include that phrase, but they said "We need to weave in the given phrases." The phrases were not listed in the user message? They mention "They want us to weave in the given phrases." But the user didn't list them. The earlier part of the conversation had "The phrases are: We need to incorporate these into the text." But they didn't list them. Maybe they omitted. But we can still produce content with relevant phrases: "packers and movers near hitech city hyderabad", "Bike Transport from Electronic City to Hyderabad", "Two-Wheeler Shifting Charges", "Verified Shree Ashirwad Standard".

We need to keep the design: background #0b132b, color #cbd5e1, etc.

We need to produce a section with container, card, badge, heading, and the list.

We need to ensure the list is 280-340 words. Let's craft 8 items each ~40 words. Let's write them and count.

I'll draft each item and count words.

Item 1: "Heavy‑Duty Corrugated Cartons – These double‑wall cartons resist crushing forces and absorb shock, ensuring that the bike’s frame and components stay intact during transit. For a 250 kg motorcycle, they reduce the risk of denting or broken gears."

Count words: Heavy‑Duty(1) Corrugated(2) Cartons(3) –(4) These(5) double‑wall(6) cartons(7) resist(8) crushing(9) forces(10) and(11) absorb(12) shock,(13) ensuring(14) that(15) the(16) bike’s(17) frame(18) and(19) components(20) stay(21) intact(22) during(23) transit.(24) For(25) a(26) 250 kg(27) motorcycle,(28) they(29) reduce(30) the(31) risk(32) of(33) denting(34) or(35) broken(36) gears.(37)

37 words. Good.

Item 2: "Bubble Cushioning – Layering high‑density bubble wrap around the engine, handlebars, and seat cushions provides a 3‑inch buffer that mitigates vibration and road bumps. This simple yet effective layer cuts down on micro‑scratches and keeps the paint job pristine."

Count: Bubble(1) Cushioning(2) –(3) Layering(4) high‑density(5) bubble(6) wrap(7) around(8) the(9) engine,(10) handlebars,(11) and(12) seat(13) cushions(14) provides(15) a(16) 3‑inch(17) buffer(18) that(19) mitigates(20) vibration(21) and(22) road(23) bumps.(24) This(25) simple(26) yet(27) effective(28) layer(29) cuts(30) down(31) on(
  ...
  <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
    <div style="background: rgba(15, 23, 42, 0.85); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 26px 24px; box-shadow: 0 10px 30px rgba(0,0,0,0.35);">
      ...
      <h2 style="color: #ffffff; font-size: 1.6rem; font-weight: 800; margin: 0 0 16px 0; line-height: 1.3;">
        Seamless Shifting Across Highway Corridors: <span style="color: #f59e0b;">Electronic City &amp; Hyderabad Operations</span>
      </h2>
      <p style="color: #cbd5e1; font-size: 0.96rem; line-height: 1.75; margin: 0;">
        Whether you are coordinating an outstation residential shift from Electronic City to Hyderabad or planning an interstate industrial transfer, choosing certified <a href="<?php echo SITE_URL; ?>" title="Packers and Movers" style="color: #f59e0b; font-weight: 700; text-decoration: underline;">packers and movers</a> ensures your furniture, appliances, and vehicle reach without transit damage. As Jharkhand's trusted relocation brand, Shree Ashirwad operates as premier <a href="<?php echo SITE_URL; ?>" title="Shree Ashirwad Packers and Movers" style="color: #f59e0b; font-weight: 700; text-decoration: underline;">packers and movers</a> with regular dedicated container truck departures directly linked to our state operations at <a href="<?php echo SITE_URL; ?>packers-and-movers-in-ranchi" title="Packers and Movers in Ranchi" style="color: #38bdf8; font-weight: 700; text-decoration: underline;">packers and movers in Ranchi</a>, providing complete end-to-end packing, GPS consignment tracking, and verified IBA-approved reimbursement billing for families and professionals throughout Electronic City to Hyderabad highway corridor.
      </p>
    </div>
  </div>
</section>
  ...
  <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px;">
    <h2 style="color: #ffffff; font-size: 1.7rem; font-weight: 800; margin-bottom: 25px; text-align: center;">Dedicated Heavy-Haul &amp; Fleet Specifications</h2>
      ...
      <div style="margin-bottom: 14px; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 8px; padding: 16px 20px;">
        <h3 style="color: #f8fafc; font-size: 1.1rem; font-weight: 700; margin-bottom: 8px;">Dedicated Heavy-Haul &amp; Fleet Specifications</h3>
    ...
    <div style="background: #0f172a; border-radius: 12px; overflow: hidden; border: 1px solid rgba(245, 158, 11, 0.3); box-shadow: 0 10px 30px rgba(0,0,0,0.3);">
      <div style="padding: 16px 24px; background: rgba(245, 158, 11, 0.08); border-bottom: 1px solid rgba(245, 158, 11, 0.2); display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 10px;">
        <div style="color: #f59e0b; font-weight: 700; font-size: 1.05rem; display: flex; align-items: center; gap: 10px;">
          <span>📍</span> Verified Relocation Corridor &amp; GPS Hub: Electronic City to Hyderabad Highway
        </div>
      ...
      <div style="width: 100%; height: 380px; position: relative;">
        <iframe width="100%" height="380" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?q=Electronic+City+to+Hyderabad+Highway&t=&z=12&ie=UTF8&iwloc=&output=embed" loading="lazy" style="border:0; width:100%; height:100%; display:block;"></iframe>
      </div>
    </div>
  </div>
</section>
