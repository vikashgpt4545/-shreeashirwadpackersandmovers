...
$page_title = "Car Transportation in Sasaram | Professional Car Carrier Rohtas";
$page_desc = "Reliable car transportation in Sasaram, Rohtas district, Bihar. Open & enclosed hydraulic car carriers, doorstep pick-up, and full transit insurance via NH-19 GT Road.";
$page_keywords = "car transportation in sasaram, best car carrier sasaram, affordable car shipping rohtas, car movers sasaram, doorstep car delivery sasaram";
...
$faq_list = [
    [
        'q' => 'How are cars safely transported to/from Sasaram (BR-24 Rohtas)?',
    ...
    [
        'q' => 'What are the car transport rates from Sasaram to Patna, Varanasi, or Delhi?',
    ...
    [
        'q' => 'Which major transport highways serve Sasaram car shipping?',
        'a' => 'Car carriers travel via the NH-19 (Golden Quadrant / GT Road corridor), connecting Sasaram, Bhabua, Varanasi, and Dehri-on-Sone.'
    ],
    [
        'q' => 'Do you pick up cars directly from residences in Sasaram?',
    ...
    [
        'q' => 'Is transit insurance included during Sasaram car shipping?',
    ...
    [
        'q' => 'What documentation is required to ship a car from Sasaram?',
    ...
    [
        'q' => 'How long does car carrier delivery take from Sasaram?',
    ...
    [
        'q' => 'How can I book car carrier service in Sasaram?',
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            CAR TRANSPORTATION SASARAM (ROHTAS BR-24)
          </span>
          <h1 style="font-size: 2.7rem; font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #ffffff;">
            Professional <span style="color: #f59e0b;">Car Transportation in Sasaram</span>
          </h1>
          <p style="font-size: 1.12rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Shree Ashirwad Packers and Movers provides doorstep car carrier services across Sasaram (Rohtas district headquarters) via NH-19 GT Road express corridor. Featuring open-trailer and enclosed car container shipping, hydraulic ramp loading, 4-point wheel locks, and 100% IBA-compliant GST billing.
          </p>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20a%20car%20transport%20quote%20for%20Sasaram." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #e2e8f0; line-height: 1.8;">
    <div class="container" style="max-width: 1000px;">
      ...
      <span class="section-tag" style="color: #f59e0b; text-transform: uppercase; font-weight: 700; font-size: 0.85rem; letter-spacing: 1px;">
        ROHTAS DISTRICT VEHICLE LOGISTICS
      </span>
      <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">
        Doorstep Car Carrier Shipping in <span style="color: #f59e0b;">Sasaram</span>
      </h2>
      
      <p style="font-size: 1.05rem; color: #cbd5e1; margin-bottom: 25px;">
        Shree Ashirwad Packers and Movers provides safe car transportation across Sasaram town, GT Road, Fazalganj, Dehri-on-Sone, and Rohtas district. We utilize open multi-car trailers and single-car enclosed hydraulic containers equipped with 4-point wheel tie-down safety locks.
      </p>

      <!-- Rate Matrix Table -->
      <div style="overflow-x: auto; margin: 40px 0;">
        <h3 style="font-size: 1.5rem; color: #ffffff; font-weight: 700; margin-bottom: 15px;">
          Estimated Car Carrier Rates for Sasaram
        </h3>
  ...
  <section class="faq-section" style="padding: 60px 0; background: #070d1e; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      <div style="text-align: center; margin-bottom: 40px;">
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff;">Frequently Asked Questions (Car Transport Sasaram)</h2>
      </div>
...
<script type="application/ld+json">
{
  ...
  "description": "Professional car transportation in Sasaram, Rohtas district, Bihar with doorstep pickup and transit insurance.",
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers,\n\nI would like a Car Transport Quote for Sasaram:\n- Name: " + name + "\n- Phone: " + phone + "\n- Moving From: " + moveFrom + "\n- Moving To: " + moveTo;
