    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For a secure and efficient household shifting experience from Bhandup to the Destination Hub, we employ a carefully crafted freight highway route. Our route utilizes National Highway Arterial Corridors and Multi-Axle Express Freight Highways, ensuring a swift and hassle-free journey. The exact route begins at Bhandup&#039;s City Centre, where our team efficiently loads and secures household items onto our specially designed container. From there, the container traverses through the interstate border checkpost at the Mumbai-Pune border, where automated e-Way bill clearance facilitates seamless clearance.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">To guarantee damage-free transit, we meticulously pack and load each item, taking care to prevent even minor movements that could lead to damage. Our team utilizes customized packaging materials and specialized loading techniques to safeguard delicate items, such as fine china, glassware, and electronics. Additionally, our team provides real-time tracking and updates on the container&#039;s journey, ensuring you&#039;re always informed about the status of your relocation. By leveraging speed-governed container transit and expert packing and loading techniques, we guarantee a smooth and secure relocation experience, making us the go-to packers and movers in Bhandup.</p>
        </div>
      </div>
    </div>
  </section>
