...
$faq_list = [
    ...
    [
        'q' => 'How are relocation charges calculated for Car Transportation in Namagiripettai 8409531615?',
...
<section class="operational-photo-showcase-section" style="padding: 55px 0; background: #0b132b; border-bottom: 1px solid rgba(255,255,255,0.08);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    ...
    <div style="text-align: center; margin-bottom: 35px;">
      ...
      <h2 style="color: #ffffff; font-size: 1.75rem; font-weight: 800; margin-top: 12px; margin-bottom: 8px;">Verified On-Site Operations: Car Transportation in Namagiripettai 8409531615</h2>
...
We need to heal the HTML section. Remove AI thought leaks, etc. The content is about Car Transportation in Namagiripettai. We need to keep design system palette: background #0b132b or rgba(15,23,42,0.75). Colors: #ffffff / #cbd5e1. Badges etc. We need to ensure no internal planning text. The current content has no such text. But we need to ensure no stray backticks or prompt echoes. There are no backticks. We need to check for double-escaped tags: I see <i class="fas fa-check-circle" style="color: #10b981; ...> which is fine. No double-escaped. But there is a stray <i class="fas fa-check-circle" style="color: #10b981; margin-top: 4px; flex-shrink: 0; font-size: 0.9rem;"></i> inside list items. That's fine.

We need to en<section>...</section> code block, no markdown fences. So just output the section.

We might want to adjust some inline styles to match design system: background #0b132b for outer section. Also maybe adjust container background to rgba(15,23,42,0.75). But it's fine.

Also we might want to add a "Verified Shree Ashirwad Standard" badge somewhere? The instruction says preserve the exact dark navy palette, badges, and 'Verified Shree Ashirwad Standard' tags. But the current content doesn't have that. We could add a badge at the top maybe. But not required? The instruction says preserve the exact dark navy palette, badges, and 'Verified Shree Ashirwad Standard' tags. That implies we should include a badge somewhere. We can add a small badge near the heading.

Let's add a span with class "badge" style: background: #60a5fa; color: #ffffff; border-radius: 20px; padding: 4px 12px; font-size: 0.78rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; margin-left: 8px; maybe.

But we need to keep the same style as earlier: the earlier span had background rgba(59,130,246,0.12); color #60a5fa; etc. We can keep that.

We can add a second span: "Verified Shree Ashirwad Standard" with style: background: #10b981; color: #ffffff; border-radius: 20px; padding: 4px 12px; font-size: 0.78rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; display: inline-block; margin-left: 8px; maybe.

But the instruction: "Preserve the exact dark navy palette (background: #0b132b or rgba(15, 23, 42, 0.75); color: #ffffff / #cbd5e1; badges, and 'Verified Shree Ashirwad Standard' tags)." So we need to include that tag. Let's add a badge after the heading.

Also we need to ensure the outer section background uses #0b132b. Let's change style to background: #0b132b; color:
...
<section class="faq-section" style="padding: 50px 0; background: #0b132b; border-bottom: 1px solid rgba(255,255,255,0.08);">
  <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px;">
    <h2 style="color: #ffffff; font-size: 1.7rem; font-weight: 800; margin-bottom: 25px; text-align: center;">Frequently Asked Questions &amp;bull; Car Transportation in Namagiripettai 8409531615</h2>
