...
$faq_list = [
    [
        'q' => 'How long does shipment transit take from East Godavari District to null?',
    ...
    [
        'q' => 'How are relocation charges calculated for Car Transportation in East Godavari | Safe Carrier Service?',
        'a' => 'Our moving estimates between East Godavari District and null are calculated using transparent parameters: total consignment volume (cft), distance (~350 km), packaging material grade (7-layer corrugated and bubble sheets), dedicated enclosed container capacity, and insurance declaration. We provide 100% itemized, fixed-price quotations with zero moving-day surcharges.'
    ],
    [
    ...
    [
        ...
        'a' => 'Yes. Upon vehicle dispatch from East Godavari District, you receive a private GPS tracking portal link and automated WhatsApp transit checkpoints as our truck clears interstate toll plazas and border checkposts en route to null.'
    ],
    [
...
<h3>Enclosed Containerized Carriers
  ...
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Enclosed carriers offer an extra layer of security, minimizing the risk of vandalism compared to open trailers. The closed environment makes it difficult for unauthorized individuals to access and tamper with your vehicle.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Enclosed carriers usually have limited space compared to open trailers. This means that the number of vehicles being transported at the same time might be fewer, ensuring that each car receives the necessary care and attention.</p>
  </div>
</div>

<h3>Open Trailers

  Lower Cost: Open trailers are generally cheaper than enclosed carriers due to the absence of additional protective components. If cost is a significant factor in your decision, open trailers could be a suitable choice.
  More Vehicles: Open trailers can transport a larger number of cars simultaneously, making them more cost-effective for large-scale transportation needs.
  Exposure to Environmental Factors: Cars transported on open trailers are vulnerable to rain, dust, and stones thrown up by other vehicles on the road. This can result in cosmetic damage, especially during long-distance transport.


Local and Long-Distance Transportation</h3>
<p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>For local transportation within East Godavari, enclosed carriers may still offer added protection from flying stones and debris.</p>
...
<p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>When considering movers and carrier services in and around East Godavari, there are several reliable options to choose from.</p>
...
<h3>Carrier Services in East Godavari</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Carrier Services in East Godavari ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
...
<section class="content-ui-section" style="padding: 55px 0; background: #070d1e; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
	...
	<h3>Important Guidelines for Car Transportation in East Godavari
	
		Ensure that all paperwork is in order, including the RC copy, insurance certificate, and PUC.
		Collect the IBA-approved consignment bill of lading from the transporter.
		If applicable, obtain the 100% declared-value marine transit insurance document.
		Provide accurate and detailed information about your car, such as make, model, year, and registration details, on the bill of lading.
		Inform the transporter about any customized or sensitive parts on your car.
		Have the car thoroughly cleaned and prepared before transportation.
		Remove all personal belongings and valuable items from the car before the transportation process.
		Obtain the vehicle&amp;#039;s immobilizer code (if applicable) for car security purposes.
		Ensure that the vehicle is in a good condition and has a valid PUC and insurance.
		Collect the original vehicle registration certificate (RC) and submission of the photocopy of the RC.
	

	Additional Documents for Car Transportation in East Godavari</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Important Guidelines for Car Transportation in East Godavari
	...
	Additional Documents for Car Transportation in East Godavari ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
    ...
    <div style="background: #0f172a; border-radius: 12px; overflow: hidden; border: 1px solid rgba(245, 158, 11, 0.3); box-shadow: 0 10px 30px rgba(0,0,0,0.3);">
      <div style="padding: 16px 24px; background: rgba(245, 158, 11, 0.08); border-bottom: 1px solid rgba(245, 158, 11, 0.2); display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 10px;">
        <div style="color: #f59e0b; font-weight: 700; font-size: 1.05rem; display: flex; align-items: center; gap: 10px;">
          <span>📍</span> Verified Relocation Corridor &amp; GPS Hub: East Godavari District to null Highway
        </div>
      ...
      <div style="width: 100%; height: 380px; position: relative;">
        <iframe width="100%" height="380" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?q=East+Godavari+District+to+null+Highway&t=&z=12&ie=UTF8&iwloc=&output=embed" loading="lazy" style="border:0; width:100%; height:100%; display:block;"></iframe>
      </div>
    </div>
  </div>
</section>
      ...
      <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px; border-bottom: 1px solid rgba(255,255,255,0.08); padding-bottom: 16px; margin-bottom: 20px;">
        <div>
          ...
          <h3 style="color: #ffffff; font-size: 1.25rem; font-weight: 700; margin-top: 8px; margin-bottom: 0;">
            East Godavari District to null Interstate Logistics Corridor via NH-33, NH-43 &amp; NH-20 Expressway Network
          </h3>
        </div>
