    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For a seamless household shifting and relocation experience from Chandigarh to the Destination Hub, we recommend utilizing the National Highway Arterial Corridors and Multi-Axle Express Freight Highways. The exact freight highway route spans around 850 km, passing through strategic checkposts such as the Punjab border crossing and the Chandigarh Railway Station. To facilitate efficient border clearance, our team ensures automated e-Way bill clearance, significantly reducing the risk of delays or fines. Moreover, our speed-governed container transit ensures a smooth and timely delivery, with transit durations ranging between 2 to 3 working days.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">To protect your household items or vehicles during transit, we employ a bespoke packing and loading strategy. Our expert team meticulously wraps and secures each item, utilizing high-grade packaging materials and specialized equipment to prevent damage. Additional measures include the use of GPS tracking, regular transit updates, and a dedicated customer support hotline. By choosing Shree Ashirwad Packers and Movers, you can trust that your valuable possessions or vehicles will be handled with utmost care, ensuring a stress-free relocation experience. With our expert logistics services, you can focus on preparing for your new home, knowing that your belongings are in good hands.</p>
        </div>
      </div>
    </div>
  </section>
