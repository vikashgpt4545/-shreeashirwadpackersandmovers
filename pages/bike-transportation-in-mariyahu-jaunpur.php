...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
	...
	<div style="background: rgba(245, 158, 11, 0.08); border-left: 4px solid #f59e0b; border-radius: 0 10px 10px 0; padding: 18px 22px; margin: 24px 0;"><h4 style="color: #f59e0b; font-size: 1.05rem; font-weight: 700; margin: 0 0 6px 0;">Important Logistics AdvisoryWhen transporting two-wheelers and motorcycles, it is essential to follow a comprehensive pre-loading protocol to ensure a safe and hassle-free journey. This guide will outline the critical steps involved in preparing your bike for a reliable transportation experience. Consider these protocols when booking bike transport by train or any other means.

	
  
    01
    360-Degree Digital Condition Audit:</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Conduct a detailed inspection of your motorcycle or two-wheeler before transportation. This audit ensures that any issues are addressed and potential damages are minimized during transit.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Battery Terminal Checks:</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Inspect the battery terminals for any signs of corrosion or disconnection. Correcting these issues beforehand will prevent any electrical issues during transportation.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Adjust the fuel level to one-quarter tank to avoid fuel leakage or spillage during transit. This precaution also ensures that the bike is not too heavy, as excessive weight may impact the transportation process.
  
  
    04
    FASTag Management:
    Ensure that the FASTag (Fastag.in is one recognized platform) is properly installed on the motorcycle or two-wheeler. This electronic toll collection tag ensures a smooth journey on highways without stopping at toll booths.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
	...
	<h3>1. Pre-Transport Inspection
	
		Motorcycle/Two-Wheeler Inspection: Conduct a thorough inspection before the bike is packed and loaded onto the transportation vehicle. Check the following:
			...
			Tyre tread depth
			Battery condition and placement
			Air filter condition
			Engine oil level and condition
			Spark plugs and air-fuel mixture
			Tyre condition, including punctures and damage
		
	
	

	2. Documentation Requirements</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for 1. Pre-Transport Inspection
	...
	2. Documentation Requirements ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
