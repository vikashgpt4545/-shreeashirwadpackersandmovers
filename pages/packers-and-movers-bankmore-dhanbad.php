...
$faq_list = [
    [
        'q' => 'Do you provide house shifting services across Bankmore commercial and residential areas in Dhanbad?',
        'a' => 'Yes, we cover all areas in and around Bankmore including Park Market, Urmila Tower road, Dhanbad Plaza lane, Court Road extension, and surrounding residential colonies with door-to-door packing and moving.'
    ],
    [
        'q' => 'Are GST bills issued in Bankmore valid for employee corporate claim reimbursement?',
        'a' => 'Yes, we issue 100% genuine IBA-compliant GST invoices, Lorry Receipts (LR), money receipts, and itemized inventory lists accepted by BCCL, Railways, Banks, and corporate HR departments.'
    ],
    [
        'q' => 'How many days in advance should I book packers and movers in Bankmore Dhanbad?',
        'a' => 'Booking 2 to 3 days in advance ensures priority vehicle scheduling, truck entry permits for congested Bankmore market streets, and customized 7-layer packaging preparation.'
    ],
    [
        'q' => 'Can you handle heavy furniture disassembly and reassembly in Bankmore?',
        'a' => 'Yes, our experienced move crew includes carpenters who disassemble modular double beds, wardrobes, and wall units at origin and reassemble them at your new residence.'
    ],
    [
        'q' => 'Is transit insurance provided for goods moved from Bankmore Dhanbad?',
    ...
    [
        'q' => 'How are motorcycles packed and shipped from Bankmore Dhanbad?',
        'a' => 'Two-wheelers are wrapped in air-bubble wrap, paddy straw padding, and heavy corrugated sheets before being loaded into specialized container trucks.'
    ],
    [
        'q' => 'Are packing materials included in the quote estimate for Bankmore shifting?',
        'a' => 'Yes, all 7 layers of packaging material (bubble wrap, corrugated sheets, stretch film, cartons) are fully included in the estimate.'
    ],
    [
        'q' => 'Do you provide local shifting within Bankmore and Greater Dhanbad city?',
        'a' => 'Yes, we handle both local intra-city shifting within Dhanbad and intercity long-distance relocations across India.'
    ],
    [
        'q' => 'Are there any hidden or unexpected extra charges in Bankmore moves?',
        'a' => 'No, we maintain 100% price transparency with written quotations provided prior to move execution.'
    ],
    [
        'q' => 'How can I book Shree Ashirwad Packers in Bankmore Dhanbad?',
        'a' => 'Call +91 8409531615 or click the WhatsApp button to get an instant quotation from our team.'
    ],
    [
        'q' => 'What are the charges for shifting a 2BHK apartment in Bankmore Dhanbad?',
        'a' => 'Local 2BHK household shifting within Dhanbad from Bankmore ranges between ₹5,500 and ₹9,500 depending on goods volume and floor height.'
    ],
    [
        'q' => 'Do you handle commercial office and shop shifting in Bankmore market?',
        'a' => 'Yes, we provide commercial office shifting, showroom inventory moving, IT hardware transport, and document archive relocation across Bankmore.'
    ],
    [
        'q' => 'How are fragile glass items and Smart TVs protected during Bankmore moves?',
        'a' => 'Fragile glassware and Smart TVs are protected using air-bubble film, corner foam padding, 5-ply corrugated sheets, and custom wooden crating.'
    ],
    [
        'q' => 'Do you offer car carrier services from Bankmore Dhanbad to other states?',
        'a' => 'Yes, we operate covered hydraulic car trailer carriers to transport sedans, SUVs, and luxury cars from Bankmore to any state across India.'
    ],
    [
        'q' => 'Can I track my moving truck in real time from Bankmore?',
        'a' => 'Yes, all our container trucks are fitted with active GPS satellite tracking hardware, enabling live location monitoring throughout transit.'
    ],
    [
        'q' => 'Do you serve nearby areas like Court Road, Park Market, and Dhanbad Railway Station?',
        'a' => 'Yes, our move teams routinely operate across Court Road, Park Market, Railway Station colonies, and Shastri Nagar.'
    ],
    [
        'q' => 'Is warehouse storage available if my new home in Bankmore is not ready?',
        'a' => 'Yes, we provide clean, CCTV-monitored, pest-controlled warehouse storage facilities in Dhanbad for short-term and long-term storage.'
    ],
    [
        'q' => 'What items are restricted from loading into the truck?',
        'a' => 'Flammable liquids, gas cylinders, explosives, hazardous chemicals, illegal items, and unsealed food items cannot be packed or transported.'
    ],
    [
        'q' => 'Are there extra fees if there is no elevator in my Bankmore apartment building?',
        'a' => 'Floor elevation is evaluated during pre-move estimation, and any stair-carry labor charges are transparently listed in your initial quote.'
    ],
    [
        'q' => 'Why is Shree Ashirwad Packers the preferred choice in Bankmore Dhanbad?',
        'a' => 'With 15+ years of operational experience, 2,800+ completed Bankmore moves, 100% IBA GST billing compliance, and a zero-damage guarantee, we are Dhanbad\'s most trusted movers.'
    ]
];
...
<main class="site-main">
  ...
  <div class="breadcrumb-wrapper">
    <div class="container">
      <div class="breadcrumb-list">
        ...
        <span class="breadcrumb-separator">/</span>
        <span class="breadcrumb-item active">Packers and Movers Bankmore Dhanbad</span>
      </div>
    </div>
  </div>
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            Bankmore Shifting Specialists
          </span>
          <h1 style="font-size: 2.8rem; font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #ffffff;">
            Reliable <span style="color: #f59e0b;">Packers and Movers Bankmore Dhanbad</span>
          </h1>
          <p style="font-size: 1.1rem; color: #cbd5e1; line-height: 1.7; margin-bottom: 25px;">
            Planning local household or commercial relocation in Bankmore Dhanbad? Shree Ashirwad Packers and Movers provides top-tier home shifting, IBA-approved corporate bills, enclosed vehicle transport, and 7-layer protective packaging across Bankmore market, Park Market, Urmila Tower road, Dhanbad Plaza, Court Road, and Shastri Nagar.
          </p>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20need%20shifting%20quote%20for%20Bankmore%20Dhanbad." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
              <i class="fab fa-whatsapp"></i> Chat on WhatsApp
            </a>
          </div>

          <div style="display: flex; gap: 20px; font-size: 0.9rem; color: #94a3b8;">
            <span><strong style="color: #f59e0b;">2,800+</strong> Bankmore Moves</span>
            <span><strong style="color: #f59e0b;">Commercial Hub</strong> Dispatch</span>
        ...
        <div class="hero-form-card" style="background: rgba(255, 255, 255, 0.05); backdrop-filter: blur(10px); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
          <h2 style="font-size: 1.4rem; color: #ffffff; margin-bottom: 8px; font-weight: 700; text-align: center;">Get Bankmore Quote</h2>
          ...
          <form action="#" method="POST" onsubmit="sendHeroWhatsAppLead(event, this);">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 14px;">
              <input type="text" name="move_from" class="form-control" value="Bankmore Dhanbad" required style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.3); color: #fff;">
    ...
    <div class="container">
      <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px; text-align: center;">
        <div style="padding: 20px; background: rgba(23, 42, 84, 0.5); border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          ...
          <div style="font-size: 0.9rem; color: #cbd5e1; margin-top: 5px;">Bankmore Moves Completed</div>
        </div>
        <div style="padding: 20px; background: rgba(23, 42, 84, 0.5); border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <div style="font-size: 2.2rem; font-weight: 800; color: #f59e0b; font-family: 'Poppins', sans-serif;">Bankmore Hub</div>
          <div style="font-size: 0.9rem; color: #cbd5e1; margin-top: 5px;">Central Financial &amp; Market Zone</div>
        </div>
        <div style="padding: 20px; background: rgba(23, 42, 84, 0.5); border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
        ...
        <div style="padding: 20px; background: rgba(23, 42, 84, 0.5); border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          ...
          <div style="font-size: 0.9rem; color: #cbd5e1; margin-top: 5px;">GST Invoice &amp; BCCL Claims</div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section style="padding: 70px 0; background: #0b132b; color: #e2e8f0; line-height: 1.8;">
    <div class="container" style="max-width: 950px;">
      ...
      <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">
        Specialized Shifting Solutions for <span style="color: #f59e0b;">Bankmore Dhanbad</span>
      </h2>

      <p style="font-size: 1.05rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 20px;">
        Bankmore is the heart of commerce, banking, and retail trade in central Dhanbad. Situated near Dhanbad Junction railway station and major commercial landmarks such as Dhanbad Plaza, Urmila Tower, Park Market, Court Road, and Shastri Nagar, Bankmore witnesses continuous movement of business owners, corporate executives, banking officers, and families.
      </p>

      <p style="font-size: 1.05rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 20px;">
        At <strong>Shree Ashirwad Packers and Movers</strong>, our localized operational setup in Bankmore enables rapid truck positioning and expert navigation through busy commercial thoroughfares and narrow residential lanes. Whether you are relocating locally within Dhanbad or moving intercity to Kolkata, Ranchi, Patna, or Asansol, our dedicated crew manages packing, loading, transport, and doorstep assembly with maximum safety.
      </p>
      ...
      <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; margin: 35px 0;">
        ...
        <div style="background: linear-gradient(145deg, #172a54 0%, #0d1736 100%); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 22px; box-shadow: 0 10px 25px rgba(0,0,0,0.3);">
          ...
          <h3 style="font-size: 1.1rem; color: #ffffff; font-weight: 700; margin-bottom: 10px;">Central Commercial Fleet Positioning</h3>
          <p style="font-size: 0.9rem; color: #cbd5e1; line-height: 1.6; margin: 0;">
            Immediate truck dispatch across Bankmore market, Urmila Tower lane, Court Road, and Dhanbad Junction railway station area.
          </p>
        </div>
        ...
        <div style="background: linear-gradient(145deg, #172a54 0%, #0d1736 100%); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 22px; box-shadow: 0 10px 25px rgba(0,0,0,0.3);">
          ...
          <h3 style="font-size: 1.1rem; color: #ffffff; font-weight: 700; margin-bottom: 10px;">Complete Doorstep Coverage</h3>
          <p style="font-size: 0.9rem; color: #cbd5e1; line-height: 1.6; margin: 0;">
            Serving Park Market, Dhanbad Plaza, Shastri Nagar, Court Road, and all apartment complexes across Bankmore.
          </p>
        </div>
        ...
        <div style="background: linear-gradient(145deg, #172a54 0%, #0d1736 100%); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 22px; box-shadow: 0 10px 25px rgba(0,0,0,0.3);">
          ...
          <h3 style="font-size: 1.1rem; color: #ffffff; font-weight: 700; margin-bottom: 10px;">IBA Approved GST Invoices</h3>
          <p style="font-size: 0.9rem; color: #cbd5e1; line-height: 1.6; margin: 0;">
            100% genuine IBA-compliant GST bills, Lorry Receipts (LR), and itemized inventory lists for corporate &amp; PSU claim reimbursement.
          </p>
        </div>
        ...
        <div style="background: linear-gradient(145deg, #172a54 0%, #0d1736 100%); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 22px; box-shadow: 0 10px 25px rgba(0,0,0,0.3);">
          ...
          <p style="font-size: 0.9rem; color: #cbd5e1; line-height: 1.6; margin: 0;">
            Multi-layer shock resistance combining air-bubble rolls, 5-ply corrugated sheets, stretch wrap, foam guards, and timber crating.
          </p>
        </div>
        ...
        <div style="background: linear-gradient(145deg, #172a54 0%, #0d1736 100%); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 22px; box-shadow: 0 10px 25px rgba(0,0,0,0.3);">
          ...
          <p style="font-size: 0.9rem; color: #cbd5e1; line-height: 1.6; margin: 0;">
            Covered hydraulic car trailers for automobiles and dedicated bike container shipping from Bankmore across India.
          </p>
        </div>
        ...
        <div style="background: linear-gradient(145deg, #172a54 0%, #0d1736 100%); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 22px; box-shadow: 0 10px 25px rgba(0,0,0,0.3);">
          ...
          <p style="font-size: 0.9rem; color: #cbd5e1; line-height: 1.6; margin: 0;">
            Our trained move crew dismantles furniture at origin and reassembles every bed, wardrobe, and dining table at your new destination.
          </p>
        </div>
    ...
    <div class="container" style="max-width: 950px;">
      ...
      <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 24px;">
        ...
        <div style="background: #101c40; padding: 25px; border-radius: 12px; border: 1.5px solid rgba(245, 158, 11, 0.25);">
          ...
          <p style="font-size: 0.95rem; color: #cbd5e1; line-height: 1.7; margin: 0;">
            Inside our closed container trucks, items are secured using heavy-duty nylon safety belts tied to internal container wall rings. This eliminates item sliding, friction scuffs, or tipping over during highway travel.
          </p>
        </div>
        ...
        <div style="background: #101c40; padding: 25px; border-radius: 12px; border: 1.5px solid rgba(245, 158, 11, 0.25);">
          ...
          <p style="font-size: 0.95rem; color: #cbd5e1; line-height: 1.7; margin: 0;">
            Our vehicles are fitted with real-time GPS tracking hardware. Clients receive direct location updates, ensuring complete transparency while your goods are in transit.
          </p>
        </div>
        ...
        <div style="background: #101c40; padding: 25px; border-radius: 12px; border: 1.5px solid rgba(245, 158, 11, 0.25);">
          ...
          <p style="font-size: 0.95rem; color: #cbd5e1; line-height: 1.7; margin: 0;">
            We back long-distance intercity shipments with 100% full-value transit insurance policy documentation, covering declared goods against unexpected highway risks.
          </p>
        </div>
  ...
  <section style="padding: 70px 0; background: #0b132b; color: #ffffff;">
    <div class="container" style="max-width: 950px;">
      ...
      <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">
        Estimated <span style="color: #f59e0b;">Packers and Movers Bankmore Dhanbad Charges</span>
      </h2>
      <p style="font-size: 1.05rem; color: #cbd5e1; line-height: 1.7; margin-bottom: 25px;">
        We maintain complete price transparency without hidden fees or unexpected surcharges. Below is an estimated cost breakdown for local Dhanbad shifting and intercity relocation from Bankmore:
      </p>
        ...
        <table style="width: 100%; border-collapse: collapse; background: #172a54; border-radius: 12px; overflow: hidden; border: 1px solid rgba(245, 158, 11, 0.3);">
          ...
          <tbody style="color: #cbd5e1; font-size: 0.9rem; line-height: 1.6;">
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.08);">
              <td style="padding: 14px 20px; font-weight: 700; color: #ffffff;">1 BHK Household (Local Dhanbad)</td>
            ...
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.08); background: rgba(255,255,255,0.02);">
              <td style="padding: 14px 20px; font-weight: 700; color: #ffffff;">2 BHK Apartment (Local Dhanbad)</td>
            ...
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.08); background: rgba(255,255,255,0.02);">
              <td style="padding: 14px 20px; font-weight: 700; color: #ffffff;">Intercity Shifting (Bankmore to Kolkata/Patna)</td>
    ...
    <div class="container" style="max-width: 900px;">
      ...
      <div class="section-header text-center" style="margin-bottom: 45px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin-top: 10px;">
          5-Stage Execution Workflow for <span style="color: #f59e0b;">Bankmore Shifting</span>
        </h2>
      </div>
      ...
      <div style="display: flex; flex-direction: column; gap: 20px;">
        ...
        <div style="display: flex; gap: 20px; background: #101c40; padding: 24px; border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          ...
          <div>
            ...
            <p style="font-size: 0.95rem; color: #cbd5e1; margin: 0; line-height: 1.6;">
              Contact our Dhanbad helpline via <strong><?php echo SITE_PHONE; ?></strong> or WhatsApp. Our move coordinator conducts an in-person or video survey of your Bankmore residence to evaluate item volume and truck requirements.
            </p>
          </div>
        </div>
        ...
        <div style="display: flex; gap: 20px; background: #101c40; padding: 24px; border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          ...
          <div>
            ...
            <p style="font-size: 0.95rem; color: #cbd5e1; margin: 0; line-height: 1.6;">
              Our uniformed packaging experts arrive at your Bankmore home with bubble wrap, 5-ply corrugated sheets, stretch wrap, and custom wooden crating for delicate items.
            </p>
          </div>
        </div>
  ...
  <section style="padding: 70px 0; background: #0b132b; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      ...
      <p style="font-size: 1.05rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 20px;">
        Business owners, banking personnel, BCCL executives, railway employees, and defense staff moving to or from Bankmore Dhanbad receive complete 100% compliant claim documentation:
      </p>
  ...
  <section style="padding: 70px 0; background: #070d1e; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      ...
      <p style="font-size: 1.05rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 20px;">
        Our operational network extends across all major residential and commercial hubs surrounding Bankmore:
      </p>
      ...
      <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px; margin-bottom: 30px;">
        ...
        <div style="background: #101c40; padding: 18px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #ffffff; font-size: 1.1rem; margin-bottom: 8px;">Hirapur Educational Quarter</h4>
          <p style="font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;">Immediate academic and residential neighborhood near IIT ISM.</p>
          <a href="<?php echo SITE_URL; ?>packers-and-movers-hirapur-dhanbad" title="Explore Packers and Movers Hirapur →" style="color: #f59e0b; text-decoration: underline; font-weight: 600; font-size: 0.9rem;">
            Explore Packers and Movers Hirapur →
          </a>
        </div>

        <div style="background: #101c40; padding: 18px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #ffffff; font-size: 1.1rem; margin-bottom: 8px;">Saraidhela Residential Sector</h4>
          <p style="font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;">Modern apartment residential and healthcare extension.</p>
        ...
        <div style="background: #101c40; padding: 18px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #ffffff; font-size: 1.1rem; margin-bottom: 8px;">Jharia Mining Township</h4>
          <p style="font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;">Historic commercial mining township near Bankmore.</p>
  ...
  <section style="padding: 70px 0; background: #0b132b; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      ...
      <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">
        Major Intercity Routes from <span style="color: #f59e0b;">Bankmore Dhanbad</span>
      </h2>

      <p style="font-size: 1.05rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
        We operate daily container services connecting Bankmore Dhanbad to key intercity destinations:
      </p>
      ...
      <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px; margin-bottom: 30px;">
        <div style="background: #172a54; padding: 18px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          ...
          <p style="font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;">Daily express container route to capital city Ranchi.</p>
        ...
        <div style="background: #172a54; padding: 18px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          ...
          <p style="font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;">Direct interstate GT Road NH-19 highway transport to West Bengal.</p>
        ...
        <div style="background: #172a54; padding: 18px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          ...
          <p style="font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;">Interstate container route connecting Dhanbad to Bihar capital.</p>
  ...
  <section style="padding: 70px 0; background: #070d1e; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      ...
      <div class="section-header text-center" style="margin-bottom: 45px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin-top: 10px;">
          Frequently Asked Questions About <span style="color: #f59e0b;">Bankmore Dhanbad Shifting</span>
        </h2>
      </div>
  ...
  <section class="cta-banner-section" style="padding: 70px 0; background: linear-gradient(135deg, #172a54 0%, #0b132b 100%); border-top: 1.5px solid rgba(245, 158, 11, 0.4); color: #ffffff;">
    <div class="container" style="max-width: 900px; text-align: center;">
      ...
      <span class="section-tag" style="background: rgba(245, 158, 11, 0.2); color: #f59e0b; padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase;">
        Book Bankmore Shifting Services
      </span>

      <h2 style="font-size: 2.3rem; font-weight: 800; margin: 15px 0 15px 0; color: #ffffff;">
        Ready to Move with <span style="color: #f59e0b;">Packers and Movers Bankmore Dhanbad</span>?
      </h2>

      <p style="font-size: 1.05rem; color: #cbd5e1; max-width: 750px; margin: 0 auto 30px auto; line-height: 1.7;">
        Contact our Dhanbad head office today for a guaranteed fixed price quote and enjoy smooth, safe, zero-damage home or office shifting.
      </p>
      ...
      <div style="display: flex; gap: 15px; justify-content: center; flex-wrap: wrap; margin-bottom: 25px;">
        ...
        <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20need%20a%20shifting%20quote%20for%20Bankmore%20Dhanbad." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 30px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1.05rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
          <i class="fab fa-whatsapp"></i> Chat on WhatsApp
        </a>
    ...
    <div class="container" style="max-width: 950px;">
      ...
      <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 15px;">
        <div style="background: #172a54; padding: 18px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2); text-align: center;">
          <div style="font-size: 1.5rem; margin-bottom: 6px;"><i class="fas fa-truck"></i></div>
