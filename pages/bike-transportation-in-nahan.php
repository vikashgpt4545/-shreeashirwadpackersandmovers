...
<section class="content-ui-section" style="padding: 55px 0; background: #070d1e; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    ...
    01
    Protocol 01</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>A self-attested photocopy of your vehicle&#039;s Registration Certificate (RC) is a crucial document for bike transportation.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>This photocopy will serve as proof of ownership and will be required by the transporter and the authorities during the transportation process.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 03</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>To make it easier, ensure that you have a clear and legible copy of your RC beforehand.</p>
  </div>
</div>

    <h3>2. Current PUC (Pollution Under Control)
    
        A valid Pollution Under Control (PUC) certificate is mandatory for transportation purposes.
        The PUC certificate verifies that your bike meets the emission standards set by the government.
        Make sure the certificate is not expired and is valid for the date of transportation.
    

    3. Valid Insurance Certificate
    
        A valid insurance certificate is necessary to cover your bike during transportation.
        Make sure the insurance policy is current and covers the entire transportation period.
        It is advisable to get a comprehensive insurance policy that covers damage during transit.
    

    4. IBA-approved Consignment Bill (Consignment Bill)
    
        An IBA-approved consignment bill is essential for bike transportation.
        This bill serves as a legal agreement between you and the transporter, detailing the terms and conditions of the transportation process.
        Make sure to review the bill thoroughly before signing it to ensure all required details are included.
    

    5. Original Vehicle Registration Document (RC)
    
        Original vehicle registration documents (RC) are necessary for bike transportation.
        Make sure to keep your RC with you at all times as it serves as proof of ownership and details of the bike.
        It is advisable to keep a photocopy of the RC with you for your records.
    

    6. Original Pollution Under Control (PUC) Certificate</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for 2. Current PUC (Pollution Under Control)
    ...
    6. Original Pollution Under Control (PUC) Certificate ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
    ...
    <div style="background: #0f172a; border-radius: 12px; overflow: hidden; border: 1px solid rgba(245, 158, 11, 0.3); box-shadow: 0 10px 30px rgba(0,0,0,0.3);">
      <div style="padding: 16px 24px; background: rgba(245, 158, 11, 0.08); border-bottom: 1px solid rgba(245, 158, 11, 0.2); display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 10px;">
        <div style="color: #f59e0b; font-weight: 700; font-size: 1.05rem; display: flex; align-items: center; gap: 10px;">
          <span>📍</span> Verified Relocation Corridor &amp; GPS Hub: Nahan to unspecified Highway
        </div>
      ...
      <div style="width: 100%; height: 380px; position: relative;">
        <iframe width="100%" height="380" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?q=Nahan+to+unspecified+Highway&t=&z=12&ie=UTF8&iwloc=&output=embed" loading="lazy" style="border:0; width:100%; height:100%; display:block;"></iframe>
      </div>
    </div>
  </div>
</section>
