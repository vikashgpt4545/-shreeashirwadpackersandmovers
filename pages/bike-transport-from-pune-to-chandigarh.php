...
$page_keywords = "bike transport from pune to chandigarh, bike shipping pune to chandigarh, motorcycle transport pune to chandigarh charges, bike courier service pune chandigarh, two wheeler relocation pune chandigarh";
...
<main class="site-main" style="background-color: #0b132b; color: #cbd5e1; font-family: 'Inter', sans-serif;">
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            PUNE TO CHANDIGARH BIKE RELOCATION
          </span>
          ...
          <p style="font-size: 1.05rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Relocate your motorcycle safely from Pune to Chandigarh (~1,650 km) with 100% door-to-door protection. Multi-layer bubble wrapping, enclosed container trucks, GPS tracking, and comprehensive transit insurance included.
          </p>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20need%20a%20quote%20for%20bike%20transport%20from%20Pune%20to%20Chandigarh." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
        ...
        <div class="hero-form-card" style="background: rgba(255, 255, 255, 0.04); backdrop-filter: blur(10px); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
          <h2 style="font-size: 1.3rem; color: #ffffff; margin-bottom: 8px; font-weight: 700; text-align: center;">Get Pune → Chandigarh Quote</h2>
    ...
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 25px; text-align: center;">
        <div style="background: rgba(255,255,255,0.03); padding: 20px; border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <div style="font-size: 2.2rem; font-weight: 800; color: #f59e0b;">2,100+</div>
          <div style="font-size: 0.9rem; color: #94a3b8;">Bikes Shifted to Chandigarh</div>
        </div>
        <div style="background: rgba(255,255,255,0.03); padding: 20px; border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <div style="font-size: 2.2rem; font-weight: 800; color: #f59e0b;">1,650+ KM</div>
  ...
  <section style="padding: 60px 0; background: #0b132b;">
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 15px;">
      <h2 style="font-size: 2rem; font-weight: 800; text-align: center; color: #ffffff; margin-bottom: 15px;">
        Why Choose Our <span style="color: #f59e0b;">Pune to Chandigarh</span> Bike Transport?
      </h2>
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 25px;">
        ...
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border-left: 4px solid #f59e0b;">
          <h3 style="font-size: 1.2rem; color: #ffffff; margin-bottom: 10px;">Full Doorstep Chandigarh Delivery</h3>
          <p style="font-size: 0.9rem; color: #94a3b8; line-height: 1.6;">Direct delivery across Sector 17, Sector 35, Sector 22, Manimajra, Zirakpur, and Mohali.</p>
        </div>
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border-left: 4px solid #f59e0b;">
  ...
  <section style="padding: 60px 0; background: #1c2541; border-top: 1px solid rgba(255, 255, 255, 0.05);">
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 15px;">
      <h2 style="font-size: 2rem; font-weight: 800; text-align: center; color: #ffffff; margin-bottom: 15px;">
        Estimated <span style="color: #f59e0b;">Pune to Chandigarh</span> Bike Shifting Charges
      </h2>
      <p style="text-align: center; color: #94a3b8; max-width: 700px; margin: 0 auto 40px auto; font-size: 0.95rem;">
        ...
        <table style="width: 100%; border-collapse: collapse; text-align: left; color: #cbd5e1; font-size: 0.95rem;">
          ...
          <tbody>
            ...
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
              ...
              <td style="padding: 16px; border-right: 1px solid rgba(255,255,255,0.05);">₹ 6,000 - ₹ 7,500</td>
              <td style="padding: 16px; border-right: 1px solid rgba(255,255,255,0.05); color: #f59e0b;">₹ 7,500 - ₹ 9,200</td>
              <td style="padding: 16px;">4 - 5 Days</td>
            </tr>
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
              ...
              <td style="padding: 16px; border-right: 1px solid rgba(255,255,255,0.05);">₹ 7,500 - ₹ 9,500</td>
            ...
            <tr>
              ...
              <td style="padding: 16px; border-right: 1px solid rgba(255,255,255,0.05);">₹ 10,500 - ₹ 14,000</td>
              <td style="padding: 16px; border-right: 1px solid rgba(255,255,255,0.05); color: #f59e0b;">₹ 14,000 - ₹ 17,000</td>
              <td style="padding: 16px;">4 - 5 Days</td>
            </tr>
          </tbody>
        </table>
  ...
  <section style="padding: 60px 0; background: #0b132b; border-top: 1px solid rgba(255,255,255,0.05);">
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px;">
      <h2 style="font-size: 2rem; font-weight: 800; text-align: center; color: #ffffff; margin-bottom: 30px;">
        Frequently Asked Questions — <span style="color: #f59e0b;">Pune to Chandigarh</span>
      </h2>

      <div style="display: flex; flex-direction: column; gap: 20px;">
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
          <h3 style="font-size: 1.1rem; color: #ffffff; margin-bottom: 10px;">What is the cost of bike transport from Pune to Chandigarh?</h3>
          <p style="font-size: 0.9rem; color: #94a3b8; line-height: 1.6;">Charges range between ₹4,800 and ₹9,500 depending on vehicle engine capacity and packaging selection.</p>
        </div>
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
          <h3 style="font-size: 1.1rem; color: #ffffff; margin-bottom: 10px;">How long does transit take between Pune and Chandigarh?</h3>
        ...
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
          ...
          <p style="font-size: 0.9rem; color: #94a3b8; line-height: 1.6;">Yes, we pick up your motorcycle directly from your doorstep anywhere in Pune and deliver it directly to Chandigarh.</p>
        </div>
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
  ...
  <section style="padding: 60px 0; background: linear-gradient(135deg, #1c2541 0%, #0b132b 100%); text-align: center; border-top: 1px solid rgba(245, 158, 11, 0.3);">
    <div class="container" style="max-width: 900px; margin: 0 auto; padding: 0 15px;">
      <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin-bottom: 15px;">Book Your Pune to Chandigarh Bike Transport Today!</h2>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the cost of bike transport from Pune to Chandigarh?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Charges range between ₹4,800 and ₹9,500 depending on vehicle engine capacity and packaging selection."
      }
    },
    {
      "@type": "Question",
      "name": "How long does transit take between Pune and Chandigarh?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, we pick up your motorcycle directly from your doorstep anywhere in Pune and deliver it directly to Chandigarh."
      }
    },
    {
      "@type": "Question",
