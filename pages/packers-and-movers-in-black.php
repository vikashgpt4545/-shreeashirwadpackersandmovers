    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For shifting households and vehicles from Black (City Centre, Railway Station Road, Industrial Area) to Destination Hub, our experts recommend utilizing the National Highway Arterial Corridors and Multi-Axle Express Freight Highways. The optimal route involves traversing through the following checkpoints: Border Crossings at Delhi and Gujarat, and automated e-Way bill clearance at designated checkposts. Speed-governed container transit ensures a hassle-free journey, with transit duration ranging from 2 to 3 working days.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">To protect your household items or vehicles during transit, our team follows a meticulous packing and loading process. We utilize sturdy, specially designed containers to prevent damage and ensure secure transportation. Each item is carefully wrapped, labeled, and documented to prevent loss or theft. Additionally, our team provides insurance coverage against any unforeseen circumstances, ensuring your belongings arrive safely at the destination. We also offer specialized services for vehicles, including cleaning and detailing, to ensure a like-new condition upon arrival. With our expert logistics and attention to detail, you can trust your valuable possessions to us, knowing they&#039;re in good hands throughout the journey.</p>
        </div>
      </div>
    </div>
  </section>
