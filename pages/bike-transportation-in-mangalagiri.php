...
$faq_list = [
    [
        'q' => 'How are relocation charges calculated for Bike Transportation in Mangalagiri | Secure Two-Wheeler Shifting?',
...
<section class="content-ui-section" style="padding: 55px 0; background: #070d1e; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    ...
    01
    Protocol 01</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Take photos of the two-wheeler/motorcycle from every angle to document its condition before transportation</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Use the digital images to create a comprehensive condition report for future reference</p>
  </div>
</div>
	<h3>2. Battery Terminal Checks
	
		Ensure that the battery terminals are clean and properly connected
		Check the battery level and ensure it is not drained too low or too high
		Apply a protective covering to the terminals to prevent corrosion during transportation
	
	3. One-Quarter Tank Fuel Regulation
	
		Ensure the two-wheeler/motorcycle has a quarter tank of fuel to ensure safe transportation
		Avoid filling the tank too full as it can lead to leaks and damage during transit
		If the vehicle has an immobilizer, ensure it is turned off or deactivated before transportation
	
	4. FASTag Management
	
		Ensure that the FASTag (Fastag Application Supported Toll Transaction) is installed and functioning correctly
		For FASTag-enabled vehicles, ensure that the tag is appropriately registered and linked to the vehicle owner&amp;#039;s registered details
		If the FASTag is not applicable, ensure that the vehicle has a valid toll pass or cash payment options are available for the transit
	
	5. Door-to-Door Delivery
	
		Ensure that the transporter offers door-to-door delivery services
		Arrange for an appropriate loading and unloading equipment to prevent damage during transportation
		Ensure that the transporter employs a dedicated team for loading and unloading to avoid mix-ups or misplacement of vehicles
	
	6. Insurance Coverage</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for 2. Battery Terminal Checks
	...
	6. Insurance Coverage ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Enclosed carriers offer the ultimate protection for your bicycle. By encasing your bike within a sturdy container, it shields it from flying highway stones, rain, dust, and even potential theft.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">No Damage Risk:</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>With enclosed carriers, the chances of your bicycle sustaining external damages are significantly reduced, ensuring a safe arrival at your destination.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Vandalism Prevention:</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Compared to open trailers, enclosed carriers prevent any potential vandalism or tampering with your bicycle, providing peace of mind during transportation.</p>
  </div>
</div>
	...
	<h3>Open Trailers</h3>
	<p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Open trailers are a common choice for bike transportation, offering a more cost-effective option compared to enclosed carriers. However, they come with certain risks:</p>
	...
	<h3>Comparison with Other Bike Transportation Services</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Comparison with Other Bike Transportation Services ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
