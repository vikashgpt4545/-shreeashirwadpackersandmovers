...
<main class="site-main">
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          ...
          <p style="font-size: 1.08rem; color: #cbd5e1; line-height: 1.7; margin-bottom: 25px;">
            Planning home or commercial relocation in Kitadih? Shree Ashirwad Packers and Movers provides top-rated zero-damage household moving, IBA corporate billing, bike transport, and 7-layer packaging across Kitadih main road, Bagbera border, and Tatanagar station route.
          </p>
  ...
  <section style="padding: 35px 0; background: #070d19; border-bottom: 1px solid rgba(245, 158, 11, 0.2);">
    <div class="container">
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 15px; text-align: center;">
        ...
        <div><h3 style="color: #f59e0b; font-size: 2rem; font-weight: 800;">2,400+</h3><p style="color: #cbd5e1; font-size: 0.85rem;">Kitadih Relocations</p></div>
  ...
  <section style="padding: 60px 0; background: #f8fafc;">
    <div class="container">
      <div style="text-align: center; max-width: 800px; margin: 0 auto 40px auto;">
        <span style="color: #d32f2f; font-weight: 700; text-transform: uppercase; font-size: 0.85rem;">Kitadih Local Advantage</span>
      ...
      <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 25px;">
        <div style="background: #ffffff; padding: 25px; border-radius: 12px; border-top: 4px solid #d32f2f; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
          <h3 style="font-size: 1.15rem; color: #0b132b; margin-bottom: 8px; font-weight: 700;">Bagbera &amp; Station Link Access</h3>
          <p style="color: #64748b; font-size: 0.9rem; line-height: 1.6;">Our drivers navigate Kitadih main road, Bagbera links, Loco Colony lanes, and Tatanagar Station route efficiently, bypassing peak railway traffic for fast loading and unloading.</p>
        </div>
        <div style="background: #ffffff; padding: 25px; border-radius: 12px; border-top: 4px solid #f59e0b; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
          ...
          <p style="color: #64748b; font-size: 0.9rem; line-height: 1.6;">100% genuine IBA-approved GST invoices, official Lorry Receipts (LR), and itemized inventory lists tailored for South Eastern Railway staff, Tata employees, bank managers, and teachers.</p>
        </div>
        <div style="background: #ffffff; padding: 25px; border-radius: 12px; border-top: 4px solid #d32f2f; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
        ...
        <div style="background: #ffffff; padding: 25px; border-radius: 12px; border-top: 4px solid #f59e0b; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
          ...
          <p style="color: #64748b; font-size: 0.9rem; line-height: 1.6;">Smooth loading and packing for independent houses, multi-story apartments, and railway quarters across Kitadih with dedicated carpentry support.</p>
        </div>
        <div style="background: #ffffff; padding: 25px; border-radius: 12px; border-top: 4px solid #d32f2f; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
          <h3 style="font-size: 1.15rem; color: #0b132b; margin-bottom: 8px; font-weight: 700;">GPS Enclosed Fleet</h3>
          <p style="color: #64748b; font-size: 0.9rem; line-height: 1.6;">Sealed weatherproof container vehicles equipped with live satellite tracking for real-time location updates from Kitadih to any location nationwide.</p>
        </div>
        <div style="background: #ffffff; padding: 25px; border-radius: 12px; border-top: 4px solid #f59e0b; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
      ...
      <div style="background: linear-gradient(145deg, #0b132b 0%, #172a54 100%); border: 1px solid rgba(245, 158, 11, 0.3); padding: 30px; border-radius: 12px; margin: 35px 0; color: #ffffff;">
        <h3 style="color: #f59e0b; font-size: 1.3rem; font-weight: 700; margin-bottom: 14px;">Specialized Shifting Solutions: Kitadih Jamshedpur Sector</h3>
        <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.7; margin-bottom: 14px;">
          Kitadih is a prominent residential hub located in the southern corridor of Jamshedpur, bordering Bagbera, Parsudih, and the Tatanagar Railway Station colony. Due to its strategic position along major railway corridors and commercial link roads, residents in Kitadih frequently require dependable shifting services for local transfers within Jamshedpur as well as long-distance intercity moves to Ranchi, Patna, Kolkata, and Dhanbad.
        </p>
        <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.7; margin-bottom: 14px;">
          Our <strong>packers and movers kitadih jamshedpur</strong> service delivers end-to-end relocation management. We deploy trained move managers and skilled carpenters who execute systematic packing using 7 protective layers: water-resistant stretch film, high-density air bubble wrap, 5-ply corrugated cardboard sheets, foam edge protectors, quilted moving blankets, official tamper-evident security tape, and custom timber crating for delicate glass tops, marble mandirs, and large Smart TVs.
        </p>
        <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.7; margin-bottom: 14px;">
          We specialize in serving Indian Railways employees, Tata group personnel, school educators, and commercial shop owners in Kitadih. We provide 100% authentic IBA-approved GST invoices, money receipts, official consignment Lorry Receipts (LR), and itemized inventory lists necessary for hassle-free corporate and government claim reimbursements.
        </p>
        <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.7; margin-bottom: 14px;">
          Our local transport crews understand the specific road navigation requirements of Kitadih main road, narrow residential lanes near Loco Colony, and busy Tatanagar station market areas. We plan pickup schedules around peak traffic hours to guarantee prompt arrival, safe loading, and rapid transit.
        </p>
  ...
  <section style="padding: 60px 0; background: #ffffff;">
    <div class="container">
      <div style="text-align: center; max-width: 800px; margin: 0 auto 40px auto;">
        <h2 style="font-size: 2.1rem; color: #0b132b; font-weight: 800;">Shifting Solutions in <span style="color: #d32f2f;">Kitadih Jamshedpur</span></h2>
      </div>
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 25px;">
        <div style="background: #f8fafc; padding: 25px; border-radius: 10px; border: 1px solid #e2e8f0;">
          <h3 style="font-size: 1.2rem; color: #0b132b; margin-bottom: 10px;">🏡 Kitadih Household Shifting</h3>
          <p style="color: #64748b; font-size: 0.9rem; line-height: 1.6;">Complete house shifting services in Kitadih covering furniture disassembly, fragile items packing, heavy lifting, container transport, unloading, and complete room-by-room reassembly at your destination.</p>
        </div>
        <div style="background: #f8fafc; padding: 25px; border-radius: 10px; border: 1px solid #e2e8f0;">
          <h3 style="font-size: 1.2rem; color: #0b132b; margin-bottom: 10px;">🏢 Kitadih Office &amp; Commercial Moving</h3>
          <p style="color: #64748b; font-size: 0.9rem; line-height: 1.6;">Fast office, bank branch, and retail shop relocation in Kitadih with specialized computer system packing, document file tagging, weekend execution, and minimal business downtime.</p>
        </div>
        <div style="background: #f8fafc; padding: 25px; border-radius: 10px; border: 1px solid #e2e8f0;">
          <h3 style="font-size: 1.2rem; color: #0b132b; margin-bottom: 10px;">🚗 Closed Car Carrier Transport</h3>
          <p style="color: #64748b; font-size: 0.9rem; line-height: 1.6;">Enclosed hydraulic car container trailers for safe, scratch-free door-to-door car transport from Kitadih Jamshedpur to any major city across India with full insurance coverage.</p>
        </div>
        <div style="background: #f8fafc; padding: 25px; border-radius: 10px; border: 1px solid #e2e8f0;">
          <h3 style="font-size: 1.2rem; color: #0b132b; margin-bottom: 10px;">🏍️ Two-Wheeler / Bike Shipping</h3>
          <p style="color: #64748b; font-size: 0.9rem; line-height: 1.6;">Multi-layer air bubble wrapping, paddy straw padding, and corrugated box encasing for 100% scratch-free motorcycle and scooter shipping inside closed trucks from Kitadih.</p>
        </div>
        <div style="background: #f8fafc; padding: 25px; border-radius: 10px; border: 1px solid #e2e8f0;">
          <h3 style="font-size: 1.2rem; color: #0b132b; margin-bottom: 10px;">📦 Custom Wooden Box Crating</h3>
          <p style="color: #64748b; font-size: 0.9rem; line-height: 1.6;">Solid custom timber crate framing constructed on-site for large LED Smart TVs, glass table tops, delicate marble mandirs, mirrors, and valuable artwork in Kitadih.</p>
        </div>
        <div style="background: #f8fafc; padding: 25px; border-radius: 10px; border: 1px solid #e2e8f0;">
  ...
  <section style="padding: 50px 0; background: #070d19; color: #ffffff;">
    <div class="container">
      <div style="text-align: center; max-width: 800px; margin: 0 auto 35px auto;">
        <h2 style="font-size: 2rem; color: #ffffff; font-weight: 800;">7-Layer Safety Packaging for <span style="color: #f59e0b;">Kitadih Moves</span></h2>
      </div>
    ...
    <div class="container" style="max-width: 950px;">
      <div style="text-align: center; margin-bottom: 40px;">
        ...
        <h2 style="font-size: 2.1rem; font-weight: 800; color: #ffffff; margin-top: 8px;">
          Kitadih Shifting Cost Guide &amp; Process Overview
        </h2>
        <p style="color: #cbd5e1; font-size: 0.95rem; margin-top: 8px;">
          Everything you need to know about pricing, packing standards, and route planning for moving in Kitadih Jamshedpur.
        </p>
      </div>
      ...
      <div style="background: rgba(255,255,255,0.04); border: 1px solid rgba(245,158,11,0.25); border-radius: 12px; padding: 25px; margin-bottom: 35px;">
        <h3 style="color: #f59e0b; font-size: 1.25rem; font-weight: 700; margin-bottom: 16px;">Estimated Shifting Charges in Kitadih Jamshedpur</h3>
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 25px;">
        <div style="background: rgba(255,255,255,0.04); border: 1px solid rgba(245,158,11,0.2); padding: 22px; border-radius: 10px;">
          <h4 style="color: #f59e0b; font-size: 1.1rem; margin-bottom: 10px;">Why IBA Approved Bills Matter in Kitadih</h4>
          <p style="color: #cbd5e1; font-size: 0.9rem; line-height: 1.6; margin: 0;">
            Kitadih is home to numerous Railway personnel, bank officers, and public sector workers. We issue 100% authentic IBA-approved GST bills with matching consignment notes, lorry receipts, and itemized inventories that satisfy all official claim requirements.
          </p>
        </div>
        <div style="background: rgba(255,255,255,0.04); border: 1px solid rgba(245,158,11,0.2); padding: 22px; border-radius: 10px;">
  ...
  <section style="padding: 50px 0; background: #f8fafc;">
    <div class="container">
      <div style="text-align: center; max-width: 800px; margin: 0 auto 30px auto;">
        <h3 style="font-size: 1.8rem; color: #0b132b; font-weight: 800;">Connecting <span style="color: #d32f2f;">Kitadih</span> to Key Locations</h3>
      </div>
  ...
  <section style="padding: 50px 0; background: #ffffff;">
    <div class="container">
      ...
      <div style="max-width: 850px; margin: 0 auto; display: flex; flex-direction: column; gap: 12px;">
        ...
        <div style="background: #f8fafc; padding: 18px; border-radius: 8px; border: 1px solid #e2e8f0;"><h4 style="color: #0b132b; font-weight: 700;">Q8: Do you disassemble beds and wardrobes?</h4><p style="color: #64748b; font-size: 0.9rem; line-height: 1.6; margin-top: 6px;">Yes, our experienced carpenters disassemble double beds, wardrobes, and modular furniture at your Kitadih origin and perform full reassembly at your new destination.</p></div>
  ...
  <section class="cta-banner-section" style="padding: 50px 0; background: linear-gradient(135deg, #0b132b 0%, #1c2541 100%); color: #ffffff;">
    <div class="container">
      <div style="text-align: center; max-width: 800px; margin: 0 auto;">
        <h2 style="font-size: 2.1rem; font-weight: 800; margin-bottom: 15px;">Book Kitadih Shifting Services Today</h2>
        <div style="display: flex; gap: 15px; justify-content: center; flex-wrap: wrap;">
          ...
          <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20need%20shifting%20quote%20for%20Kitadih." target="_blank" style="padding: 12px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #fff; border-radius: 50px; font-weight: 700; text-decoration: none;">💬 WhatsApp Quote</a>
        </div>
      </div>
    </div>
  </section>
