...
<ul style="list-style: none; padding-left: 0; margin: 16px 0 20px 0; display: flex; flex-direction: column; gap: 10px;"><li style="display: flex; align-items: flex-start; gap: 10px; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.07); padding: 10px 14px; border-radius: 8px; font-size: 0.92rem; line-height: 1.55; color: #cbd5e1;"><i class="fas fa-check-circle" style="color: #10b981; margin-top: 4px; flex-shrink: 0; font-size: 0.9rem;"></i><span>To minimize the risks and ensure a hassle-free experience, it is essential to follow proper pre-loading protocols.</span></li><li style="display: flex; align-items: flex-start; gap: 10px; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.07); padding: 10px 14px; border-radius: 8px; font-size: 0.92rem; line-height: 1.55; color: #cbd5e1;"><i class="fas fa-check-circle" style="color: #10b981; margin-top: 4px; flex-shrink: 0; font-size: 0.9rem;"></i><span>In this guide, we will discuss essential steps for packing, pre-trip inspections, and managing transportation details for safe transportation of your vehicle.</span></li></ul>
    ...
    01
    Protocol 01</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Conduct a thorough visual inspection of the vehicle, focusing on its bodywork, exhaust, wheels, electrical components, and exhaust system.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Take detailed photos of the bike or motorcycle, capturing all angles to document its condition before transport.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 03</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Ensure accurate documentation to support potential claims or disputes during transportation.</p>
  </div>
</div>

	<h3>2. Battery and Battery Terminal Checks
	
		Verify the battery is fully charged and securely fastened to avoid any damage during transit.
		Inspect the battery terminals for corrosion or damage and clean them if necessary.
		Ensure the battery is properly connected to prevent disconnection during transportation.
	

	3. One-Quarter Tank Fuel Regulation
	
		Fill the fuel tank to approximately one-quarter of its capacity.
		Fuel levels should not exceed one-third to avoid fuel leakage or spillage during transport.
		Disconnect the battery to avoid any accidental start-ups during transportation.
	

	4. FASTag Management
	
		Check if FASTag (Fastag) is mandatory for your destination state and ensure that it is functional.
		If your destination state requires FASTag, make sure to apply for one beforehand and ensure it is properly installed on your vehicle.
		For motorcycles, ensure FASTag is installed on either the front or rear windscreen, depending on the rules of the destination state.
	

	5. Packing and Preparation
	
		Ensure that the vehicle is clean and free from any dirt or debris before transportation.
		Remove any unnecessary items from the vehicle, including accessories, luggage, and personal belongings.
		Disconnect any external accessories, such as GPS devices or intercoms, to avoid any potential damage during transportation.
	

	6. Container Selection and Packaging</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for 2. Battery and Battery Terminal Checks
	...
	6. Container Selection and Packaging ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
