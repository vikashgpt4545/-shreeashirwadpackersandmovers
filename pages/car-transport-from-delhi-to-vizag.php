...
$page_keywords = "car transport from delhi to vizag, car transport in delhi, car transport service, vehicle transport services, car shipping cost, car shifting services, all india car transport company, car carrier service";
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            DELHI TO VIZAG CAR SHIFTING SPECIALISTS
          </span>
          <h1 style="font-size: 2.5rem; font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #ffffff;">
            Professional <span style="color: #f59e0b;">Car Transport from Delhi to Vizag</span>
          </h1>
          <p style="font-size: 1.1rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Relocating your vehicle across ~1,780 km from Delhi NCR to the port city of Vizag (Visakhapatnam), Andhra Pradesh? Trust Shree Ashirwad Packers and Movers for express 4-5 day transit via NH19 &amp; NH16 coastal freight corridors. Enclosed multi-car trailers with 100% all-risk insurance and live GPS tracking.
          </p>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20a%20car%20transport%20quote%20from%20Delhi%20to%20Vizag." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
      ...
      <div style="background: #0f172a; border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 35px 30px; margin-bottom: 40px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
        ...
        <div style="display: flex; flex-wrap: wrap; justify-content: space-between; align-items: center; gap: 15px; margin-bottom: 20px;">
          <span style="background: rgba(245, 158, 11, 0.1); color: #f59e0b; border: 1.5px solid rgba(245, 158, 11, 0.3); padding: 6px 20px; border-radius: 30px; font-size: 0.8rem; font-weight: 700; text-transform: uppercase; letter-spacing: 1px;">
            MASTER GUIDE &bull; DELHI TO VIZAG CAR TRANSPORT
          </span>
      ...
      <div style="background: #0f172a; border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 16px; padding: 40px 35px; line-height: 1.8; color: #cbd5e1; font-size: 1rem; box-shadow: 0 10px 30px rgba(0,0,0,0.3);">
        ...
        <section style="margin-bottom: 35px;">
          <h2 style="font-size: 1.6rem; font-weight: 800; color: #ffffff; margin-bottom: 16px; padding-bottom: 10px; border-bottom: 2px solid rgba(245, 158, 11, 0.4);">
            1. Delhi to Vizag Route Logistics &amp; Transit Time
          </h2>
          <p>
            The major east-coast freight corridor connecting Delhi NCR to Vizag covers approximately 1,780 kilometers passing through Agra, Kanpur, Varanasi, Ranchi, Sambalpur, Bhubaneswar, and Srikakulam via NH19 &amp; NH16. Estimated vehicle transit duration is <strong>4 to 5 business days</strong>.
          </p>
          <p style="margin-top: 12px;">
            Our dedicated <strong>car carrier service</strong> collects vehicles from across Delhi NCR (Connaught Place, Dwarka, Rohini, South Ext, Janakpuri, Laxmi Nagar, Gurgaon, Noida) and delivers directly across Vizag (Gajuwaka, MVP Colony, Seethammadhara, Madhurawada, Dwaraka Nagar, Siripuram, Pendurthi, Gopalapatnam, Rushikonda, Steel Plant Township).
          </p>
        </section>
        ...
        <section style="margin-bottom: 35px;">
          <h2 style="font-size: 1.6rem; font-weight: 800; color: #ffffff; margin-bottom: 16px; padding-bottom: 10px; border-bottom: 2px solid rgba(245, 158, 11, 0.4);">
            2. Estimated Car Shifting Cost Table: Delhi to Vizag
          </h2>
          <p>
            Below is the standard <strong>car shipping cost</strong> tariff matrix for shipping cars from Delhi to Vizag across open multi-car trailers and enclosed container carriers:
          </p>
        ...
        <section style="margin-bottom: 20px;">
          <h2 style="font-size: 1.6rem; font-weight: 800; color: #ffffff; margin-bottom: 16px; padding-bottom: 10px; border-bottom: 2px solid rgba(245, 158, 11, 0.4);">
            5. Why Choose Shree Ashirwad for Delhi to Vizag Car Shifting?
          </h2>
          <div style="background: #070d19; border: 1.5px solid rgba(245, 158, 11, 0.4); border-radius: 14px; padding: 25px;">
            <ul style="padding-left: 20px; margin: 0; line-height: 1.85; color: #cbd5e1;">
              ...
              <li><strong>Door-to-Door Service:</strong> Pickup directly from your residence in Delhi NCR and delivery at your doorstep in Vizag.</li>
            </ul>
          </div>
        </section>
  ...
  <script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the cost of car transport from Delhi to Vizag?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Car transport charges from Delhi to Vizag range from ₹12,000 to ₹19,500 for hatchbacks and sedans, and ₹16,500 to ₹37,000 for SUVs and luxury vehicles in enclosed containers."
      }
    },
    {
      "@type": "Question",
      "name": "How long does car shipping take from Delhi to Vizag?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Car transport from Delhi to Vizag takes 4 to 5 business days via NH19 and NH16."
      }
    },
    {
      "@type": "Question",
      "name": "Do you deliver cars across MVP Colony and Gajuwaka in Vizag?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, we provide door-to-door delivery across all Vizag localities including Gajuwaka, MVP Colony, Seethammadhara, Madhurawada, Dwaraka Nagar, and Siripuram."
      }
    },
    {
      "@type": "Question",
      "name": "What documents are required to transport a car to Vizag?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    <div class="container" style="max-width: 980px; margin: 0 auto; padding: 0 15px;">
      ...
      <div style="text-align: center; margin-bottom: 35px;">
        ...
        <h2 style="font-size: 2.05rem; font-weight: 800; color: #ffffff; margin-top: 14px;">
          Questions About <span style="color: #f59e0b;">Delhi to Vizag Car Transport</span>
        </h2>
      </div>
      ...
      <div style="display: flex; flex-direction: column; gap: 14px;">
        ...
        <details style="background: #0f172a; border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 12px; overflow: hidden;">
          <summary style="padding: 18px 22px; color: #ffffff; font-weight: 700; font-size: 1rem; cursor: pointer; display: flex; justify-content: space-between; align-items: center;">
            <span><strong style="color: #f59e0b; margin-right: 8px;">Q1.</strong> What is the cost of car transport from Delhi to Vizag?</span>
          ...
          <div style="padding: 15px 22px 20px 22px; color: #cbd5e1; font-size: 0.93rem; line-height: 1.7; border-top: 1px solid rgba(255,255,255,0.08);">
            Car transport charges from Delhi to Vizag range from ₹12,000 to ₹19,500 for hatchbacks and sedans, and ₹16,500 to ₹37,000 for SUVs and luxury vehicles in enclosed containers.
          </div>
        </details>

        <details style="background: #0f172a; border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 12px; overflow: hidden;">
          <summary style="padding: 18px 22px; color: #ffffff; font-weight: 700; font-size: 1rem; cursor: pointer; display: flex; justify-content: space-between; align-items: center;">
            <span><strong style="color: #f59e0b; margin-right: 8px;">Q2.</strong> How long does car shipping take from Delhi to Vizag?</span>
            <span style="color: #f59e0b; font-size: 1.2rem; font-weight: 800;">&#43;</span>
          </summary>
          <div style="padding: 15px 22px 20px 22px; color: #cbd5e1; font-size: 0.93rem; line-height: 1.7; border-top: 1px solid rgba(255,255,255,0.08);">
            Car transport from Delhi to Vizag takes 4 to 5 business days via NH19 and NH16.
          </div>
        </details>

        <details style="background: #0f172a; border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 12px; overflow: hidden;">
          <summary style="padding: 18px 22px; color: #ffffff; font-weight: 700; font-size: 1rem; cursor: pointer; display: flex; justify-content: space-between; align-items: center;">
            <span><strong style="color: #f59e0b; margin-right: 8px;">Q3.</strong> Do you deliver cars across MVP Colony and Gajuwaka in Vizag?</span>
            <span style="color: #f59e0b; font-size: 1.2rem; font-weight: 800;">&#43;</span>
          </summary>
          <div style="padding: 15px 22px 20px 22px; color: #cbd5e1; font-size: 0.93rem; line-height: 1.7; border-top: 1px solid rgba(255,255,255,0.08);">
            Yes, we provide door-to-door delivery across all Vizag localities including Gajuwaka, MVP Colony, Seethammadhara, Madhurawada, Dwaraka Nagar, and Siripuram.
          </div>
        </details>

        <details style="background: #0f172a; border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 12px; overflow: hidden;">
          <summary style="padding: 18px 22px; color: #ffffff; font-weight: 700; font-size: 1rem; cursor: pointer; display: flex; justify-content: space-between; align-items: center;">
            <span><strong style="color: #f59e0b; margin-right: 8px;">Q4.</strong> What documents are required to transport a car to Vizag?</span>
            <span style="color: #f59e0b; font-size: 1.2rem; font-weight: 800;">&#43;</span>
          </summary>
          <div style="padding: 15px 22px 20px 22px; color: #cbd5e1; font-size: 0.93rem; line-height: 1.7; border-top: 1px solid rgba(255,255,255,0.08);">
    ...
    <div class="container" style="max-width: 980px; margin: 0 auto; padding: 0 15px;">
      ...
      <div style="background: linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #070d19 100%); border: 1.5px solid rgba(245, 158, 11, 0.4); border-radius: 20px; padding: 45px 30px; text-align: center; box-shadow: 0 20px 40px rgba(0,0,0,0.5);">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin-bottom: 18px; line-height: 1.3;">
          Book <span style="color: #f59e0b;">Car Transport from Delhi to Vizag</span> Today!
        </h2>
        ...
        <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 15px; margin-bottom: 30px;">
          ...
          <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad,%20I%20want%20to%20book%20car%20transport%20from%20Delhi%20to%20Vizag." title="Chat on WhatsApp" target="_blank" style="padding: 14px 28px; background: #25D366; color: #ffffff; border-radius: 30px; font-weight: 700; font-size: 1rem; text-decoration: none; display: inline-flex; align-items: center; gap: 8px; box-shadow: 0 6px 20px rgba(37, 211, 102, 0.4);">
