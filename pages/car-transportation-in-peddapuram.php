...
$faq_list = [
    ...
    [
        'q' => 'How are relocation charges calculated for Car Transportation in Peddapuram 8409531615?',
...
<section class="operational-photo-showcase-section" style="padding: 55px 0; background: #0b132b; border-bottom: 1px solid rgba(255,255,255,0.08);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    ...
    <div style="text-align: center; margin-bottom: 35px;">
      ...
      <h2 style="color: #ffffff; font-size: 1.75rem; font-weight: 800; margin-top: 12px; margin-bottom: 8px;">Verified On-Site Operations: Car Transportation in Peddapuram 8409531615</h2>
...
<section class="content-ui-section" style="padding: 55px 0; background: #070d1e; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    ...
    01
    Protocol 01</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Utilize a 360-degree digital condition audit to inspect and document the vehicle&#039;s condition before transport.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Take photographs or create detailed video recordings of the vehicle&#039;s exterior, interior, engine, tires, and undercarriage.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 03</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Identify any existing damages, scratches, dents, or signs of wear and tear.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #a855f722; color: #a855f7; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">04</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 04</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Document the condition report and present it to the client upon pickup for verification.</p>
  </div>
</div>

	<h3>2. Battery Terminal Checks
	
		Inspect the vehicle&amp;#039;s battery terminals to ensure proper connections and battery health.
		Verify that the cables are securely attached and the terminals are clean and free of corrosion.
		If necessary, apply a protective coating to the terminals to prevent corrosion during transportation.
		Document any issues found and provide recommendations for rectification before transport.
	

	3. Fuel Regulation
	
		Check the fuel level and ensure it&amp;#039;s maintained at a quarter tank.
		Filling the tank to excess can cause damage to the fuel system during transportation.
		Opt for a quarter tank fuel regulation to minimize risks and ensure a smooth transport process.
		Additionally, ensure the engine is well-maintained and in good condition.
	

	4. FASTag Management
	
		If the vehicle is equipped with a FASTag (Fastag), ensure it is properly installed and functioning.
		FASTag plays a crucial role in seamless high-speed transportation on Indian highways.
		If the vehicle doesn&amp;#039;t have a FASTag, provide instructions to the client on obtaining one before transportation.
		Ensure the FASTag is properly mounted and functional during the transport process.
	

	5. Vehicle Transport Services Near Me
	
		Research and locate reliable vehicle transport services in your area.
		Consider factors like experience, reputation, insurance coverage, and customer reviews when selecting a service provider.
		Coordinate with the chosen service provider to ensure a smooth pickup and delivery process.
		Ensure clear communication between the client and transport company to avoid miscommunication regarding pickup, transit, and delivery locations.
	

	6. Car Shifting by Train</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for 2. Battery Terminal Checks
	...
	6. Car Shifting by Train ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
...
<section class="faq-section" style="padding: 50px 0; background: #0b132b; border-bottom: 1px solid rgba(255,255,255,0.08);">
  <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px;">
    <h2 style="color: #ffffff; font-size: 1.7rem; font-weight: 800; margin-bottom: 25px; text-align: center;">Frequently Asked Questions &amp;bull; Car Transportation in Peddapuram 8409531615</h2>
