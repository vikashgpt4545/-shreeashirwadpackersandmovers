...
<section class="content-ui-section" style="padding: 55px 0; background: #070d1e; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  ...
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>A photocopy of the owner&#039;s RTO Registration Certificate (RC) should be provided. This document proves the ownership of the vehicle and is necessary for safe transportation.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Current PUC:</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>A valid Pollution Under Control (PUC) certificate is essential to ensure that the vehicle meets environmental standards. This document proves that the vehicle is in a roadworthy condition and emits no harmful pollutants.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Valid insurance certificate:</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>A valid car insurance certificate is required to cover any potential damages or accidents during transportation. It confirms that the owner is financially responsible for any liabilities.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #a855f722; color: #a855f7; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">04</div>
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>An Insurance Board of India (IBA) approved consignment bilty is crucial for vehicle transportation. It acts as a contract between the transporter and the owner, detailing the condition of the vehicle before and after transportation.</p>
  </div>
</div>
	...
	<h3>Advantages of Marine Transit Insurance:
	
		Full Coverage: Marine transit insurance provides complete protection for your vehicle, covering any damages or losses during transportation.
		Peace of Mind: With this insurance, you can have a stress-free experience knowing that your vehicle is fully insured.
		Repair Costs: In case of any damages, the insurance will cover the repair costs, ensuring that you don&amp;#039;t bear the financial burden.
	
	Procedures for Marine Transit Insurance:
	
		Declare the vehicle value: Before procuring the marine transit insurance, it is essential to declare the accurate value of your vehicle. This ensures that the insurance coverage aligns with the actual value of your car.
		Purchase Insurance: Seek assistance from a reliable insurance provider to purchase the marine transit insurance policy. Make sure to confirm the coverage details and understand the policy terms thoroughly.
		Submit Declared Value: Submit the declared value of your vehicle along with the insurance policy to the transporter during the transportation process.
	
	Tips for Optimal Car Transportation:</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Advantages of Marine Transit Insurance:
	...
	Tips for Optimal Car Transportation: ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
