...
$page_keywords = "car transport from delhi to bhubaneswar, car transport in delhi, car transport service, vehicle transport services, car shipping cost, car shifting services, all india car transport company, car carrier service";
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            DELHI TO BHUBANESWAR CAR SHIFTING SPECIALISTS
          </span>
          <h1 style="font-size: 2.5rem; font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #ffffff;">
            Professional <span style="color: #f59e0b;">Car Transport from Delhi to Bhubaneswar</span>
          </h1>
          <p style="font-size: 1.1rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Relocating your vehicle ~1,550 km from Delhi to Bhubaneswar? Trust Shree Ashirwad Packers and Movers for express 4-5 day transit via NH19 &amp; NH16 national highway corridor. Enclosed multi-car trailers with 100% all-risk transit insurance and live GPS tracking.
          </p>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20a%20car%20transport%20quote%20from%20Delhi%20to%20Bhubaneswar." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
        ...
        <div class="hero-form-card" style="background: rgba(255, 255, 255, 0.05); backdrop-filter: blur(10px); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
          <h2 style="font-size: 1.4rem; color: #ffffff; margin-bottom: 8px; font-weight: 700; text-align: center;">Get Delhi to Bhubaneswar Quote</h2>
      ...
      <div style="background: #0f172a; border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 35px 30px; margin-bottom: 40px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
        ...
        <div style="display: flex; flex-wrap: wrap; justify-content: space-between; align-items: center; gap: 15px; margin-bottom: 20px;">
          <span style="background: rgba(245, 158, 11, 0.1); color: #f59e0b; border: 1.5px solid rgba(245, 158, 11, 0.3); padding: 6px 20px; border-radius: 30px; font-size: 0.8rem; font-weight: 700; text-transform: uppercase; letter-spacing: 1px;">
            MASTER GUIDE &bull; DELHI TO BHUBANESWAR CAR TRANSPORT
          </span>
        ...
        <h2 style="font-size: 2.1rem; font-weight: 800; color: #ffffff; line-height: 1.35; margin-bottom: 18px;">
          Complete Guide: Car Transport from Delhi to Bhubaneswar
        </h2>

        <p style="font-size: 1.05rem; color: #cbd5e1; line-height: 1.75; margin: 0;">
          Shipping a vehicle ~1,550 km from <strong>Delhi NCR</strong> to <strong>Bhubaneswar</strong> along the East Coast corridor requires reliable <strong>vehicle transport services</strong>. Shree Ashirwad Packers and Movers delivers 4-5 day door-to-door car shipping backed by trusted <strong>car transport in delhi</strong> and <strong>all india car transport company</strong> networks.
        </p>
        ...
        <div style="background: rgba(245, 158, 11, 0.08); border-left: 4px solid #f59e0b; border-radius: 8px; padding: 20px 22px; margin-top: 25px;">
          ...
          <ul style="margin: 0; padding-left: 20px; color: #cbd5e1; font-size: 0.93rem; line-height: 1.75;">
            <li>Express 4 to 5 day transit via NH19 &amp; NH16 national highway corridor.</li>
            ...
            <li>Full assistance with Delhi NCR to Odisha RTO paperwork &amp; e-Way Bills.</li>
          </ul>
        </div>
      ...
      <div style="background: #0f172a; border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 16px; padding: 40px 35px; line-height: 1.8; color: #cbd5e1; font-size: 1rem; box-shadow: 0 10px 30px rgba(0,0,0,0.3);">
        ...
        <section style="margin-bottom: 35px;">
          <h2 style="font-size: 1.6rem; font-weight: 800; color: #ffffff; margin-bottom: 16px; padding-bottom: 10px; border-bottom: 2px solid rgba(245, 158, 11, 0.4);">
            1. Delhi to Bhubaneswar Route Logistics &amp; Transit Time
          </h2>
          <p>
            The national highway corridor connecting Delhi to Bhubaneswar spans approximately 1,550 kilometers passing through Agra, Kanpur, Prayagraj, Varanasi, and Ranchi via NH19 &amp; NH16. Estimated vehicle transit duration is <strong>4 to 5 business days</strong>.
          </p>
          <p style="margin-top: 12px;">
            Our dedicated <strong>car carrier service</strong> collects vehicles from across Delhi NCR (Dwarka, Rohini, South Extension, Janakpuri, Connaught Place, Vasant Kunj, Noida, Gurgaon) and delivers directly across Bhubaneswar (Jaydev Vihar, Saheed Nagar, Patia, Khandagiri, Nayapalli, Rasulgarh, Tamando, Kalinga Nagar).
          </p>
        </section>
        ...
        <section style="margin-bottom: 35px;">
          <h2 style="font-size: 1.6rem; font-weight: 800; color: #ffffff; margin-bottom: 16px; padding-bottom: 10px; border-bottom: 2px solid rgba(245, 158, 11, 0.4);">
            2. Estimated Car Shifting Cost Table: Delhi to Bhubaneswar
          </h2>
          <p>
            Below is the standard <strong>car shipping cost</strong> tariff matrix for car shipping from Delhi to Bhubaneswar across open multi-car trailers and enclosed container carriers:
          </p>
            ...
            <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 0.9rem; color: #cbd5e1;">
              ...
              <tbody>
                <tr>
                  ...
                  <td style="padding: 12px; border: 1px solid rgba(255,255,255,0.1);">₹15,500 – ₹18,500</td>
                ...
                <tr style="background: rgba(255,255,255,0.02);">
                  ...
                  <td style="padding: 12px; border: 1px solid rgba(255,255,255,0.1);">₹18,000 – ₹21,500</td>
                  <td style="padding: 12px; border: 1px solid rgba(255,255,255,0.1);">4 – 5 Days</td>
                </tr>
                <tr>
                  ...
                  <td style="padding: 12px; border: 1px solid rgba(255,255,255,0.1);">₹21,500 – ₹25,500</td>
                  <td style="padding: 12px; border: 1px solid rgba(255,255,255,0.1);">4 – 5 Days</td>
                </tr>
                <tr style="background: rgba(255,255,255,0.02);">
        ...
        <section style="margin-bottom: 35px;">
          ...
          <p>
            Transporting a vehicle interstate from Delhi NCR into Odisha requires standard statutory documentation:
          </p>
        ...
        <section style="margin-bottom: 20px;">
          <h2 style="font-size: 1.6rem; font-weight: 800; color: #ffffff; margin-bottom: 16px; padding-bottom: 10px; border-bottom: 2px solid rgba(245, 158, 11, 0.4);">
            5. Why Choose Shree Ashirwad for Delhi to Bhubaneswar Car Shifting?
          </h2>
          <div style="background: #070d19; border: 1.5px solid rgba(245, 158, 11, 0.4); border-radius: 14px; padding: 25px;">
            <ul style="padding-left: 20px; margin: 0; line-height: 1.85; color: #cbd5e1;">
              ...
              <li><strong>Express National Highway Transit:</strong> Direct connection via NH19 &amp; NH16 highway corridor.</li>
              ...
              <li><strong>Door-to-Door Service:</strong> Pickup directly from your Delhi location and delivery at your doorstep in Bhubaneswar.</li>
            </ul>
          </div>
        </section>
  ...
  <script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How much does it cost to transport a car from Delhi to Bhubaneswar?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Car transport charges from Delhi to Bhubaneswar range between ₹12,000 and ₹25,500 depending on vehicle category (hatchback, sedan, SUV) and carrier type."
      }
    },
    {
      "@type": "Question",
      "name": "How long does car shipping take from Delhi to Bhubaneswar?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Car transport from Delhi to Bhubaneswar takes 4 to 5 business days via NH19/NH16 corridor."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "What documents are required for Delhi to Bhubaneswar car transport?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Can I track my car during Delhi to Bhubaneswar transit?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    <div class="container" style="max-width: 980px; margin: 0 auto; padding: 0 15px;">
      ...
      <div style="text-align: center; margin-bottom: 35px;">
        ...
        <h2 style="font-size: 2.05rem; font-weight: 800; color: #ffffff; margin-top: 14px;">
          Questions About <span style="color: #f59e0b;">Delhi to Bhubaneswar Car Transport</span>
        </h2>
      </div>
      ...
      <div style="display: flex; flex-direction: column; gap: 14px;">
        ...
        <details style="background: #0f172a; border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 12px; overflow: hidden;">
          <summary style="padding: 18px 22px; color: #ffffff; font-weight: 700; font-size: 1rem; cursor: pointer; display: flex; justify-content: space-between; align-items: center;">
            <span><strong style="color: #f59e0b; margin-right: 8px;">Q1.</strong> How much does it cost to transport a car from Delhi to Bhubaneswar?</span>
          ...
          <div style="padding: 15px 22px 20px 22px; color: #cbd5e1; font-size: 0.93rem; line-height: 1.7; border-top: 1px solid rgba(255,255,255,0.08);">
            Car transport charges from Delhi to Bhubaneswar range between ₹12,000 and ₹25,500 depending on vehicle category (hatchback, sedan, SUV) and carrier type.
          </div>
        </details>

        <details style="background: #0f172a; border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 12px; overflow: hidden;">
          <summary style="padding: 18px 22px; color: #ffffff; font-weight: 700; font-size: 1rem; cursor: pointer; display: flex; justify-content: space-between; align-items: center;">
            <span><strong style="color: #f59e0b; margin-right: 8px;">Q2.</strong> How long does car shipping take from Delhi to Bhubaneswar?</span>
            <span style="color: #f59e0b; font-size: 1.2rem; font-weight: 800;">&#43;</span>
          </summary>
          <div style="padding: 15px 22px 20px 22px; color: #cbd5e1; font-size: 0.93rem; line-height: 1.7; border-top: 1px solid rgba(255,255,255,0.08);">
            Car transport from Delhi to Bhubaneswar takes 4 to 5 business days via NH19/NH16 corridor.
          </div>
        </details>
        ...
        <details style="background: #0f172a; border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 12px; overflow: hidden;">
          <summary style="padding: 18px 22px; color: #ffffff; font-weight: 700; font-size: 1rem; cursor: pointer; display: flex; justify-content: space-between; align-items: center;">
            <span><strong style="color: #f59e0b; margin-right: 8px;">Q4.</strong> What documents are required for Delhi to Bhubaneswar car transport?</span>
            <span style="color: #f59e0b; font-size: 1.2rem; font-weight: 800;">&#43;</span>
          </summary>
          <div style="padding: 15px 22px 20px 22px; color: #cbd5e1; font-size: 0.93rem; line-height: 1.7; border-top: 1px solid rgba(255,255,255,0.08);">
        ...
        <details style="background: #0f172a; border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 12px; overflow: hidden;">
          <summary style="padding: 18px 22px; color: #ffffff; font-weight: 700; font-size: 1rem; cursor: pointer; display: flex; justify-content: space-between; align-items: center;">
            <span><strong style="color: #f59e0b; margin-right: 8px;">Q6.</strong> Can I track my car during Delhi to Bhubaneswar transit?</span>
            <span style="color: #f59e0b; font-size: 1.2rem; font-weight: 800;">&#43;</span>
          </summary>
          <div style="padding: 15px 22px 20px 22px; color: #cbd5e1; font-size: 0.93rem; line-height: 1.7; border-top: 1px solid rgba(255,255,255,0.08);">
    ...
    <div class="container" style="max-width: 980px; margin: 0 auto; padding: 0 15px;">
      ...
      <div style="background: linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #070d19 100%); border: 1.5px solid rgba(245, 158, 11, 0.4); border-radius: 20px; padding: 45px 30px; text-align: center; box-shadow: 0 20px 40px rgba(0,0,0,0.5);">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin-bottom: 18px; line-height: 1.3;">
          Book <span style="color: #f59e0b;">Car Transport from Delhi to Bhubaneswar</span> Today!
        </h2>
        ...
        <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 15px; margin-bottom: 30px;">
          ...
          <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad,%20I%20want%20to%20book%20car%20transport%20from%20Delhi%20to%20Bhubaneswar." title="Chat on WhatsApp" target="_blank" style="padding: 14px 28px; background: #25D366; color: #ffffff; border-radius: 30px; font-weight: 700; font-size: 1rem; text-decoration: none; display: inline-flex; align-items: center; gap: 8px; box-shadow: 0 6px 20px rgba(37, 211, 102, 0.4);">
