    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For a seamless logistics experience on the route from Business (City Centre, Railway Station Road, Industrial Area) to Destination Hub, we recommend utilizing the National Highway Arterial Corridors and Multi-Axle Express Freight Highways. The most efficient route would be to take the NH-44 from Bangalore to Pune, followed by NH-61 to Delhi, and finally NH-44 to the destination hub. Interstate border checkposts such as the Anandpur Sahib Checkpost in Punjab and the Una Checkpost in Haryana are crucial to ensure smooth transit. Our team ensures automated e-Way bill clearance to avoid any delays or penalties. With speed-governed container transit, we guarantee a swift delivery of your goods, taking approximately 2 to 3 working days.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">At Shree Ashirwad Packers and Movers, we understand the importance of quality moving and packing services for businesses in Bangalore. Our expert packing, loading, and transit protection measures are tailored specifically for household items and vehicles on this corridor. We employ state-of-the-art techniques to ensure damage-free transit, including custom-made packing solutions, specialized equipment for vehicle transportation, and 24/7 monitoring of transit. Our team of experienced professionals will handle your goods with utmost care, ensuring a stress-free relocation experience. With</p>
        </div>
      </div>
    </div>
  </section>
