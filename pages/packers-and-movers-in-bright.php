    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">As a senior logistics coordinator for Shree Ashirwad Packers and Movers, we understand the intricacies of transporting household items or vehicles from Bright (City Centre, Railway Station Road, Industrial Area) to Destination Hub (City Centre, Railway Station Road, Industrial Area) via the National Highway Arterial Corridors &amp; Multi-Axle Express Freight Highways. For this route, we follow the exact freight highway route, which spans approximately 850 km. Our team closely monitors interstate border checkposts to ensure seamless transit. Additionally, we utilize automated e-Way bill clearance, ensuring compliance with regulatory requirements and reducing transit time.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">To ensure damage-free transit protection, our packing and loading procedures are tailored specifically for household items or vehicles. We use sturdy, customized packaging materials and employ a meticulous loading process to prevent shifting during transit. Our experienced team carefully inspects each shipment before dispatch, and we maintain a fleet of well-maintained vehicles to guarantee a smooth journey. By leveraging our expertise and cutting-edge logistics solutions, we provide a safe and efficient relocation service for our clients in Bright, Chennai. Whether it&#039;s a residential move or a corporate relocation, our services are designed to provide peace of mind and exceed expectations.</p>
        </div>
      </div>
    </div>
  </section>
