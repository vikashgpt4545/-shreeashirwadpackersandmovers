...
$page_title = "Loading Unloading | Shree Ashirwad Packers & Movers";
...
$page_keywords = "movers and packers with loading and unloading, manpower for goods loading and unloading nagpur, gst rate on loading and unloading of goods, home shifting service ravet, how to transport furniture to another state, packers and movers charges in south delhi, courier cost for fridge in bangalore, movers and packers nagpur bbill, reliable cargo movers and packers gstid, ultra safe packers and movers gurugram haryana, safe india packers and movers ahmedabad, packers and movers in miyapur area, world moving & storage";
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello+Shree+Ashirwad+Packers+%26+Movers%2C+I+would+like+to+request+a+quotation+for+Loading+Unloading+from+Origin+City+to+Major+Indian+City." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="text-align: center; margin-bottom: 40px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; margin-top: 8px;">
          Loading Unloading <span style="color: #f59e0b;">Cost Matrix &amp; Tariffs</span>
        </h2>
    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For a seamless household shifting and relocation from our origin city to a major Indian city via the National Highway Arterial Corridors and Multi-Axle Express Freight Highways, our logistics services employ a carefully curated freight highway route. The journey begins at the City Centre, Railway Station Road, and Industrial Area, where our team meticulously packs and loads household items onto a speed-governed container. The precise route traverses through numerous interstate border checkposts, ensuring expedient passage and adhering to regulatory compliance. Our team utilizes automated e-Way bill clearance, streamlining the paperwork and reducing transit durations.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">To guarantee damage-free transit protection, our experienced packing specialists employ customized packing materials and techniques tailored to each household item. This includes fragile item handling, wardrobe care, and specialized packing for heavy machinery or vehicles. Upon arrival at the destination city&#039;s City Centre, Railway Station Road, and Industrial Area, our team ensures efficient unloading, relocating, and organization of the household items, ensuring a hassle-free relocation experience. By utilizing our expert knowledge of the corridor, cutting-edge logistics technology, and personalized attention to detail, we provide a secure, efficient, and timely solution for households and individuals seeking reliable movers and packers services.</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px;">
      <div style="text-align: center; margin-bottom: 45px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin-top: 10px;">
          Frequently Asked Questions About <span style="color: #f59e0b;">Loading Unloading</span>
        </h2>
      </div>
  ...
  <section style="padding: 60px 0; background: linear-gradient(135deg, #172a54 0%, #0b132b 100%); border-top: 1.5px solid rgba(245, 158, 11, 0.4); color: #ffffff;">
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px; text-align: center;">
      <h2 style="font-size: 2.3rem; font-weight: 800; margin-bottom: 16px;">
        Book Your <span style="color: #f59e0b;">Loading Unloading</span> Today!
      </h2>
      ...
      <div style="display: flex; gap: 16px; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="https://wa.me/918409531615?text=Hello+Shree+Ashirwad+Packers+%26+Movers%2C+I+would+like+to+request+a+quotation+for+Loading+Unloading+from+Origin+City+to+Major+Indian+City." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 15px 32px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1.05rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
          <i class="fab fa-whatsapp" style="margin-right: 8px;"></i> Chat on WhatsApp
        </a>
      </div>
    </div>
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers & Movers,\n\nI would like to request a shifting estimate for Loading Unloading:\n- Name: " + name + "\n- Phone: " + phone + "\n- Pickup Location: " + moveFrom + "\n- Destination Location: " + moveTo;
  ...
  "@graph": [
    {
      ...
      "knowsAbout": ["movers and packers with loading and unloading","manpower for goods loading and unloading nagpur","gst rate on loading and unloading of goods","home shifting service ravet","how to transport furniture to another state","packers and movers charges in south delhi","courier cost for fridge in bangalore","movers and packers nagpur bbill","reliable cargo movers and packers gstid","ultra safe packers and movers gurugram haryana","safe india packers and movers ahmedabad","packers and movers in miyapur area","world moving & storage"],
