...
$page_title = "Local House Shifting | Shree Ashirwad Packers & Movers";
...
$page_keywords = "house shifting services in hosur, house shifting transporters hyderabad telangana, house material shifting letter format, moving household goods in bangalore, how to transport furniture by train, household item shifting charges from kolkata to mumbai, packers and movers charges in kharagpur, verified packers and movers, packers and movers bill service wakad pune, safex packers and movers bhopal, ultra-safe-packers-movers-ggn, prestige packers and movers hyderabad, omx international packers and movers bangalore";
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello+Shree+Ashirwad+Packers+%26+Movers%2C+I+would+like+to+request+a+quotation+for+Local+House+Shifting+from+Origin+City+to+Major+Indian+City." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="text-align: center; margin-bottom: 40px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; margin-top: 8px;">
          Local House Shifting <span style="color: #f59e0b;">Cost Matrix &amp; Tariffs</span>
        </h2>
    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For household shifting services in Hosur, utilizing the National Highway Arterial Corridors and Multi-Axle Express Freight Highways is essential. The exact freight highway route from the Origin City to Major Indian City will depend on the specific destinations, but generally, it will follow the NH-44, NH-207, and NH-56. Interstate border checkposts such as the Tamil Nadu-Punjab border at Kodumalai will require clearance through the Automated System for Customs Clearance (ASCC). Our team will ensure seamless e-Way bill clearance and speedy container transit via dedicated lanes.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">To ensure damage-free transit protection for household items, we employ specialized packing techniques, including bubble wrapping, foam sheeting, and customized box sizes. Vehicles are secured with tie-downs and straps to prevent movement during transit. We also utilize climate-controlled containers to safeguard sensitive items from extreme temperatures. Our team will conduct a thorough inventory of household goods, including electronics, furniture, and personal effects, to ensure accurate weighbridges and e-Way bill calculations. By utilizing our expertise and technology, you can trust that your household goods will arrive safely and securely at your destination. With our house shifting services in Hosur, you can focus on your relocation while we take care of the logistics.</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px;">
      <div style="text-align: center; margin-bottom: 45px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin-top: 10px;">
          Frequently Asked Questions About <span style="color: #f59e0b;">Local House Shifting</span>
        </h2>
      </div>
  ...
  <section style="padding: 60px 0; background: linear-gradient(135deg, #172a54 0%, #0b132b 100%); border-top: 1.5px solid rgba(245, 158, 11, 0.4); color: #ffffff;">
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px; text-align: center;">
      <h2 style="font-size: 2.3rem; font-weight: 800; margin-bottom: 16px;">
        Book Your <span style="color: #f59e0b;">Local House Shifting</span> Today!
      </h2>
      ...
      <div style="display: flex; gap: 16px; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="https://wa.me/918409531615?text=Hello+Shree+Ashirwad+Packers+%26+Movers%2C+I+would+like+to+request+a+quotation+for+Local+House+Shifting+from+Origin+City+to+Major+Indian+City." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 15px 32px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1.05rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
          <i class="fab fa-whatsapp" style="margin-right: 8px;"></i> Chat on WhatsApp
        </a>
      </div>
    </div>
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers & Movers,\n\nI would like to request a shifting estimate for Local House Shifting:\n- Name: " + name + "\n- Phone: " + phone + "\n- Pickup Location: " + moveFrom + "\n- Destination Location: " + moveTo;
  ...
  "@graph": [
    {
      ...
      "knowsAbout": ["house shifting services in hosur","house shifting transporters hyderabad telangana","house material shifting letter format","moving household goods in bangalore","how to transport furniture by train","household item shifting charges from kolkata to mumbai","packers and movers charges in kharagpur","verified packers and movers","packers and movers bill service wakad pune","safex packers and movers bhopal","ultra-safe-packers-movers-ggn","prestige packers and movers hyderabad","omx international packers and movers bangalore"],
