...
$faq_list = [
    ...
    ['q' => 'How much does bike transport cost from Dhanbad to other cities?', 'a' => 'Local bike shipping within Dhanbad costs â‚¹1,500 to â‚¹2,500, while intercity bike transport to major Indian cities ranges from â‚¹2,500 to â‚¹5,500.'],
    ['q' => 'How much does car transport cost from Dhanbad?', 'a' => 'Intercity car transport from Dhanbad ranges between â‚¹4,800 and â‚¹9,000 depending on vehicle size (hatchback, sedan, SUV) and destination distance.'],
  ...
  <section style="padding: 70px 0; background: #0b132b; color: #e2e8f0; line-height: 1.8;">
    <div class="container" style="max-width: 950px;">
      ...
      <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 24px; margin-top: 30px;">
        ...
        <div style="background: #172a54; padding: 25px; border-radius: 12px; border: 1.5px solid rgba(245, 158, 11, 0.25);">
          <div style="font-size: 1.3rem; font-weight: 800; color: #f59e0b; margin-bottom: 10px;">ðŸš— Four-Wheeler Safety Protocol</div>
          <p style="font-size: 0.95rem; color: #cbd5e1; line-height: 1.7; margin: 0;">
