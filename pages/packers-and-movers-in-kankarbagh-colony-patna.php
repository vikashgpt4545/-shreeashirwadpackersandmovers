...
$page_title = "Packers and Movers in Kankarbagh Colony Patna | Safe Home Moving";
$page_desc = "Hire trusted packers and movers in Kankarbagh Colony, Patna. Professional house shifting, room moving, bike/car transport near Doctor's Colony & Housing Board with IBA GST bill.";
$page_keywords = "packers and movers in kankarbagh colony patna, best packers and movers kankarbagh colony, movers and packers kankarbagh colony patna, local shifting kankarbagh colony, house shifting services kankarbagh colony patna";
$canonical_url = "https://shreeashirwadpackersandmovers.com/pages/packers-and-movers-in-kankarbagh-colony-patna.php";

$page_city = "Kankarbagh Colony, Patna, Bihar";

$faq_list = [
    [
        'q' => 'What are the home relocation charges in Kankarbagh Colony, Patna?',
        'a' => 'Local house relocation charges in Kankarbagh Colony range from ₹2,500–₹5,000 for 1BHK/2BHK flats, and ₹7,000–₹13,000 for 3BHK/4BHK Housing Board flats or independent houses.'
    ],
    [
        'q' => 'Which sectors within Kankarbagh Colony are covered?',
        'a' => 'We cover all sectors including Housing Board Colony, Doctor\'s Colony, Lohia Nagar, Hanuman Nagar, and Old Bypass Road.'
    ],
    [
        'q' => 'Do you provide IBA approved GST invoices for government employee reimbursement?',
        'a' => 'Yes, 100% genuine IBA-compliant GST bills, consignment notes (LR), and itemized survey sheets are provided.'
    ],
    [
        'q' => 'What protective packing materials are used for household goods?',
        'a' => 'We use 5-layer corrugated boxes, air-bubble wraps, waterproof stretch wrapping, edge protectors, and heavy plastic sheets.'
    ],
    [
        'q' => 'How do moving trucks navigate multi-story housing colony blocks in Kankarbagh?',
        'a' => 'We use specialized hydraulic lifts/rope pulley systems for upper floors without elevators and shuttle pick-up vans for narrow inner colony roads.'
    ],
    [
        'q' => 'Is vehicle transport (car/bike) provided from Kankarbagh Colony Patna?',
        'a' => 'Yes, we offer door-to-door bike and car transport with covered auto carriers across India.'
    ],
    [
        'q' => 'Can you handle medical clinic and office relocation in Kankarbagh Doctor\'s Colony?',
        'a' => 'Yes, we provide specialized clinic equipment packing, lab apparatus handling, and office furniture relocation.'
    ],
    [
        'q' => 'Is transit insurance included with shifting services?',
        'a' => 'Yes, full transit insurance coverage (1.5%) is provided to protect your valuables.'
    ],
    [
        'q' => 'What items are restricted during home packing?',
        'a' => 'Flammables, gas cylinders, liquid paints, cash, jewelry, and chemical products are excluded.'
    ],
    [
        'q' => 'How can I book Packers and Movers in Kankarbagh Colony Patna?',
        'a' => 'Call +91 8409531615 or submit your relocation details on WhatsApp for an immediate free estimate.'
    ]
];
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            PACKERS AND MOVERS KANKARBAGH COLONY PATNA
          </span>
          <h1 style="font-size: 2.7rem; font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #ffffff;">
            Professional <span style="color: #f59e0b;">Packers and Movers in Kankarbagh Colony Patna</span>
          </h1>
          <p style="font-size: 1.12rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Shree Ashirwad Packers and Movers offers expert household shifting, room moving, and office relocation in Kankarbagh Colony, Patna. Serving Housing Board Colony, Doctor's Colony, and Hanuman Nagar with 100% IBA-approved GST billing.
          </p>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20a%20shifting%20quote%20for%20Kankarbagh%20Colony%20Patna." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
        ...
        <div class="hero-form-card" style="background: rgba(255, 255, 255, 0.05); backdrop-filter: blur(10px); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
          <h2 style="font-size: 1.4rem; color: #ffffff; margin-bottom: 8px; font-weight: 700; text-align: center;">Get Kankarbagh Colony Quote</h2>
          ...
          <form action="#" method="POST" onsubmit="sendHeroWhatsAppLead(event, this);">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 14px;">
              <input type="text" name="move_from" class="form-control" value="Kankarbagh Colony, Patna" required style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.3); color: #fff;">
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #e2e8f0; line-height: 1.8;">
    <div class="container" style="max-width: 1000px;">
      ...
      <span class="section-tag" style="color: #f59e0b; text-transform: uppercase; font-weight: 700; font-size: 0.85rem; letter-spacing: 1px;">
        KANKARBAGH COLONY LOGISTICS
      </span>
      <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">
        Doorstep House & Office Relocation in <span style="color: #f59e0b;">Kankarbagh Colony, Patna</span>
      </h2>
      
      <p style="font-size: 1.05rem; color: #cbd5e1; margin-bottom: 25px;">
        Kankarbagh Colony is one of Asia's largest residential townships. Shree Ashirwad Packers and Movers provides seamless house moving, room packing, and commercial office shifting tailored to multi-story apartments and housing board quarters.
      </p>

      <!-- Rate Matrix Table -->
      <div style="overflow-x: auto; margin: 40px 0;">
        <h3 style="font-size: 1.5rem; color: #ffffff; font-weight: 700; margin-bottom: 15px;">
          Estimated Relocation Rates for Kankarbagh Colony, Patna
        </h3>
        <table style="width: 100%; border-collapse: collapse; background: #172a54; border-radius: 10px; overflow: hidden; border: 1px solid rgba(245, 158, 11, 0.3);">
          <thead>
            <tr style="background: #1e3a8a; color: #f59e0b; text-align: left;">
              ...
              <th style="padding: 14px 16px;">Local Within Patna (Kankarbagh Colony)</th>
  ...
  <section class="faq-section" style="padding: 60px 0; background: #070d1e; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      <div style="text-align: center; margin-bottom: 40px;">
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff;">Frequently Asked Questions (Kankarbagh Colony Patna)</h2>
      </div>
...
<script type="application/ld+json">
{
  ...
  "description": "Trusted packers and movers in Kankarbagh Colony, Patna offering home & office relocation.",
  "url": "<?php echo $canonical_url; ?>",
  "telephone": "<?php echo SITE_PHONE_RAW; ?>",
  "address": {
    "@type": "PostalAddress",
    "addressLocality": "Kankarbagh Colony, Patna",
    "addressRegion": "Bihar",
    "addressCountry": "IN"
  },
  "areaServed": "Kankarbagh Colony, Patna, Bihar",
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers,\n\nI would like a Shifting Quote for Kankarbagh Colony Patna:\n- Name: " + name + "\n- Phone: " + phone + "\n- Moving From: " + moveFrom + "\n- Moving To: " + moveTo;
