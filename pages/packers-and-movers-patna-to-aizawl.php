...
$page_title = "Packers and Movers Patna to Aizawl | Safe Intercity Relocation";
$page_desc = "Hire certified packers and movers from Patna to Aizawl, Mizoram. Shree Ashirwad Packers offers safe household shifting, bike transport, and car carrier services via NH-27 with 100% IBA GST bills & insurance.";
$page_keywords = "packers and movers patna to aizawl, best packers and movers patna to aizawl, house shifting patna to aizawl, bike transport patna to aizawl, car carrier patna to aizawl, shree ashirwad packers aizawl";
...
$faq_list = [
    [
        'q' => 'What are the charges for packers and movers from Patna to Aizawl?',
        'a' => 'Intercity shifting rates from Patna to Aizawl start from ₹16,500 to ₹28,500 for a 1 BHK, ₹25,500 to ₹39,000 for a 2 BHK, and ₹35,000 to ₹52,000 for a 3 BHK family house, depending on volume and transport vehicle.'
    ],
    [
        'q' => 'How long does goods delivery take from Patna to Aizawl?',
        'a' => 'The distance between Patna and Aizawl is approximately 1,380 km via Silchar-Aizawl highway corridor. Covered container transit takes around 5 to 7 days for doorstep delivery.'
    ],
    [
    ...
    [
        'q' => 'Is bike and car transport available from Patna to Aizawl?',
    ...
    [
        'q' => 'Do you cover shifting across all hill localities in Aizawl?',
        'a' => 'Yes, we serve Aizawl city center, Khatla, Zarkawt, Dawrpui, Chanmari, Zemabawk, and all surrounding areas of Mizoram.'
    ],
    [
        'q' => 'Is transit insurance included with intercity shifting to Aizawl?',
    ...
    [
        'q' => 'How do I schedule a pre-move survey in Patna for Aizawl shifting?',
    ...
    [
        'q' => 'What items are restricted during packing for long-distance hill transit?',
        'a' => 'Flammables, gas cylinders, liquid chemicals, batteries, cash, jewelry, and contraband substances are strictly prohibited.'
    ],
    [
        'q' => 'How can I book Packers and Movers Patna to Aizawl?',
...
<main class="site-main">
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            PATNA TO AIZAWL RELOCATION SPECIALISTS
          </span>
          ...
          <p style="font-size: 1.08rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Shree Ashirwad Packers and Movers provides certified doorstep household shifting, bike transport, and car carrier services from Patna to Aizawl, Mizoram. 100% IBA-approved GST invoices & transit insurance included.
          </p>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20a%20shifting%20quote%20for%20Patna%20to%20Aizawl." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
          ...
          <div style="display: flex; gap: 20px; font-size: 0.9rem; color: #94a3b8;">
            ...
            <span><strong style="color: #f59e0b;">Aizawl & Mizoram</strong> Coverage</span>
          </div>
        </div>

        <!-- Hero Lead Form Column -->
        <div class="hero-form-card" style="background: rgba(255, 255, 255, 0.05); backdrop-filter: blur(10px); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
          <h2 style="font-size: 1.4rem; color: #ffffff; margin-bottom: 8px; font-weight: 700; text-align: center;">Get Aizawl Quote</h2>
  ...
  <section style="background: #172a54; padding: 30px 0; border-top: 1px solid rgba(255,255,255,0.1); border-bottom: 1px solid rgba(255,255,255,0.1);">
    <div class="container">
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; text-align: center; color: #ffffff;">
        <div>
          <div style="font-size: 2.2rem; font-weight: 800; color: #f59e0b;">1,380 KM</div>
          <div style="font-size: 0.9rem; color: #cbd5e1;">Patna-Aizawl Route Distance</div>
        </div>
        <div>
          <div style="font-size: 2.2rem; font-weight: 800; color: #f59e0b;">5-7 DAYS</div>
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #ffffff;">
    <div class="container">
      <div style="max-width: 900px; margin: 0 auto;">
        <h2 style="font-size: 2rem; font-weight: 700; color: #f59e0b; margin-bottom: 20px;">Reliable Patna to Aizawl Goods Transportation Services</h2>
        <p style="font-size: 1.05rem; line-height: 1.8; color: #cbd5e1; margin-bottom: 20px;">
          Relocating from Patna to Aizawl requires experienced logistics execution across hill state terrain. Shree Ashirwad Packers and Movers provides dedicated covered container vehicles, trained packing crews, and complete insurance security to guarantee smooth intercity shifting.
        </p>
        <p style="font-size: 1.05rem; line-height: 1.8; color: #cbd5e1; margin-bottom: 20px;">
  ...
  <section style="padding: 60px 0; background: #1c2541; color: #ffffff;">
    <div class="container">
      <h2 style="font-size: 2rem; font-weight: 700; text-align: center; color: #f59e0b; margin-bottom: 35px;">Patna to Aizawl Shifting Cost Breakdown</h2>
        ...
        <table style="width: 100%; border-collapse: collapse; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); border-radius: 8px;">
          ...
          <tbody style="color: #cbd5e1;">
            <tr>
              ...
              <td style="padding: 15px; border: 1px solid rgba(255,255,255,0.1);">₹16,500 - ₹28,500</td>
            ...
            <tr>
              ...
              <td style="padding: 15px; border: 1px solid rgba(255,255,255,0.1);">₹25,500 - ₹39,000</td>
            ...
            <tr>
              ...
              <td style="padding: 15px; border: 1px solid rgba(255,255,255,0.1);">₹35,000 - ₹52,000</td>
            ...
            <tr>
              ...
              <td style="padding: 15px; border: 1px solid rgba(255,255,255,0.1);">₹6,000 - ₹10,500</td>
            ...
            <tr>
              ...
              <td style="padding: 15px; border: 1px solid rgba(255,255,255,0.1);">₹20,000 - ₹30,000</td>
    ...
    <div class="container">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 25px;">
        ...
        <div style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; padding: 25px;">
          ...
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.6;">Complete door-to-door residential goods packaging, transportation, and setup in Aizawl.</p>
        </div>

        <div style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; padding: 25px;">
          <h3 style="font-size: 1.3rem; color: #f59e0b; margin-bottom: 10px;">Bike & Scooter Shipping</h3>
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.6;">Zero-scratch two-wheeler packaging and secure enclosed transit to Aizawl.</p>
        </div>

        <div style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; padding: 25px;">
          <h3 style="font-size: 1.3rem; color: #f59e0b; margin-bottom: 10px;">Car Transport Service</h3>
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.6;">Specialized enclosed car carriers with doorstep pick-up in Patna and delivery in Aizawl.</p>
        </div>
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #ffffff;">
    <div class="container">
      <h2 style="font-size: 2rem; font-weight: 700; text-align: center; color: #f59e0b; margin-bottom: 35px;">Coverage Across Patna & Aizawl</h2>
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px; max-width: 900px; margin: 0 auto;">
        ...
        <div style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.1); padding: 25px; border-radius: 12px;">
          <h3 style="color: #f59e0b; font-size: 1.2rem; margin-bottom: 15px;">Aizawl Destination Hubs</h3>
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.8;">Aizawl City Center, Khatla, Zarkawt, Dawrpui, Chanmari, Zemabawk, and surrounding Mizoram regions.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section style="padding: 60px 0; background: #1c2541; color: #ffffff;">
    <div class="container">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 15px; max-width: 1000px; margin: 0 auto; text-align: center;">
        ...
        <a href="<?php echo SITE_URL; ?>pages/packers-and-movers-patna-to-imphal.php" style="color: #cbd5e1; text-decoration: none; padding: 12px; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); border-radius: 8px; display: block;">Patna to Imphal</a>
        <a href="<?php echo SITE_URL; ?>pages/packers-and-movers-patna-to-silchar.php" style="color: #cbd5e1; text-decoration: none; padding: 12px; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); border-radius: 8px; display: block;">Patna to Silchar</a>
      </div>
    </div>
  </section>
  ...
  <section style="padding: 60px 0; background: linear-gradient(135deg, #172a54 0%, #0b132b 100%); text-align: center; color: #ffffff; border-top: 1px solid rgba(255,255,255,0.1);">
    <div class="container" style="max-width: 800px; margin: 0 auto;">
      <h2 style="font-size: 2.2rem; font-weight: 800; margin-bottom: 15px; color: #ffffff;">Book Safe Patna to Aizawl Shifting Today</h2>
      ...
      <div style="display: flex; gap: 15px; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20a%20shifting%20quote%20for%20Patna%20to%20Aizawl." target="_blank" style="padding: 15px 35px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "MovingCompany",
  "name": "Shree Ashirwad Packers and Movers Patna to Aizawl",
  "url": "<?php echo $canonical_url; ?>",
  "logo": "https://shreeashirwadpackersandmovers.com/assets/images/logo.png",
  "telephone": "+91-8409531615",
  "priceRange": "₹16500 - ₹52000",
  "description": "Professional household shifting, vehicle transport, and IBA-approved billing services from Patna to Aizawl.",
  "address": {
    "@type": "PostalAddress",
