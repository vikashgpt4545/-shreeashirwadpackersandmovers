...
$page_title = "Car Transportation in Katihar | Professional Car Carrier BR-39";
$page_desc = "Reliable car transportation in Katihar (BR-39 RTO), Bihar. Open & enclosed hydraulic car carriers, doorstep pick-up, and full transit insurance via NH-31 & SH-98 corridors.";
$page_keywords = "car transportation in katihar, best car carrier katihar, affordable car shipping katihar, car movers katihar, doorstep car delivery katihar";
...
$faq_list = [
    [
        'q' => 'How are cars safely transported to/from Katihar (BR-39 RTO)?',
    ...
    [
        'q' => 'What are the car transport rates from Katihar to Patna, Siliguri, or Delhi?',
    ...
    [
        'q' => 'Which major transport highways serve Katihar car shipping?',
        'a' => 'Car carriers travel via NH-31 (Katihar-Purnea highway), SH-98 (Katihar-Manihari road), Railway Colony junction, and Mirchaibari bypass.'
    ],
    [
        'q' => 'Do you pick up cars directly from residences in Katihar?',
    ...
    [
        'q' => 'Is transit insurance included during Katihar car shipping?',
    ...
    [
        'q' => 'What documentation is required to ship a car from Katihar?',
    ...
    [
        'q' => 'How long does car carrier delivery take from Katihar?',
    ...
    [
        'q' => 'How can I book car carrier service in Katihar?',
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            CAR TRANSPORTATION KATIHAR (BR-39 SEEMANCHAL)
          </span>
          <h1 style="font-size: 2.7rem; font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #ffffff;">
            Professional <span style="color: #f59e0b;">Car Transportation in Katihar</span>
          </h1>
          <p style="font-size: 1.12rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Shree Ashirwad Packers and Movers provides doorstep car carrier services across Katihar (BR-39 RTO) via NH-31 and SH-98 corridors. Featuring open-trailer and enclosed car container shipping, hydraulic ramp loading, 4-point wheel locks, and 100% IBA-compliant GST billing.
          </p>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20a%20car%20transport%20quote%20for%20Katihar." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #e2e8f0; line-height: 1.8;">
    <div class="container" style="max-width: 1000px;">
      ...
      <span class="section-tag" style="color: #f59e0b; text-transform: uppercase; font-weight: 700; font-size: 0.85rem; letter-spacing: 1px;">
        KATIHAR VEHICLE LOGISTICS
      </span>
      <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">
        Doorstep Car Carrier Shipping in <span style="color: #f59e0b;">Katihar</span>
      </h2>
      
      <p style="font-size: 1.05rem; color: #cbd5e1; margin-bottom: 25px;">
        Shree Ashirwad Packers and Movers provides safe car transportation across Mirchaibari, Railway Colony, MG Road, Binodpur, Tezabganj, Naya Tola, and Manihari Road in Katihar. We utilize open multi-car trailers and single-car enclosed hydraulic containers equipped with 4-point wheel tie-down safety locks.
      </p>

      <!-- Rate Matrix Table -->
      <div style="overflow-x: auto; margin: 40px 0;">
        <h3 style="font-size: 1.5rem; color: #ffffff; font-weight: 700; margin-bottom: 15px;">
          Estimated Car Carrier Rates for Katihar
        </h3>
  ...
  <section class="faq-section" style="padding: 60px 0; background: #070d1e; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      <div style="text-align: center; margin-bottom: 40px;">
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff;">Frequently Asked Questions (Car Transport Katihar)</h2>
      </div>
...
<script type="application/ld+json">
{
  ...
  "description": "Professional car transportation in Katihar, Bihar with doorstep pickup and transit insurance.",
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers,\n\nI would like a Car Transport Quote for Katihar:\n- Name: " + name + "\n- Phone: " + phone + "\n- Moving From: " + moveFrom + "\n- Moving To: " + moveTo;
