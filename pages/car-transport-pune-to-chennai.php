...
$faq_list = [
    [
        'q' => 'How are relocation charges calculated for Car Transport Pune to Chennai | Certified Auto Carrier?',
...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  ...
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Enclosed containerized carriers ensure a safe journey for your possessions. These carriers are constructed with robust materials, providing a sturdy barrier against flying stones, rain, dust, and potential vandalism.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Security:</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Since the items are in a closed space, unauthorized access is minimized, giving you peace of mind.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Visual Appeal:</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>If presentation matters, enclosed carriers are the way to go, as your goods will be securely transported and displayed in a visually appealing manner.</p>
  </div>
</div>
...
<h3>Why Choose South Cargo Packers and Movers Pune Maharashtra


  Experienced Team: Our skilled professionals have years of experience in handling relocations, ensuring a hassle-free experience.
  Comprehensive Services: We offer a range of services, including packaging, loading, and unloading, to ensure a seamless transition.
  Customer Reviews: Our track record of satisfied customers speaks for itself, highlighting our dedication to delivering a secure and reliable service.
  Transportation Options: We provide open and enclosed carriers for cars, ensuring that you can choose the most suitable option based on your requirements.


Reliable Packers and Movers in Pune</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Why Choose South Cargo Packers and Movers Pune Maharashtra
...
Reliable Packers and Movers in Pune ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Pune to Chennai corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
