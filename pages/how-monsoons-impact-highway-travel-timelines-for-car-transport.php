...
<section class="content-ui-section" style="padding: 55px 0; background: #070d1e; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    <div style="background: rgba(15, 23, 42, 0.65); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 16px; padding: 36px 32px; box-shadow: 0 12px 30px rgba(0,0,0,0.35);">
      ...
      <div style="font-size: 1.02rem; line-height: 1.8; color: #cbd5e1;"><p>Before embarking on any automobile or car transport journey during monsoons, specialized pre-loading protocols ensure vehicle protection, regulatory compliance, and water-ingress prevention. A meticulous audit covers the vehicle's exterior, interior, mechanical systems, and weatherproofing seals before highway carrier departure.</p>
<ul style="list-style: none; padding-left: 0; margin: 18px 0;">
  <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;"><i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i><span><strong>360-Degree Digital Condition Audit:</strong> High-resolution exterior and underbody photographic logging records pre-existing panel condition and seals before enclosed container loading.</span></li>
  <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;"><i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i><span><strong>Battery Terminal Isolation:</strong> Disconnection and anti-corrosive insulation of terminals prevents moisture-induced shorts and battery drainage during extended transit delays.</span></li>
  <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;"><i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i><span><strong>One-Quarter Fuel Level Compliance:</strong> Fuel tanks are kept to one-quarter volume, minimizing transit weight and adhering to highway carrier fire safety codes.</span></li>
  <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;"><i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i><span><strong>FASTag & Sensor Sealing:</strong> Windshield FASTag shielding and sensor seals safeguard electronics against torrential highway spray and moisture exposure.</span></li>
</ul></div>
    </div>
  </div>
</section>
