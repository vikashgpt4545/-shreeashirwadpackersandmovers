...
$faq_list = [
    ...
    [
        'q' => 'How are relocation charges calculated for Bike Transport in Visakhapatnam | Safe Vizag Two-Wheeler Shifting?',
    ...
    [
        'q' => 'How many days in advance should I confirm my booking for Bike Transport in Visakhapatnam | Safe Vizag Two-Wheeler Shifting?',
...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
	...
	1. Meet at the Delivery Location
	
  
    01
    Protocol 01</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Ensure the driver and the recipient are present at the designated delivery location.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Verify the identity of the recipient using their identification document.</p>
  </div>
</div>

	<h4>2. Examine the Vehicle in Daylight Conditions
	
		Conduct a thorough examination of the vehicle in daylight conditions to ensure the following:
		
			Exterior of the vehicle: Check for any visible damage, scratches, dents, or paintwork issues.
			Interior of the vehicle: Ensure that there is no damage to the seats, flooring, and other interior components.
			Engine and Chassis Condition: Examine the engine, exhaust, and chassis for any signs of damage or tampering.
			Odometer Reading: Compare the odometer reading with the loaded vehicle details mentioned in the LR bill of lading.
		
	

	3. Document the Condition and Take Photos
	
		Utilize the pickup photos as a reference and document any discrepancies found during the inspection.
		Take additional photos of any observed damage, defects, or unusual conditions.
		Ensure the photos clearly show all aspects of the vehicle, including the exterior, interior, engine, and chassis.
	

	4. Odometer Verification
	
		Compare the recorded odometer reading with the loaded vehicle details mentioned in the LR bill of lading.
		If there is a discrepancy in the recorded odometer reading, contact the shipper for clarification and obtain written approval before proceeding with the delivery.
	

	5. Vehicle Handover and Documentation
	
		Upon verifying the vehicle&amp;#039;s condition and odometer reading, proceed with handing over the vehicle to the recipient.
		Collect the returned LR bill of lading, completed condition report, and any necessary documents from the recipient.
		Make sure the recipient signs the condition report, acknowledging their acceptance of the vehicle&amp;#039;s condition.
	

	6. Sign-off and Completion of Handover</h4><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for 2. Examine the Vehicle in Daylight Conditions
	...
	6. Sign-off and Completion of Handover ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
