...
$faq_list = [
    [
        'q' => 'How are relocation charges calculated for Car Transport from Mumbai to Kolkata | Express Container Carrier?',
        'a' => 'Our moving estimates between Mumbai and Kolkata are calculated using transparent parameters: total consignment volume (cft), distance (~650 km), packaging material grade (7-layer corrugated and bubble sheets), dedicated enclosed container capacity, and insurance declaration. We provide 100% itemized, fixed-price quotations with zero moving-day surcharges.'
    ],
    [
        'q' => 'How long does shipment transit take from Mumbai to Kolkata?',
