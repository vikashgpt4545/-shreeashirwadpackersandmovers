...
$faq_list = [
    ['q' => 'How much does household shifting cost from Bokaro to Buxar?', 'a' => 'Interstate house shifting from Bokaro to Buxar ranges from â‚¹12,000 to â‚¹18,000 for 1BHK, â‚¹17,000 to â‚¹27,000 for 2BHK, and â‚¹24,000 to â‚¹38,000 for 3BHK houses.'],
      ...
      <div style="overflow-x: auto; margin-top: 20px;">
        <table style="width: 100%; border-collapse: collapse; background: #172a54; border-radius: 10px; overflow: hidden;">
          ...
          <tbody style="color: #cbd5e1; font-size: 0.9rem;">
            ...
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.08);"><td style="padding: 12px; font-weight: 700; color: #fff;">Bike Transport</td><td style="padding: 12px;">Bubble Wrap + Box</td><td style="padding: 12px;">1 Day</td><td style="padding: 12px; color: #f59e0b;">â‚¹3,200 - â‚¹5,400</td></tr>
