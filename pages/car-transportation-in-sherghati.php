...
$faq_list = [
    ...
    [
        'q' => 'How are relocation charges calculated for Car Transportation in Sherghati 8409531615?',
    ...
    [
        'q' => 'How many days in advance should I confirm my booking for Car Transportation in Sherghati 8409531615?',
        'a' => 'For regional moves within Sherghati, booking 2 to 3 days prior is recommended. For intercity transit to null, we advise confirming 4 to 7 days ahead to reserve dedicated weatherproof container trucks and preferred morning departure slots.'
    ],
    [
...
<section class="operational-photo-showcase-section" style="padding: 55px 0; background: #0b132b; border-bottom: 1px solid rgba(255,255,255,0.08);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    ...
    <div style="text-align: center; margin-bottom: 35px;">
      ...
      <h2 style="color: #ffffff; font-size: 1.75rem; font-weight: 800; margin-top: 12px; margin-bottom: 8px;">Verified On-Site Operations: Car Transportation in Sherghati 8409531615</h2>
...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    ...
    01
    Protocol 01</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>The Road Transport Organisation (RTO) has issued a Registration Certificate (RC) to you, which is a legal document proving your ownership of the vehicle.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>To ensure the paperwork is valid, you must obtain a self-attested copy of the RC.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 03</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>The self-attested copy will be used to register the vehicle with the new RTO in Sherghati.</p>
  </div>
</div>
	<h3>2. Current PUC:
	
		Pollution Under Control (PUC) certificate is a document proving that your vehicle meets the emission standards set by the Government of India.
		Make sure your PUC certificate is valid and up-to-date, as an expired PUC may result in additional inspection fees and delays.
		The certificate should be specifically for the state of Jharkhand, as the Sherghati RTO will require it.
	
	3. Valid Insurance Certificate:
	
		Having a valid insurance certificate for your vehicle is crucial, as it ensures financial coverage in case of any accident, damage, or theft during transportation.
		Make sure the insurance certificate is issued by a recognized insurance provider and covers the entire duration of transportation.
		You can obtain a duplicate copy of the insurance certificate from your insurance provider, ensuring that it meets the requirements of the Sherghati RTO.
	
	4. IBA-Approved Consignment Bill of Landing (BOL):
	
		The Insurance Brokers Association of India (IBA) has provided a standard format for the Consignment Bill of Landing (BOL).
		This document serves as proof of the shipment details, including the vehicle make, model, color, and condition.
		Make sure to obtain an IBA-approved BOL from your transporter or logistics provider.
	
	5. Marine Transit Insurance (100% declared value):
	
		Marine transit insurance provides coverage for your vehicle during transportation via road or transport.
		The 100% declared value insurance ensures that the insurance company will cover the full value of your vehicle in case of any loss or damage during transportation.
		Make sure to obtain a 100% declared value marine transit insurance from a reliable insurance provider.
	
	Additional Required Documents:</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for 2. Current PUC:
	...
	Additional Required Documents: ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
...
<section class="faq-section" style="padding: 50px 0; background: #0b132b; border-bottom: 1px solid rgba(255,255,255,0.08);">
  <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px;">
    <h2 style="color: #ffffff; font-size: 1.7rem; font-weight: 800; margin-bottom: 25px; text-align: center;">Frequently Asked Questions &amp;bull; Car Transportation in Sherghati 8409531615</h2>
