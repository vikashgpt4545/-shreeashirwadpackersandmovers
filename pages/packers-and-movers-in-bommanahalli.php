    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">As a senior logistics coordinator for Shree Ashirwad Packers and Movers, I recommend utilizing the National Highway Arterial Corridors and Multi-Axle Express Freight Highways for the route from Bommanahalli to Destination Hub. The exact freight highway route will be NH 4, NH 44, and NH 44A, passing through interstate border checkposts in Gujarat and Maharashtra. To ensure seamless clearance, we will obtain an e-Way bill through the GSTN portal and electronically clear customs at designated checkposts. Our speed-governed container transit will guarantee timely arrival, with an expected duration of 2 to 3 working days.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For household shifting and relocation, our team will employ specialized packing techniques to protect your belongings during transit. We will use high-quality packing materials, such as bubble wrap, foam sheets, and custom-cut cardboard boxes, to safeguard fragile items. Our expert packers will meticulously wrap and secure every item, ensuring damage-free transit. For vehicles, we will conduct a thorough pre-loading inspection to ensure all necessary documents are in order and the vehicle is properly loaded. Our transit insurance policy will provide an additional layer of security, ensuring that you are protected against any unforeseen losses or damages. With Shree Ashirwad Packers and Movers</p>
        </div>
      </div>
    </div>
  </section>
