...
$page_title = "Car Movers and Packers in Patna | Enclosed Car Carrier Services";
$page_desc = "Top-rated car movers and packers in Patna. Shree Ashirwad Packers offers covered hydraulic car carriers, zero-scratch guarantees, transit insurance, and IBA GST bills.";
$page_keywords = "car movers and packers in patna, car carrier patna, enclosed car transport patna, car shifting patna, vehicle transport patna";
...
$faq_list = [
    [
        'q' => 'How are cars safely transported by car movers and packers in Patna?',
    ...
    [
        'q' => 'What is the cost of hiring car movers and packers in Patna?',
    ...
    [
        'q' => 'What documents are required to book car movers in Patna?',
    ...
    [
        'q' => 'How can I get an instant quote for car movers and packers in Patna?',
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(14, 165, 233, 0.15); color: #0ea5e9; border: 1px solid rgba(14, 165, 233, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            PATNA CAR MOVERS SPECIALISTS
          </span>
          <h1 style="font-size: 2.7rem; font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #ffffff;">
            Enclosed <span style="color: #0ea5e9;">Car Movers & Packers in Patna</span>
          </h1>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20a%20Car%20Movers%20quote%20for%20Patna." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
  ...
  <section class="faq-section" style="padding: 60px 0; background: #070d1e; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      <div style="text-align: center; margin-bottom: 40px;">
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff;">Frequently Asked Questions (Car Movers Patna)</h2>
      </div>
...
<script type="application/ld+json">
{
  ...
  "description": "Car movers and packers in Patna offering enclosed hydraulic car carrier shipping, doorstep pickup, and IBA GST bills.",
