...
$page_keywords = "iba approved packers and movers in patna, iba approved movers patna, bank shifting bills patna, govt employee relocation patna, iba consignment note patna, iba bill packers patna";
...
<main class="site-main">
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(16, 185, 129, 0.15); color: #10b981; border: 1px solid rgba(16, 185, 129, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            IBA APPROVED RELOCATION PATNA
          </span>
          <h1 style="font-size: 2.7rem; font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #ffffff;">
            IBA Approved <span style="color: #10b981;">Packers and Movers in Patna</span>
          </h1>
          <p style="font-size: 1.12rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Shree Ashirwad Packers and Movers is officially registered for Bank, Defense, Railway, and Government employee relocation across Patna. Get 100% genuine IBA-format consignment bills, GST tax invoices, and full claim approval assurance.
          </p>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20need%20an%20IBA%20approved%20shifting%20bill%20quote%20for%20Patna." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
          ...
          <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 15px; border-top: 1px solid rgba(255, 255, 255, 0.1); padding-top: 20px;">
            ...
            <div>
              ...
              <p style="font-size: 0.85rem; color: #94a3b8; margin: 0;">Consignment Note</p>
            </div>
            <div>
        ...
        <div class="hero-form-wrapper" style="background: rgba(255, 255, 255, 0.05); backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.1); padding: 30px; border-radius: 16px;">
          ...
          <form id="heroLeadForm" onsubmit="sendHeroWhatsAppLead(event)" style="display: flex; flex-direction: column; gap: 15px;">
            ...
            <select id="hero_service" required style="width: 100%; padding: 12px 15px; border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.2); background: #1e293b; color: #ffffff; font-size: 0.95rem;">
              <option value="IBA Bank Employee Relocation">IBA Bank Employee Relocation</option>
              <option value="IBA Defense / Military Move">IBA Defense / Military Move</option>
    ...
    <div class="container">
      <div style="max-width: 900px; margin: 0 auto; background: #ffffff; padding: 40px; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.05);">
        ...
        <h2 style="font-size: 2rem; color: #0f172a; margin-bottom: 20px; font-weight: 800;">
          Official IBA Approved Relocation Billing in Patna
        </h2>
        
        <p style="font-size: 1.05rem; line-height: 1.8; color: #334155; margin-bottom: 20px;">
          Government officers, bank employees, defense personnel, and public sector workers in <strong>Patna (Bihar)</strong> require compliant, official documentation for 100% employer claim reimbursement. Shree Ashirwad Packers and Movers supplies complete IBA-compliant documentation across <strong>Boring Road, Kankarbagh, Danapur, Bailey Road, Patliputra Colony, Ashiana Nagar, Exhibition Road, and Bihta</strong>.
        </p>

        <h3 style="font-size: 1.4rem; color: #1e293b; margin: 25px 0 15px; font-weight: 700;">
          Complete Document Set Supplied for Claims
        </h3>
        
        <ul style="line-height: 1.8; color: #334155; margin-bottom: 25px; padding-left: 20px;">
          <li><strong>Serial-Numbered IBA Consignment Note (LR Copy):</strong> Official consignment document with vehicle registration number and driver details.</li>
          <li><strong>GST Tax Invoice & Payment Receipt:</strong> Stamped original GST invoice conforming to employer HR/Accounts requirements.</li>
          <li><strong>Itemized Goods Inventory Sheet:</strong> Complete item count signed by customer and move supervisor.</li>
          <li><strong>Transit Insurance Policy Certificate:</strong> Marine/cargo transit insurance receipt matching declared item value.</li>
        </ul>
  ...
  <section class="rate-matrix" style="padding: 60px 0; background: #ffffff;">
    <div class="container">
      <div style="text-align: center; max-width: 700px; margin: 0 auto 40px;">
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #0f172a;">IBA Approved Relocation Tariff Matrix (Patna)</h2>
        <p style="color: #64748b; font-size: 1.05rem;">Standard official billing tariff rates for bank and government relocation in Patna.</p>
      </div>
        ...
        <table style="width: 100%; border-collapse: collapse; background: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.06);">
          <thead>
            <tr style="background: #0f172a; color: #ffffff; text-align: left;">
              <th style="padding: 16px 20px; font-size: 0.95rem;">Official Category</th>
          ...
          <tbody>
            <tr style="border-bottom: 1px solid #e2e8f0;">
              <td style="padding: 16px 20px; font-weight: 600; color: #1e293b;">1 BHK IBA Approved Move</td>
            ...
            <tr style="border-bottom: 1px solid #e2e8f0; background: #f8fafc;">
              <td style="padding: 16px 20px; font-weight: 600; color: #1e293b;">2 BHK IBA Approved Move</td>
            ...
            <tr style="border-bottom: 1px solid #e2e8f0;">
              <td style="padding: 16px 20px; font-weight: 600; color: #1e293b;">3 BHK IBA Approved Move</td>
            ...
            <tr>
              <td style="padding: 16px 20px; font-weight: 600; color: #1e293b;">IBA Car Carrier Transport Bill</td>
  ...
  <section class="faq-section" style="padding: 60px 0; background: #f8fafc;">
    <div class="container">
      <div style="text-align: center; max-width: 700px; margin: 0 auto 40px;">
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #0f172a;">Frequently Asked Questions (IBA Approved Patna)</h2>
        <p style="color: #64748b; font-size: 1.05rem;">Common questions about IBA approved shifting bills and government claim documentation in Patna.</p>
      </div>
...
function sendHeroWhatsAppLead(event) {
  ...
  var message = "Hello Shree Ashirwad Packers,%0A%0A" +
    "I would like to request an *Official IBA Relocation Bill Quote* for Patna:%0A" +
