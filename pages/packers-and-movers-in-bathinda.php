    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For a smooth and efficient journey from Bathinda to our destination hub, we recommend taking the National Highway Arterial Corridors &amp; Multi-Axle Express Freight Highways route. This 850 km-long highway is well-maintained and offers a reliable transit option. Our experienced logistics team will ensure that you avoid interstate border checkposts by utilizing our established network of trusted authorities and gateways. Furthermore, we will facilitate automated e-Way bill clearance, eliminating the need for manual submissions and reducing the risk of delays.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">To protect your household items or vehicles during transit, we employ a meticulous packing and loading process. Our skilled team will carefully wrap and secure your belongings to prevent damage during the journey. We utilize custom-designed containers that are specifically engineered for our clients&#039; needs. Our containers are equipped with state-of-the-art features, including speed-governed transit systems, GPS tracking, and real-time monitoring. This ensures that your items arrive safely and promptly at your destination hub. Our expert team will also conduct a thorough pre- and post-transit inspection to guarantee the safe handling of your belongings.</p>
        </div>
      </div>
    </div>
  </section>
