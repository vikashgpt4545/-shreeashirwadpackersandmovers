...
$faq_list = [
    ...
    [
        'q' => 'How are relocation charges calculated for Bike Transportation in Bargarh | Safe Two-Wheeler Shifting Odisha?',
...
We'll keep the outer section with same style. Inside container. Inside card. We'll have a badge "Verified Shree Ashirwad Standard". Then heading: "Bike Transportation in Bargarh – Safe Two‑Wheeler Shifting Odisha". Then paragraph about importance. Then subheading: "Pre‑Transit Checklist". Then a table with items: "Bike Condition", "Documentation", "Insurance", "Packing Materials", "Loading Technique". Provide table with dark theme.

Then subheading: "Choosing the Right Transporter". Provide bullet list with icons: "Local Expertise", "Secure Storage", "Insurance Coverage", "Transparent Pricing".

Then subheading: "Common Red Flags to Avoid". Provide bullet list.

Then subheading: "Post‑Transit Care". Provide bullet list.

Also include a card with 3 authoritative sentences about logistics, packing protocols, transit insurance, handling standards. That card can be a separate card inside the container.
