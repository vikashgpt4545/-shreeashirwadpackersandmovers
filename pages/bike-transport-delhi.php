...
$faq_list = [
    ...
    [
        'q' => 'How are relocation charges calculated for Bike Transport in Delhi | Safe Two-Wheeler Shifting?',
        'a' => 'Our moving estimates between Delhi and Ranchi are calculated using transparent parameters: total consignment volume (cft), distance (~350 km), packaging material grade (7-layer corrugated and bubble sheets), dedicated enclosed container capacity, and insurance declaration. We provide 100% itemized, fixed-price quotations with zero moving-day surcharges.'
    ],
    [
    ...
    [
        ...
        'a' => 'Our certified moving crews are equipped with heavy furniture lifter straps, hydraulic trolleys, and protective floor sheets. We coordinate smoothly with apartment society management in both Delhi and Ranchi to ensure elevator compliance.'
    ],
];
...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    ...
    01
    Protocol 01</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>RC (Registration Certificate) is a crucial document required for bike transport.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Make sure to get a self-attested copy of your RC.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 03</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>This copy ensures that the bike has been registered in your name, and anyone attempting to tamper with it can be identified.</p>
  </div>
</div>
	<h3>2. Current PUC (Pollution Under Control) Certificate
	
		PUC is a test conducted to ensure that the vehicle meets the emission standards.
		Make sure that your bike&amp;#039;s PUC is valid before transport.
		It serves as proof that your bike is roadworthy and doesn&amp;#039;t pose a threat to environmental health.
	
	3. Valid Insurance Certificate
	
		Regardless of the distance, it&amp;#039;s essential to have a valid insurance certificate for your bike.
		Make sure to get a copy of your insurance certificate before transport.
		It covers any potential damages or theft during transit, providing you with peace of mind.
	
	4. IBA-Approved Consignment Bill of Lading
	
		IBA (Indian Bureau of Wheels) is an industry association that ensures safe and secure transportation of vehicles.
		An IBA-approved consignment bill of lading is crucial for bike transport.
		This document outlines the details of the transport, including the sender and receiver information, bike specifications, and insurance coverage.
	
	5. Declaration of Value for Marine Transit Insurance
	
		Marine transit insurance is required for long-distance bike transport.
		A declaration of value ensures that the insurance covers the full worth of your bike.
		It is crucial to ensure that the bike&amp;#039;s value is accurately stated to avoid any discrepancies during claim settlement.
	
	6. Valid Driving License
	
		A valid driving license is necessary for bike transport.
		The transport company may require your driving license to ensure that you are the legal owner of the bike.
		Make sure to keep your driving license safe and easily accessible during the transport process.
	
	7. Original Vehicle Ownership Documents</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for 2. Current PUC (Pollution Under Control) Certificate
	...
	7. Original Vehicle Ownership Documents ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
