...
$faq_list = [
    ['q' => 'How much does local home shifting cost in Valmiki Nagar Bokaro?', 'a' => 'Local household shifting within Valmiki Nagar Bokaro ranges from â‚¹3,500 to â‚¹7,500 for 1BHK, â‚¹6,500 to â‚¹12,500 for 2BHK, and â‚¹10,500 to â‚¹18,500 for 3BHK houses.'],
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        <div class="hero-text">
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20need%20shifting%20quote%20in%20Valmiki%20Nagar%20Bokaro." target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; text-decoration: none;">ðŸ’¬ WhatsApp Quote</a>
          </div>
        </div>
