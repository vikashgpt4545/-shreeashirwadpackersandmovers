...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    <div style="background: rgba(15, 23, 42, 0.65); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 16px; padding: 36px 32px; box-shadow: 0 12px 30px rgba(0,0,0,0.35);">
      ...
      <div style="font-size: 1.02rem; line-height: 1.8; color: #cbd5e1;"><p>The destination delivery handover for two-wheelers and motorcycles in Maryadpur Mau constitutes a critical quality and accountability checkpoint. Upon arrival, the logistics team conducts a daylight condition re-inspection, systematically comparing the vehicle's current state against the reference pickup photographs captured at the point of origin.</p>
<ul style="list-style: none; padding-left: 0; margin: 18px 0;">
  <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;"><i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i><span><strong>Daylight Re-Inspection:</strong> A systematic 360-degree visual audit verifies panels, exhaust, handlebars, and mirrors against original dispatch photos to guarantee zero transit damage.</span></li>
  <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;"><i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i><span><strong>Odometer Verification:</strong> Mileage readings are cross-checked against the official consignment bilty (LR) to confirm the motorcycle was securely transported without unauthorized road usage.</span></li>
  <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;"><i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i><span><strong>Signed Condition Handover:</strong> The recipient signs the condition acknowledgment form, completing the formal chain-of-custody transfer and concluding the transit cycle.</span></li>
</ul></div>
    </div>
  </div>
</section>
