...
$page_keywords = "bike transport from chennai to kolkata, motorcycle shipping chennai to kolkata, two wheeler transport chennai kolkata, bike packers and movers chennai kolkata, bike shifting charges chennai kolkata";
...
<main class="site-main">
  ...
  <div class="breadcrumb-wrapper">
    <div class="container">
      <div class="breadcrumb-list">
        ...
        <span class="breadcrumb-item active">Bike Transport from Chennai to Kolkata</span>
      </div>
    </div>
  </div>
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            CHENNAI TO KOLKATA EAST COAST SPECIALISTS
          </span>
          <h1 style="font-size: 2.7rem; font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #ffffff;">
            Safe &amp; Insured <span style="color: #f59e0b;">Bike Transport from Chennai to Kolkata</span>
          </h1>
          <p style="font-size: 1.12rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Transporting your motorcycle 1,670 km from Chennai to Kolkata? Shree Ashirwad Packers and Movers offers heavy-duty 7-layer bubble packaging, enclosed truck carriers, doorstep pickup from any location in Chennai, and safe delivery across Kolkata including Salt Lake, New Town, Howrah, Park Street, and Dum Dum.
          </p>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20a%20quote%20for%20bike%20transport%20from%20Chennai%20to%20Kolkata." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
          ...
          <div style="display: flex; gap: 20px; font-size: 0.9rem; color: #94a3b8;">
            ...
            <span><strong style="color: #f59e0b;">3-5 Days</strong> Express Delivery</span>
          </div>
        </div>
        ...
        <div class="hero-form-card" style="background: rgba(255, 255, 255, 0.05); backdrop-filter: blur(10px); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
          ...
          <p style="font-size: 0.85rem; color: #94a3b8; text-align: center; margin-bottom: 20px;">Transparent pricing for Chennai to Kolkata motorcycle shipping</p>
    ...
    <div class="container">
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 20px; text-align: center;">
        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 12px; padding: 20px;">
          <h3 style="font-size: 2rem; color: #f59e0b; margin-bottom: 5px; font-weight: 800;">1,670 km</h3>
          <p style="color: #94a3b8; font-size: 0.9rem; margin: 0;">NH16 East Coast Highway Route</p>
        </div>
        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 12px; padding: 20px;">
          <h3 style="font-size: 2rem; color: #f59e0b; margin-bottom: 5px; font-weight: 800;">3 - 5 Days</h3>
          <p style="color: #94a3b8; font-size: 0.9rem; margin: 0;">Interstate Transit Time</p>
        </div>
        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 12px; padding: 20px;">
          <h3 style="font-size: 2rem; color: #f59e0b; margin-bottom: 5px; font-weight: 800;">10,200+</h3>
          <p style="color: #94a3b8; font-size: 0.9rem; margin: 0;">Vehicles Relocated on East Corridor</p>
        </div>
        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 12px; padding: 20px;">
    ...
    <div class="container">
      <div style="max-width: 900px; margin: 0 auto;">
        <h2 style="font-size: 2rem; color: #ffffff; font-weight: 700; margin-bottom: 20px;">
          Reliable <span style="color: #f59e0b;">Chennai to Kolkata Bike Transport</span> Solutions
        </h2>
        <p style="line-height: 1.8; margin-bottom: 20px;">
          Shipping a motorcycle along the 1,670 km East Coast corridor (NH16) from Tamil Nadu through Andhra Pradesh and Odisha into West Bengal requires experienced handlers and robust protective wrapping. Shree Ashirwad Packers and Movers uses covered containers fitted with wheel docks and belt harnesses to insulate your bike against coastal moisture, road debris, and long-distance vibration.
        </p>
        <p style="line-height: 1.8;">
          From everyday scooties and commuter bikes to tourers, Royal Enfields, and high-performance sports bikes, our logistical operations handle complete paperwork, transit insurance, and doorstep pickup and delivery across all areas of Kolkata.
        </p>
      </div>
    </div>
  </section>
  ...
  <section style="padding: 60px 0; background: #1c2541; color: #ffffff;">
    <div class="container">
      <h2 style="font-size: 2rem; text-align: center; font-weight: 700; margin-bottom: 10px;">
        Bike Transport Charges from <span style="color: #f59e0b;">Chennai to Kolkata</span>
      </h2>
        ...
        <table style="width: 100%; border-collapse: collapse; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; overflow: hidden;">
          ...
          <tbody>
            ...
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.05); background: rgba(255,255,255,0.02);">
              ...
              <td style="padding: 16px 20px; color: #f59e0b; font-weight: 700;">₹4,800 - ₹6,800</td>
              <td style="padding: 16px 20px;">3 - 5 Days</td>
            </tr>
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
              <td style="padding: 16px 20px;">Executive &amp; Sports Bikes</td>
              <td style="padding: 16px 20px;">150cc - 250cc</td>
              <td style="padding: 16px 20px; color: #f59e0b; font-weight: 700;">₹5,800 - ₹8,200</td>
              <td style="padding: 16px 20px;">3 - 5 Days</td>
            </tr>
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.05); background: rgba(255,255,255,0.02);">
              <td style="padding: 16px 20px;">Cruisers &amp; Royal Enfield</td>
              <td style="padding: 16px 20px;">350cc - 500cc</td>
              <td style="padding: 16px 20px; color: #f59e0b; font-weight: 700;">₹7,500 - ₹10,500</td>
              <td style="padding: 16px 20px;">3 - 5 Days</td>
            </tr>
            <tr>
              <td style="padding: 16px 20px;">Premium Superbikes</td>
              <td style="padding: 16px 20px;">500cc+ / Imported</td>
              <td style="padding: 16px 20px; color: #f59e0b; font-weight: 700;">₹11,000 - ₹16,000</td>
              <td style="padding: 16px 20px;">3 - 5 Days</td>
            </tr>
          </tbody>
        </table>
    ...
    <div class="container">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 20px;">
        ...
        <div style="background: rgba(0,0,0,0.2); border-radius: 12px; padding: 25px; border: 1px solid rgba(255,255,255,0.05);">
          ...
          <p style="color: #94a3b8; font-size: 0.9rem; line-height: 1.6;">Safe delivery to your residence in Kolkata with joint unpacking inspection and sign-off.</p>
        </div>
      </div>
    </div>
  </section>

  <!-- Section 7: Locality Coverage (Chennai & Kolkata) -->
  <section style="padding: 60px 0; background: #0b132b; color: #ffffff;">
    <div class="container">
      <h2 style="font-size: 2rem; text-align: center; font-weight: 700; margin-bottom: 30px;">
        Locality Coverage: <span style="color: #f59e0b;">Chennai Pickup &amp; Kolkata Delivery</span>
      </h2>
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px;">
        ...
        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 12px; padding: 25px;">
          <h3 style="color: #f59e0b; font-size: 1.3rem; margin-bottom: 15px;">Kolkata Delivery Localities</h3>
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.8;">
            Salt Lake, New Town, Park Street, Howrah, Dum Dum, Ballygunge, Behala, Alipore, Garia, Tollygunge, Kasba, Jadavpur.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div style="max-width: 900px; margin: 0 auto; display: flex; flex-direction: column; gap: 15px;">
        ...
        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; padding: 20px;">
          <h3 style="font-size: 1.1rem; color: #f59e0b; margin-bottom: 10px; font-weight: 700;">How long does bike transport from Chennai to Kolkata take?</h3>
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.6; margin: 0;">Interstate bike transport between Chennai and Kolkata typically takes 3 to 5 days via the NH16 East Coast highway corridor.</p>
        </div>

        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; padding: 20px;">
          <h3 style="font-size: 1.1rem; color: #f59e0b; margin-bottom: 10px; font-weight: 700;">Is transit insurance mandatory for shipping a bike to Kolkata?</h3>
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.6; margin: 0;">We strongly recommend full all-risk transit insurance for long distances like Chennai to Kolkata to protect against damage or accidents during interstate transit.</p>
        </div>
        ...
        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; padding: 20px;">
          <h3 style="font-size: 1.1rem; color: #f59e0b; margin-bottom: 10px; font-weight: 700;">What documents are required for shipping a bike from Chennai to Kolkata?</h3>
        ...
        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; padding: 20px;">
          <h3 style="font-size: 1.1rem; color: #f59e0b; margin-bottom: 10px; font-weight: 700;">What is the cost of bike transport from Chennai to Kolkata?</h3>
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.6; margin: 0;">Standard commuter bikes start from ₹3,800 - ₹5,500, while premium sports bikes and cruisers range between ₹7,500 and ₹12,500 depending on vehicle model and packaging type.</p>
        </div>

        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; padding: 20px;">
          <h3 style="font-size: 1.1rem; color: #f59e0b; margin-bottom: 10px; font-weight: 700;">How can I track my bike during transit from Chennai to Kolkata?</h3>
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.6; margin: 0;">We provide continuous SMS and WhatsApp updates along with dedicated driver contact info for real-time tracking along the NH16 East Coast highway corridor.</p>
        </div>

        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; padding: 20px;">
          <h3 style="font-size: 1.1rem; color: #f59e0b; margin-bottom: 10px; font-weight: 700;">Which delivery areas are covered in Kolkata?</h3>
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.6; margin: 0;">We deliver directly to Salt Lake, New Town, Park Street, Howrah, Dum Dum, Ballygunge, Behala, Alipore, Garia, Tollygunge, Kasba, and Jadavpur.</p>
        </div>
  ...
  <section style="padding: 50px 0; background: linear-gradient(135deg, #1e293b 0%, #0f172a 100%); text-align: center; color: #ffffff; border-top: 1px solid rgba(245, 158, 11, 0.3);">
    <div class="container">
      <h2 style="font-size: 2.2rem; font-weight: 800; margin-bottom: 15px;">Book Your Bike Transport from Chennai to Kolkata</h2>
      ...
      <div style="display: flex; gap: 15px; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20to%20book%20bike%20transport%20from%20Chennai%20to%20Kolkata." target="_blank" style="padding: 14px 32px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #fff; border-radius: 50px; font-weight: 700; text-decoration: none;">
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How long does bike transport from Chennai to Kolkata take?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Interstate bike transport between Chennai and Kolkata typically takes 3 to 5 days via the NH16 East Coast highway corridor."
      }
    },
    {
      "@type": "Question",
      "name": "Is transit insurance mandatory for shipping a bike to Kolkata?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "We strongly recommend full all-risk transit insurance for long distances like Chennai to Kolkata to protect against damage or accidents during interstate transit."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "What documents are required for shipping a bike from Chennai to Kolkata?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "What is the cost of bike transport from Chennai to Kolkata?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Standard commuter bikes start from ₹3,800 - ₹5,500, while premium sports bikes and cruisers range between ₹7,500 and ₹12,500 depending on vehicle model and packaging type."
      }
    },
    {
      "@type": "Question",
      "name": "How can I track my bike during transit from Chennai to Kolkata?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "We provide continuous SMS and WhatsApp updates along with dedicated driver contact info for real-time tracking along the NH16 East Coast highway corridor."
      }
    },
    {
      "@type": "Question",
      "name": "Which delivery areas are covered in Kolkata?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "We deliver directly to Salt Lake, New Town, Park Street, Howrah, Dum Dum, Ballygunge, Behala, Alipore, Garia, Tollygunge, Kasba, and Jadavpur."
      }
    },
    {
      "@type": "Question",
