...
$page_keywords = "bike transportation in srirampore, bike transport service, bike transport services, bike transport, bike transport near me, bike transport by train, bike transport cost, railway bike transport charges, best bike transportation in srirampore, affordable bike transport srirampore, Serampore bike transport, WB-16 bike transport";
...
<main class="site-main">
  ...
  <div class="breadcrumb-wrapper">
    <div class="container">
      <div class="breadcrumb-list">
        ...
        <span class="breadcrumb-item active">Bike Transportation in Srirampore</span>
      </div>
    </div>
  </div>
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            SRIRAMPORE HOOGHLY (WB-16 RTO) BIKE LOGISTICS
          </span>
          ...
          <p style="font-size: 1.05rem; color: #cbd5e1; line-height: 1.7; margin-bottom: 25px;">
            Shree Ashirwad Packers and Movers provides safe, insured, and doorstep motorcycle transport across Srirampore (Serampore, WB-16 RTO, Hooghly District &amp; GT Road Corridor) via express routes. 7-layer Gangetic humid moisture &amp; jute-dust proof packaging, covered container trucks, and IBA-approved GST bills for Corporate, Academic, Govt &amp; Defense transfers.
          </p>
        ...
        <div class="hero-form-card" style="background: rgba(255, 255, 255, 0.05); backdrop-filter: blur(10px); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
          <h2 style="font-size: 1.4rem; color: #ffffff; margin-bottom: 8px; font-weight: 700; text-align: center;">Get Srirampore Bike Quote</h2>
          ...
          <form action="#" method="POST" onsubmit="sendHeroWhatsAppLead(event, this);">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 14px;">
              <input type="text" name="move_from" class="form-control" value="Srirampore (WB)" required style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.3); color: #fff;">
    ...
    <div class="container">
      <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px; text-align: center;">
        <div style="padding: 20px; background: rgba(23, 42, 84, 0.5); border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          ...
          <div style="font-size: 0.9rem; color: #cbd5e1; margin-top: 5px;">Starting Metro Shifting</div>
        </div>
        <div style="padding: 20px; background: rgba(23, 42, 84, 0.5); border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <div style="font-size: 2.2rem; font-weight: 800; color: #f59e0b; font-family: 'Poppins', sans-serif;">GT Road / NH-19</div>
          <div style="font-size: 0.9rem; color: #cbd5e1; margin-top: 5px;">Dankuni Express Corridor</div>
        </div>
        <div style="padding: 20px; background: rgba(23, 42, 84, 0.5); border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <div style="font-size: 2.2rem; font-weight: 800; color: #f59e0b; font-family: 'Poppins', sans-serif;">7-Layer</div>
          <div style="font-size: 0.9rem; color: #cbd5e1; margin-top: 5px;">Gangetic Moisture Shield</div>
        </div>
        <div style="padding: 20px; background: rgba(23, 42, 84, 0.5); border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
    ...
    <div class="container">
      ...
      <div style="max-width: 950px; margin: 0 auto;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">
          Why Choose Us for <span style="color: #f59e0b;">Srirampore Bike Transportation</span>
        </h2>
        ...
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; margin: 30px 0;">
          ...
          <div style="background: linear-gradient(145deg, #172a54 0%, #0d1736 100%); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 22px;">
            ...
            <p style="font-size: 0.9rem; color: #cbd5e1; margin: 0;">
              Humid moisture barrier stretch film, 80-GSM bubble wrap, corrugated armor &amp; handlebar pads.
            </p>
          </div>
          ...
          <div style="background: linear-gradient(145deg, #172a54 0%, #0d1736 100%); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 22px;">
            ...
            <h3 style="font-size: 1.1rem; color: #ffffff; font-weight: 700; margin-bottom: 10px;">Doorstep Pickup Across WB-16</h3>
            <p style="font-size: 0.9rem; color: #cbd5e1; margin: 0;">
              Free pickup across Srirampore Station, GT Road, Mahesh, Rishra &amp; Battala Chowk.
            </p>
          </div>
          ...
          <div style="background: linear-gradient(145deg, #172a54 0%, #0d1736 100%); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 22px;">
            ...
            <h3 style="font-size: 1.1rem; color: #ffffff; font-weight: 700; margin-bottom: 10px;">Corporate &amp; Govt Bills</h3>
            <p style="font-size: 0.9rem; color: #cbd5e1; margin: 0;">
              Official GST invoices suitable for Corporate, Academic &amp; Govt employee claims.
            </p>
          </div>
  ...
  <section style="padding: 60px 0; background: #070d1e; color: #ffffff;">
    <div class="container" style="max-width: 950px;">
      ...
      <h2 style="font-size: 2.1rem; font-weight: 800; color: #ffffff; margin: 10px 0 25px 0;">
        Estimated Bike Transport Rates for Srirampore
      </h2>
        ...
        <table style="width: 100%; border-collapse: collapse; background: #101c40; border-radius: 12px; overflow: hidden; font-size: 0.95rem;">
          <thead>
            <tr style="background: #172a54; color: #f59e0b; text-align: left;">
              ...
              <th style="padding: 16px; border-bottom: 2px solid rgba(245,158,11,0.3);">Kolkata Metro Area (Howrah / Salt Lake)</th>
              <th style="padding: 16px; border-bottom: 2px solid rgba(245,158,11,0.3);">Interstate (Delhi NCR / Patna / Ranchi)</th>
              <th style="padding: 16px; border-bottom: 2px solid rgba(245,158,11,0.3);">Long Distance (Bengaluru / Mumbai / Pune)</th>
            </tr>
          </thead>
          <tbody>
            ...
            <tr>
              ...
              <td style="padding: 14px 16px; color: #6ee7b7; font-weight: 700;">₹7,000 - ₹9,800</td>
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #ffffff;">
    <div class="container" style="max-width: 950px;">
      ...
      <h2 style="font-size: 2.1rem; font-weight: 800; color: #ffffff; margin: 10px 0 25px 0;">
        Our 7-Layer Srirampore All-Weather Bike Packaging Protocol
      </h2>
      ...
      <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 15px;">
        ...
        <div style="background: #172a54; padding: 18px; border-radius: 10px; border-left: 4px solid #f59e0b;">
          ...
          <h4 style="font-size: 0.8rem; color: #f59e0b; font-weight: 700;">Gangetic Moisture Barrier</h4>
          <p style="font-size: 0.82rem; color: #cbd5e1; margin: 0;">Tightly wrapping humid river moisture &amp; dust barrier stretch film around bike body.</p>
        </div>
  ...
  <!-- 7. Srirampore Localities Covered -->
  <section style="padding: 60px 0; background: #070d1e; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      ...
      <h2 style="font-size: 2.1rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">
        Serving All Major <span style="color: #f59e0b;">Srirampore &amp; Hooghly Localities</span>
      </h2>
      ...
      <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px; margin-bottom: 25px;">
        <div style="background: #101c40; padding: 16px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #f59e0b; font-size: 1rem; margin-bottom: 4px;">Srirampore Core</h4>
          <p style="font-size: 0.85rem; color: #94a3b8; margin: 0;">Srirampore Railway Station, GT Road, Battala Chowk, Serampore College Area.</p>
        </div>

        <div style="background: #101c40; padding: 16px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #f59e0b; font-size: 1rem; margin-bottom: 4px;">Neighborhoods</h4>
          <p style="font-size: 0.85rem; color: #94a3b8; margin: 0;">Mahesh, Rishra Border, Chatra, Ballabhpur, Rajbari, Sheoraphuli.</p>
        </div>

        <div style="background: #101c40; padding: 16px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #f59e0b; font-size: 1rem; margin-bottom: 4px;">Hooghly Industrial Belt</h4>
          <p style="font-size: 0.85rem; color: #94a3b8; margin: 0;">Dankuni Logistics Hub, Uttarpara, Konnagar, Baidyabati, Chinsurah.</p>
        </div>

        <div style="background: #101c40; padding: 16px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #f59e0b; font-size: 1rem; margin-bottom: 4px;">Highway Corridors</h4>
          <p style="font-size: 0.85rem; color: #94a3b8; margin: 0;">GT Road, SH-6, NH-19 Delhi Road, Durgapur Expressway Connection.</p>
        </div>

        <div style="background: #101c40; padding: 16px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #f59e0b; font-size: 1rem; margin-bottom: 4px;">West Bengal Metros</h4>
          <p style="font-size: 0.85rem; color: #94a3b8; margin: 0;">Kolkata, Howrah, Durgapur, Asansol, Siliguri, Kharagpur.</p>
        </div>

        <div style="background: #101c40; padding: 16px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #f59e0b; font-size: 1rem; margin-bottom: 4px;">Interstate Metros</h4>
          <p style="font-size: 0.85rem; color: #94a3b8; margin: 0;">Delhi NCR, Bengaluru, Mumbai, Hyderabad, Chennai, Patna.</p>
        </div>
      </div>
  ...
  <!-- 8. Popular Intercity Routes from Srirampore -->
  <section style="padding: 60px 0; background: #0b132b; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      ...
      <h2 style="font-size: 2.1rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">
        Popular Intercity Bike Shipping Corridors from Srirampore
      </h2>
      ...
      <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px; margin-bottom: 25px;">
        <div style="background: #172a54; padding: 18px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #ffffff; font-size: 1.05rem; margin-bottom: 6px;">Srirampore to Kolkata / Howrah / Dankuni / Salt Lake</h4>
          <p style="font-size: 0.88rem; color: #94a3b8; margin: 0;">Daily express container shuttles via GT Road &amp; Dankuni taking 2 to 4 hours.</p>
        </div>

        <div style="background: #172a54; padding: 18px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #ffffff; font-size: 1.05rem; margin-bottom: 6px;">Srirampore to Durgapur / Asansol / Dhanbad / Ranchi</h4>
          <p style="font-size: 0.88rem; color: #94a3b8; margin: 0;">Direct NH-19 express container truck shipping taking 1 to 2 days.</p>
        </div>

        <div style="background: #172a54; padding: 18px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #ffffff; font-size: 1.05rem; margin-bottom: 6px;">Srirampore to Delhi NCR / Patna / Lucknow / Kanpur</h4>
          <p style="font-size: 0.88rem; color: #94a3b8; margin: 0;">Interstate covered container shipping taking 2 to 4 days.</p>
        </div>

        <div style="background: #172a54; padding: 18px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #ffffff; font-size: 1.05rem; margin-bottom: 6px;">Srirampore to Bengaluru / Mumbai / Pune / Hyderabad</h4>
  ...
  <section style="padding: 60px 0; background: #070d1e; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      ...
      <h2 style="font-size: 2.1rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">
        IBA Approved GST Billing &amp; Corporate / Government Claims
      </h2>
      ...
      <div style="background: #101c40; border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 12px; padding: 25px;">
        ...
        <ol style="margin: 0; padding-left: 20px; color: #cbd5e1; line-height: 1.8; font-size: 0.95rem;">
          ...
          <li><strong>Official Money Receipt</strong> for 100% corporate/academic/government claim reimbursement.</li>
        </ol>
      </div>
    ...
    <div class="container" style="max-width: 900px;">
      ...
      <div class="section-header text-center" style="margin-bottom: 40px;">
        ...
        <h2 style="font-size: 2.1rem; font-weight: 800; color: #ffffff; margin-top: 10px;">
          Frequently Asked Questions — <span style="color: #f59e0b;">Srirampore Bike Transport</span>
        </h2>
      </div>
  ...
  <section style="padding: 60px 0; background: linear-gradient(135deg, #172a54 0%, #0b132b 100%); border-top: 1.5px solid rgba(245, 158, 11, 0.4); color: #ffffff;">
    <div class="container" style="max-width: 900px; text-align: center;">
      ...
      <span class="section-tag" style="background: rgba(245, 158, 11, 0.2); color: #f59e0b; padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase;">
        Book Bike Transportation in Srirampore
      </span>
      ...
      <p style="font-size: 1.05rem; color: #cbd5e1; max-width: 750px; margin: 0 auto 30px auto; line-height: 1.7;">
        Get your instant price estimate today! Free doorstep pickup across Srirampore Station, GT Road, Mahesh, Rishra &amp; Battala Chowk, 7-layer Gangetic moisture proof packaging, and 100% insured container truck delivery.
      </p>
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers & Movers,\n\nI am requesting a Bike Transport Quote for Srirampore, WB:\n- Name: " + name + "\n- Phone: " + phone + "\n- From: " + moveFrom + "\n- Destination City: " + moveTo;
