...
<section class="content-ui-section" style="padding: 55px 0; background: #070d1e; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  ...
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>A self-attested photocopy of the bike&#039;s registration certificate (RC) is mandatory.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>The self-attestation ensures the document&#039;s authenticity and safeguards both the customer and the transportation company.</p>
  </div>
</div>
	...
	<h3>Additional Documentation Recommended
	
		A copy of your Identity Proof (like Aadhaar Card, Passport, Driving License)
		A copy of your Address Proof (like Electricity Bill, Ration Card, or Passport)
		A copy of the consignee&amp;#039;s (recipient&amp;#039;s) identity and address proof
	
	It is advisable to gather these additional documents to provide comprehensive proof of identity and address for all parties involved.
	When preparing for bike transportation in Srirampore, ensure that you have all the mentioned documents ready. Ensuring these essential documents accompany your bike will guarantee a smooth and legal transportation process.
	Preparing for the Transport Process</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Additional Documentation Recommended
	...
	It is advisable to gather these additional documents to provide comprehensive proof of identity and address for all parties involved.
	When preparing for bike transportation in Srirampore, ensure that you have all the mentioned documents ready. Ensuring these essential documents accompany your bike will guarantee a smooth and legal transportation process.
	Preparing for the Transport Process ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
