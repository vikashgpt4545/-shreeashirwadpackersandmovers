    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For relocation from Borabanda, Hyderabad to any destination hub, we utilize the National Highway Arterial Corridors &amp; Multi-Axle Express Freight Highways, which cover a distance of approximately 850 kilometers. This route passes through the interstate border checkposts of Telangana and Andhra Pradesh, ensuring seamless clearance of electronic ways bills. To expedite the process, our team leverages automated systems for e-way bill submission, thereby reducing the risk of delays. Moreover, our speed-governed container transit ensures efficient transportation of household items, vehicles, or any other cargo.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">To ensure damage-free transit protection, our experienced packing team expertly wraps household items in protective materials and loads them onto our specially designed containers. We take utmost care to secure the cargo from any form of physical stress or vibration during transit. To safeguard vehicles, our technicians meticulously perform pre-transport checks, lubricate critical components, and load the vehicle onto our containers. Our logistics team continuously monitors the transit, providing real-time updates to ensure timely delivery of goods. By combining cutting-edge technology with meticulous attention to detail, we guarantee a secure, efficient, and hassle-free relocation experience for our clients in Borabanda, Hyderabad.</p>
        </div>
      </div>
    </div>
  </section>
