...
$page_keywords = "bike transportation in khunti, bike transport khunti jharkhand, motorcycle parcel ranchi jamshedpur, bike shipping kolkata delhi";
...
<main class="site-main">
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            BIKE TRANSPORTATION KHUNTI (JH-23 JHARKHAND)
          </span>
          <h1 style="font-size: 2.7rem; font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #ffffff;">
            Professional <span style="color: #f59e0b;">Bike Transportation in Khunti</span>
          </h1>
          <p style="font-size: 1.12rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Shree Ashirwad Packers and Movers provides safe, insured, and doorstep motorcycle transport across Khunti, NH-20 corridor, Jharkhand, and national routes. Complete with 7-layer bubble wrapping and IBA-approved GST bills.
          </p>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20a%20bike%20transport%20quote%20for%20Khunti." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
        ...
        <div class="hero-form-card" style="background: rgba(255, 255, 255, 0.05); backdrop-filter: blur(10px); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
          <h2 style="font-size: 1.4rem; color: #ffffff; margin-bottom: 8px; font-weight: 700; text-align: center;">Get Khunti Bike Quote</h2>
          ...
          <form action="#" method="POST" onsubmit="sendHeroWhatsAppLead(event, this);">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 14px;">
              <input type="text" name="move_from" class="form-control" value="Khunti, JH" required style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.3); color: #fff;">
  ...
  <section style="background: #070d1e; padding: 30px 0; border-bottom: 1px solid rgba(255,255,255,0.08);">
    <div class="container">
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; text-align: center;">
        ...
        <div style="background: #101c40; padding: 20px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
          <div style="font-size: 2rem; font-weight: 800; color: #f59e0b;">JH-23 RTO</div>
          <div style="font-size: 0.88rem; color: #cbd5e1; margin-top: 5px;">Khunti JH Network</div>
        </div>
        <div style="background: #101c40; padding: 20px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #ffffff;">
    <div class="container">
      <div style="text-align: center; max-width: 700px; margin: 0 auto 40px auto;">
        <span style="color: #f59e0b; font-weight: 700; text-transform: uppercase; font-size: 0.85rem;">WHY CHOOSE US IN KHUNTI</span>
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 25px;">
        ...
        <div style="background: #101c40; padding: 25px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.08);">
          ...
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.6;">Door-to-door pickup across Khunti Town, Torpa Road, Murhu, and Karra.</p>
        </div>
        <div style="background: #101c40; padding: 25px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.08);">
  ...
  <section style="padding: 60px 0; background: #070d1e; color: #ffffff;">
    <div class="container">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px;">
        ...
        <div style="background: #101c40; padding: 20px; border-radius: 10px; border-left: 4px solid #f59e0b;">
          <h4 style="font-size: 1.1rem; color: #ffffff; margin-bottom: 8px;">NH-20 Highway Corridor</h4>
          <p style="color: #cbd5e1; font-size: 0.9rem;">Fast-track vehicle shipping connecting Khunti directly to Ranchi, Jamshedpur, Kolkata, & Delhi.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section style="padding: 60px 0; background: #070d1e; color: #ffffff;">
    <div class="container">
      <div style="text-align: center; margin-bottom: 30px;">
        <h2 style="font-size: 2rem; font-weight: 800;">Khunti Doorstep Pickup Localities</h2>
        <p style="color: #cbd5e1; font-size: 0.95rem;">Free doorstep pickup across Khunti town & district</p>
      </div>
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 15px; text-align: center;">
        <div style="background: #101c40; padding: 15px; border-radius: 8px; color: #cbd5e1;">Khunti Town Centre</div>
        <div style="background: #101c40; padding: 15px; border-radius: 8px; color: #cbd5e1;">Torpa Road</div>
        <div style="background: #101c40; padding: 15px; border-radius: 8px; color: #cbd5e1;">Murhu Sector</div>
        <div style="background: #101c40; padding: 15px; border-radius: 8px; color: #cbd5e1;">Karra Locality</div>
        ...
        <div style="background: #101c40; padding: 15px; border-radius: 8px; color: #cbd5e1;">Ranchi Highway Link</div>
      </div>
    </div>
  </section>
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #ffffff;">
    <div class="container">
      <div style="text-align: center; margin-bottom: 30px;">
        <h2 style="font-size: 2rem; font-weight: 800;">Popular Intercity Routes from Khunti</h2>
      </div>
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 15px; text-align: center;">
        <a href="<?php echo SITE_URL; ?>/pages/bike-transport-from-ranchi-to-bangalore.php" style="background: #101c40; padding: 15px; border-radius: 8px; color: #f59e0b; text-decoration: none; font-weight: 600;">Khunti → Bangalore</a>
        <a href="<?php echo SITE_URL; ?>/pages/bike-transport-from-kolkata-to-bangalore.php" style="background: #101c40; padding: 15px; border-radius: 8px; color: #f59e0b; text-decoration: none; font-weight: 600;">Khunti → Kolkata</a>
        <a href="<?php echo SITE_URL; ?>/pages/bike-transport-from-delhi-to-bangalore.php" style="background: #101c40; padding: 15px; border-radius: 8px; color: #f59e0b; text-decoration: none; font-weight: 600;">Khunti → Delhi</a>
        <a href="<?php echo SITE_URL; ?>/pages/bike-transport-from-mumbai-to-bangalore.php" style="background: #101c40; padding: 15px; border-radius: 8px; color: #f59e0b; text-decoration: none; font-weight: 600;">Khunti → Mumbai</a>
      </div>
    </div>
  </section>
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      <div style="text-align: center; margin-bottom: 40px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; margin-top: 10px;">Got Questions About Khunti Bike Transport?</h2>
      </div>
  ...
  <section style="padding: 60px 0; background: linear-gradient(135deg, #1c2541 0%, #0b132b 100%); color: #ffffff; text-align: center; border-top: 1px solid rgba(245,158,11,0.3);">
    <div class="container" style="max-width: 800px;">
      <h2 style="font-size: 2.3rem; font-weight: 800; margin-bottom: 15px;">Book Your Khunti Bike Transport Today</h2>
      <p style="font-size: 1.1rem; color: #cbd5e1; margin-bottom: 30px;">Safe 7-layer packaging, doorstep pickup, transparent pricing, and IBA approved bills across Jharkhand.</p>
      <div style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20to%20book%20bike%20transport%20in%20Khunti." title="Instant WhatsApp Booking" target="_blank" style="padding: 15px 35px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1.05rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
