...
$faq_list = [
    ...
    [
        'q' => 'How are relocation charges calculated for Car Transportation in Tharangambadi 8409531615?',
    ...
    [
        'q' => 'How many days in advance should I confirm my booking for Car Transportation in Tharangambadi 8409531615?',
...
<section class="operational-photo-showcase-section" style="padding: 55px 0; background: #0b132b; border-bottom: 1px solid rgba(255,255,255,0.08);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    ...
    <div style="text-align: center; margin-bottom: 35px;">
      ...
      <h2 style="color: #ffffff; font-size: 1.75rem; font-weight: 800; margin-top: 12px; margin-bottom: 8px;">Verified On-Site Operations: Car Transportation in Tharangambadi 8409531615</h2>
...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
	...
	<h3>Preparation for Handover:

	
  
    01
    Protocol 01</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Ensure the vehicle is parked in a well-lit area during daylight hours.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Collect the pickup photos taken before the vehicle left the sender&#039;s location.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 03</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Obtain the LR bill of lading (BOL) document containing the vehicle details and odometer reading.</p>
  </div>
</div>
	...
	<h3>Daylight Condition Re-inspection:
		...
		Upon arrival at the recipient&amp;#039;s location, verify the following details against the pickup photos:
		
			Exterior appearance: Check for any scratches, dents, or damage that may have occurred during transportation.
			Interior condition: Inspect the interior for signs of wear and tear, stains, or any additional damages.
			Engine and undercarriage: Examine the engine, undercarriage, and underbody for any potential damages or issues.
		

	If any discrepancies are found, document them in a detailed report for communication with the sender.

	Odometer Verification:

	
		Compare the vehicle&amp;#039;s current odometer reading to the one mentioned in the LR BOL document.
		
			Make sure the mileage displayed on the odometer matches the value mentioned on the LR BOL.
			If there is any discrepancy, note it down and provide evidence such as photos to support your claim.
		

	Sign-off Examination:

	
		Conduct a thorough examination of the vehicle, ensuring all components are present and functioning properly.
		
			Check the engine, tires, brakes, suspension, and all other essential systems.
			Verify that all doors, windows, and locks are working correctly.
			Inspect the exterior and interior for any remaining damages or missing parts.
			Check the vehicle registration, license plates, and any other documentation for accuracy.
		

	Upon completing the above checks, prepare a detailed condition report outlining any discrepancies or damages found.

	Sign-off Procedure:</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Daylight Condition Re-inspection:
	...
	Sign-off Procedure: ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
...
<section class="faq-section" style="padding: 50px 0; background: #0b132b; border-bottom: 1px solid rgba(255,255,255,0.08);">
  <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px;">
    <h2 style="color: #ffffff; font-size: 1.7rem; font-weight: 800; margin-bottom: 25px; text-align: center;">Frequently Asked Questions &amp;bull; Car Transportation in Tharangambadi 8409531615</h2>
