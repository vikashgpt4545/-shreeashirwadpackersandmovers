...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    ...
    01
    Protocol 01</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>A self-attested copy of your Registration Certificate (RC) is required to prove that the car belongs to you.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Make sure to get the copy attested by a notary or a relevant authority to ensure its authenticity.</p>
  </div>
</div>
	<h3>2. Current PUC
	
		A valid Pollution Under Control (PUC) certificate proves that the car is emission-free and meets environmental standards.
		Make sure your PUC certificate is valid and not expired.
	
	3. Valid Insurance Certificate
	
		A valid insurance certificate is essential to cover any potential damages or accidents during transportation.
		Make sure the insurance policy covers the car&amp;#039;s entire value.
	
	4. IBA-Approved Consignment Bill of Lading
	
		An IBA-approved consignment bill of lading ensures proper documentation and helps in tracking the car during transportation.
		Make sure the bill of lading clearly states the details of the car, destination, and the shipping company.
	
	5. Declaration of Car&amp;#039;s Value
	
		Submit a declaration stating the exact value of your car to ensure proper insurance coverage.
		Make sure to declare the car&amp;#039;s value accurately to avoid any disputes during the transportation process.
	
	6. Proof of Ownership (Registration Certificate, Insurance Policy, etc.)
	
		Provide proof of ownership, such as your Registration Certificate (RC) and insurance policy, to ensure a smooth transportation process.
		Make sure these documents are up-to-date and valid before submitting them.
	
	7. Vehicle Inspection Report
	
		Obtain a vehicle inspection report from a certified mechanic or authorized service center.
		This report provides proof of the car&amp;#039;s condition and helps in assessing any potential damages during transportation.
	
	8. Car&amp;#039;s Original Documents
	
		Keep your original car documents, including the RC, insurance policy, and the inspection report, with you for reference.
		These documents will be required for verification purposes during the transportation process.
	
	9. Declaration of Vehicle Condition</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for 2. Current PUC
	...
	9. Declaration of Vehicle Condition ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
    ...
    <div style="background: #0f172a; border-radius: 12px; overflow: hidden; border: 1px solid rgba(245, 158, 11, 0.3); box-shadow: 0 10px 30px rgba(0,0,0,0.3);">
      <div style="padding: 16px 24px; background: rgba(245, 158, 11, 0.08); border-bottom: 1px solid rgba(245, 158, 11, 0.2); display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 10px;">
        <div style="color: #f59e0b; font-weight: 700; font-size: 1.05rem; display: flex; align-items: center; gap: 10px;">
          <span>📍</span> Verified Relocation Corridor &amp; GPS Hub: Baramulla to Rishikesh Highway
        </div>
      ...
      <div style="width: 100%; height: 380px; position: relative;">
        <iframe width="100%" height="380" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?q=Baramulla+to+Rishikesh+Highway&t=&z=12&ie=UTF8&iwloc=&output=embed" loading="lazy" style="border:0; width:100%; height:100%; display:block;"></iframe>
      </div>
    </div>
  </div>
</section>
