...
$page_desc = "Professional car transport from Bangalore to Patna by Shree Ashirwad Packers and Movers. Express 5-7 day delivery via NH44/NH30 corridor, 100% all-risk transit insurance & doorstep pickup across Koramangala, Whitefield, Indiranagar to Boring Road, Kankerbagh, Patna.";
...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
   ...
   Need to carefully track word count. Target: 300-340.

3.  **Draft Generation (Mental Refinement & Word Count Control):**
