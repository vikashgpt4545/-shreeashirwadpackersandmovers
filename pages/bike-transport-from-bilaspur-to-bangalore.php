...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    <div style="background: rgba(15, 23, 42, 0.65); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 16px; padding: 36px 32px; box-shadow: 0 12px 30px rgba(0,0,0,0.35);">
      ...
      <div style="font-size: 1.02rem; line-height: 1.8; color: #cbd5e1;"><p style="margin-bottom: 15px;">Two-wheeler transport from Bilaspur to Bangalore spans approximately 1,450 km across the central and southern freight corridors via NH 44. To ensure zero-vibration movement, motorcycles are secured in specialized closed container carriers equipped with front-wheel chock cradles, heavy-duty ratchet straps, and comprehensive high-density bubble wrap.</p>
        <p style="margin-bottom: 15px;">Transit vehicles are speed-governed and monitored via real-time satellite GPS tracking with milestone updates sent directly to clients. Full documentation—including self-attested RC photocopy, current PUC, valid insurance certificate, and IBA-approved consignment bilty—is verified before dispatch, backed by 100% declared-value marine transit insurance.</p></div>
    </div>
  </div>
</section>
