...
$faq_list = [
    [
        'q' => 'How are relocation charges calculated for Bike Transportation Services India | Doorstep Two-Wheeler Shifting?',
    ...
    [
        'q' => 'How many days in advance should I confirm my booking for Bike Transportation Services India | Doorstep Two-Wheeler Shifting?',
...
<section class="content-ui-section" style="padding: 55px 0; background: #070d1e; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  ...
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Due to the enclosed environment, bikes are less likely to get damaged during transit. This is particularly important when dealing with sensitive components that can be easily scratched or dented.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Visibility:</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Since the bikes are inaccessible from the outside, transportation companies can prevent unauthorized access and tampering with your bike. This provides added security and peace of mind.</p>
  </div>
</div>
	...
	<h3>Enclosed Containerized Carriers
		...
		Bike Parcel Services: Bike parcel services, also known as secure bike transport, often utilize enclosed carriers to ensure safe delivery of bikes. Services like Bike Parcel in Thanjavur provide secure transportation options using enclosed carriers, offering complete protection for your bike.
		Bike Transport Companies: Enclosed carriers are commonly employed by professional bike transport companies like Bike Transport. These carriers securely transport bikes to various destinations, ensuring minimal risk of external factors affecting your bike.
	
	Open Trailers</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Enclosed Containerized Carriers
