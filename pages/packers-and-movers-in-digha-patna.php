...
$page_title = "Packers and Movers in Digha Patna | Safe Local House Shifting";
$page_desc = "Top-rated packers and movers in Digha, Patna. Verified local household shifting, office relocation, bike & car transportation with 100% IBA-approved GST billing.";
$page_keywords = "packers and movers in digha patna, best packers and movers digha, movers and packers digha patna, local shifting digha, house shifting services digha";
$canonical_url = "https://shreeashirwadpackersandmovers.com/pages/packers-and-movers-in-digha-patna.php";

$page_city = "Digha, Patna, Bihar";

$faq_list = [
    [
        'q' => 'How are local house shifting services charged in Digha, Patna?',
        'a' => 'Local shifting within Digha and nearby areas like Digha Ghat, JP Ganga Path, or Ashiana-Digha Road ranges from ₹2,500–₹5,500 for 1BHK/2BHK apartments, and ₹6,500–₹12,500 for 3BHK/independent houses including packing, loading, transport, and unloading.'
    ],
    [
        'q' => 'Which sub-localities around Digha do you cover for doorstep pickup?',
        'a' => 'We cover all residential sectors across Digha Ghat, JP Ganga Path Expressway corridor, Digha-Ashiana Road, Rajiv Nagar extension, and Makhdumpur.'
    ],
    [
        'q' => 'What packing materials are used for household items during local Digha shifting?',
    ...
    [
        ...
        'a' => 'JP Ganga Path (Marine Drive Patna) offers high-speed, traffic-free connectivity for our moving trucks to dispatch goods rapidly to eastern Patna and bypass points.'
    ],
    [
        'q' => 'Can you handle same-day urgent house shifting within Digha?',
    ...
    [
        'q' => 'Is vehicle transportation (bike/car) available alongside household shifting from Digha?',
        'a' => 'Yes, we provide integrated vehicle shipping using specialized enclosed car carriers and two-wheeler hydraulic ramps for moves from Digha to anywhere in India.'
    ],
    [
    ...
    [
        'q' => 'How can I book Packers and Movers in Digha Patna?',
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          ...
          <h1 style="font-size: 2.7rem; font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #ffffff;">
            Reliable <span style="color: #f59e0b;">Packers and Movers in Digha Patna</span>
          </h1>
          <p style="font-size: 1.12rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Shree Ashirwad Packers and Movers provides top-rated household shifting, office relocation, and vehicle transport across Digha, Patna. Serving Digha Ghat, JP Ganga Path, Digha-Ashiana Road, Rajiv Nagar, and Makhdumpur with 100% IBA-compliant GST billing.
          </p>
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #e2e8f0; line-height: 1.8;">
    <div class="container" style="max-width: 1000px;">
      ...
      <span class="section-tag" style="color: #f59e0b; text-transform: uppercase; font-weight: 700; font-size: 0.85rem; letter-spacing: 1px;">
        DIGHA NEIGHBORHOOD LOGISTICS
      </span>
      <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">
        Doorstep House & Office Relocation in <span style="color: #f59e0b;">Digha, Patna</span>
      </h2>
      
      <p style="font-size: 1.05rem; color: #cbd5e1; margin-bottom: 25px;">
        Digha is a strategic northern Patna riverside locality connected directly via JP Ganga Path Expressway. Shree Ashirwad Packers and Movers deploys trained packing crews and specialized transport fleets across Digha Ghat, JP Ganga Path, Digha-Ashiana Road, Rajiv Nagar, and Makhdumpur.
      </p>

      <!-- Rate Matrix Table -->
      <div style="overflow-x: auto; margin: 40px 0;">
        <h3 style="font-size: 1.5rem; color: #ffffff; font-weight: 700; margin-bottom: 15px;">
          Estimated Relocation Rates for Digha, Patna
        </h3>
        <table style="width: 100%; border-collapse: collapse; background: #172a54; border-radius: 10px; overflow: hidden; border: 1px solid rgba(245, 158, 11, 0.3);">
          <thead>
            <tr style="background: #1e3a8a; color: #f59e0b; text-align: left;">
              ...
              <th style="padding: 14px 16px;">Local Within Patna (Digha)</th>
  ...
  <section class="faq-section" style="padding: 60px 0; background: #070d1e; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      <div style="text-align: center; margin-bottom: 40px;">
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff;">Frequently Asked Questions (Digha Patna)</h2>
      </div>
...
<script type="application/ld+json">
{
  ...
  "description": "Top-rated packers and movers in Digha, Patna with doorstep pickup and transit insurance.",
  "url": "<?php echo $canonical_url; ?>",
  "telephone": "<?php echo SITE_PHONE_RAW; ?>",
  "address": {
    "@type": "PostalAddress",
    "addressLocality": "Digha, Patna",
    "addressRegion": "Bihar",
    "addressCountry": "IN"
  },
  "areaServed": "Digha, Patna, Bihar",
