...
$page_title = "Packers and Movers in Ghosi Mau | Safe Home Shifting UP-54";
$page_desc = "Top-rated packers and movers in Ghosi, Mau district. Verified local house shifting, household packing, bike/car carrier, 100% IBA-approved GST bills. Call 8409531615.";
$page_keywords = "packers and movers in ghosi mau, home shifting ghosi, house relocation ghosi mau, IBA approved packers ghosi, luggage transport ghosi, bike transport ghosi mau";
$canonical_url = "https://shreeashirwadpackersandmovers.com/packers-and-movers-in-mau";

$page_city = "Ghosi, Mau, Uttar Pradesh";

$faq_list = [
    ['q' => 'How are local home shifting services executed in Ghosi Mau?', 'a' => 'Our professional team conducts pre-move survey, packs goods using 5-layer corrugated sheets and bubble wrap, loads into closed container trucks, and unloads at your new destination.'],
    ['q' => 'What are the packing and moving charges in Ghosi Mau?', 'a' => 'Local 1BHK home shifting in Ghosi ranges from ₹3,500 to ₹6,500, 2BHK shifting ranges from ₹6,000 to ₹10,500, while long-distance interstate relocation depends on volume and mileage.'],
    ['q' => 'Which major highway routes connect Ghosi Mau for transport?', 'a' => 'Ghosi is located along NH-29 (Varanasi-Gorakhpur Highway) connecting directly to Mau Nath Bhanjan, Azamgarh, Dohrighat, and Purvanchal Expressway.'],
    ['q' => 'Do you collect goods directly from residences in Ghosi?', 'a' => 'Yes, free doorstep pickup and packing service is provided across Ghosi market, Madhuban road, Dohrighat road, and nearby rural/semi-urban areas.'],
    ['q' => 'Is transit insurance included during relocation from Ghosi?', 'a' => 'Yes, full-value 100% transit insurance policies are issued covering declared household goods against transit damage or accidents.'],
    ['q' => 'What items are prohibited during household shifting from Ghosi?', 'a' => 'Hazardous items such as LPG cylinders, petrol/kerosene, crackers, paint thinners, and perishable foodstuffs cannot be loaded.'],
    ['q' => 'What documentation is required for official relocation reimbursement?', 'a' => 'We supply 100% genuine IBA-compliant GST consignment invoices, survey lists, Lorry Receipts (LR), and money receipts.'],
    ['q' => 'How long does intercity household delivery take from Ghosi?', 'a' => 'Deliveries to nearby UP/Bihar cities take 24–48 hours, while interstate transport to Delhi NCR, Mumbai, or Bengaluru takes 3–5 days.'],
    ['q' => 'Can you transport my motorcycle or car alongside household items?', 'a' => 'Yes, we provide dedicated bike bubble packing and car carrier transport services alongside your home shifting load.'],
    ['q' => 'How can I book packers and movers service in Ghosi Mau?', 'a' => 'Call +91 8409531615 or submit your shifting requirement on WhatsApp for instant quote generation and slot booking.']
];
...
<main class="site-main">
  ...
  <div class="breadcrumb-wrapper">
    <div class="container">
      <div class="breadcrumb-list">
        ...
        <span class="breadcrumb-item"><a href="<?php echo SITE_URL; ?>packers-and-movers-in-mau" title="Mau">Mau</a></span>
        <span class="breadcrumb-separator">/</span>
        <span class="breadcrumb-item active">Packers and Movers in Ghosi Mau</span>
      </div>
    </div>
  </div>
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            IBA Approved Relocation Services
          </span>
          <h1 style="font-size: 2.6rem; font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #ffffff;">
            Safe &amp; Reliable <span style="color: #f59e0b;">Packers and Movers in Ghosi Mau</span>
          </h1>
          <p style="font-size: 1.05rem; color: #cbd5e1; line-height: 1.7; margin-bottom: 25px;">
            Planning to relocate your house, office, bike, or car from Ghosi (Mau UP)? Shree Ashirwad Packers and Movers offers multi-layer bubble wrap packing, closed container trucks, experienced loading labor, full transit insurance, and 100% IBA-approved GST bills.
          </p>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20information%20about%20shifting%20in%20Ghosi%20Mau." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
              <i class="fab fa-whatsapp"></i> Chat on WhatsApp
            </a>
          </div>

          <div style="display: flex; gap: 20px; font-size: 0.9rem; color: #94a3b8;">
            <span><strong style="color: #f59e0b;">1,200+</strong> Moves Completed</span>
        ...
        <div class="hero-form-card" style="background: rgba(255, 255, 255, 0.05); backdrop-filter: blur(10px); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
          <h2 style="font-size: 1.4rem; color: #ffffff; margin-bottom: 8px; font-weight: 700; text-align: center;">Get Ghosi Shifting Quote</h2>
          ...
          <form action="#" method="POST" onsubmit="sendHeroWhatsAppLead(event, this);">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 14px;">
              <input type="text" name="move_from" class="form-control" placeholder="Pickup (e.g. Ghosi Mau)" value="Ghosi Mau" required style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.3); color: #fff;">
              <input type="text" name="move_to" class="form-control" placeholder="Destination City" required style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.3); color: #fff;">
            </div>
            <div style="margin-bottom: 16px;">
              <textarea name="message" class="form-control" rows="2" placeholder="Moving Details (e.g. 1BHK, 2BHK, Bike Shifting, Car Carrier)" style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.3); color: #fff;"></textarea>
            </div>
    ...
    <div class="container">
      <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px; text-align: center;">
        <div style="padding: 20px; background: rgba(23, 42, 84, 0.5); border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          ...
          <div style="font-size: 0.9rem; color: #cbd5e1; margin-top: 5px;">Relocations in Ghosi Sector</div>
        </div>
        <div style="padding: 20px; background: rgba(23, 42, 84, 0.5); border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <div style="font-size: 2.2rem; font-weight: 800; color: #f59e0b; font-family: 'Poppins', sans-serif;">Zero</div>
          <div style="font-size: 0.9rem; color: #cbd5e1; margin-top: 5px;">Damage Record Guarantee</div>
        </div>
        <div style="padding: 20px; background: rgba(23, 42, 84, 0.5); border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <div style="font-size: 2.2rem; font-weight: 800; color: #f59e0b; font-family: 'Poppins', sans-serif;">Weatherproof</div>
        ...
        <div style="padding: 20px; background: rgba(23, 42, 84, 0.5); border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          ...
          <div style="font-size: 0.9rem; color: #cbd5e1; margin-top: 5px;">Official GST Reimbursement Bills</div>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div style="max-width: 950px; margin: 0 auto;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">
          Why Choose Us for <span style="color: #f59e0b;">Packers and Movers in Ghosi Mau</span>?
        </h2>
        ...
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; margin: 30px 0;">
          ...
          <div style="background: linear-gradient(145deg, #172a54 0%, #0d1736 100%); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 22px;">
            ...
            <h3 style="font-size: 1.1rem; color: #ffffff; font-weight: 700; margin-bottom: 10px;">Doorstep Home Shifting</h3>
            <p style="font-size: 0.9rem; color: #cbd5e1; margin: 0;">
              Complete packing, loading, transport, unloading, and unpacking at your new home in Ghosi or anywhere in India.
            </p>
          </div>
          ...
          <div style="background: linear-gradient(145deg, #172a54 0%, #0d1736 100%); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 22px;">
            ...
            <h3 style="font-size: 1.1rem; color: #ffffff; font-weight: 700; margin-bottom: 10px;">Multi-Layer Packaging</h3>
            <p style="font-size: 0.9rem; color: #cbd5e1; margin: 0;">
              High-density bubble wrap, corrugated sheets, foam edge protectors, and stretch wrap shield furniture from scratches.
            </p>
          </div>
          ...
          <div style="background: linear-gradient(145deg, #172a54 0%, #0d1736 100%); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 22px;">
            ...
            <h3 style="font-size: 1.1rem; color: #ffffff; font-weight: 700; margin-bottom: 10px;">IBA GST Claim Billing</h3>
            <p style="font-size: 0.9rem; color: #cbd5e1; margin: 0;">
              100% genuine IBA GST consignment bills and Lorry Receipts for corporate and government relocation claims.
            </p>
          </div>
          ...
          <div style="background: linear-gradient(145deg, #172a54 0%, #0d1736 100%); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 22px;">
            ...
            <h3 style="font-size: 1.1rem; color: #ffffff; font-weight: 700; margin-bottom: 10px;">Dedicated Containers</h3>
            <p style="font-size: 0.9rem; color: #cbd5e1; margin: 0;">
              Weatherproof closed container trucks ensuring zero dust, rain, or theft risk during highway transport.
            </p>
          </div>
          ...
          <div style="background: linear-gradient(145deg, #172a54 0%, #0d1736 100%); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 22px;">
            ...
            <p style="font-size: 0.9rem; color: #cbd5e1; margin: 0;">
              Safe two-wheeler bubble packing and car carrier transport alongside household goods.
            </p>
          </div>
          ...
          <div style="background: linear-gradient(145deg, #172a54 0%, #0d1736 100%); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 22px;">
            ...
            <p style="font-size: 0.9rem; color: #cbd5e1; margin: 0;">
              Complete transit insurance coverage guarding declared household items against accidental loss or damage.
            </p>
          </div>
  ...
  <section style="padding: 60px 0; background: #070d1e; color: #ffffff;">
    <div class="container" style="max-width: 950px;">
      ...
      <h2 style="font-size: 2.1rem; font-weight: 800; color: #ffffff; margin: 10px 0 25px 0;">
        Specialized Services in <span style="color: #f59e0b;">Ghosi Mau</span>
      </h2>
      ...
      <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px;">
        <div style="background: #101c40; padding: 20px; border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          ...
          <p style="font-size: 0.88rem; color: #cbd5e1; margin: 0;">1BHK, 2BHK, 3BHK home packing, loading, transport, and unloading.</p>
        </div>

        <div style="background: #101c40; padding: 20px; border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #f59e0b; font-size: 1.05rem; margin-bottom: 8px;">Bike Transportation</h4>
          <p style="font-size: 0.88rem; color: #cbd5e1; margin: 0;">7-layer bubble wrapping &amp; belt tie-down motorcycle shipping.</p>
        </div>
        ...
        <div style="background: #101c40; padding: 20px; border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #f59e0b; font-size: 1.05rem; margin-bottom: 8px;">Office &amp; Corporate Relocation</h4>
          <p style="font-size: 0.88rem; color: #cbd5e1; margin: 0;">Systematic office furniture, IT asset, and document file relocation.</p>
        </div>

        <div style="background: #101c40; padding: 20px; border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #f59e0b; font-size: 1.05rem; margin-bottom: 8px;">Luggage &amp; Part-Load Shipping</h4>
          <p style="font-size: 0.88rem; color: #cbd5e1; margin: 0;">Budget part-load parcel transport for students &amp; bachelor workers.</p>
        </div>

        <div style="background: #101c40; padding: 20px; border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #f59e0b; font-size: 1.05rem; margin-bottom: 8px;">Warehousing &amp; Storage</h4>
          <p style="font-size: 0.88rem; color: #cbd5e1; margin: 0;">Safe, CCTV-monitored short-term and long-term goods storage.</p>
        </div>
      </div>
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #ffffff;">
    <div class="container" style="max-width: 950px;">
      ...
      <h2 style="font-size: 2.1rem; font-weight: 800; color: #ffffff; margin: 10px 0 25px 0;">
        Our 7-Layer Household Safety Packaging Standard
      </h2>
      ...
      <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 15px;">
        <div style="background: #172a54; padding: 18px; border-radius: 10px; border-left: 4px solid #f59e0b;">
          ...
          <h4 style="font-size: 0.95rem; color: #fff; margin: 4px 0;">Pre-Move Survey &amp; Labelling</h4>
          <p style="font-size: 0.82rem; color: #cbd5e1; margin: 0;">Itemized inventory listing and room-wise color coding.</p>
        </div>
        ...
        <div style="background: #172a54; padding: 18px; border-radius: 10px; border-left: 4px solid #f59e0b;">
          ...
          <p style="font-size: 0.82rem; color: #cbd5e1; margin: 0;">Heavy bubble wrap around electronics, glassware, &amp; polished wood.</p>
        </div>
        ...
        <div style="background: #172a54; padding: 18px; border-radius: 10px; border-left: 4px solid #f59e0b;">
          ...
          <p style="font-size: 0.82rem; color: #cbd5e1; margin: 0;">Heavy cardboard casing over sofa corners, tables, &amp; wardrobes.</p>
        </div>
        ...
        <div style="background: #172a54; padding: 18px; border-radius: 10px; border-left: 4px solid #f59e0b;">
          ...
          <p style="font-size: 0.82rem; color: #cbd5e1; margin: 0;">Waterproof plastic stretch film bound around packed cartons.</p>
        </div>
        ...
        <div style="background: #172a54; padding: 18px; border-radius: 10px; border-left: 4px solid #f59e0b;">
          ...
          <p style="font-size: 0.82rem; color: #cbd5e1; margin: 0;">High-density foam pads protecting glass tabletops &amp; mirrors.</p>
        </div>
        ...
        <div style="background: #172a54; padding: 18px; border-radius: 10px; border-left: 4px solid #f59e0b;">
          ...
          <p style="font-size: 0.82rem; color: #cbd5e1; margin: 0;">Custom wooden crates constructed for fragile marble, LED TVs &amp; art.</p>
        </div>
        ...
        <div style="background: #172a54; padding: 18px; border-radius: 10px; border-left: 4px solid #f59e0b; grid-column: span 2;">
          ...
          <h4 style="font-size: 0.95rem; color: #fff; margin: 4px 0;">Truck Container Belting</h4>
          <p style="font-size: 0.82rem; color: #cbd5e1; margin: 0;">Goods anchored tightly to container walls with safety belts before transport.</p>
        </div>
      </div>
  ...
  <section style="padding: 60px 0; background: #070d1e; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      ...
      <span class="section-tag" style="color: #f59e0b; text-transform: uppercase; font-weight: 700; font-size: 0.85rem; letter-spacing: 1px;">Mau District Master Hubs</span>
      <h2 style="font-size: 2.1rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">
        Explore Nearby Relocation Hubs in <span style="color: #f59e0b;">Mau District</span>
      </h2>

      <p style="font-size: 1rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 20px;">
        As part of our Mau District Master Hub network, we serve all major surrounding localities:
      </p>
      ...
      <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px; margin-bottom: 25px;">
        <div style="background: #101c40; padding: 18px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #ffffff; font-size: 1.05rem; margin-bottom: 6px;">Mau District Master Hub</h4>
          <p style="font-size: 0.88rem; color: #94a3b8; margin-bottom: 8px;">Main district headquarters for home shifting and vehicle shipping.</p>
          <a href="<?php echo SITE_URL; ?>packers-and-movers-in-mau" title="Packers Movers Mau Master Hub →" style="color: #f59e0b; text-decoration: underline; font-weight: 600; font-size: 0.88rem;">
            Packers Movers Mau Master Hub →
          </a>
        </div>

        <div style="background: #101c40; padding: 18px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #ffffff; font-size: 1.05rem; margin-bottom: 6px;">Ghosi Bike Transport Hub</h4>
          <p style="font-size: 0.88rem; color: #94a3b8; margin-bottom: 8px;">Enriched motorcycle packaging and door delivery in Ghosi.</p>
          <a href="<?php echo SITE_URL; ?>bike-transportation-in-ghosi" title="Bike Transportation Ghosi →" style="color: #f59e0b; text-decoration: underline; font-weight: 600; font-size: 0.88rem;">
            Bike Transportation Ghosi →
          </a>
        </div>

        <div style="background: #101c40; padding: 18px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #ffffff; font-size: 1.05rem; margin-bottom: 6px;">Car Carrier Ghosi Hub</h4>
          <p style="font-size: 0.88rem; color: #94a3b8; margin-bottom: 8px;">Open trailer and enclosed car container transport from Ghosi.</p>
          <a href="<?php echo SITE_URL; ?>car-transportation-in-ghosi" title="Car Transportation Ghosi →" style="color: #f59e0b; text-decoration: underline; font-weight: 600; font-size: 0.88rem;">
            Car Transportation Ghosi →
          </a>
        </div>

        <div style="background: #101c40; padding: 18px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #ffffff; font-size: 1.05rem; margin-bottom: 6px;">Dohrighat Sub-Locality</h4>
          <p style="font-size: 0.88rem; color: #94a3b8; margin-bottom: 8px;">Relocation services near Dohrighat Ghaghara river bridge.</p>
          <a href="<?php echo SITE_URL; ?>bike-transportation-in-dohrighat" title="Bike Transportation Dohrighat →" style="color: #f59e0b; text-decoration: underline; font-weight: 600; font-size: 0.88rem;">
            Bike Transportation Dohrighat →
          </a>
        </div>
      </div>
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      ...
      <h2 style="font-size: 2.1rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">
        Popular Shifting Routes from <span style="color: #f59e0b;">Ghosi Mau</span>
      </h2>

      <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px; margin-bottom: 25px;">
        <div style="background: #172a54; padding: 18px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #ffffff; font-size: 1.05rem; margin-bottom: 6px;">Ghosi to Delhi NCR</h4>
          <p style="font-size: 0.88rem; color: #94a3b8; margin-bottom: 8px;">Direct container truck shifting to Delhi, Noida, Gurgaon via Purvanchal Expressway.</p>
        </div>

        <div style="background: #172a54; padding: 18px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #ffffff; font-size: 1.05rem; margin-bottom: 6px;">Ghosi to Mumbai / Pune</h4>
          <p style="font-size: 0.88rem; color: #94a3b8; margin-bottom: 8px;">Long-distance household &amp; vehicle transport to Maharashtra hubs.</p>
        </div>

        <div style="background: #172a54; padding: 18px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #ffffff; font-size: 1.05rem; margin-bottom: 6px;">Ghosi to Bangalore / Hyderabad</h4>
          <p style="font-size: 0.88rem; color: #94a3b8; margin-bottom: 8px;">Interstate home shifting to IT tech parks in South India.</p>
        </div>

        <div style="background: #172a54; padding: 18px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #ffffff; font-size: 1.05rem; margin-bottom: 6px;">Ghosi to Patna / Ranchi</h4>
          <p style="font-size: 0.88rem; color: #94a3b8; margin-bottom: 8px;">Daily express goods transport connecting Ghosi Mau to Bihar &amp; Jharkhand.</p>
        </div>
      </div>
  ...
  <section style="padding: 60px 0; background: #070d1e; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      ...
      <h2 style="font-size: 2.1rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">
        IBA Approved GST Billing in Ghosi Mau
      </h2>
      ...
      <div style="background: #101c40; border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 12px; padding: 25px;">
        ...
        <ol style="margin: 0; padding-left: 20px; color: #cbd5e1; line-height: 1.8; font-size: 0.95rem;">
          <li><strong>Official GST Consignment Invoice</strong> detailing itemized packing &amp; freight charges.</li>
          <li><strong>Itemized Goods Inventory List</strong> signed prior to loading in Ghosi Mau.</li>
          <li><strong>Consignment Lorry Receipt (LR Copy)</strong> with carrier vehicle registration details.</li>
          <li><strong>IBA Approved Code &amp; Stamp Registration</strong> on official letterhead.</li>
          <li><strong>Transit Insurance Policy Certificate</strong> covering declared goods value.</li>
          <li><strong>Stamped Money Receipt</strong> for company/govt relocation reimbursement.</li>
        </ol>
      </div>
    ...
    <div class="container" style="max-width: 900px;">
      ...
      <div class="section-header text-center" style="margin-bottom: 40px;">
        ...
        <h2 style="font-size: 2.1rem; font-weight: 800; color: #ffffff; margin-top: 10px;">
          Frequently Asked Questions — <span style="color: #f59e0b;">Ghosi Mau Shifting</span>
        </h2>
      </div>
  ...
  <section style="padding: 60px 0; background: linear-gradient(135deg, #172a54 0%, #0b132b 100%); border-top: 1.5px solid rgba(245, 158, 11, 0.4); color: #ffffff;">
    <div class="container" style="max-width: 900px; text-align: center;">
      ...
      <span class="section-tag" style="background: rgba(245, 158, 11, 0.2); color: #f59e0b; padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase;">
        Book Shifting in Ghosi Mau
      </span>

      <h2 style="font-size: 2.2rem; font-weight: 800; margin: 15px 0 15px 0; color: #ffffff;">
        Need Reliable <span style="color: #f59e0b;">Packers and Movers in Ghosi Mau</span>?
      </h2>

      <p style="font-size: 1.05rem; color: #cbd5e1; max-width: 750px; margin: 0 auto 30px auto; line-height: 1.7;">
        Contact our Mau office today for a free home survey and transparent fixed-price estimate with 100% IBA-compliant GST billing.
      </p>
      ...
      <div style="display: flex; gap: 15px; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20a%20shifting%20quote%20for%20Ghosi%20Mau." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 30px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1.05rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
          <i class="fab fa-whatsapp"></i> Chat on WhatsApp
        </a>
      </div>
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers & Movers,\n\nI would like to request a Shifting Quote from Ghosi Mau:\n- Name: " + name + "\n- Phone: " + phone + "\n- Moving From: " + moveFrom + "\n- Moving To: " + moveTo;
