...
$page_keywords = "car transport from delhi to hyderabad, car transport delhi hyderabad route, car transport service, vehicle transport services, car shipping cost, car shifting services, all india car transport company, car carrier service, car transport in delhi";
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          ...
          <p style="font-size: 1.1rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Relocating your vehicle ~1,550 km from Delhi to Hyderabad? Trust Shree Ashirwad Packers and Movers for express 3-4 day transit via NH44 national highway corridor. Enclosed multi-car trailers with 100% all-risk transit insurance and live GPS tracking.
          </p>
    ...
    <div class="container" style="max-width: 980px; margin: 0 auto; padding: 0 15px;">
      ...
      <div style="background: #0f172a; border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 35px 30px; margin-bottom: 40px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
        ...
        <h2 style="font-size: 2.1rem; font-weight: 800; color: #ffffff; line-height: 1.35; margin-bottom: 18px;">
          Complete Guide: Car Transport from Delhi to Hyderabad
        </h2>

        <p style="font-size: 1.05rem; color: #cbd5e1; line-height: 1.75; margin: 0;">
          Shipping a vehicle ~1,550 km from <strong>Delhi NCR</strong> to <strong>Hyderabad</strong> along the North-South central highway corridor requires expert long-distance <strong>vehicle transport services</strong>. Shree Ashirwad Packers and Movers delivers 3-4 day door-to-door car shipping backed by trusted <strong>car transport in delhi</strong> and <strong>all india car transport company</strong> networks.
        </p>
        ...
        <div style="background: rgba(245, 158, 11, 0.08); border-left: 4px solid #f59e0b; border-radius: 8px; padding: 20px 22px; margin-top: 25px;">
          ...
          <ul style="margin: 0; padding-left: 20px; color: #cbd5e1; font-size: 0.93rem; line-height: 1.75;">
            <li>Express 3 to 4 day transit via NH44 national highway corridor.</li>
            ...
            <li>Full assistance with Delhi NCR to Telangana RTO paperwork &amp; e-Way Bills.</li>
          </ul>
        </div>
      ...
      <div style="background: #0f172a; border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 16px; padding: 40px 35px; line-height: 1.8; color: #cbd5e1; font-size: 1rem; box-shadow: 0 10px 30px rgba(0,0,0,0.3);">
        ...
        <section style="margin-bottom: 35px;">
          ...
          <p>
            The national highway corridor connecting Delhi to Hyderabad spans approximately 1,550 kilometers passing through Agra, Gwalior, Jhansi, Nagpur, and Adilabad via NH44. Estimated vehicle transit duration is <strong>3 to 4 business days</strong>.
          </p>
          <p style="margin-top: 12px;">
            Our dedicated <strong>car carrier service</strong> collects vehicles from across Delhi NCR (Dwarka, Rohini, South Extension, Janakpuri, Connaught Place, Vasant Kunj, Noida, Gurgaon) and delivers directly across Hyderabad (Hitech City, Gachibowli, Madhapur, Kukatpally, Banjara Hills, Jubilee Hills, Secunderabad, Kondapur).
          </p>
        </section>
        ...
        <section style="margin-bottom: 35px;">
          ...
          <p>
            Below is the standard <strong>car shipping cost</strong> tariff matrix for car shipping from Delhi to Hyderabad across open multi-car trailers and enclosed container carriers:
          </p>
        ...
        <section style="margin-bottom: 35px;">
          ...
          <p>
            Transporting a vehicle interstate from Delhi NCR into Telangana requires standard statutory documentation:
          </p>
        ...
        <section style="margin-bottom: 20px;">
          ...
          <div style="background: #070d19; border: 1.5px solid rgba(245, 158, 11, 0.4); border-radius: 14px; padding: 25px;">
            <ul style="padding-left: 20px; margin: 0; line-height: 1.85; color: #cbd5e1;">
              ...
              <li><strong>Express National Highway Transit:</strong> Direct connection via NH44 highway corridor.</li>
              ...
              <li><strong>Door-to-Door Service:</strong> Pickup directly from your Delhi location and delivery at your doorstep in Hyderabad.</li>
            </ul>
          </div>
        </section>
  ...
  <script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How much does it cost to transport a car from Delhi to Hyderabad?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Car transport charges from Delhi to Hyderabad range between ₹10,500 and ₹24,000 depending on vehicle category (hatchback, sedan, SUV) and carrier type."
      }
    },
    {
      "@type": "Question",
      "name": "How long does car shipping take from Delhi to Hyderabad?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Car transport from Delhi to Hyderabad takes 3 to 4 business days via NH44 corridor."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "What documents are required for Delhi to Hyderabad car transport?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Can I track my car during Delhi to Hyderabad transit?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <div style="display: flex; flex-direction: column; gap: 14px;">
        ...
        <details style="background: #0f172a; border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 12px; overflow: hidden;">
          <summary style="padding: 18px 22px; color: #ffffff; font-weight: 700; font-size: 1rem; cursor: pointer; display: flex; justify-content: space-between; align-items: center;">
            <span><strong style="color: #f59e0b; margin-right: 8px;">Q1.</strong> How much does it cost to transport a car from Delhi to Hyderabad?</span>
          ...
          <div style="padding: 15px 22px 20px 22px; color: #cbd5e1; font-size: 0.93rem; line-height: 1.7; border-top: 1px solid rgba(255,255,255,0.08);">
            Car transport charges from Delhi to Hyderabad range between ₹10,500 and ₹24,000 depending on vehicle category (hatchback, sedan, SUV) and carrier type.
          </div>
        </details>

        <details style="background: #0f172a; border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 12px; overflow: hidden;">
          <summary style="padding: 18px 22px; color: #ffffff; font-weight: 700; font-size: 1rem; cursor: pointer; display: flex; justify-content: space-between; align-items: center;">
            <span><strong style="color: #f59e0b; margin-right: 8px;">Q2.</strong> How long does car shipping take from Delhi to Hyderabad?</span>
            <span style="color: #f59e0b; font-size: 1.2rem; font-weight: 800;">&#43;</span>
          </summary>
          <div style="padding: 15px 22px 20px 22px; color: #cbd5e1; font-size: 0.93rem; line-height: 1.7; border-top: 1px solid rgba(255,255,255,0.08);">
            Car transport from Delhi to Hyderabad takes 3 to 4 business days via NH44 corridor.
          </div>
        </details>
        ...
        <details style="background: #0f172a; border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 12px; overflow: hidden;">
          <summary style="padding: 18px 22px; color: #ffffff; font-weight: 700; font-size: 1rem; cursor: pointer; display: flex; justify-content: space-between; align-items: center;">
            <span><strong style="color: #f59e0b; margin-right: 8px;">Q4.</strong> What documents are required for Delhi to Hyderabad car transport?</span>
            <span style="color: #f59e0b; font-size: 1.2rem; font-weight: 800;">&#43;</span>
          </summary>
          <div style="padding: 15px 22px 20px 22px; color: #cbd5e1; font-size: 0.93rem; line-height: 1.7; border-top: 1px solid rgba(255,255,255,0.08);">
        ...
        <details style="background: #0f172a; border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 12px; overflow: hidden;">
          <summary style="padding: 18px 22px; color: #ffffff; font-weight: 700; font-size: 1rem; cursor: pointer; display: flex; justify-content: space-between; align-items: center;">
            <span><strong style="color: #f59e0b; margin-right: 8px;">Q6.</strong> Can I track my car during Delhi to Hyderabad transit?</span>
            <span style="color: #f59e0b; font-size: 1.2rem; font-weight: 800;">&#43;</span>
          </summary>
          <div style="padding: 15px 22px 20px 22px; color: #cbd5e1; font-size: 0.93rem; line-height: 1.7; border-top: 1px solid rgba(255,255,255,0.08);">
    ...
    <div class="container" style="max-width: 980px; margin: 0 auto; padding: 0 15px;">
      ...
      <div style="background: linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #070d19 100%); border: 1.5px solid rgba(245, 158, 11, 0.4); border-radius: 20px; padding: 45px 30px; text-align: center; box-shadow: 0 20px 40px rgba(0,0,0,0.5);">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin-bottom: 18px; line-height: 1.3;">
          Book <span style="color: #f59e0b;">Car Transport from Delhi to Hyderabad</span> Today!
        </h2>
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers & Movers,\n\nI am requesting a Car Transport Quote from Delhi to Hyderabad:\n- Name: " + name + "\n- Phone: " + phone + "\n- Pickup City: " + moveFrom + "\n- Destination City: " + moveTo;
