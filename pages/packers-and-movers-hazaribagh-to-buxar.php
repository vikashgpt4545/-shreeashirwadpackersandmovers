...
$faq_list = [
    ...
    ['q' => 'What are the charges for 1BHK/2BHK home shifting from Hazaribagh to Buxar?', 'a' => 'Intercity shifting from Hazaribagh to Buxar ranges from â‚¹10,500 to â‚¹16,500 for a 1BHK, â‚¹16,500 to â‚¹24,000 for a 2BHK, and â‚¹23,500 to â‚¹34,000 for a 3BHK home.'],
...
<main class="site-main">
  ...
  <section style="padding: 60px 0; background: #070d1e; color: #ffffff; border-top: 1px solid rgba(245, 158, 11, 0.15);">
    <div class="container" style="max-width: 950px;">
      ...
      <h2 style="font-size: 2rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">7-Layer Highway Protective Packaging for Hazaribagh to Buxar Transit</h2>
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #ffffff;">
    <div class="container" style="max-width: 950px;">
      ...
      <h2 style="font-size: 2rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">Specialized Car & Bike Carrier Services from Hazaribagh to Buxar</h2>
      <p style="font-size: 1.05rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
        Transporting cars, SUVs, and motorcycles from Hazaribagh to Buxar requires closed hydraulic multi-deck car trailers and motorcycle stand anchorage:
      </p>
  ...
  <section style="padding: 60px 0; background: #070d1e; color: #ffffff; border-top: 1px solid rgba(245, 158, 11, 0.15);">
    <div class="container" style="max-width: 950px;">
      ...
      <p style="font-size: 1.05rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
        NTPC officers, BSF Meru Camp personnel, CCL executives, bank employees, and state government staff shifting from Hazaribagh to Buxar receive 100% compliant claim bills for HR approval:
      </p>
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #ffffff; border-top: 1px solid rgba(245, 158, 11, 0.15);">
    <div class="container" style="max-width: 950px;">
      ...
      <h2 style="font-size: 2rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">4-Protocol Zero-Damage Execution System for Hazaribagh to Buxar</h2>
  ...
  <section style="padding: 60px 0; background: #070d1e; color: #ffffff; border-top: 1px solid rgba(245, 158, 11, 0.15);">
    <div class="container" style="max-width: 950px;">
      ...
      <h2 style="font-size: 2rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">NTPC Coal Mining & Defense (BSF Meru) Corporate Relocation Framework for Buxar</h2>
      <p style="font-size: 1.05rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
        As Hazaribagh serves as a central hub for NTPC Barkagaon Coal Mining Project, BSF TC&amp;S Meru Camp, CCL North Karanpura Coalfields, and Vinoba Bhave University, institutional and government relocations in Buxar follow strict audit guidelines. Shree Ashirwad Packers and Movers provides standard IBA-compliant documentation packages tailored for fast HR reimbursement:
      </p>
      <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
        <div style="background: #101c40; padding: 20px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #ffffff; border-top: 1px solid rgba(245, 158, 11, 0.15);">
    <div class="container" style="max-width: 950px;">
      ...
      <h2 style="font-size: 2rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">How Shifting Charges are Calculated for Hazaribagh to Buxar Moves</h2>
      <p style="font-size: 1.05rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
        Relocation pricing in Buxar is calculated based on total cargo volume (CFT), floor elevation, elevator availability, packaging material grade, vehicle type, and total road distance. Our binding quotes guarantee zero hidden fees:
      </p>
