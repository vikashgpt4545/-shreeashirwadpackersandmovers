...
$page_keywords = "bike transportation in patiala, best bike transportation in patiala, affordable bike transportation in patiala, top bike transportation in patiala company, doorstep bike transportation in patiala, transport nagar patiala, bike transport service, bike transport cost, bike transport by train, railway bike transport charges, patiala bike transport";
...
<main class="site-main">
  ...
  <div class="breadcrumb-wrapper">
    <div class="container">
      <div class="breadcrumb-list">
        ...
        <span class="breadcrumb-item active">Bike Transportation in Patiala</span>
      </div>
    </div>
  </div>
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            PATIALA ROYAL CITY (PB-11 TRANSPORT NAGAR) BIKE LOGISTICS
          </span>
          ...
          <p style="font-size: 1.05rem; color: #cbd5e1; line-height: 1.7; margin-bottom: 25px;">
            Shree Ashirwad Packers and Movers delivers safe, insured, and doorstep motorcycle transport across Patiala (PB-11 RTO, Transport Nagar Patiala hub) via NH-7 Zirakpur and NH-44 GT Road expressways. 7-layer winter-fog proof wrapping, covered container carriers, and IBA-approved GST bills.
          </p>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20a%20bike%20transport%20quote%20for%20Patiala." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
              <i class="fab fa-whatsapp" style="margin-right: 8px;"></i> Chat on WhatsApp
            </a>
          </div>

          <div style="display: flex; gap: 20px; font-size: 0.9rem; color: #94a3b8;">
            <span><strong style="color: #f59e0b;">Transport Nagar</strong> Hub</span>
        ...
        <div class="hero-form-card" style="background: rgba(255, 255, 255, 0.05); backdrop-filter: blur(10px); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
          <h2 style="font-size: 1.4rem; color: #ffffff; margin-bottom: 8px; font-weight: 700; text-align: center;">Get Patiala Bike Quote</h2>
          ...
          <form action="#" method="POST" onsubmit="sendHeroWhatsAppLead(event, this);">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 14px;">
              <input type="text" name="move_from" class="form-control" value="Patiala (PB)" required style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.3); color: #fff;">
              <input type="text" name="move_to" class="form-control" placeholder="Destination City" required style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.3); color: #fff;">
            </div>
            <div style="margin-bottom: 16px;">
              <textarea name="message" class="form-control" rows="2" placeholder="Bike Model (e.g. Royal Enfield Bullet / Activa / Pulsar)" style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.3); color: #fff;"></textarea>
            </div>
  ...
  <section class="stats-section" style="padding: 45px 0; background: #070d1e; border-bottom: 1px solid rgba(245, 158, 11, 0.2);">
    <div class="container">
      <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px; text-align: center;">
        ...
        <div style="padding: 20px; background: rgba(23, 42, 84, 0.5); border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <div style="font-size: 2.2rem; font-weight: 800; color: #f59e0b; font-family: 'Poppins', sans-serif;">NH-7</div>
        ...
        <div style="padding: 20px; background: rgba(23, 42, 84, 0.5); border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          ...
          <div style="font-size: 0.9rem; color: #cbd5e1; margin-top: 5px;">Fog &amp; Smog Proof Packing</div>
        </div>
        <div style="padding: 20px; background: rgba(23, 42, 84, 0.5); border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
    ...
    <div class="container">
      ...
      <div style="max-width: 950px; margin: 0 auto;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">
          Why Choose Us for <span style="color: #f59e0b;">Patiala Bike Transportation</span>
        </h2>
        ...
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; margin: 30px 0;">
          ...
          <div style="background: linear-gradient(145deg, #172a54 0%, #0d1736 100%); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 22px;">
            ...
            <p style="font-size: 0.9rem; color: #cbd5e1; margin: 0;">
              Optional heavy wooden frame crating for Royal Enfield Bullet, Jawa, sports bikes, and vintage models.
            </p>
          </div>
          ...
          <div style="background: linear-gradient(145deg, #172a54 0%, #0d1736 100%); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 22px;">
            ...
            <p style="font-size: 0.9rem; color: #cbd5e1; margin: 0;">
              Winter-fog barrier stretch film, heavy bubble wrap, corrugated sheets &amp; engine foam padding.
            </p>
          </div>
          ...
          <div style="background: linear-gradient(145deg, #172a54 0%, #0d1736 100%); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 22px;">
            ...
            <h3 style="font-size: 1.1rem; color: #ffffff; font-weight: 700; margin-bottom: 10px;">Doorstep Pickup Across PB-11</h3>
            <p style="font-size: 0.9rem; color: #cbd5e1; margin: 0;">
              Pickup available across Transport Nagar Patiala, Urban Estate, Model Town, Punjabi University &amp; Tripuri.
            </p>
          </div>
          ...
          <div style="background: linear-gradient(145deg, #172a54 0%, #0d1736 100%); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 22px;">
            ...
            <p style="font-size: 0.9rem; color: #cbd5e1; margin: 0;">
              0.3% comprehensive policy covering full vehicle valuation against highway transit hazards.
            </p>
          </div>
          ...
          <div style="background: linear-gradient(145deg, #172a54 0%, #0d1736 100%); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 22px;">
            ...
            <p style="font-size: 0.9rem; color: #cbd5e1; margin: 0;">
              All-weather covered container trucks preventing rain, road smog, and highway vibration damage.
            </p>
          </div>
          ...
          <div style="background: linear-gradient(145deg, #172a54 0%, #0d1736 100%); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 22px;">
            ...
            <p style="font-size: 0.9rem; color: #cbd5e1; margin: 0;">
              Official GST invoices suitable for University, Govt, Military, Bank &amp; Corporate claim reimbursement.
            </p>
          </div>
  ...
  <section style="padding: 60px 0; background: #070d1e; color: #ffffff;">
    <div class="container" style="max-width: 950px;">
      ...
      <h2 style="font-size: 2.1rem; font-weight: 800; color: #ffffff; margin: 10px 0 25px 0;">
        Estimated Bike Transport Rates for Patiala
      </h2>
        ...
        <table style="width: 100%; border-collapse: collapse; background: #101c40; border-radius: 12px; overflow: hidden; font-size: 0.95rem;">
          <thead>
            <tr style="background: #172a54; color: #f59e0b; text-align: left;">
              ...
              <th style="padding: 16px; border-bottom: 2px solid rgba(245,158,11,0.3);">Regional (Chandigarh / Ludhiana)</th>
              <th style="padding: 16px; border-bottom: 2px solid rgba(245,158,11,0.3);">Interstate (Delhi NCR / Jaipur)</th>
              <th style="padding: 16px; border-bottom: 2px solid rgba(245,158,11,0.3);">Long Distance (Mumbai / Bangalore)</th>
            </tr>
          </thead>
          <tbody>
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #ffffff;">
    <div class="container" style="max-width: 950px;">
      ...
      <h2 style="font-size: 2.1rem; font-weight: 800; color: #ffffff; margin: 10px 0 25px 0;">
        Our 7-Layer Fog &amp; Smog Proof Bike Packaging &amp; Crating Protocol
      </h2>
      ...
      <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 15px;">
        ...
        <div style="background: #172a54; padding: 18px; border-radius: 10px; border-left: 4px solid #f59e0b;">
          ...
          <h4 style="font-size: 0.95rem; color: #fff; margin: 4px 0;">Fog &amp; Smog Barrier Film</h4>
          <p style="font-size: 0.82rem; color: #cbd5e1; margin: 0;">Tightly wrapping moisture &amp; smog barrier stretch film around bike body.</p>
        </div>
  ...
  <section style="padding: 60px 0; background: #070d1e; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      ...
      <h2 style="font-size: 2.1rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">
        Serving All Major <span style="color: #f59e0b;">Patiala Localities</span>
      </h2>
      ...
      <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px; margin-bottom: 25px;">
        <div style="background: #101c40; padding: 16px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #f59e0b; font-size: 1rem; margin-bottom: 4px;">Logistics &amp; Freight Hub</h4>
          <p style="font-size: 0.85rem; color: #94a3b8; margin: 0;">Transport Nagar Patiala, Sirhind Road Industrial Area, Focal Point Patiala.</p>
        </div>

        <div style="background: #101c40; padding: 16px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #f59e0b; font-size: 1rem; margin-bottom: 4px;">Prime Residential Sectors</h4>
          <p style="font-size: 0.85rem; color: #94a3b8; margin: 0;">Urban Estate Phase 1 &amp; 2, Model Town, Punjabi University Campus Area.</p>
        </div>

        <div style="background: #101c40; padding: 16px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #f59e0b; font-size: 1rem; margin-bottom: 4px;">Royal City Central Zone</h4>
          <p style="font-size: 0.85rem; color: #94a3b8; margin: 0;">Tripuri Town, Lehal Colony, Baradari Gardens, Mall Road Commercial Zone.</p>
        </div>

        <div style="background: #101c40; padding: 16px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #f59e0b; font-size: 1rem; margin-bottom: 4px;">Highway Corridors</h4>
          <p style="font-size: 0.85rem; color: #94a3b8; margin: 0;">NH-7 Zirakpur Highway, Rajpura Road Link, Nabha Road Bypass.</p>
        </div>

        <div style="background: #101c40; padding: 16px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #f59e0b; font-size: 1rem; margin-bottom: 4px;">Suburban Residential Belts</h4>
          <p style="font-size: 0.85rem; color: #94a3b8; margin: 0;">Dashmesh Nagar, SST Nagar, Punjabi Bagh, Factory Area Colony.</p>
        </div>

        <div style="background: #101c40; padding: 16px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #f59e0b; font-size: 1rem; margin-bottom: 4px;">District Peripheral Towns</h4>
          <p style="font-size: 0.85rem; color: #94a3b8; margin: 0;">Rajpura, Nabha, Samana, Sirhind Border Road.</p>
        </div>
      </div>
  ...
  <!-- 8. Popular Intercity Routes from Patiala -->
  <section style="padding: 60px 0; background: #0b132b; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      ...
      <h2 style="font-size: 2.1rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">
        Popular Intercity Bike Shipping Corridors from Patiala
      </h2>
      ...
      <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px; margin-bottom: 25px;">
        <div style="background: #172a54; padding: 18px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #ffffff; font-size: 1.05rem; margin-bottom: 6px;">Patiala to Chandigarh / Mohali / Ludhiana</h4>
          <p style="font-size: 0.88rem; color: #94a3b8; margin: 0;">Daily covered container trucks via NH-7 with 24-hour delivery.</p>
        </div>

        <div style="background: #172a54; padding: 18px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #ffffff; font-size: 1.05rem; margin-bottom: 6px;">Patiala to Delhi NCR / Ambala / Jaipur</h4>
          <p style="font-size: 0.88rem; color: #94a3b8; margin: 0;">Direct GT Road express vehicle carriers with full transit insurance.</p>
        </div>

        <div style="background: #172a54; padding: 18px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #ffffff; font-size: 1.05rem; margin-bottom: 6px;">Patiala to Mumbai / Pune / Ahmedabad</h4>
          <p style="font-size: 0.88rem; color: #94a3b8; margin: 0;">Interstate container shipping with 3 to 4 day transit time.</p>
        </div>

        <div style="background: #172a54; padding: 18px; border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <h4 style="color: #ffffff; font-size: 1.05rem; margin-bottom: 6px;">Patiala to Bengaluru / Hyderabad / Kolkata</h4>
          <p style="font-size: 0.88rem; color: #94a3b8; margin: 0;">Long-distance sealed container carriers taking 4 to 5 days.</p>
        </div>
      </div>
    ...
    <div class="container" style="max-width: 900px;">
      ...
      <div class="section-header text-center" style="margin-bottom: 40px;">
        ...
        <h2 style="font-size: 2.1rem; font-weight: 800; color: #ffffff; margin-top: 10px;">
          Frequently Asked Questions — <span style="color: #f59e0b;">Patiala Bike Transport</span>
        </h2>
      </div>
  ...
  <section style="padding: 60px 0; background: linear-gradient(135deg, #172a54 0%, #0b132b 100%); border-top: 1.5px solid rgba(245, 158, 11, 0.4); color: #ffffff;">
    <div class="container" style="max-width: 900px; text-align: center;">
      ...
      <span class="section-tag" style="background: rgba(245, 158, 11, 0.2); color: #f59e0b; padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase;">
        Book Bike Transportation in Patiala
      </span>
      ...
      <p style="font-size: 1.05rem; color: #cbd5e1; max-width: 750px; margin: 0 auto 30px auto; line-height: 1.7;">
        Get your instant price estimate today! Free doorstep pickup across Transport Nagar Patiala, Urban Estate, Model Town, Punjabi University &amp; Tripuri, 7-layer winter-fog proof wrapping, and 100% insured container truck delivery.
      </p>
      ...
      <div style="display: flex; gap: 15px; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20a%20bike%20transport%20quote%20for%20Patiala." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 30px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1.05rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers & Movers,\n\nI am requesting a Bike Transport Quote for Patiala:\n- Name: " + name + "\n- Phone: " + phone + "\n- From: " + moveFrom + "\n- Destination City: " + moveTo;
