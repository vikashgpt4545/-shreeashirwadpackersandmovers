...
$page_keywords = "bike transport from kurnool to hyderabad, bike shipping kurnool to hyderabad, motorcycle transport kurnool to hyderabad charges, bike courier service kurnool hyderabad, two wheeler relocation kurnool hyderabad";
...
<main class="site-main" style="background-color: #0b132b; color: #cbd5e1; font-family: 'Inter', sans-serif;">
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            KURNOOL TO HYDERABAD BIKE RELOCATION
          </span>
          ...
          <p style="font-size: 1.05rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Relocate your motorcycle safely from Kurnool to Hyderabad (~210 km via NH44) with same-day / next-day door-to-door protection. Multi-layer bubble wrapping, enclosed container trucks, GPS tracking, and comprehensive transit insurance included.
          </p>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20need%20a%20quote%20for%20bike%20transport%20from%20Kurnool%20to%20Hyderabad." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
          ...
          <div style="display: flex; gap: 20px; font-size: 0.9rem; color: #94a3b8;">
            ...
            <span><strong style="color: #f59e0b;">24 Hours</strong> Same-Day Delivery</span>
          </div>
        </div>
        ...
        <div class="hero-form-card" style="background: rgba(255, 255, 255, 0.04); backdrop-filter: blur(10px); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
          <h2 style="font-size: 1.3rem; color: #ffffff; margin-bottom: 8px; font-weight: 700; text-align: center;">Get Kurnool → Hyderabad Quote</h2>
          ...
          <form action="#" method="POST" onsubmit="sendHeroWhatsAppLead(event, this);">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 14px;">
              <input type="text" name="move_from" class="form-control" value="Kurnool" required style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.3); color: #fff;">
    ...
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 25px; text-align: center;">
        <div style="background: rgba(255,255,255,0.03); padding: 20px; border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <div style="font-size: 2.2rem; font-weight: 800; color: #f59e0b;">3,100+</div>
          <div style="font-size: 0.9rem; color: #94a3b8;">Bikes Shifted to Hyderabad</div>
        </div>
        <div style="background: rgba(255,255,255,0.03); padding: 20px; border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <div style="font-size: 2.2rem; font-weight: 800; color: #f59e0b;">210+ KM</div>
          <div style="font-size: 0.9rem; color: #94a3b8;">NH44 Direct Highway Corridor</div>
        </div>
        <div style="background: rgba(255,255,255,0.03); padding: 20px; border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
  ...
  <section style="padding: 60px 0; background: #0b132b;">
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 15px;">
      <h2 style="font-size: 2rem; font-weight: 800; text-align: center; color: #ffffff; margin-bottom: 15px;">
        Why Choose Our <span style="color: #f59e0b;">Kurnool to Hyderabad</span> Bike Transport?
      </h2>
      <p style="text-align: center; color: #94a3b8; max-width: 700px; margin: 0 auto 40px auto; font-size: 0.95rem;">
        Fast, safe, and direct two-wheeler shifting between Kurnool and Hyderabad.
      </p>
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 25px;">
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border-left: 4px solid #f59e0b;">
          ...
          <p style="font-size: 0.9rem; color: #94a3b8; line-height: 1.6;">Weatherproof covered container vehicles shield your vehicle against highway dust, rain, and vibrations along NH44.</p>
        </div>
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border-left: 4px solid #f59e0b;">
          <h3 style="font-size: 1.2rem; color: #ffffff; margin-bottom: 10px;">Kurnool Doorstep Pickup</h3>
          <p style="font-size: 0.9rem; color: #94a3b8; line-height: 1.6;">Doorstep pickup across Nandyal Checkpost, C-Camp, Bellary Road, Raj Vihar, and all Kurnool localities.</p>
        </div>
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border-left: 4px solid #f59e0b;">
        ...
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border-left: 4px solid #f59e0b;">
          ...
          <p style="font-size: 0.9rem; color: #94a3b8; line-height: 1.6;">Direct delivery across Hitech City, Gachibowli, Madhapur, Kukatpally, Banjara Hills, Jubilee Hills, and Secunderabad.</p>
        </div>
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border-left: 4px solid #f59e0b;">
  ...
  <section style="padding: 60px 0; background: #1c2541; border-top: 1px solid rgba(255, 255, 255, 0.05);">
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 15px;">
      <h2 style="font-size: 2rem; font-weight: 800; text-align: center; color: #ffffff; margin-bottom: 15px;">
        Estimated <span style="color: #f59e0b;">Kurnool to Hyderabad</span> Bike Shifting Charges
      </h2>
      <p style="text-align: center; color: #94a3b8; max-width: 700px; margin: 0 auto 40px auto; font-size: 0.95rem;">
        ...
        <table style="width: 100%; border-collapse: collapse; text-align: left; color: #cbd5e1; font-size: 0.95rem;">
          ...
          <tbody>
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
              ...
              <td style="padding: 16px; border-right: 1px solid rgba(255,255,255,0.05);">₹ 2,200 - ₹ 3,200</td>
              <td style="padding: 16px; border-right: 1px solid rgba(255,255,255,0.05); color: #f59e0b;">₹ 3,200 - ₹ 4,200</td>
              <td style="padding: 16px;">24 Hours</td>
            </tr>
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
              ...
              <td style="padding: 16px; border-right: 1px solid rgba(255,255,255,0.05);">₹ 3,200 - ₹ 4,200</td>
              <td style="padding: 16px; border-right: 1px solid rgba(255,255,255,0.05); color: #f59e0b;">₹ 4,200 - ₹ 5,500</td>
              <td style="padding: 16px;">24 Hours</td>
            </tr>
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
              ...
              <td style="padding: 16px; border-right: 1px solid rgba(255,255,255,0.05);">₹ 4,200 - ₹ 5,800</td>
              <td style="padding: 16px; border-right: 1px solid rgba(255,255,255,0.05); color: #f59e0b;">₹ 5,800 - ₹ 7,200</td>
              <td style="padding: 16px;">24 Hours</td>
            </tr>
            <tr>
  ...
  <section style="padding: 50px 0; background: #1c2541; border-top: 1px solid rgba(255,255,255,0.05);">
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 15px;">
      <h3 style="font-size: 1.5rem; color: #ffffff; margin-bottom: 20px;">Top Pickup Localities in Kurnool</h3>
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 15px;">
        <a href="<?php echo SITE_URL; ?>/pages/bike-transportation.php" style="background: #0b132b; padding: 15px; border-radius: 8px; color: #f59e0b; text-decoration: none; border: 1px solid rgba(255,255,255,0.05);">Nandyal Checkpost Bike Shipping</a>
        <a href="<?php echo SITE_URL; ?>/pages/bike-transportation.php" style="background: #0b132b; padding: 15px; border-radius: 8px; color: #f59e0b; text-decoration: none; border: 1px solid rgba(255,255,255,0.05);">C-Camp Two-Wheeler Shifting</a>
        <a href="<?php echo SITE_URL; ?>/pages/bike-transportation.php" style="background: #0b132b; padding: 15px; border-radius: 8px; color: #f59e0b; text-decoration: none; border: 1px solid rgba(255,255,255,0.05);">Bellary Road Motorcycle Courier</a>
        <a href="<?php echo SITE_URL; ?>/pages/bike-transportation.php" style="background: #0b132b; padding: 15px; border-radius: 8px; color: #f59e0b; text-decoration: none; border: 1px solid rgba(255,255,255,0.05);">Raj Vihar Bike Transport</a>
      </div>
    </div>
  </section>
  ...
  <section style="padding: 50px 0; background: #0b132b; border-top: 1px solid rgba(255,255,255,0.05);">
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 15px;">
      <h3 style="font-size: 1.5rem; color: #ffffff; margin-bottom: 20px;">Popular Routes from Kurnool</h3>
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 15px;">
        <a href="<?php echo SITE_URL; ?>/pages/bike-transport-from-kurnool-to-bangalore.php" style="background: #1c2541; padding: 15px; border-radius: 8px; color: #f59e0b; text-decoration: none; border: 1px solid rgba(255,255,255,0.05);">Kurnool to Bangalore</a>
        <a href="<?php echo SITE_URL; ?>/pages/bike-transport-from-kurnool-to-hyderabad.php" style="background: #1c2541; padding: 15px; border-radius: 8px; color: #f59e0b; text-decoration: none; border: 1px solid rgba(255,255,255,0.05);">Kurnool to Hyderabad</a>
        <a href="<?php echo SITE_URL; ?>/pages/bike-transport-from-bangalore-to-kurnool.php" style="background: #1c2541; padding: 15px; border-radius: 8px; color: #f59e0b; text-decoration: none; border: 1px solid rgba(255,255,255,0.05);">Bangalore to Kurnool</a>
        <a href="<?php echo SITE_URL; ?>/pages/bike-transport-from-hyderabad-to-kurnool.php" style="background: #1c2541; padding: 15px; border-radius: 8px; color: #f59e0b; text-decoration: none; border: 1px solid rgba(255,255,255,0.05);">Hyderabad to Kurnool</a>
      </div>
    </div>
  </section>
  ...
  <section style="padding: 60px 0; background: #0b132b; border-top: 1px solid rgba(255,255,255,0.05);">
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px;">
      <h2 style="font-size: 2rem; font-weight: 800; text-align: center; color: #ffffff; margin-bottom: 30px;">
        Frequently Asked Questions — <span style="color: #f59e0b;">Kurnool to Hyderabad</span>
      </h2>

      <div style="display: flex; flex-direction: column; gap: 20px;">
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
          <h3 style="font-size: 1.1rem; color: #ffffff; margin-bottom: 10px;">What is the cost of bike transport from Kurnool to Hyderabad?</h3>
          <p style="font-size: 0.9rem; color: #94a3b8; line-height: 1.6;">Charges range between ₹2,200 and ₹5,800 depending on vehicle engine capacity and packaging selection.</p>
        </div>
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
          <h3 style="font-size: 1.1rem; color: #ffffff; margin-bottom: 10px;">How long does transit take between Kurnool and Hyderabad?</h3>
          <p style="font-size: 0.9rem; color: #94a3b8; line-height: 1.6;">Delivery usually takes 24 hours via direct NH44 container trucks.</p>
        </div>
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
        ...
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
          <h3 style="font-size: 1.1rem; color: #ffffff; margin-bottom: 10px;">Is door-to-door pickup provided in Kurnool?</h3>
          <p style="font-size: 0.9rem; color: #94a3b8; line-height: 1.6;">Yes, we pick up your motorcycle directly from your doorstep anywhere in Kurnool and deliver it directly to Hyderabad.</p>
        </div>
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
  ...
  <section style="padding: 60px 0; background: linear-gradient(135deg, #1c2541 0%, #0b132b 100%); text-align: center; border-top: 1px solid rgba(245, 158, 11, 0.3);">
    <div class="container" style="max-width: 900px; margin: 0 auto; padding: 0 15px;">
      <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin-bottom: 15px;">Book Your Kurnool to Hyderabad Bike Transport Today!</h2>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the cost of bike transport from Kurnool to Hyderabad?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Charges range between ₹2,200 and ₹5,800 depending on vehicle engine capacity and packaging selection."
      }
    },
    {
      "@type": "Question",
      "name": "How long does transit take between Kurnool and Hyderabad?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Delivery usually takes 24 hours via direct NH44 container trucks."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "Is door-to-door pickup provided in Kurnool?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, we pick up your motorcycle directly from your doorstep anywhere in Kurnool and deliver it directly to Hyderabad."
      }
    },
    {
      "@type": "Question",
