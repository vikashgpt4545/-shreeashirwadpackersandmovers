...
$faq_list = [
    ...
    [
        'q' => 'How are relocation charges calculated for Bike Transport in Akola | Safe Two-Wheeler Shifting?',
...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  ...
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>These carriers protect the bike from external elements, ensuring a clean arrival at the destination.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>The ramp is smoothly operated by hydraulic systems, allowing for easy loading and unloading of bikes.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>The enclosed design provides stability during transit, reducing the risk of accidents.</p>
  </div>
</div>
	...
	<h3>Additional Considerations
		...
		Insurance: Many companies offering bike transport services provide insurance for added protection.
		Experienced Drivers: Trained drivers ensure safe transport by following all necessary guidelines and precautions.
		Transportation Qualifications: Companies must comply with relevant transportation qualifications and regulations to provide reliable bike transport services.
	
	
	
		Railway Transport: Bikes can be transported via trains under certain conditions, subject to availability and specific guidelines.
		Reputable Services: When choosing a transport service, select a reputable company with a proven track record.
		Packaging and Loading: Ensure bikes are properly packaged and loaded onto vehicles for safe transportation.
	
	Additional Information</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Additional Considerations
	...
	Additional Information ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
