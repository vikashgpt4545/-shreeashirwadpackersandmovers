    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For a seamless and efficient relocation from Benz Circle to the Destination Hub, our team at Shree Ashirwad Packers and Movers has identified the optimal freight highway route. The most suitable route for this journey is the National Highway Arterial Corridors and Multi-Axle Express Freight Highways, spanning approximately 850 km. To ensure hassle-free transit, we also recommend checking for interstate border checkposts along the route and facilitating automated e-Way bill clearance. Moreover, to guarantee a speedy and secure transit, our team will utilize speed-governed container transit, carefully monitoring the container&#039;s movement to minimize the risk of damage or delays.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">To safeguard your household items or vehicles during the transit, we employ a tailored packing and loading strategy. Our expert packers will carefully wrap and secure each item to prevent damage, while also ensuring that the container is securely loaded to withstand the rigors of the journey. We also offer specialized protective measures for vehicles, including custom wrapping and padding to prevent scratches or dents. With our dedicated team and cutting-edge logistics expertise, you can trust that your belongings will arrive at the Destination Hub in pristine condition, minimizing the risk of damage or loss. Our packers and movers in Benz Circle are well-equipped to handle even the most complex relocations, ensuring</p>
        </div>
      </div>
    </div>
  </section>
