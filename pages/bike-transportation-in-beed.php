...
$faq_list = [
    [
        'q' => 'How long does shipment transit take from Beed, Maharashtra, India to Destination city or null?',
    ...
    [
        'q' => 'How are relocation charges calculated for Bike Transportation in Beed | Safe Two-Wheeler Shifting Maharashtra?',
        'a' => 'Our moving estimates between Beed, Maharashtra, India and Destination city or null are calculated using transparent parameters: total consignment volume (cft), distance (~350 km), packaging material grade (7-layer corrugated and bubble sheets), dedicated enclosed container capacity, and insurance declaration. We provide 100% itemized, fixed-price quotations with zero moving-day surcharges.'
    ],
    [
    ...
    [
        'q' => 'How many days in advance should I confirm my booking for Bike Transportation in Beed | Safe Two-Wheeler Shifting Maharashtra?',
        'a' => 'For regional moves within Beed, Maharashtra, India, booking 2 to 3 days prior is recommended. For intercity transit to Destination city or null, we advise confirming 4 to 7 days ahead to reserve dedicated weatherproof container trucks and preferred morning departure slots.'
    ],
    [
        'q' => 'Do you offer temporary warehousing if my new residence in Destination city or null is not ready?',
    ...
    [
        ...
        'a' => 'Yes. Upon vehicle dispatch from Beed, Maharashtra, India, you receive a private GPS tracking portal link and automated WhatsApp transit checkpoints as our truck clears interstate toll plazas and border checkposts en route to Destination city or null.'
    ],
];
...
<section class="content-ui-section" style="padding: 55px 0; background: #070d1e; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
	...
	<h3>1. Self-attested RC photocopy
	
  
    01
    Protocol 01</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>The registration certificate (RC) is a vital document that proves ownership of your bike.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>To ensure its authenticity, it is advisable to obtain a self-attested copy of the RC.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 03</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>This copy should be kept safely as it will be required during the transportation process.</p>
  </div>
</div>
	<h3>2. Current PUC (Pollution Under Control)
	
		The PUC certificate confirms that your bike complies with emission and noise pollution standards.
		Make sure your PUC is valid and not expired, as it is a mandatory requirement for bike transportation.
		An expired PUC may lead to additional inspection charges and delay the transportation process.
	
	3. Valid Insurance Certificate
	
		Your bike&amp;#039;s insurance certificate is essential as it covers any damages or accidents during transportation.
		Make sure your insurance certificate is valid and covers the entire duration of the transportation process.
		It is recommended to obtain a copy of the insurance policy for reference.
	
	4. IBA-Approved Consignment Bill of Lading
	
		The IBA-approved consignment bill of lading serves as a contract between you and the transportation service provider.
		This document details the pickup and delivery addresses, bike details, and the agreed-upon terms and conditions for transportation.
		Make sure to thoroughly review the bill of lading to ensure accuracy and clarify any doubts before signing it.
	
	5. Declaration Form
	
		A declaration form is typically provided by the transportation service provider.
		This form is used to acknowledge the condition of your bike before transportation.
		Ensure you fill out the form accurately, detailing any existing damages or scratches on your bike.
	
	6. Vehicle Survey Report
	
		A vehicle survey report is required for bike transportation.
		This report is prepared by the transportation service provider and serves as a record of the bike&amp;#039;s initial condition.
		Ensure you receive and retain a copy of this report for future reference.
	
	7. Insurance Documents</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for 2. Current PUC (Pollution Under Control)
	...
	7. Insurance Documents ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
    ...
    <div style="background: #0f172a; border-radius: 12px; overflow: hidden; border: 1px solid rgba(245, 158, 11, 0.3); box-shadow: 0 10px 30px rgba(0,0,0,0.3);">
      <div style="padding: 16px 24px; background: rgba(245, 158, 11, 0.08); border-bottom: 1px solid rgba(245, 158, 11, 0.2); display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 10px;">
        <div style="color: #f59e0b; font-weight: 700; font-size: 1.05rem; display: flex; align-items: center; gap: 10px;">
          <span>📍</span> Verified Relocation Corridor &amp; GPS Hub: Beed, Maharashtra, India to Destination city or null Highway
        </div>
      ...
      <div style="width: 100%; height: 380px; position: relative;">
        <iframe width="100%" height="380" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?q=Beed%2C+Maharashtra%2C+India+to+Destination+city+or+null+Highway&t=&z=12&ie=UTF8&iwloc=&output=embed" loading="lazy" style="border:0; width:100%; height:100%; display:block;"></iframe>
      </div>
    </div>
  </div>
</section>
      ...
      <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px; border-bottom: 1px solid rgba(255,255,255,0.08); padding-bottom: 16px; margin-bottom: 20px;">
        <div>
          ...
          <h3 style="color: #ffffff; font-size: 1.25rem; font-weight: 700; margin-top: 8px; margin-bottom: 0;">
            Beed, Maharashtra, India to Destination city or null Interstate Logistics Corridor via NH-33, NH-43 &amp; NH-20 Expressway Network
          </h3>
        </div>
