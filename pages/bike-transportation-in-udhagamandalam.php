...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    ...
    01
    Protocol 01</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Capable of accommodating various bike sizes and models, these carriers are specifically designed for efficient transportation in Ooty.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>The enclosed structure protects bikes from external factors, ensuring their pristine condition upon delivery.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>The hydraulic system allows for smooth and controlled loading of bikes, minimizing the risk of damage during transportation.</p>
  </div>
</div>

	<h3>Individual Steel Wheel-Lock Chocks
	
		The steel wheel-lock chocks are used to secure each bike individually, ensuring maximum stability and safety.
		These chocks ensure that each wheel is firmly locked in place, preventing any accidental movement during transit.
		This meticulous approach guarantees minimal risk of damage or accidents during transportation.
	

	High-Tensile Ratchet Lashing
	
		High-tensile ratchet lashing is used to secure the entire bike, ensuring that no movement occurs during transit.
		The ratchet system ensures a tight and reliable bond between the bike and the carrier, preventing any accidental dislodgement.
		This advanced lashing technique guarantees the safe transit of bikes across Ooty and its surrounds.
	

	In addition to the aforementioned safety measures, bike transportation services in Ooty provide:

	Bike Parcel Service Near Shollinganallur
	
		For those seeking to transport their bikes without physically riding them, specialized bike parcel services are available.
		These services ensure secure transportation of bikes in Ooty, offering convenience and peace of mind.
		Consider using these services if you wish to avoid the hassles of riding your bike through Ooty&amp;#039;s challenging terrain.
	

	Two-Wheeler Transport
	
		Besides bike parcel services, dedicated two-wheeler transport is also available for those wishing to transport motorcycles or scooters.
		These services cater to a wider range of two-wheelers, providing secure transportation options throughout Ooty.
		Consider utilizing these services if you own a motorcycle or scooter and require hassle-free transportation.
	

	Interstate Bike Shipping</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Individual Steel Wheel-Lock Chocks
	...
	Interstate Bike Shipping ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    <div style="background: rgba(15, 23, 42, 0.65); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 16px; padding: 36px 32px; box-shadow: 0 12px 30px rgba(0,0,0,0.35);">
      ...
      <div style="font-size: 1.02rem; line-height: 1.8; color: #cbd5e1;">
	<h3>Introduction</h3>
	<p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>This document details the process of conducting a destination delivery handover for two-wheeler vehicles (motorcycles) and outlines the necessary steps to ensure a smooth and accurate handover.</p>
    ...
    01
    Protocol 01</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Upon arrival at the destination, inspect the two-wheeler/motorcycle again under daylight conditions.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Verify the overall condition of the vehicle, including appearance, scratches, dents, and any visible damages.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 03</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Check the functioning of lights, brakes, indicators, and other essential components.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #a855f722; color: #a855f7; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">04</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 04</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Document any new damages found during the re-inspection in detail (e.g., using a digital camera or smartphone)</p>
  </div>
</div>

	<h3>Step 2: Odometer Verification
	
		Compare the distance displayed on the vehicle&amp;#039;s odometer with the information provided in the Load Receipt (LR) bill of lading.
		If the distance differs significantly (e.g., more than 50km), consider conducting a thorough odometer check.
		To perform the odometer check, drive the vehicle for a short distance (e.g., around 5km) and confirm the distance displayed on the odometer matches the recorded values.


	Step 3: Signed Condition Sign-off
	
		Request the recipient or authorized person responsible to sign the LR bill of lading, confirming the vehicle&amp;#039;s condition and odometer reading.
		Ensure the signee has a clear understanding of the vehicle&amp;#039;s condition and any discrepancies found during the re-inspection.
		Include their signature and date on the LR bill of lading.


	Notes and Recommendations
	
		It is essential to perform the re-inspection and odometer verification during daylight hours for accurate assessment.
		In case of any discrepancies or doubts, consult with the recipient or the responsible party before signing the LR bill of lading.
		Upon completion of the inspection, provide the recipient or authorized person with a detailed report outlining the findings and any agreed-upon resolutions.
		Ensure both parties understand the importance of promptly reporting and addressing any issues found after the inspection.


	Record-Keeping and Documentation</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Step 2: Odometer Verification
	...
	Record-Keeping and Documentation ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
