...
<main class="site-main">
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            SALEM TO CHENNAI BIKE RELOCATION SPECIALISTS
          </span>
          <h1 style="font-size: 2.5rem; font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #ffffff;">
            Professional <span style="color: #f59e0b;">Bike Transport from Salem to Chennai</span>
          </h1>
          <p style="font-size: 1.1rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Transporting your two-wheeler from Salem to Chennai (~340 km via NH44/NH48) requires specialized closed-container carriers, 7-layer safety wrapping, and full transit insurance. Shree Ashirwad Packers and Movers delivers fast 18 to 36-hour door-to-door bike shipping with IBA-approved GST documentation.
          </p>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20a%20quote%20for%20Bike%20Transport%20from%20Salem%20to%20Chennai." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
          ...
          <div style="display: flex; gap: 20px; font-size: 0.9rem; color: #94a3b8; flex-wrap: wrap;">
            ...
            <span><strong style="color: #f59e0b;">18-36 Hrs</strong> Express Delivery</span>
          </div>
        </div>
        ...
        <div class="hero-form-card" style="background: rgba(255, 255, 255, 0.05); backdrop-filter: blur(10px); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
          ...
          <p style="font-size: 0.85rem; color: #94a3b8; text-align: center; margin-bottom: 20px;">Salem → Chennai Shifting Estimate in 2 Mins</p>
    ...
    <div class="container">
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; text-align: center;">
        ...
        <div style="padding: 15px; background: rgba(255,255,255,0.03); border-radius: 10px; border: 1px solid rgba(255,255,255,0.05);">
          ...
          <div style="font-size: 0.85rem; color: #94a3b8; margin-top: 5px;">Salem → Chennai Route</div>
        </div>
        <div style="padding: 15px; background: rgba(255,255,255,0.03); border-radius: 10px; border: 1px solid rgba(255,255,255,0.05);">
          <div style="font-size: 1.8rem; font-weight: 800; color: #f59e0b;">18 - 36 Hours</div>
  ...
  <section style="background: #0b132b; padding: 60px 0; color: #ffffff;">
    <div class="container">
      <div style="text-align: center; margin-bottom: 40px;">
        <h2 style="font-size: 2rem; font-weight: 800; color: #ffffff;">Why Choose Us for Salem to Chennai Bike Shipping?</h2>
        <p style="color: #94a3b8; margin-top: 10px;">End-to-end relocation protocols tailored for high-value two-wheelers on the NH44 corridor.</p>
      </div>
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 25px;">
        ...
        <div style="background: rgba(255,255,255,0.03); padding: 25px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.08);">
          ...
          <p style="font-size: 0.9rem; color: #94a3b8; line-height: 1.6;">Direct doorstep pickup across Hasthampatti, Fairlands, Suramangalam, Ammapet, and delivery across Chennai.</p>
        </div>
        <div style="background: rgba(255,255,255,0.03); padding: 25px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.08);">
        ...
        <div style="background: rgba(255,255,255,0.03); padding: 25px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.08);">
          ...
          <p style="font-size: 0.9rem; color: #94a3b8; line-height: 1.6;">Structured daily departures ensuring your bike reaches Chennai within the committed 18 to 36-hour window.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section style="background: #0f172a; padding: 60px 0; color: #ffffff;">
    <div class="container">
      <div style="text-align: center; margin-bottom: 40px;">
        <h2 style="font-size: 2rem; font-weight: 800; color: #ffffff;">Salem to Chennai Bike Transport Charges</h2>
        ...
        <table style="width: 100%; border-collapse: collapse; background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.08); text-align: left; font-size: 0.95rem;">
          ...
          <tbody style="color: #cbd5e1;">
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
              ...
              <td style="padding: 15px; color: #f59e0b; font-weight: 700;">₹2,500 - ₹3,300</td>
              <td style="padding: 15px;">₹3,600 - ₹4,300</td>
              <td style="padding: 15px;">18 - 24 Hours</td>
            </tr>
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
              <td style="padding: 15px;">Commuter Motorcycles</td>
              <td style="padding: 15px;">125cc - 180cc</td>
              <td style="padding: 15px; color: #f59e0b; font-weight: 700;">₹2,900 - ₹3,900</td>
              <td style="padding: 15px;">₹4,100 - ₹4,900</td>
              <td style="padding: 15px;">18 - 24 Hours</td>
            </tr>
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
              <td style="padding: 15px;">Sports / Cruiser Bikes</td>
              <td style="padding: 15px;">200cc - 500cc</td>
              <td style="padding: 15px; color: #f59e0b; font-weight: 700;">₹3,600 - ₹4,900</td>
              <td style="padding: 15px;">₹5,000 - ₹6,200</td>
              <td style="padding: 15px;">24 - 36 Hours</td>
            </tr>
            <tr>
              <td style="padding: 15px;">Superbikes / Premium Cruisers</td>
              <td style="padding: 15px;">500cc+</td>
              <td style="padding: 15px; color: #f59e0b; font-weight: 700;">₹5,600 - ₹8,200</td>
              <td style="padding: 15px;">₹7,600 - ₹10,200</td>
              <td style="padding: 15px;">24 - 36 Hours</td>
            </tr>
          </tbody>
        </table>
  ...
  <section style="background: #0f172a; padding: 60px 0; color: #ffffff;">
    <div class="container">
      <div style="text-align: center; margin-bottom: 40px;">
        <h2 style="font-size: 1.8rem; font-weight: 800; color: #ffffff;">Salem Pickup Hubs</h2>
        <p style="color: #94a3b8; margin-top: 8px;">Free door pickup across major regions in Salem.</p>
      </div>
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 15px;">
        <div style="background: rgba(255,255,255,0.03); padding: 15px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); text-align: center; color: #cbd5e1;">Hasthampatti & Fairlands</div>
        <div style="background: rgba(255,255,255,0.03); padding: 15px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); text-align: center; color: #cbd5e1;">Suramangalam & Salem Junction</div>
        <div style="background: rgba(255,255,255,0.03); padding: 15px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); text-align: center; color: #cbd5e1;">Ammapet & Shevapet</div>
        <div style="background: rgba(255,255,255,0.03); padding: 15px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); text-align: center; color: #cbd5e1;">Meyyanur & Five Roads</div>
        <div style="background: rgba(255,255,255,0.03); padding: 15px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); text-align: center; color: #cbd5e1;">Kondalampatti & Seelanaickenpatti</div>
        <div style="background: rgba(255,255,255,0.03); padding: 15px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); text-align: center; color: #cbd5e1;">Steel Plant Road & Gorimedu</div>
      </div>
    </div>
  </section>
  ...
  <section style="background: #0b132b; padding: 60px 0; color: #ffffff;">
    <div class="container">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 15px;">
        ...
        <a href="<?php echo SITE_URL; ?>/pages/bike-transport-from-tirunelveli-to-chennai.php" style="display: block; padding: 15px; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 8px; color: #f59e0b; text-decoration: none; text-align: center;">Tirunelveli → Chennai</a>
        <a href="<?php echo SITE_URL; ?>/pages/bike-transport-from-chennai-to-trichy.php" style="display: block; padding: 15px; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 8px; color: #f59e0b; text-decoration: none; text-align: center;">Chennai → Trichy</a>
  ...
  <section style="background: #0b132b; padding: 60px 0; color: #ffffff;">
    <div class="container">
      <div style="text-align: center; margin-bottom: 40px;">
        ...
        <p style="color: #94a3b8; margin-top: 10px;">Everything you need to know about bike transport from Salem to Chennai.</p>
      </div>
      ...
      <div style="max-width: 800px; margin: 0 auto; display: grid; gap: 15px;">
        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; padding: 20px;">
          <h3 style="font-size: 1.1rem; color: #f59e0b; margin-bottom: 10px;">How long does bike transport from Salem to Chennai take?</h3>
          <p style="font-size: 0.92rem; color: #cbd5e1; line-height: 1.6;">Transit typically takes 18 to 36 hours via covered container trucks on the NH44/NH48 corridor.</p>
        </div>

        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; padding: 20px;">
          <h3 style="font-size: 1.1rem; color: #f59e0b; margin-bottom: 10px;">What documents are required for bike transport from Salem?</h3>
        ...
        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; padding: 20px;">
          <h3 style="font-size: 1.1rem; color: #f59e0b; margin-bottom: 10px;">Is doorstep pickup available in Salem?</h3>
          <p style="font-size: 0.92rem; color: #cbd5e1; line-height: 1.6;">Yes, we offer doorstep bike pickup from all locations in Salem including Hasthampatti, Fairlands, Suramangalam, Ammapet, and Five Roads.</p>
        </div>
        ...
        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; padding: 20px;">
          <h3 style="font-size: 1.1rem; color: #f59e0b; margin-bottom: 10px;">What are the charges for bike shifting from Salem to Chennai?</h3>
          <p style="font-size: 0.92rem; color: #cbd5e1; line-height: 1.6;">Charges range between ₹2,500 and ₹8,200 depending on bike CC, weight, and standard or wooden crate packaging.</p>
        </div>

        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; padding: 20px;">
          <h3 style="font-size: 1.1rem; color: #f59e0b; margin-bottom: 10px;">Do you deliver to all areas in Chennai?</h3>
          <p style="font-size: 0.92rem; color: #cbd5e1; line-height: 1.6;">Yes, doorstep delivery is available across Anna Nagar, Adyar, Velachery, OMR IT Hub, Porur, Tambaram, and T. Nagar.</p>
        </div>

        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; padding: 20px;">
          <h3 style="font-size: 1.1rem; color: #f59e0b; margin-bottom: 10px;">How is my motorcycle secured during transit?</h3>
          <p style="color: #cbd5e1; font-size: 0.92rem; line-height: 1.6;">Your motorcycle is packed in multi-layer bubble wrap and locked into covered containers using heavy-duty nylon ratchet tie-down straps.</p>
        </div>

        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; padding: 20px;">
          <h3 style="font-size: 1.1rem; color: #f59e0b; margin-bottom: 10px;">Are GST invoices provided for company relocation claims?</h3>
          <p style="color: #cbd5e1; font-size: 0.92rem; line-height: 1.6;">Yes, we issue 18% GST tax invoices along with official Lorry Receipt (LR) copies accepted by employer HR teams.</p>
        </div>

        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; padding: 20px;">
          <h3 style="font-size: 1.1rem; color: #f59e0b; margin-bottom: 10px;">Should fuel be emptied before handing over the vehicle?</h3>
          <p style="color: #cbd5e1; font-size: 0.92rem; line-height: 1.6;">Yes, keep less than 1 liter of fuel in the bike tank to ensure container safety regulations during transit.</p>
        </div>

        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; padding: 20px;">
          <h3 style="font-size: 1.1rem; color: #f59e0b; margin-bottom: 10px;">Is wooden crate packaging available for premium cruisers?</h3>
          <p style="color: #cbd5e1; font-size: 0.92rem; line-height: 1.6;">Yes, customized wooden crate packaging is available for Royal Enfield, Jawa, Triumph, and premium sports bikes.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section style="background: linear-gradient(135deg, #1c2541 0%, #0b132b 100%); padding: 60px 0; text-align: center; color: #ffffff; border-top: 1px solid rgba(245, 158, 11, 0.3);">
    <div class="container">
      <h2 style="font-size: 2.2rem; font-weight: 800; margin-bottom: 15px;">Book Your Bike Transport from Salem to Chennai Today</h2>
      ...
      <div style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20to%20book%20Bike%20Transport%20from%20Salem%20to%20Chennai." target="_blank" title="WhatsApp Us" style="padding: 15px 35px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #fff; border-radius: 50px; font-weight: 700; text-decoration: none; font-size: 1.05rem; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How long does bike transport from Salem to Chennai take?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Transit typically takes 18 to 36 hours via covered container trucks on the NH44/NH48 corridor."
      }
    },
    {
      "@type": "Question",
      "name": "What documents are required for bike transport from Salem?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is doorstep pickup available in Salem?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, we offer doorstep bike pickup from all locations in Salem including Hasthampatti, Fairlands, Suramangalam, Ammapet, and Five Roads."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "What are the charges for bike shifting from Salem to Chennai?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Charges range between ₹2,500 and ₹8,200 depending on bike CC, weight, and standard or wooden crate packaging."
      }
    },
    {
      "@type": "Question",
      "name": "Do you deliver to all areas in Chennai?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, doorstep delivery is available across Anna Nagar, Adyar, Velachery, OMR IT Hub, Porur, Tambaram, and T. Nagar."
      }
    },
    {
      "@type": "Question",
      "name": "How is my motorcycle secured during transit?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Your motorcycle is packed in multi-layer bubble wrap and locked into covered containers using heavy-duty nylon ratchet tie-down straps."
      }
    },
    {
      "@type": "Question",
      "name": "Are GST invoices provided for company relocation claims?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, we issue 18% GST tax invoices along with official Lorry Receipt (LR) copies accepted by employer HR teams."
      }
    },
    {
      "@type": "Question",
      "name": "Should fuel be emptied before handing over the vehicle?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, keep less than 1 liter of fuel in the bike tank to ensure container safety regulations during transit."
      }
    },
    {
      "@type": "Question",
      "name": "Is wooden crate packaging available for premium cruisers?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, customized wooden crate packaging is available for Royal Enfield, Jawa, Triumph, and premium sports bikes."
      }
    }
  ]
}
