...
<main class="site-main">
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            AHMEDABAD TO AJMER BIKE RELOCATION
          </span>
          <h1 style="font-size: 2.5rem; font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #ffffff;">
            Bike Transport from <span style="color: #f59e0b;">Ahmedabad to Ajmer</span>
          </h1>
          <p style="font-size: 1.1rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Planning bike transport from Ahmedabad to Ajmer? Get safe, insured, and doorstep motorcycle shipping services with 7-layer foam wrapping and fast delivery.
          </p>
          ...
          <div style="display: flex; gap: 20px; font-size: 0.9rem; color: #94a3b8;">
            ...
            <span><strong style="color: #f59e0b;">2-4 Days</strong> Express Transit</span>
          </div>
        </div>

        <!-- Hero Lead Form Column -->
        <div class="hero-form-card" style="background: rgba(255, 255, 255, 0.05); backdrop-filter: blur(10px); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
          <h2 style="font-size: 1.4rem; color: #ffffff; margin-bottom: 8px; font-weight: 700; text-align: center;">Get Ahmedabad to Ajmer Quote</h2>
  ...
  <section style="background: #070d1e; padding: 30px 0; border-bottom: 1px solid rgba(255,255,255,0.08);">
    <div class="container">
      <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px; text-align: center;">
        ...
        <div style="background: rgba(255,255,255,0.03); padding: 20px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
          <h3 style="color: #f59e0b; font-size: 1.8rem; font-weight: 800; margin: 0;">2 - 4 Days</h3>
          <p style="color: #94a3b8; font-size: 0.85rem; margin-top: 5px;">Fast Transit Time</p>
        </div>
        <div style="background: rgba(255,255,255,0.03); padding: 20px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
        ...
        <div style="background: rgba(255,255,255,0.03); padding: 20px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
          ...
          <p style="color: #94a3b8; font-size: 0.85rem; margin-top: 5px;">User Rating</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section style="padding: 70px 0; background: #0b132b; color: #ffffff;">
    <div class="container">
      <div style="text-align: center; margin-bottom: 45px;">
        <span style="color: #f59e0b; font-weight: 700; text-transform: uppercase; font-size: 0.85rem; letter-spacing: 1px;">Service Highlights</span>
        <h2 style="font-size: 2.2rem; font-weight: 800; margin-top: 8px;">Why Choose Us for <span style="color: #f59e0b;">Ahmedabad to Ajmer Bike Shipping</span></h2>
      </div>
      <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 25px;">
        <div style="background: #172a54; padding: 25px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.25);">
          ...
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.6;">Bubble wrap, foam sheets, and stretch film protect bodywork from scratches and dust.</p>
        </div>
        <div style="background: #172a54; padding: 25px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.25);">
          <h3 style="color: #f59e0b; font-size: 1.2rem; font-weight: 700; margin-bottom: 10px;"><i class="fas fa-truck-moving" style="margin-right: 8px;"></i> Covered Vehicle Carrier</h3>
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.6;">Enclosed transport container protects your bike from weather elements and road debris.</p>
        </div>
        <div style="background: #172a54; padding: 25px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.25);">
          <h3 style="color: #f59e0b; font-size: 1.2rem; font-weight: 700; margin-bottom: 10px;"><i class="fas fa-home" style="margin-right: 8px;"></i> Doorstep Pickup in Ahmedabad</h3>
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.6;">Doorstep pickup across Satellite, Bodakdev, SG Highway, Maninagar, Chandkheda, and Bopal.</p>
        </div>
        <div style="background: #172a54; padding: 25px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.25);">
          ...
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.6;">Complete transit risk coverage based on declared vehicle value.</p>
        </div>
        <div style="background: #172a54; padding: 25px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.25);">
          <h3 style="color: #f59e0b; font-size: 1.2rem; font-weight: 700; margin-bottom: 10px;"><i class="fas fa-clock" style="margin-right: 8px;"></i> Express 2-4 Day Delivery</h3>
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.6;">Direct highway routing ensures fast and timely delivery to your doorstep in Ajmer.</p>
        </div>
        <div style="background: #172a54; padding: 25px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.25);">
          ...
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.6;">All-inclusive price quotes with zero hidden charges or extra tolls.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section style="padding: 60px 0; background: #070d1e; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      <div style="text-align: center; margin-bottom: 35px;">
        <span style="color: #f59e0b; font-weight: 700; text-transform: uppercase; font-size: 0.85rem;">Tariff Matrix</span>
        <h2 style="font-size: 2rem; font-weight: 800; margin-top: 8px;">Ahmedabad to Ajmer Bike Shipping Rates</h2>
      </div>
        ...
        <table style="width: 100%; border-collapse: collapse; text-align: left; color: #cbd5e1;">
          ...
          <tbody>
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.08);">
              ...
              <td style="padding: 14px 18px;">2 - 4 Days</td>
            </tr>
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.08);">
            ...
            <tr>
              ...
              <td style="padding: 14px 18px;">~550 km</td>
              <td style="padding: 14px 18px; color: #f59e0b; font-weight: 700;">₹6,500 - ₹9,500</td>
              <td style="padding: 14px 18px;">2 - 4 Days</td>
            </tr>
          </tbody>
        </table>
  ...
  <section style="padding: 70px 0; background: #0b132b; color: #ffffff;">
    <div class="container" style="max-width: 950px;">
      <div style="text-align: center; margin-bottom: 40px;">
        <span style="color: #f59e0b; font-weight: 700; text-transform: uppercase; font-size: 0.85rem;">Safety Standards</span>
  ...
  <section style="padding: 60px 0; background: #070d1e; color: #ffffff;">
    <div class="container" style="max-width: 900px; text-align: center;">
      ...
      <h2 style="font-size: 2rem; font-weight: 800; margin-top: 8px; margin-bottom: 25px;">Ahmedabad Pickup &amp; Ajmer Delivery Areas</h2>
      <p style="color: #cbd5e1; font-size: 1rem; line-height: 1.8;">
        Pickup available in Ahmedabad (Navrangpura, SG Highway, Satellite, Bodakdev, Maninagar, Vastrapur, Chandkheda, Bopal) with direct doorstep drop in Ajmer (Vaishali Nagar, Panchsheel Nagar, Civil Lines, Makhupura, and Madar).
      </p>
    </div>
  </section>
    ...
    <div class="container" style="max-width: 900px;">
      <div class="text-center" style="margin-bottom: 45px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin-top: 10px;">
          Frequently Asked Questions About <span style="color: #f59e0b;">Ahmedabad to Ajmer Bike Transport</span>
        </h2>
      </div>
  ...
  <section style="padding: 60px 0; background: linear-gradient(135deg, #172a54 0%, #0b132b 100%); border-top: 1.5px solid rgba(245, 158, 11, 0.4); color: #ffffff;">
    <div class="container" style="max-width: 900px; text-align: center;">
      <h2 style="font-size: 2.2rem; font-weight: 800; margin-bottom: 15px;">
        Book Bike Transport from Ahmedabad to Ajmer
      </h2>
