    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For a seamless household shifting and relocation experience from Chandigarh to our Destination Hub, we recommend the following freight highway route: NH 44 East via NH 205 to NH 52, followed by NH 205B to NH 205C. This route passes through the interstate border checkpost at Attari-Wagah Border, which is known for its stringent customs and immigration checks. To expedite the clearance process, we suggest using automated e-Way bill clearance services, which can be initiated through our dedicated portal.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">To ensure damage-free transit protection, our packing and loading services are tailored to accommodate household items and vehicles on this corridor. We employ a multi-axle, speed-governed container transit, which enables us to maintain a consistent speed of 80-100 km/h, thereby reducing transit duration to 2 to 3 working days. Our team of expert packers and handlers will carefully pack and load your belongings, including fragile items and vehicles, onto the transit vehicle, ensuring a secure and damage-free journey. Additionally, we provide real-time tracking and updates to ensure you remain informed about the transit progress. By choosing our services, you can trust that your household items or vehicle will be transported safely and efficiently to our Destination Hub.</p>
        </div>
      </div>
    </div>
  </section>
