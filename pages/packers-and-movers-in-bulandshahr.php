    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For a reliable and efficient relocation from Bulandshahr to any destination hub, our team at Shree Ashirwad Packers and Movers advises adhering to the precise freight highway route. Our experts will navigate the ~850 km journey via National Highway Arterial Corridors and Multi-Axle Express Freight Highways. The recommended route involves taking NH 10, then merging onto NH 2, and finally connecting to NH 12 to reach the destination hub. Before embarking on the journey, it&#039;s crucial to clear interstate border checkposts and obtain automated e-Way bill clearance for seamless transit.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">To ensure damage-free transit protection, our specialized packing and loading services cater specifically to household items or vehicles. We utilize sturdy, customized packing materials and ergonomic loading techniques to prevent shifting and damage during transit. For households, we utilize specialized packing techniques, including furniture disassembly and custom wrapping, to safeguard valuable items. For vehicles, our team applies a specialized protective coating to prevent rust and corrosion. Throughout the transit, our experienced drivers ensure speed-governed container transit, guaranteeing timely delivery while maintaining the safety and security of your belongings.</p>
        </div>
      </div>
    </div>
  </section>
