...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  ...
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Double-check the connection of the battery terminals to prevent any electrical issues during transit. Ensure the battery is properly secured and covered to avoid any accidental spillage.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Fill your two-wheeler or motorcycle with just one-quarter of its tank capacity. This prevents the vehicle from weighing too much, minimizing the risk of accidents due to stability issues.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #a855f722; color: #a855f7; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">04</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">FASTag Management:</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Ensure the FASTag (Fastag) for toll payment is properly installed and functional before loading the vehicle onto the transportation vehicles. This ensures a smooth and hassle-free journey.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #ec489922; color: #ec4899; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">05</div>
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Partner with a trusted and experienced packers and movers company to ensure quality services and expertise in handling two-wheelers and motorcycles.</p>
  </div>
</div>

	<p>In case you are planning to ship your two-wheeler or motorcycle via the Indian Railways, here's how the process works:</p>

	<h3>Shipping Two-Wheelers via Railways
	
		Bike Parcel Services: Take advantage of dedicated bike parcel services offered by top packers and movers to ensure smooth handling and transportation.
		Selection of Suitable Vehicle: Choose a suitable vehicle for transportation according to the weight and size of your two-wheeler or motorcycle. This ensures safe and efficient loading and unloading.
		Preparation of Vehicle: Clean your two-wheeler or motorcycle thoroughly, removing any personal belongings or excess weight that could cause instability during transit.
		Proper Packaging: The vehicle should be properly packed to avoid any damage during transportation. You can opt for customized packaging solutions offered by reputable packers and movers.
	

	Additional Services</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Shipping Two-Wheelers via Railways
