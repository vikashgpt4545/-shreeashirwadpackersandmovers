...
<section class="content-ui-section" style="padding: 55px 0; background: #070d1e; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    ...
    01
    Protocol 01</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Original Registration Certificate (RC) of the vehicle</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Photocopy of the RC that needs to be self-attested by the vehicle owner</p>
  </div>
</div>
	...
	<h3>2. Current PUC
		...
		Current PUC is mandatory to ensure that the vehicle meets emission and safety standards.
	
	The PUC certificate confirms that the vehicle is fit for the road and adheres to local environmental regulations. It is crucial to provide a valid PUC before the car can be transported.
	3. Valid Insurance Certificate
	
		Insurance certificate covering the vehicle
		The insurance certificate should be valid, ensuring financial protection in case of any accident or damage during transportation.
	
	Having a valid insurance certificate is essential to safeguard both the vehicle and the transportation company. Make sure the insurance covers the vehicle during transportation and covers any potential damages.
	4. IBA-Approved Consignment Bill of Lading
	
		A bill of lading issued by the transportation company
		The bill of lading must be IBA (Indian Bureau of Road Transport) approved, ensuring compliance with regulations and standards.
	
	An IBA-approved consignment bill of lading is an important document that details the transportation agreement between the vehicle owner and the transportation company. This ensures that all parties are aware of the terms and conditions of the car transportation.
	5. 100% Declared-Value Marine Transit Insurance
	
		100% declared-value insurance coverage provided by a reputable insurance company
		A marine transit insurance ensures that the vehicle is fully protected against any potential damages or losses during transportation, especially during sea or road transit.
	
	A marine transit insurance is crucial to ensure that your vehicle is fully covered during the transportation process. Ensure that the insurance company provides a 100% declared-value coverage, which covers the entire value of your vehicle.
	6. Vehicle Survey Report</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for 2. Current PUC
	...
	A marine transit insurance is crucial to ensure that your vehicle is fully covered during the transportation process. Ensure that the insurance company provides a 100% declared-value coverage, which covers the entire value of your vehicle.
	6. Vehicle Survey Report ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
