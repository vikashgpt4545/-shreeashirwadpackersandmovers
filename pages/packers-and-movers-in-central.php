    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For relocation services from Central (City Centre, Railway Station Road, Industrial Area) to Destination Hub (City Centre, Railway Station Road, Industrial Area), Shree Ashirwad Packers and Movers recommends utilizing the National Highway Arterial Corridors &amp; Multi-Axle Express Freight Highways. This route spans approximately 850 km, with the primary checkpost at the Delhi-Gurgaon border. To ensure seamless transit, our logistics team will assist with automated e-Way bill clearance, minimizing the risk of delays or penalties. With speed-governed container transit, our services guarantee a safe and efficient journey.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">To safeguard your household items or vehicles, our specialized packing and loading services will ensure damage-free transit. For household shifting, we employ eco-friendly packing materials, carefully selected to protect your belongings during transit. For vehicles, our expert technicians will perform thorough pre-trip inspections before loading, ensuring a smooth and secure journey. Throughout the transit, our dedicated team will monitor the progress, providing you with real-time updates and ensuring your belongings arrive safely at the destination. With Shree Ashirwad Packers and Movers, you can trust that your relocation needs will be handled with the utmost care and attention to detail.</p>
        </div>
      </div>
    </div>
  </section>
