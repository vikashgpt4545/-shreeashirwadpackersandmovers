...
$faq_list = [
    [
        'q' => 'How are relocation charges calculated for Bike Transportation in Niwai | Secure Two-Wheeler Shifting Rajasthan?',
  ...
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    <div style="background: rgba(15, 23, 42, 0.65); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 16px; padding: 36px 32px; box-shadow: 0 12px 30px rgba(0,0,0,0.35);">
      ...
      <div style="font-size: 1.02rem; line-height: 1.8; color: #cbd5e1;">
        <p>This document outlines the procedures for delivering two‑wheelers at the destination in Niwai. The handover process includes a daylight re‑inspection, odometer verification, and a signed condition sign‑off.</p>
        ...
        <ul style="list-style: none; padding-left: 0; margin: 18px 0;">
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            ...
            <span>Upon arrival, inspect the two‑wheeler thoroughly under daylight.</span>
          </li>
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>Assess exterior, body panels, and any attached accessories.</span>
          </li>
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>Check for scratches, dents, or missing parts against the pickup photos.</span>
          </li>
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>Confirm the vehicle colour matches the documented images.</span>
          </li>
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>Inspect tires for tread depth, wear patterns, and visible damage.</span>
          </li>
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>Test brakes, lights, indicators, horn, and other essential components.</span>
          </li>
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>Ensure mirrors, seat, and all accessories are securely fitted and functional.</span>
          </li>
        </ul>
        ...
        <ul style="list-style: none; padding-left: 0; margin: 18px 0;">
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>Compare the displayed odometer reading with the figure on the Loader Responsibility (LR) Bill of Lading.</span>
          </li>
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>Verify that the mileage recorded matches the journey distance logged by the transporter.</span>
          </li>
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>If any discrepancy appears, immediately contact the transporter for clarification and updated documentation.</span>
          </li>
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>Confirm the odometer reading is accurate before signing the delivery note.</span>
          </li>
        </ul>
        ...
        <ul style="list-style: none; padding-left: 0; margin: 18px 0;">
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>Require the customer or authorized signatory to inspect the vehicle and confirm its condition.</span>
          </li>
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>Have the signatory sign the delivery note or any other provided documentation.</span>
          </li>
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>Document any damages or discrepancies noted during the inspection.</span>
          </li>
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>Ask the signatory to verify the odometer reading matches the recorded journey distance.</span>
          </li>
          <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
            <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
            <span>Collect a signed copy for both the customer and the transporter to maintain a clear record.</span>
          </li>
        </ul>

        <p>Conducting a thorough inspection and verification process ensures a smooth transition of the vehicle from the transporter to the recipient, fostering trust, transparency, and protection for both parties.</p>

        <h3 style="color: #ffffff; margin-top: 24px;">Importance of Daylight Inspection</h3>
        <p>Daylight provides natural illumination that reveals scratches, dents, and subtle paint variations more accurately than artificial lighting, reducing the risk of undiscovered damage.</p>

        <h3 style="color: #ffffff; margin-top: 24px;">Significance of Odometer Verification</h3>
        <p>Accurate odometer verification safeguards against mileage disputes, ensures the vehicle’s resale value is protected, and confirms that the bike has not been subjected to unauthorized travel.</p>
      </div>
    </div>
  </div>
</section>
