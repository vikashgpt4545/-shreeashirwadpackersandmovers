...
$page_desc = "Top-rated packers and movers in Kankarbagh, Patna. Verified local household shifting, office relocation, bike & car transportation with 100% IBA-approved GST billing.";
$page_keywords = "packers and movers in kankarbagh patna, best packers and movers kankarbagh, movers and packers kankarbagh patna, local shifting kankarbagh, house shifting services kankarbagh";
$canonical_url = "https://shreeashirwadpackersandmovers.com/pages/packers-and-movers-in-kankarbagh-patna.php";

$page_city = "Kankarbagh, Patna, Bihar";

$faq_list = [
    [
        'q' => 'How are local house shifting services charged in Kankarbagh, Patna?',
        'a' => 'Local shifting within Kankarbagh and nearby areas like Old Bypass, Hanuman Nagar, or Rajendra Nagar ranges from ₹2,500–₹5,500 for 1BHK/2BHK apartments, and ₹6,500–₹12,500 for 3BHK/independent houses including packing, loading, transport, and unloading.'
    ],
    [
    ...
    [
        ...
        'a' => 'Our experienced moving crew uses manual shoulder straps, stair-climbing gear, and compact pickup vehicles (Tata Ace / Pickup 1.7T) designed for narrow residential lanes and multi-story walk-up apartments.'
    ],
    [
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #e2e8f0; line-height: 1.8;">
    <div class="container" style="max-width: 1000px;">
      ...
      <span class="section-tag" style="color: #f59e0b; text-transform: uppercase; font-weight: 700; font-size: 0.85rem; letter-spacing: 1px;">
        KANKARBAGH NEIGHBORHOOD LOGISTICS
      </span>
      <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">
        Doorstep House & Office Relocation in <span style="color: #f59e0b;">Kankarbagh, Patna</span>
      </h2>
      
      <p style="font-size: 1.05rem; color: #cbd5e1; margin-bottom: 25px;">
        As one of Asia's largest residential colonies, Kankarbagh presents unique moving requirements spanning multi-story apartment complexes and bustling commercial hubs. Shree Ashirwad Packers and Movers deploys trained packing crews and specialized transport fleets across PC Colony, Housing Board Colony, Doctor's Colony, Chiraiyatand, Ashok Nagar, and Kanti Factory Road.
      </p>

      <!-- Rate Matrix Table -->
      <div style="overflow-x: auto; margin: 40px 0;">
        <h3 style="font-size: 1.5rem; color: #ffffff; font-weight: 700; margin-bottom: 15px;">
          Estimated Relocation Rates for Kankarbagh, Patna
        </h3>
        <table style="width: 100%; border-collapse: collapse; background: #172a54; border-radius: 10px; overflow: hidden; border: 1px solid rgba(245, 158, 11, 0.3);">
          <thead>
            <tr style="background: #1e3a8a; color: #f59e0b; text-align: left;">
              ...
              <th style="padding: 14px 16px;">Local Within Patna (Kankarbagh)</th>
...
<script type="application/ld+json">
{
  ...
  "description": "Top-rated packers and movers in Kankarbagh, Patna with doorstep pickup and transit insurance.",
