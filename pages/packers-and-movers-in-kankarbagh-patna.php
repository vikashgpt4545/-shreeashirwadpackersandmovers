...
$page_title = "Packers and Movers in Kankarbagh Patna | Safe Local Household Shifting";
$page_desc = "Top-rated packers and movers in Kankarbagh Patna. Shree Ashirwad Packers offers verified local household shifting, office relocation, and bike/car transport with 100% IBA-approved GST billing.";
$page_keywords = "packers and movers in kankarbagh patna, best packers and movers in kankarbagh patna, house shifting kankarbagh patna, room moving kankarbagh patna, local shifting kankarbagh patna, shree ashirwad packers kankarbagh";
$canonical_url = "https://shreeashirwadpackersandmovers.com/pages/packers-and-movers-in-kankarbagh-patna.php";

$faq_list = [
  [
    "q" => "How are local house shifting services charged in Kankarbagh Patna?",
    "a" => "Local shifting within Kankarbagh and nearby areas like Old Bypass, Hanuman Nagar, or Rajendra Nagar ranges from Rs 3,500 for 1 BHK, Rs 6,500 - 10,500 for 2 BHK, and Rs 10,500 - 16,000 for 3 BHK independent houses."
  ],
  [
    "q" => "Which areas in Kankarbagh do you cover for doorstep packing & pickup?",
    "a" => "We cover all blocks and sub-localities in Kankarbagh including Housing Board Colony, PC Colony, Doctor's Colony, Chiraiyatand, Ashok Nagar, Hanuman Nagar, Kanti Factory Road, and Old Bypass Road."
  ],
  [
    "q" => "What packing materials are used for household items during local Kankarbagh shifting?",
  ...
  [
    "q" => "Can you handle same-day urgent house shifting within Kankarbagh?",
  ...
  [
    "q" => "How do you handle narrow lanes or apartment building shifting without elevators in Kankarbagh?",
    "a" => "Our experienced moving crew uses manual shoulder straps, stair-climbing gear, and compact pickup vehicles (Tata Ace / Bolero Pickup) designed for narrow residential lanes."
  ],
  [
    "q" => "Is vehicle transportation (bike/car) available alongside household shifting from Kankarbagh?",
    "a" => "Yes, we provide integrated vehicle shipping using specialized enclosed car carriers and two-wheeler hydraulic ramps for moves from Kankarbagh to anywhere in India."
  ],
  [
  ...
  [
    "q" => "How can I book Packers and Movers in Kankarbagh Patna?",
...
<main class="site-main">
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            PACKERS AND MOVERS KANKARBAGH PATNA
          </span>
          <h1 style="font-size: 2.7rem; font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #ffffff;">
            Reliable <span style="color: #f59e0b;">Packers and Movers in Kankarbagh Patna</span>
          </h1>
          <p style="font-size: 1.12rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Shree Ashirwad Packers and Movers provides top-rated household shifting, office relocation, and vehicle transport across Kankarbagh, Patna. Serving Housing Board Colony, PC Colony, Doctor's Colony, Chiraiyatand, Ashok Nagar, and Old Bypass with 100% IBA-compliant GST billing.
          </p>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20a%20shifting%20quote%20for%20Kankarbagh%20Patna." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
        ...
        <div class="hero-form-card" style="background: rgba(255, 255, 255, 0.05); backdrop-filter: blur(10px); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
          <h2 style="font-size: 1.4rem; color: #ffffff; margin-bottom: 8px; font-weight: 700; text-align: center;">Get Kankarbagh Quote</h2>
  ...
  <section style="padding: 60px 0; background: #ffffff;">
    <div class="container">
      <div style="text-align: center; margin-bottom: 40px;">
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #0f172a;">Kankarbagh Patna Shifting Price Matrix</h2>
        <p style="color: #64748b;">Transparent estimates for local home and office relocation in Kankarbagh Patna</p>
      </div>
  ...
  <section style="padding: 60px 0; background: #f8fafc;">
    <div class="container">
      <div style="text-align: center; margin-bottom: 40px;">
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #0f172a;">Why Choose Shree Ashirwad in Kankarbagh Patna</h2>
      ...
      <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 25px;">
        ...
        <div style="background: #ffffff; padding: 25px; border-radius: 12px; border: 1px solid #e2e8f0; box-shadow: 0 4px 6px rgba(0,0,0,0.03);">
          ...
          <p style="color: #64748b; font-size: 0.95rem; line-height: 1.6;">Compact pickup trucks safely navigate crowded Kankarbagh colonies to transfer goods to main highway carriers.</p>
        </div>
        ...
        <div style="background: #ffffff; padding: 25px; border-radius: 12px; border: 1px solid #e2e8f0; box-shadow: 0 4px 6px rgba(0,0,0,0.03);">
          ...
          <p style="color: #64748b; font-size: 0.95rem; line-height: 1.6;">Punctual pickup and prompt delivery across Kankarbagh Patna with zero unnecessary delays.</p>
        </div>
  ...
  <section style="padding: 60px 0; background: #ffffff;">
    <div class="container">
      <div style="text-align: center; margin-bottom: 40px;">
        ...
        <p style="color: #64748b;">Common queries regarding packers and movers services in Kankarbagh Patna</p>
      </div>
  ...
  <section style="background: linear-gradient(135deg, #0b132b 0%, #1c2541 100%); padding: 50px 0; color: #ffffff; text-align: center;">
    <div class="container">
      <h2 style="font-size: 2.2rem; font-weight: 800; margin-bottom: 15px;">Ready for a Seamless Move in Kankarbagh Patna?</h2>
      ...
      <div style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20need%20moving%20help%20in%20Kankarbagh%20Patna." target="_blank" style="padding: 14px 32px; background: #10b981; color: #ffffff; border-radius: 50px; font-weight: 700; text-decoration: none;">
...
<script type="application/ld+json">
{
  ...
  "@type": "MovingCompany",
  "name": "Shree Ashirwad Packers and Movers Kankarbagh Patna",
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers,\n\nI would like a Shifting Quote for Kankarbagh Patna:\n- Name: " + name + "\n- Phone: " + phone + "\n- Moving From: " + moveFrom + "\n- Moving To: " + moveTo;
