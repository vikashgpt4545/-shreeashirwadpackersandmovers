...
$faq_list = [
    [
        'q' => 'How are relocation charges calculated for Bike Transportation in Nellore | Secure Two-Wheeler Shifting Andhra?',
        'a' => 'Our moving estimates between Nellore and Major Indian Cities are calculated using transparent parameters: total consignment volume (cft), distance (~350 km), packaging material grade (7-layer corrugated and bubble sheets), dedicated enclosed container capacity, and insurance declaration. We provide 100% itemized, fixed-price quotations with zero moving-day surcharges.'
    ],
    [
    ...
    [
        'q' => 'How long does shipment transit take from Nellore to Major Indian Cities?',
...
<section class="content-ui-section" style="padding: 55px 0; background: #070d1e; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    <div style="background: rgba(15, 23, 42, 0.65); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 16px; padding: 36px 32px; box-shadow: 0 12px 30px rgba(0,0,0,0.35);">
      ...
      <p>The RTO in Nellore requires a signed declaration that the bike is being shifted for personal relocation or sale, and the transporter must present a copy of this declaration at the point of departure.</p>
      <ul style="list-style: none; padding-left: 0; margin: 18px 0;">
        <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
          ...
          <span><strong>Self‑attested RC Photocopy</strong> – A duplicate of the Registration Certificate (RC) signed by you. This proves ownership and helps the carrier verify that the bike is registered in your name.</span>
        </li>
        <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
          <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
          <span><strong>Current PUC Certificate</strong> – The Pollution Under Control (PUC) document must be valid at the time of transit. It confirms that the vehicle meets emission norms, a prerequisite for most interstate movements.</span>
        </li>
        <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
          <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
          <span><strong>Valid Insurance Certificate</strong> – Your existing third‑party or comprehensive bike insurance should be active. Ensure the policy number and expiry date are clearly visible on the copy.</span>
        </li>
        <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;">
          <i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i>
          <span><strong>IBA‑Approved Consignment Bilty</strong> – The Indian Book of Abstracts (IBA) or the recognized consignment note (bilty) serves as the contract of carriage. It records the details of the bike, pickup, destination, and agreed‑upon terms.</span>
        </li>
      </ul>
      ...
      <p>Preparing these documents in advance avoids last‑minute delays, and the inclusion of the comprehensive marine insurance gives you peace of mind knowing that your bike is fully protected throughout its journey from Nellore to the desired destination.</p>
    </div>
  </div>
</section>
