...
$page_title = "Top 10 Packers And Movers In Patna | Shree Ashirwad Packers & Movers";
$page_desc = "Get transparent, IBA-approved Top 10 Packers And Movers In Patna with Shree Ashirwad Packers and Movers. ~850 km via National Highway Arterial Corridors & Multi-Axle Express Freight Highways. 100% safe multi-layer packing, transit insurance, dedicated GPS container carriers, and doorstep delivery across Patna and Destination Hub.";
$page_keywords = "top 10 packers and movers in patna, vijayawada to gopalapatnam dailyparcle transport services, presto packers & movers patna bihar, packers and mover bangalore topatna, home shifting movers, home relocation services in bangalore, packers and movers bangalore to chennai charges, movers and packers rates, relocation transport bill, packers and movers bill chennai, safe secure packers & movers banglore, safe movers and packers pune, rajkamal packers and movers nagpur, apex relocation packers chittorgarh";
$canonical_url = "https://shreeashirwadpackersandmovers.com/top-10-packers-and-movers-in-patna";
$page_keyword_tags = array (
  0 => 'top 10 packers and movers in patna',
  1 => 'vijayawada to gopalapatnam dailyparcle transport services',
  2 => 'presto packers & movers patna bihar',
  3 => 'packers and mover bangalore topatna',
  4 => 'home shifting movers',
  5 => 'home relocation services in bangalore',
  6 => 'packers and movers bangalore to chennai charges',
  7 => 'movers and packers rates',
  ...
  12 => 'rajkamal packers and movers nagpur',
  13 => 'apex relocation packers chittorgarh',
);

$faq_list = array (
  0 => 
  array (
    'q' => 'How are relocation charges calculated for Top 10 Packers And Movers In Patna?',
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello+Shree+Ashirwad+Packers+%26+Movers%2C+I+would+like+to+request+a+quotation+for+Top+10+Packers+And+Movers+In+Patna+from+Patna+to+Destination+Hub." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="text-align: center; margin-bottom: 40px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; margin-top: 8px;">
          Top 10 Packers And Movers In Patna <span style="color: #f59e0b;">Cost Matrix &amp; Tariffs</span>
        </h2>
    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">When planning a move from Patna’s Boring Road, Kankarbagh, and Bailey Road to the Destination Hub on City Centre, Railway Station Road, and Industrial Area, the most efficient freight corridor is the 850‑km stretch that follows NH‑31 to the Patna‑Bihar border, crosses the Kosi River at Purnia, then joins NH‑27 (the East‑West Express Highway) through the Jharkhand border at Dumka, before turning north onto NH‑19 toward Kolkata. Along this route, key interstate checkposts—Patna (Bihar), Purnia (Bihar), Dumka (Jharkhand), and Asansol (West Bengal)—</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px;">
      <div style="text-align: center; margin-bottom: 45px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin-top: 10px;">
          Frequently Asked Questions About <span style="color: #f59e0b;">Top 10 Packers And Movers In Patna</span>
        </h2>
      </div>
  ...
  <section style="padding: 60px 0; background: linear-gradient(135deg, #172a54 0%, #0b132b 100%); border-top: 1.5px solid rgba(245, 158, 11, 0.4); color: #ffffff;">
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px; text-align: center;">
      <h2 style="font-size: 2.3rem; font-weight: 800; margin-bottom: 16px;">
        Book Your <span style="color: #f59e0b;">Top 10 Packers And Movers In Patna</span> Today!
      </h2>
      ...
      <div style="display: flex; gap: 16px; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="https://wa.me/918409531615?text=Hello+Shree+Ashirwad+Packers+%26+Movers%2C+I+would+like+to+request+a+quotation+for+Top+10+Packers+And+Movers+In+Patna+from+Patna+to+Destination+Hub." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 15px 32px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1.05rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
          <i class="fab fa-whatsapp" style="margin-right: 8px;"></i> Chat on WhatsApp
        </a>
      </div>
    </div>
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers & Movers,\n\nI would like to request a shifting estimate for Top 10 Packers And Movers In Patna:\n- Name: " + name + "\n- Phone: " + phone + "\n- Pickup Location: " + moveFrom + "\n- Destination Location: " + moveTo;
  ...
  "@graph": [
    {
      ...
      "knowsAbout": ["top 10 packers and movers in patna","vijayawada to gopalapatnam dailyparcle transport services","presto packers & movers patna bihar","packers and mover bangalore topatna","home shifting movers","home relocation services in bangalore","packers and movers bangalore to chennai charges","movers and packers rates","relocation transport bill","packers and movers bill chennai","safe secure packers & movers banglore","safe movers and packers pune","rajkamal packers and movers nagpur","apex relocation packers chittorgarh"],
