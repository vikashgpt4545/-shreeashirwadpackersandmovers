...
$page_title = "Car Transportation | Shree Ashirwad Packers & Movers";
...
$page_keywords = "world wide carriers, state cargo packers and movers chennai, carton box in hsr layout, lowest price packers and movers delhi, delhi to kolkata courier packers movers rates, need to shift some appliances from noida to ghazibad, unison packers and movers in jaipur, packing movingtransportation, ultra safe packers and movers review, smart movers reviews, bangalore to mumbai transport";
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello+Shree+Ashirwad+Packers+%26+Movers%2C+I+would+like+to+request+a+quotation+for+Car+Transportation+from+Origin+City+to+Major+Indian+City." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="text-align: center; margin-bottom: 40px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; margin-top: 8px;">
          Car Transportation <span style="color: #f59e0b;">Cost Matrix &amp; Tariffs</span>
        </h2>
    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For an 850 km city-to-city corridor, Shree Ashirwad Packers and Movers deploys world wide carriers on sealed multi-axle car carrier trailers routed through the National Highway arterial spine, linking the origin&#039;s Railway Station Road loading dock to the destination&#039;s Industrial Area via pre-mapped RTO and toll-plaza sequencing. Interstate border checkposts are cleared using pre-uploaded e-Way bills, FASTag-enabled speed governors capped at 80 km/h, and GPS-logged container transit timestamps, ensuring 2–3 working day delivery without manual weighbridge detours. Hydraulically suspended carousels and twin-axle auto carriers isolate each vehicle from road vibration, while reflective hazard markers and tamper-proof Customs seals satisfy every state transport checkpost along the corridor.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For household relocation on the same lane, we use laminated corrugated cartoning, foam-corner edge guards, and vacuum-sealed wardrobe boxes rated for 80–100 km/h truck velocities. Loading follows the four-tier vertical stacking protocol on air-ride suspension trucks — mattresses on base, fragile crockery in the upper cabin, and electronics in anti-static bubble chambers strapped with nylon binders. Every consignment is photographed pre-loading, sealed with numbered locks, and covered by an all-risk transit insurance policy, guaranteeing damage</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px;">
      <div style="text-align: center; margin-bottom: 45px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin-top: 10px;">
          Frequently Asked Questions About <span style="color: #f59e0b;">Car Transportation</span>
        </h2>
      </div>
  ...
  <section style="padding: 60px 0; background: linear-gradient(135deg, #172a54 0%, #0b132b 100%); border-top: 1.5px solid rgba(245, 158, 11, 0.4); color: #ffffff;">
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px; text-align: center;">
      <h2 style="font-size: 2.3rem; font-weight: 800; margin-bottom: 16px;">
        Book Your <span style="color: #f59e0b;">Car Transportation</span> Today!
      </h2>
      ...
      <div style="display: flex; gap: 16px; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="https://wa.me/918409531615?text=Hello+Shree+Ashirwad+Packers+%26+Movers%2C+I+would+like+to+request+a+quotation+for+Car+Transportation+from+Origin+City+to+Major+Indian+City." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 15px 32px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1.05rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
          <i class="fab fa-whatsapp" style="margin-right: 8px;"></i> Chat on WhatsApp
        </a>
      </div>
    </div>
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers & Movers,\n\nI would like to request a shifting estimate for Car Transportation:\n- Name: " + name + "\n- Phone: " + phone + "\n- Pickup Location: " + moveFrom + "\n- Destination Location: " + moveTo;
  ...
  "@graph": [
    {
      ...
      "knowsAbout": ["world wide carriers","state cargo packers and movers chennai","carton box in hsr layout","lowest price packers and movers delhi","delhi to kolkata courier packers movers rates","need to shift some appliances from noida to ghazibad","unison packers and movers in jaipur","packing movingtransportation","ultra safe packers and movers review","smart movers reviews","bangalore to mumbai transport"],
