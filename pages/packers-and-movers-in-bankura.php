    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For relocation services from Bankura to Destination Hub, our experienced logistics team has identified the optimal route. The journey will primarily follow the National Highway Arterial Corridors, utilizing the multi-axle express freight highways to ensure efficient and secure transportation. Specifically, the route will pass through the following border checkposts: Jhargram Border Checkpost and Bishnupur Border Checkpost. To expedite the process, we will facilitate automated e-Way bill clearance, reducing the risk of delays and ensuring compliance with GST regulations. Our experienced team will also ensure that the speed-governed container transit is executed to guarantee timely delivery.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">To protect your household items or vehicles during transit, we will implement a customized packing and loading strategy. Our trained packers will meticulously wrap and secure your belongings to prevent damage, utilizing high-quality packing materials and techniques. We will also utilize specialized vehicles equipped with advanced safety features, such as GPS tracking and shock-absorbing suspension, to minimize the risk of accidents. Our team will also be on standby to address any issues that may arise during transit, ensuring a smooth and incident-free relocation experience. With our expertise and specialized equipment, you can trust that your belongings will be handled with utmost care and precision.</p>
        </div>
      </div>
    </div>
  </section>
