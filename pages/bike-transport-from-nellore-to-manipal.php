...
$faq_list = [
    [
        'q' => 'How are relocation charges calculated for Bike Transport from Nellore to Manipal | Safe Two-Wheeler Shifting?',
        'a' => 'Our moving estimates between Nellore and Manipal are calculated using transparent parameters: total consignment volume (cft), distance (~650 km), packaging material grade (7-layer corrugated and bubble sheets), dedicated enclosed container capacity, and insurance declaration. We provide 100% itemized, fixed-price quotations with zero moving-day surcharges.'
    ],
    [
        'q' => 'How long does shipment transit take from Nellore to Manipal?',
    ...
    [
        ...
        'a' => 'Yes. Upon vehicle dispatch from Nellore, you receive a private GPS tracking portal link and automated WhatsApp transit checkpoints as our truck clears interstate toll plazas and border checkposts en route to Manipal.'
    ],
    [
        'q' => 'Do you offer temporary warehousing if my new residence in Manipal is not ready?',
...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    ...
    01
    Protocol 01</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Original Registration Certificate (RC) and photocopy are required to document the bike&#039;s ownership.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Make sure to self-attest the photocopy to authenticate its genuineness.</p>
  </div>
</div>
	<h3>2. Current PUC
	
		Provisional Vehicle Certificate (PUC) is a mandatory document to ensure the bike&amp;#039;s environmental and emissions compliance.
		Make sure to provide the current and valid PUC to avoid any legal complications during the transport process.
	
	3. Valid Insurance Certificate
	
		It is crucial to have a valid insurance certificate for your bike during transportation.
		Ensure that the insurance coverage remains active throughout the journey, protecting you from unexpected damages or accidents.
	
	4. IBA-Approved Consignment Bill of Lading
	
		IBA stands for Insurance Brokers Association of India, which provides guidelines and standards for documenting bike transportation.
		An IBA-approved consignment bill of lading ensures a secure transportation process and covers any potential damages or losses.
	
	5. Marine Transit Insurance
	
		To protect your bike during transportation, consider opting for a 100% declared-value marine transit insurance.
		This insurance coverage ensures that your bike&amp;#039;s value is fully covered in case of any damages or accidents during the journey.
	
	6. Vehicle Inspection Report
	
		Before the transportation process starts, ensure that you obtain a vehicle inspection report from a certified mechanic or authorized service center.
		This report serves as proof of the bike&amp;#039;s current condition and helps identify any pre-existing damages.
	
	7. Authorized Signature and Acknowledgement
	
		Collect an authorized signature and acknowledgement from the transporter or shipping company.
		This ensures that both parties agree on the bike&amp;#039;s condition and value before transportation.
	
	8. Bike Survey Report
	
		Complete a thorough survey of your bike and obtain a survey report from an authorized inspector.
		This report helps document the bike&amp;#039;s condition and value, ensuring a fair assessment during inspection in Manipal.
	
	9. Insurance Claim Declaration</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for 2. Current PUC
	...
	9. Insurance Claim Declaration ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Nellore to Manipal corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
  ...
  <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
    <div style="background: rgba(15, 23, 42, 0.85); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 26px 24px; box-shadow: 0 10px 30px rgba(0,0,0,0.35);">
      ...
      <h2 style="color: #ffffff; font-size: 1.6rem; font-weight: 800; margin: 0 0 16px 0; line-height: 1.3;">
        Seamless Shifting Across Highway Corridors: <span style="color: #f59e0b;">Nellore &amp; Manipal Operations</span>
      </h2>
      <p style="color: #cbd5e1; font-size: 0.96rem; line-height: 1.75; margin: 0;">
        Whether you are coordinating an outstation residential shift from Nellore to Manipal or planning an interstate industrial transfer, choosing certified <a href="<?php echo SITE_URL; ?>" title="Packers and Movers" style="color: #f59e0b; font-weight: 700; text-decoration: underline;">packers and movers</a> ensures your furniture, appliances, and vehicle reach without transit damage. As Jharkhand's trusted relocation brand, Shree Ashirwad operates as premier <a href="<?php echo SITE_URL; ?>" title="Shree Ashirwad Packers and Movers" style="color: #f59e0b; font-weight: 700; text-decoration: underline;">packers and movers</a> with regular dedicated container truck departures directly linked to our state operations at <a href="<?php echo SITE_URL; ?>packers-and-movers-in-ranchi" title="Packers and Movers in Ranchi" style="color: #38bdf8; font-weight: 700; text-decoration: underline;">packers and movers in Ranchi</a>, providing complete end-to-end packing, GPS consignment tracking, and verified IBA-approved reimbursement billing for families and professionals throughout Nellore to Manipal highway corridor.
      </p>
    </div>
  </div>
</section>
    ...
    <div style="background: #0f172a; border-radius: 12px; overflow: hidden; border: 1px solid rgba(245, 158, 11, 0.3); box-shadow: 0 10px 30px rgba(0,0,0,0.3);">
      <div style="padding: 16px 24px; background: rgba(245, 158, 11, 0.08); border-bottom: 1px solid rgba(245, 158, 11, 0.2); display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 10px;">
        <div style="color: #f59e0b; font-weight: 700; font-size: 1.05rem; display: flex; align-items: center; gap: 10px;">
          <span>📍</span> Verified Relocation Corridor &amp; GPS Hub: Nellore to Manipal Highway
        </div>
      ...
      <div style="width: 100%; height: 380px; position: relative;">
        <iframe width="100%" height="380" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?q=Nellore+to+Manipal+Highway&t=&z=12&ie=UTF8&iwloc=&output=embed" loading="lazy" style="border:0; width:100%; height:100%; display:block;"></iframe>
      </div>
    </div>
  </div>
</section>
