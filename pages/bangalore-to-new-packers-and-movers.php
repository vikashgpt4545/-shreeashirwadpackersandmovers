...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
   ...
   <p>Once verification is complete, the uncrating process commences with strict adherence to safety and preservation standards. Technicians will systematically test all electrical and mechanical items upon removal from their packaging. This includes verifying voltage compatibility, checking motor functions, inspecting wiring integrity, and confirming operational readiness. Any equipment requiring calibration or immediate service will be flagged and segregated for priority maintenance. Simultaneously, trained handlers will execute clean furniture placement, positioning each piece according to the pre-approved floor plan. Care is taken to protect flooring, align edges precisely, and maintain adequate clearance for ventilation and workflow efficiency.</p>
   <ul style="list-style: none; padding-left: 0; margin: 18px 0;">
