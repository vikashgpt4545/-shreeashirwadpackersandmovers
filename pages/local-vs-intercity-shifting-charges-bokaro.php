...
$faq_list = [
    ...
    ['q' => 'How much does local household shifting cost within Bokaro Steel City?', 'a' => 'Local household shifting rates in Bokaro range from â‚¹3,000 to â‚¹5,500 for a 1BHK, â‚¹5,500 to â‚¹9,500 for a 2BHK, and â‚¹9,500 to â‚¹15,000 for a 3BHK home.'],
    ['q' => 'How much does intercity shifting cost from Bokaro to Patna, Kolkata, or Delhi?', 'a' => 'Intercity relocation from Bokaro ranges between â‚¹8,500 and â‚¹25,000 depending on total distance, container truck size, and volume of household belongings.'],
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20a%20rate%20comparison%20for%20Bokaro%20shifting." target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
              ðŸ’¬ Chat on WhatsApp
            </a>
          </div>
