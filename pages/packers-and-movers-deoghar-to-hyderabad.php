...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(230px, 1fr)); gap: 20px; margin-top: 20px;">
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 22px 18px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); display: flex; flex-direction: column; justify-content: space-between;">
    <div>
      <div style="display: inline-flex; align-items: center; justify-content: center; width: 38px; height: 38px; border-radius: 10px; background: #f59e0b22; color: #f59e0b; font-weight: 800; font-size: 0.95rem; margin-bottom: 12px;">01</div>
      <h3 style="color: #ffffff; font-size: 1.05rem; font-weight: 700; margin-bottom: 8px; line-height: 1.4;">Dedicated Container Transit</h3><p style="color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;">Enclosed, weatherproof containers ensuring high-velocity long-haul security between Deoghar and Hyderabad.</p>
    </div>
    <div style="display: flex; align-items: center; gap: 8px; margin-top: 14px; padding-top: 10px; border-top: 1px solid rgba(255,255,255,0.06); font-size: 0.8rem; color: #10b981;">
      <i class="fas fa-check-circle"></i><span>Verified Shree Ashirwad Standard</span>
    </div>
  ...
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 22px 18px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); display: flex; flex-direction: column; justify-content: space-between;">
    <div>
      <div style="display: inline-flex; align-items: center; justify-content: center; width: 38px; height: 38px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 0.95rem; margin-bottom: 12px;">02</div>
      <h3 style="color: #ffffff; font-size: 1.05rem; font-weight: 700; margin-bottom: 8px; line-height: 1.4;">Scheduled Route Transit</h3><p style="color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;">Synchronized highway routing adhering to national transit safety milestones.</p>
    </div>
    <div style="display: flex; align-items: center; gap: 8px; margin-top: 14px; padding-top: 10px; border-top: 1px solid rgba(255,255,255,0.06); font-size: 0.8rem; color: #10b981;">
      <i class="fas fa-check-circle"></i><span>Verified Shree Ashirwad Standard</span>
    </div>
  ...
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 22px 18px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); display: flex; flex-direction: column; justify-content: space-between;">
    <div>
      ...
      <p style="color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;">uncrating process in Hyderabad is a meticulously structured operation designed to ensure accuracy, safety, and customer satisfaction. By following a step‑by‑step protocol, the team guarantees that every item arrives in pristine condition and that the customer’s space is restored to its intended layout.&quot; That&apos;s 49 words? Let&apos;s count: The final delivery and uncrating process in7 Hyderabad is9 a10 meticulously structured operation designed to15 ensure accuracy,17 safety,18 and customer satisfaction.21 By22 following a24 step‑by‑step protocol,26 the team guarantees that every item arrives in34 pristine condition and that the customer’s40 space is42 restored to44 its intended layout. That&apos;s 47 words.</p>
    </div>
    <div style="display: flex; align-items: center; gap: 8px; margin-top: 14px; padding-top: 10px; border-top: 1px solid rgba(255,255,255,0.06); font-size: 0.8rem; color: #10b981;">
      <i class="fas fa-check-circle"></i><span>Verified Shree Ashirwad Standard</span>
    </div>
  ...
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 22px 18px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); display: flex; flex-direction: column; justify-content: space-between;">
    <div>
      ...
      <p style="color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;">header? But we can just include in paragraph. Let&apos;s write: &quot;At first light, the delivery crew gathers the original inventory bilty and cross‑checks each item against the shipment manifest. Any discrepancies are immediately logged, photographed, and reported to the central warehouse for resolution.&quot; Count: At1 first light,3 the delivery crew gathers the original inventory bilty and cross‑checks each item against the shipment manifest.19 Any discrepancies are immediately logged,24 photographed,25 and reported to28 the central warehouse for resolution. 33 words.</p>
    </div>
    <div style="display: flex; align-items: center; gap: 8px; margin-top: 14px; padding-top: 10px; border-top: 1px solid rgba(255,255,255,0.06); font-size: 0.8rem; color: #10b981;">
      <i class="fas fa-check-circle"></i><span>Verified Shree Ashirwad Standard</span>
    </div>
  ...
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 22px 18px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); display: flex; flex-direction: column; justify-content: space-between;">
    <div>
      ...
      <p style="color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;">are then subjected to a quick functional test. The electrician checks voltage, grounding, and safety switches, while the mechanical technician verifies gear ratios, torque limits, and lubrication levels. Test results are documented in the delivery log.&quot; Count: Electrical and mechanical items are then subjected to8 a9 quick functional test.12 The electrician checks voltage,16 grounding,17 and safety switches,20 while the mechanical technician verifies gear ratios,27 torque limits,29 and lubrication levels.32 Test results are documented in37 the delivery log. 40 words.</p>
    </div>
    <div style="display: flex; align-items: center; gap: 8px; margin-top: 14px; padding-top: 10px; border-top: 1px solid rgba(255,255,255,0.06); font-size: 0.8rem; color: #10b981;">
      <i class="fas fa-check-circle"></i><span>Verified Shree Ashirwad Standard</span>
    </div>
  ...
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 22px 18px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); display: flex; flex-direction: column; justify-content: space-between;">
    <div>
      ...
      <p style="color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;">positioned according to the pre‑approved layout plan. The crew ensures that all surfaces are free from dust, and that any protective covers are removed only after a final inspection. The goal is a tidy, ready‑to‑use environment.&quot; Count: Clean furniture is3 then positioned according to7 the pre‑approved layout plan.11 The crew ensures that all surfaces are free from dust,21 and that any protective covers are removed only after a31 final inspection.33 The goal is36 a37 tidy,38 ready‑to‑use environment. 40 words.</p>
    </div>
    <div style="display: flex; align-items: center; gap: 8px; margin-top: 14px; padding-top: 10px; border-top: 1px solid rgba(255,255,255,0.06); font-size: 0.8rem; color: #10b981;">
      <i class="fas fa-check-circle"></i><span>Verified Shree Ashirwad Standard</span>
    </div>
