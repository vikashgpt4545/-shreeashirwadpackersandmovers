...
$faq_list = [
    ...
    [
        'q' => 'How are relocation charges calculated for Bike Transport from Pune to Kolkata | Safe Two-Wheeler Shifting?',
    ...
    [
        ...
        'a' => 'Our certified moving crews are equipped with heavy furniture lifter straps, hydraulic trolleys, and protective floor sheets. We coordinate smoothly with apartment society management in both Pune and Kolkata to ensure elevator compliance.'
    ],
];
...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    ...
    01
    Protocol 01</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Ensure you have appropriate lighting conditions, preferably daylight.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Gather all required documents, including the delivery notification, pickup photos, original LR bill of lading, and signed condition report from the pickup location.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 03</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Ensure both the delivering and receiving parties are present for the handover process.</p>
  </div>
</div>
	<h3>Daylight Condition Re-inspection
	
		Upon arrival at the destination, review the pickup photos provided to refresh your memory about the vehicle&amp;#039;s general condition.
		Conduct a thorough visual inspection of the two-wheeler or motorcycle vehicle in daylight conditions.
		
			Physical examination of exterior: Check for scratches, dents, rust, defects, and overall wear and tear.
			Examine the tires, rims, and wheels for proper alignment and damage.
			Inspect the engine, exhaust, fuel tank, and accessories for any visible damages or defects.
			Ensure all documentation, keys, and accessories are present.
			Verify the vehicle identification number (VIN) with the original paperwork.
		
		Inspection of the vehicle&amp;#039;s electrical and mechanical components.
		
			Examine the engine, exhaust, brakes, and other mechanical components for signs of wear and tear.
			Check the battery, lights, horn, and all electrical components for functionality.
		
		Inspect the interior for cleanliness, wear and tear, and any additional damages that may not be visible from the exterior.
		
			Check the seating, upholstery, and interior components for any signs of damage or wear.
			Verify the presence and condition of any additional equipment or accessories inside the vehicle.
		
	
	Odometer Verification</h3>
	<p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Compare the odometer reading with the provided LR bill of lading:</p>
	<ul style="list-style: none; padding-left: 0; margin: 18px 0;">
	...
	<h3>Signed Condition Report and Signed LR Bill of Lading</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Signed Condition Report and Signed LR Bill of Lading ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Pune to Kolkata corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
