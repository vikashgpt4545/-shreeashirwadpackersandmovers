...
<main class="site-main">
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          ...
          <p style="font-size: 1.12rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Reliable two-wheeler transport in Purna, Parbhani district. Major railway junction & Marathwada highway network access, multi-layer shock absorption wrapping, and 100% insured delivery.
          </p>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20a%20shifting%20quote%20for%20Purna." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
    ...
    <div class="container">
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; text-align: center;">
        <div style="background: rgba(255,255,255,0.03); padding: 20px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
          ...
          <div style="color: #cbd5e1; font-size: 0.9rem; margin-top: 5px;">Bikes Transported from Purna</div>
        </div>
        <div style="background: rgba(255,255,255,0.03); padding: 20px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
          <div style="font-size: 2.2rem; font-weight: 800; color: #f59e0b;">100%</div>
          <div style="color: #cbd5e1; font-size: 0.9rem; margin-top: 5px;">Dust & Railway Soot Shielding</div>
        </div>
        <div style="background: rgba(255,255,255,0.03); padding: 20px; border-radius: 12px; border: 1px solid rgba(245,158,11,0.2);">
  ...
  <section style="background: #0b132b; padding: 60px 0; color: #fff;">
    <div class="container">
      <div style="text-align: center; margin-bottom: 40px;">
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #fff;">Why Choose Our <span style="color: #f59e0b;">Purna Bike Shifting</span></h2>
        <p style="color: #94a3b8; max-width: 650px; margin: 10px auto 0;">Tailored logistics across Marathwada & Parbhani region.</p>
      </div>
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 25px;">
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.08);">
          <i class="fas fa-subway" style="font-size: 2rem; color: #f59e0b; margin-bottom: 15px;"></i>
          <h3 style="font-size: 1.2rem; color: #fff; margin-bottom: 10px;">Railway & Highway Express Links</h3>
          <p style="color: #cbd5e1; font-size: 0.92rem; line-height: 1.6;">Direct access to major Parbhani-Nanded transit corridors for fast dispatch.</p>
        </div>
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.08);">
          ...
          <p style="color: #cbd5e1; font-size: 0.92rem; line-height: 1.6;">Protection against Marathwada heat, road dust, and highway debris.</p>
        </div>
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.08);">
        ...
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.08);">
          ...
          <h3 style="font-size: 1.2rem; color: #fff; margin-bottom: 10px;">Purna Doorstep Pickup</h3>
          <p style="color: #cbd5e1; font-size: 0.92rem; line-height: 1.6;">Pickup service across Purna Junction area, Railway Colony, and Nanded Road.</p>
        </div>
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.08);">
          ...
          <p style="color: #cbd5e1; font-size: 0.92rem; line-height: 1.6;">Official GST bills & IBA-approved paperwork for railway and govt employees.</p>
        </div>
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.08);">
          ...
          <p style="color: #cbd5e1; font-size: 0.92rem; line-height: 1.6;">Real-time shipment updates and dedicated customer support during transit.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section style="background: #1c2541; padding: 60px 0; color: #fff;">
    <div class="container" style="max-width: 900px;">
      <h2 style="text-align: center; font-size: 2rem; font-weight: 800; margin-bottom: 30px;">Frequently Asked Questions (Purna)</h2>
      <div style="display: grid; gap: 15px;">
        <div style="background: #0b132b; padding: 20px; border-radius: 10px;">
          <h4 style="color: #f59e0b; margin-bottom: 8px;">What is the cost of bike transport from Purna?</h4>
          <p style="color: #cbd5e1; font-size: 0.9rem;">Bike transport charges from Purna start from ₹2,000 to ₹6,500 depending on distance.</p>
        </div>
        <div style="background: #0b132b; padding: 20px; border-radius: 10px;">
          <h4 style="color: #f59e0b; margin-bottom: 8px;">Do you provide official invoices for railway and government employee claims?</h4>
        ...
        <div style="background: #0b132b; padding: 20px; border-radius: 10px;">
          <h4 style="color: #f59e0b; margin-bottom: 8px;">Is insurance provided for bike transit from Purna?</h4>
          <p style="color: #cbd5e1; font-size: 0.9rem;">Yes, complete transit insurance covering damage or theft is included.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section style="background: linear-gradient(135deg, #e11d48 0%, #be123c 100%); padding: 50px 0; text-align: center; color: #fff;">
    <div class="container">
      <h2 style="font-size: 2.2rem; font-weight: 800; margin-bottom: 15px;">Book Your Purna Bike Shifting Today</h2>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the cost of bike transport from Purna?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Bike transport charges from Purna start from ₹2,000 to ₹6,500 depending on distance."
      }
    },
    {
      "@type": "Question",
      "name": "Do you provide official invoices for railway and government employee claims?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is insurance provided for bike transit from Purna?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, complete transit insurance covering damage or theft is included."
      }
    }
  ]
}
