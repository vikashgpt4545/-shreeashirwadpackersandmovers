...
$page_title = "Car Transportation in Saharsa | Professional Car Carrier BR-19";
$page_desc = "Reliable car transportation in Saharsa (BR-19 RTO), Bihar. Open & enclosed hydraulic car carriers, doorstep pick-up, and full transit insurance via SH-95 & Kosi belt corridors.";
$page_keywords = "car transportation in saharsa, best car carrier saharsa, affordable car shipping saharsa, car movers saharsa, doorstep car delivery saharsa";
...
$faq_list = [
    [
        'q' => 'How are cars safely transported to/from Saharsa (BR-19 RTO)?',
    ...
    [
        'q' => 'What are the car transport rates from Saharsa to Patna, Madhepura, or Delhi?',
        'a' => 'Regional car transport to Patna or Madhepura starts at ₹4,500–₹7,500 for hatchbacks, while long-distance interstate transport to Delhi, Mumbai, or Bengaluru ranges from ₹9,500 to ₹19,500.'
    ],
    [
        'q' => 'Which major transport highways serve Saharsa car shipping?',
        'a' => 'Car carriers travel via SH-95 (Saharsa-Madhepura road), SH-66, Gangajala bypass, and Railway Station road.'
    ],
    [
        'q' => 'Do you pick up cars directly from residences in Saharsa?',
        'a' => 'Yes, free doorstep pickup is available across Gangajala, DB Road, Super Market, Chandni Chowk, Refugee Colony, Naya Bazar, and BSF Camp Road.'
    ],
    [
        'q' => 'Is transit insurance included during Saharsa car shipping?',
    ...
    [
        'q' => 'What documentation is required to ship a car from Saharsa?',
    ...
    [
        'q' => 'How long does car carrier delivery take from Saharsa?',
    ...
    [
        'q' => 'How can I book car carrier service in Saharsa?',
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            CAR TRANSPORTATION SAHARSA (BR-19 KOSI DIVISION)
          </span>
          <h1 style="font-size: 2.7rem; font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #ffffff;">
            Professional <span style="color: #f59e0b;">Car Transportation in Saharsa</span>
          </h1>
          <p style="font-size: 1.12rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Shree Ashirwad Packers and Movers provides doorstep car carrier services across Saharsa (BR-19 RTO) via SH-95 and Kosi division transit corridors. Featuring open-trailer and enclosed car container shipping, hydraulic ramp loading, 4-point wheel locks, and 100% IBA-compliant GST billing.
          </p>
        ...
        <div class="hero-form-card" style="background: rgba(255, 255, 255, 0.05); backdrop-filter: blur(10px); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
          ...
          <form action="#" method="POST" onsubmit="sendHeroWhatsAppLead(event, this);">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 14px;">
              <input type="text" name="move_from" class="form-control" value="Saharsa" required style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.3); color: #fff;">
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #e2e8f0; line-height: 1.8;">
    <div class="container" style="max-width: 1000px;">
      ...
      <span class="section-tag" style="color: #f59e0b; text-transform: uppercase; font-weight: 700; font-size: 0.85rem; letter-spacing: 1px;">
        SAHARSA VEHICLE LOGISTICS
      </span>
      <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">
        Doorstep Car Carrier Shipping in <span style="color: #f59e0b;">Saharsa</span>
      </h2>
      
      <p style="font-size: 1.05rem; color: #cbd5e1; margin-bottom: 25px;">
        Shree Ashirwad Packers and Movers provides safe car transportation across Gangajala, DB Road, Super Market, Chandni Chowk, Refugee Colony, Naya Bazar, and BSF Camp Road in Saharsa. We utilize open multi-car trailers and single-car enclosed hydraulic containers equipped with 4-point wheel tie-down safety locks.
      </p>

      <!-- Rate Matrix Table -->
      <div style="overflow-x: auto; margin: 40px 0;">
        <h3 style="font-size: 1.5rem; color: #ffffff; font-weight: 700; margin-bottom: 15px;">
          Estimated Car Carrier Rates for Saharsa
        </h3>
        <table style="width: 100%; border-collapse: collapse; background: #172a54; border-radius: 10px; overflow: hidden; border: 1px solid rgba(245, 158, 11, 0.3);">
          <thead>
            <tr style="background: #1e3a8a; color: #f59e0b; text-align: left;">
              ...
              <th style="padding: 14px 16px;">Regional Transit (Patna / Madhepura / Supaul)</th>
  ...
  <section class="faq-section" style="padding: 60px 0; background: #070d1e; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      <div style="text-align: center; margin-bottom: 40px;">
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff;">Frequently Asked Questions (Car Transport Saharsa)</h2>
      </div>
...
<script type="application/ld+json">
{
  ...
  "description": "Professional car transportation in Saharsa, Bihar with doorstep pickup and transit insurance.",
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers,\n\nI would like a Car Transport Quote for Saharsa:\n- Name: " + name + "\n- Phone: " + phone + "\n- Moving From: " + moveFrom + "\n- Moving To: " + moveTo;
