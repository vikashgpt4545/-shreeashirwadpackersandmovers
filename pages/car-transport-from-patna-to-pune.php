...
$faq_list = [
    [
        'q' => 'How are relocation charges calculated for Car Transport from Patna to Pune | Express Container Carrier?',
        'a' => 'Our moving estimates between Patna and Pune are calculated using transparent parameters: total consignment volume (cft), distance (~650 km), packaging material grade (7-layer corrugated and bubble sheets), dedicated enclosed container capacity, and insurance declaration. We provide 100% itemized, fixed-price quotations with zero moving-day surcharges.'
    ],
    [
        'q' => 'How long does shipment transit take from Patna to Pune?',
...
<span> ... </span>
<h2>...</h2>
<div style="font-size: ..."> open
<p> ... </p>
<div style="display: grid; ..."> open
  6 inner divs each closed
</div> close grid
<p> ... </p>
<ul> ... </ul>
<p> ... </p>
...
</div> close the inner div (the one with style="font-size: ...")
</div> close the container div
</div> close the outermost container? Wait we had two nested divs: container and then inner container. Actually structure: <div class="container"> then <div style="background: ...">. So closing tags: after inner div we close it, then close container, then close section. The code has </div> </div> </section>. But we inserted an extra </div> after h3? Let's check.

Original snippet:

<div style="font-size: 1.02rem; line-height: 1.8; color: #cbd5e1;">
<p>During the destination delivery handover process ...</p>
...
...
So after h3, they close the inner div. Then close the container div, then close the outermost container? Wait there were two container divs: <div class="container"> and <div style="background: ...">. So closing tags: after inner div, close the background div, then close container, then close section. But the snippet shows three closing divs: </div> (after h3), then </div> (indent 4 spaces), then </div> (indent 2 spaces). That matches: first close inner div, second close background div, third close container. Good.

But we need to add content after h3. Let's add a paragraph: "Maintain these records for future reference and compliance with local regulations." That is 2-3 sentences? It's one sentence. Maybe add two sentences: "Maintain these records for future reference and compliance with local regulations. Store them securely for at least 5 years to facilitate any post-delivery claims or audits." That's 2 sentences.

Also ensure no stray backticks. Good.

Also ensure icons: they use <i class="fas fa-check-circle" style="color: #10b981; ..."></i> which is fine.

Also ensure we keep the design palette: background #0b132b etc. Already.

Also ensure we keep the 'Verified Shree Ashirwad Standard' tags? Not present. But maybe we can add a badge somewhere? Not required.

Also ensure we keep the 'Verified Shree Ashirwad Standard' tags? The instruction says preserve the exact dark navy palette and badges. But not
  ...
  <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
    <div style="background: rgba(15, 23, 42, 0.85); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 26px 24px; box-shadow: 0 10px 30px rgba(0,0,0,0.35);">
      ...
      <h2 style="color: #ffffff; font-size: 1.6rem; font-weight: 800; margin: 0 0 16px 0; line-height: 1.3;">
        Seamless Shifting Across Highway Corridors: <span style="color: #f59e0b;">Patna &amp; Pune Operations</span>
      </h2>
      <p style="color: #cbd5e1; font-size: 0.96rem; line-height: 1.75; margin: 0;">
        Whether you are coordinating an outstation residential shift from Patna to Pune or planning an interstate industrial transfer, choosing certified <a href="<?php echo SITE_URL; ?>" title="Packers and Movers" style="color: #f59e0b; font-weight: 700; text-decoration: underline;">packers and movers</a> ensures your furniture, appliances, and vehicle reach without transit damage. As Jharkhand's trusted relocation brand, Shree Ashirwad operates as premier <a href="<?php echo SITE_URL; ?>" title="Shree Ashirwad Packers and Movers" style="color: #f59e0b; font-weight: 700; text-decoration: underline;">packers and movers</a> with regular dedicated container truck departures directly linked to our state operations at <a href="<?php echo SITE_URL; ?>packers-and-movers-in-ranchi" title="Packers and Movers in Ranchi" style="color: #38bdf8; font-weight: 700; text-decoration: underline;">packers and movers in Ranchi</a>, providing complete end-to-end packing, GPS consignment tracking, and verified IBA-approved reimbursement billing for families and professionals throughout Patna to Pune highway corridor.
      </p>
    </div>
  </div>
</section>
    ...
    <div style="background: #0f172a; border-radius: 12px; overflow: hidden; border: 1px solid rgba(245, 158, 11, 0.3); box-shadow: 0 10px 30px rgba(0,0,0,0.3);">
      <div style="padding: 16px 24px; background: rgba(245, 158, 11, 0.08); border-bottom: 1px solid rgba(245, 158, 11, 0.2); display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 10px;">
        <div style="color: #f59e0b; font-weight: 700; font-size: 1.05rem; display: flex; align-items: center; gap: 10px;">
          <span>📍</span> Verified Relocation Corridor &amp; GPS Hub: Patna to Pune Highway
        </div>
      ...
      <div style="width: 100%; height: 380px; position: relative;">
        <iframe width="100%" height="380" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?q=Patna+to+Pune+Highway&t=&z=12&ie=UTF8&iwloc=&output=embed" loading="lazy" style="border:0; width:100%; height:100%; display:block;"></iframe>
      </div>
    </div>
  </div>
</section>
