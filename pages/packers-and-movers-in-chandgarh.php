    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For a seamless household shifting and relocation from Chandigarh to the Destination Hub, our logistics experts recommend utilizing the National Highway Arterial Corridors and Multi-Axle Express Freight Highways. The exact route involves traversing the NH 44, which connects Chandigarh to the interstate border at Ludhiana. Upon clearance at the automated e-Way bill checkpost, the transit proceeds via NH 44A, entering the Punjab territory. We ensure efficient speed-governed container transit through the dedicated freight corridors, minimizing transit duration to 2 to 3 working days.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">To guarantee damage-free transit for household items or vehicles, our team implements specialized packing and loading techniques. We utilize sturdy, custom-made crates and strategically position items to prevent shifting during transit. To further safeguard against damage, our team maintains meticulous records of pre- and post-loading inspections. Additionally, we employ a network of experienced drivers and skilled loading personnel to ensure secure loading and unloading at designated points along the route. By entrusting your household shifting and relocation needs to us, you can rest assured that your belongings will arrive at the Destination Hub in pristine condition.</p>
        </div>
      </div>
    </div>
  </section>
