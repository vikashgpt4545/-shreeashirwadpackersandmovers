...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    <div style="background: rgba(15, 23, 42, 0.65); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 16px; padding: 36px 32px; box-shadow: 0 12px 30px rgba(0,0,0,0.35);">
      ...
      <div style="font-size: 1.02rem; line-height: 1.8; color: #cbd5e1;">
	<h3>Introduction</h3>
	<p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>This handover document serves as a detailed summary of the inspection, verification, and agreement process for the delivery of a two-wheeler or motorcycle to its final destination. The inspection will be conducted during daylight hours to ensure accurate assessment of the vehicle&#039;s condition.</p>
    ...
    01
    Protocol 01</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>The vehicle will be inspected in daylight conditions to ensure a comprehensive assessment of its current condition.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>All visible damages, scratches, dents, and other imperfections will be documented.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 03</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Additionally, the functionality of the motorcycle or two-wheeler will be tested, including but not limited to:</p>
  </div>
</div>

	<h3>Step 2: Odometer Verification</h3>
	<p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>To ensure accuracy and transparency, we will verify the vehicle&#039;s odometer reading against the provided delivery documentation.</p>
	<ul style="list-style: none; padding-left: 0; margin: 18px 0;">
	...
	<p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Once the vehicle has been inspected, verified, and found to be in satisfactory condition, the following steps will be taken:</p>
	<ul style="list-style: none; padding-left: 0; margin: 18px 0;">
	...
	<h3>Important Notes
		...
		The recipient is strongly recommended to inspect the vehicle upon delivery to ensure they are satisfied with the condition upon arrival.
		In case of any discrepancies or unforeseen damages upon delivery, the recipient should immediately contact the transportation provider for assistance.
		Photographic evidence may be required to resolve any disputes regarding the vehicle&amp;#039;s condition.
	

	Required Documentation:</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Important Notes
	...
	Required Documentation: ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
