...
$faq_list = [
    ...
    [
        'q' => 'How are relocation charges calculated for Bike Transportation in Avinissery | Safe Two-Wheeler Shifting Thrissur?',
...
<h3>Step 1: Daylight Condition Re-inspection
    ...
    01
    Protocol 01</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Upon receiving the motorcycle/two-wheeler at the destination, the delivery personnel should conduct a thorough daylight inspection of the vehicle.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>This inspection should be performed under natural daylight conditions, ensuring a clear view of all aspects of the vehicle.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 03</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Check for any visible damages, scratches, dents, missing parts, or any other defects that were not mentioned in the pickup photos.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #a855f722; color: #a855f7; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">04</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 04</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Additionally, ensure that the motorcycle/two-wheeler is in its original condition and matches the details provided in the LR (Loading Receipt) bill of lading.</p>
  </div>
</div>

<h3>Step 2: Odometer Verification

	The delivery personnel should compare the displayed odometer reading with the information provided in the LR bill of lading.
	Verify that the displayed odometer reading matches the recorded distance on the LR bill of lading.
	If there are discrepancies, discuss them with the customer and seek clarification before proceeding further.


Step 3: Signed Condition Sign-off

	After verifying the vehicle condition and odometer reading, present the customer with a copy of the LR bill of lading.
	Have the customer sign the document to acknowledge their acceptance of the vehicle condition and odometer reading.
	Collect a copy of the signed LR bill of lading for your records.


Final Checklist

	Verify that the following documents are present and in order:
	
		Loading Receipt (LR) bill of lading with correct vehicle details
		Vehicle registration document (VRM or equivalent)
		Insurance documents (if applicable)
		Any additional documents provided by the sender or receiver
	


Procedures to Follow

	Upon verifying all the necessary documents, proceed with the delivery process.
	Ensure that the customer is satisfied with the vehicle condition and odometer reading before proceeding to the final delivery.
	In case of any discrepancies or concerns, escalate the issue to the appropriate personnel or supervisor for resolution.
	Upon resolving the concerns, document any necessary updates to the LR bill of lading, ensuring all parties are informed about the changes.
	Finalize the delivery process, hand over the vehicle to the customer, and confirm the successful completion of the delivery.
	Collect any necessary signatures or initials from the customer to confirm the delivery.


Post-Delivery Responsibilities</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Step 2: Odometer Verification
...
Post-Delivery Responsibilities ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
