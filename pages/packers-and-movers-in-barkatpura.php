    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">As a senior logistics coordinator for Shree Ashirwad Packers and Movers, I can confidently advise clients relocating from Barkatpura to their destination hub via the National Highway Arterial Corridors and Multi-Axle Express Freight Highways. The most efficient route for this corridor is via the NH-44, which spans approximately 850 km, passing through key border checkposts such as the Telangana-Tamil Nadu border and the Andhra Pradesh-Telangana border. To ensure seamless transit, our team will handle automated e-Way bill clearance, eliminating the need for manual paperwork and reducing transit time.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For households shifting or relocation services, our team employs specific packing and loading techniques to ensure damage-free transit protection. We utilize custom-made boxes, robust padding, and specialized lifting equipment to safeguard valuable items such as furniture, electronics, and personal effects. For vehicles, our team provides comprehensive vehicle transportation services, including pre-trip vehicle inspections, secure storage, and post-delivery vehicle inspections. With our expertise and specialized equipment, we guarantee a safe and hassle-free journey for our clients, ensuring a seamless relocation experience from Barkatpura to their destination hub.</p>
        </div>
      </div>
    </div>
  </section>
