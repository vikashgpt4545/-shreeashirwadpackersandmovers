...
$faq_list = [
    [
        'q' => 'How long does shipment transit take from Kolkata to Pune?',
    ...
    [
        'q' => 'How are relocation charges calculated for Car Transport Kolkata to Pune | Secure Car Shifting?',
...
We need to heal the HTML section. Remove AI thought leaks, etc. Ensure no internal planning text. The content is about Car Transport Kolkata to Pune. We need to rewrite sections that are out-of-context or hallucinated. The content currently includes generic info about carriers, services, etc. We need to ensure it's relevant to car transport between Kolkata and Pune. Also we need to replace placeholder tokens. There are no placeholders like 'Ranchi & Central Hubs', but we have 'packers and movers kolkata to pune' etc. That is fine.

We need to ensure no stray backticks or prompt echoes. The current code has no backticks. Good.

We need to decode any escaped tags: I see <i class="fas fa-check-circle" ...> which is fine. No double-escaped tags.

We need to convert any raw markdown tables: none.

Empty/hollow cards: none.

Design system: preserve palette. The current code uses inline styles with colors. That matches.

But we need to rewrite sections that are out-of-context: The content about "Services and Companies" lists packers and movers, but the page is about car transport. We should focus on car transport specifics: vehicle condition checks, red flags, insurance, etc. Also the "Home Shifting Charges" etc. Should be replaced with car transport cost details.

Also the heading "Enclosed Container Transporters vs Open Car Haulers for packers and movers kolkata to pune" should be updated to "Enclosed Container Transporters vs Open Car Haulers for Car Transport Kolkata to Pune".

Also the list of benefits for enclosed carriers and open trailers should be relevant to car transport. We can keep them but adjust wording.

Also the "Services and Companies" section should list car transport companies, not packers and movers. Provide realistic sentences.

Also "Home Shifting Charges in Pune" should be "Car Transport Charges in Pune".

Also "Movers and Packers Pune to Kolkata Quote" should be "Car Transport Quote from Pune to Kolkata".

Also "Expertise and Experience of Packers and Movers in Kolkata and Pune" should be "Expertise and Experience of Car Transport Providers in Kolkata and Pune".

Also we need to ensure no internal planning text. The current code has no such.

We need to ensure the final output is a single <section>...</section> block with no markdown fences.

Let's rewrite the content accordingly.

We need to keep the same structure: container, card, etc. We can keep the same styling.

We need to adjust the heading and subheadings.

Also we need to en<i> tags are correct. They are
...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  ...
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>RC copy must be self-attested and duly verified by the authorized person.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Make sure to provide a photocopy of the RC to the packers and movers.</p>
  </div>
</div>
	...
	<h3>Procedure:</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Procedure: ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Kolkata to Pune corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
  ...
  <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
    <div style="background: rgba(15, 23, 42, 0.85); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 26px 24px; box-shadow: 0 10px 30px rgba(0,0,0,0.35);">
      ...
      <h2 style="color: #ffffff; font-size: 1.6rem; font-weight: 800; margin: 0 0 16px 0; line-height: 1.3;">
        Seamless Shifting Across Highway Corridors: <span style="color: #f59e0b;">Kolkata &amp; Pune Operations</span>
      </h2>
      <p style="color: #cbd5e1; font-size: 0.96rem; line-height: 1.75; margin: 0;">
        Whether you are coordinating an outstation residential shift from Kolkata to Pune or planning an interstate industrial transfer, choosing certified <a href="<?php echo SITE_URL; ?>" title="Packers and Movers" style="color: #f59e0b; font-weight: 700; text-decoration: underline;">packers and movers</a> ensures your furniture, appliances, and vehicle reach without transit damage. As Jharkhand's trusted relocation brand, Shree Ashirwad operates as premier <a href="<?php echo SITE_URL; ?>" title="Shree Ashirwad Packers and Movers" style="color: #f59e0b; font-weight: 700; text-decoration: underline;">packers and movers</a> with regular dedicated container truck departures directly linked to our state operations at <a href="<?php echo SITE_URL; ?>packers-and-movers-in-ranchi" title="Packers and Movers in Ranchi" style="color: #38bdf8; font-weight: 700; text-decoration: underline;">packers and movers in Ranchi</a>, providing complete end-to-end packing, GPS consignment tracking, and verified IBA-approved reimbursement billing for families and professionals throughout Kolkata to Pune highway corridor.
      </p>
    </div>
  </div>
</section>
    ...
    <div style="background: #0f172a; border-radius: 12px; overflow: hidden; border: 1px solid rgba(245, 158, 11, 0.3); box-shadow: 0 10px 30px rgba(0,0,0,0.3);">
      <div style="padding: 16px 24px; background: rgba(245, 158, 11, 0.08); border-bottom: 1px solid rgba(245, 158, 11, 0.2); display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 10px;">
        <div style="color: #f59e0b; font-weight: 700; font-size: 1.05rem; display: flex; align-items: center; gap: 10px;">
          <span>📍</span> Verified Relocation Corridor &amp; GPS Hub: Kolkata to Pune Highway
        </div>
      ...
      <div style="width: 100%; height: 380px; position: relative;">
        <iframe width="100%" height="380" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?q=Kolkata+to+Pune+Highway&t=&z=12&ie=UTF8&iwloc=&output=embed" loading="lazy" style="border:0; width:100%; height:100%; display:block;"></iframe>
      </div>
    </div>
  </div>
</section>
