...
$faq_list = [
    [
        'q' => 'How are relocation charges calculated for Bike Transportation in Natham | Secure Two-Wheeler Shifting Tamil Nadu?',
...
<section class="content-ui-section" style="padding: 55px 0; background: #070d1e; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  ...
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Initiate the transportation process by selecting enclosed hydraulic ramp carriers, which offer utmost protection to your bike during transit.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>These carriers feature hydraulic mechanisms that facilitate seamless loading and unloading of bikes, ensuring minimal physical involvement and reduced chances of damages.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Ensure the bike is properly secured within the carrier using specialized straps and cushioning materials to prevent any accidental movement during transit.</p>
  </div>
</div>
	...
	<h3>Transportation Methods
	
		Transport your bike via trains: You can opt for bike shifting services where trained professionals handle the entire process, ensuring your bike arrives at its destination in pristine condition.
		For those preferring a more flexible transportation mode, bicycles can be transported via roadways using specialized carriers.
		Regardless of the transportation method, ensuring a secure bike-carrying setup is crucial.
	
	Bike Parcel by Train
	
		When opting for bike shifting services via trains, your bike will be meticulously packed and secured using the aforementioned techniques.
		The professionals ensure that your bike is housed within high-quality, weather-resistant packaging materials.
		Following packaging, the bike is precisely secured using the hydraulic ramp carriers, steel wheel-lock chocks, and high-tensile ratchet lashing.
		Once secured, the bike is transported via train, arriving at its destination in pristine condition.
	
	Bike Parcel via Road</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Transportation Methods
	...
	Bike Parcel via Road ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
...
<section class="content-ui-section" style="padding: 55px 0; background: #070d1e; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  ...
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Enclosed carriers also provide a higher level of security compared to open trailers, as the bike is kept out of sight and away from potential thieves.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Damage Prevention:</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Enclosed carriers help prevent damage due to external factors like weather conditions, as the bike is completely enclosed and sheltered.</p>
  </div>
</div>
	...
	<p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Transporting bikes by train is a viable option, especially considering the vast distances in India. However, the availability of bike transport services through trains may depend on the specific location and schedules of train routes.</p>

	<h3>Bike Parcel Services:</h3>
	<p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>In Natham, specialized bike parcel services may be available to transport bikes within the city or nearby locations. These services typically offer enclosed carriers for enhanced protection but might not be as reliable as dedicated bike transportation companies.</p>

	<h3>Bike Transport Companies:</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Bike Transport Companies: ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
