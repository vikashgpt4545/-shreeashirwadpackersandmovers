...
$faq_list = [
    ['q' => 'How much does household shifting cost from Bokaro to Bihar Sharif?', 'a' => 'Interstate house shifting from Bokaro to Bihar Sharif ranges from &#8377;11,500 to &#8377;17,500 for 1BHK, &#8377;16,500 to &#8377;26,000 for 2BHK, and &#8377;23,000 to &#8377;36,000 for 3BHK houses.'],
    ['q' => 'How long does transit take from Bokaro to Bihar Sharif?', 'a' => 'The distance from Bokaro to Bihar Sharif is approx 240-270 km. Dedicated container vehicles deliver within 1 to 2 days.'],
    ...
    ['q' => 'Do you provide car transport from Bokaro to Bihar Sharif?', 'a' => 'Yes, we transport cars using enclosed hydraulic car trailers with safety wheel locks for scratch-free highway transit.'],
    ['q' => 'How are bikes transported from Bokaro to Bihar Sharif?', 'a' => 'Motorcycles receive 5-layer bubble film wrapping, corrugated box shields, and handlebar guards before container loading.'],
    ...
    ['q' => 'Is transit insurance included for Bokaro to Bihar Sharif shifting?', 'a' => 'Yes, we issue 100% full-value transit insurance policy documentation protecting your household goods, electronics, and vehicles against all highway risks, accidents, and unforeseen events during transit.'],
    ['q' => 'How early should I book Bokaro to Bihar Sharif shifting?', 'a' => 'Booking 1 to 2 days in advance helps us reserve dedicated container trucks and specialized packing crews.'],
    ['q' => 'Do your packers disassemble and reassemble furniture?', 'a' => 'Yes, expert carpenters dismantle double beds, wooden wardrobes, dining tables, and reassemble them at your new home in Bihar Sharif.'],
    ['q' => 'Are loading and unloading included in the quote?', 'a' => 'Yes, complete loading at origin in Bokaro and unloading with room placement at destination in Bihar Sharif are included.'],
    ['q' => 'How can I track my shipment during transit to Bihar Sharif?', 'a' => 'Our highway transport trucks are monitored via live GPS satellite tracking systems with real-time updates.'],
    ['q' => 'Do you handle office and commercial shifting to Bihar Sharif?', 'a' => 'Yes, we specialize in corporate office furniture, IT equipment, server racks, and commercial stock relocation.'],
    ...
    ['q' => 'Do you provide temporary warehouse storage in Bokaro or Bihar Sharif?', 'a' => 'Yes, we offer clean, CCTV-monitored, moisture-proof storage warehouses in both Bokaro and Bihar Sharif.'],
    ['q' => 'Can I transport a single piece of furniture or luggage to Bihar Sharif?', 'a' => 'Yes, we offer shared part-load container options for single furniture items or small consignments.'],
    ['q' => 'Are there any hidden costs added at delivery time in Bihar Sharif?', 'a' => 'No, we provide fixed written binding quotes with zero hidden or surprise charges.'],
    ...
    ['q' => 'What if destination home keys are delayed in Bihar Sharif?', 'a' => 'We offer complimentary short-term truck holding or warehouse storage until your home keys are ready.'],
    ['q' => 'Why choose Shree Ashirwad Packers for Bokaro to Bihar Sharif shifting?', 'a' => 'With 15+ years of highway logistics experience, 450+ successful Bokaro to Bihar Sharif moves, 100% IBA GST compliance, and 7-layer safety, we are the top choice.']
];
