      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          ...
          <p style="font-size: 1.1rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Transporting your bike from Hyderabad to Kadapa? Shree Ashirwad Packers and Movers provides scratch-free two-wheeler transport using covered container carriers, 7-layer protective wrapping, and 100% transit insurance.
          </p>
  ...
  <section style="padding: 60px 0; background: #0b132b;">
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
      ...
      <p style="font-size: 0.85rem; color: #64748b; margin-top: 12px; text-align: center;">
        * Rates depend on exact pickup location in Hyderabad and delivery address in Kadapa.
      </p>
    </div>
  </section>
    ...
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 25px;">
        ...
        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.08); position: relative;">
          ...
          <p style="color: #94a3b8; font-size: 0.9rem; line-height: 1.6;">
            Direct highway transit towards Kadapa with status updates.
          </p>
        </div>

        <div style="background: #1c2541; padding: 25px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.08); position: relative;">
          <div style="font-size: 2.5rem; font-weight: 900; color: rgba(245, 158, 11, 0.2); position: absolute; top: 15px; right: 20px;">04</div>
          <h3 style="font-size: 1.1rem; font-weight: 700; color: #f59e0b; margin-bottom: 10px;">Kadapa Delivery</h3>
          <p style="color: #94a3b8; font-size: 0.9rem; line-height: 1.6;">
            Unpacking and joint condition inspection at your residence in RMC Colony, NGO Colony, Trunk Road, Seven Roads, etc.
          </p>
        </div>
    ...
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
      ...
      <div style="text-align: center; margin-bottom: 45px;">
        ...
        <p style="color: #94a3b8; font-size: 1rem;">
          Complete coverage across Hyderabad tech hubs and Kadapa urban sectors.
        </p>
      </div>
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px;">
        ...
        <div style="background: #0b132b; padding: 30px; border-radius: 14px; border: 1px solid rgba(255,255,255,0.08);">
          <h3 style="font-size: 1.3rem; font-weight: 700; color: #f59e0b; margin-bottom: 15px; display: flex; align-items: center; gap: 10px;">
            <i class="fas fa-map-marker-alt"></i> Kadapa Delivery Sectors
          </h3>
          <ul style="list-style: none; padding: 0; margin: 0; color: #cbd5e1; font-size: 0.95rem; line-height: 2;">
            <li><i class="fas fa-check-circle" style="color: #10b981; margin-right: 8px;"></i> RMC Colony, NGO Colony, & Cooperative Colony</li>
            <li><i class="fas fa-check-circle" style="color: #10b981; margin-right: 8px;"></i> Trunk Road, Seven Roads, & Almaspet</li>
            <li><i class="fas fa-check-circle" style="color: #10b981; margin-right: 8px;"></i> Mariyapuram, Christian Lane, & ITI Circle</li>
            <li><i class="fas fa-check-circle" style="color: #10b981; margin-right: 8px;"></i> Utukur, Yerramukkapalli, & Akkayapalle</li>
          </ul>
        </div>
  ...
  <section style="padding: 60px 0; background: #0b132b;">
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 20px;">
      ...
      <div style="text-align: center; margin-bottom: 45px;">
        ...
        <p style="color: #94a3b8; font-size: 1rem;">
          Answers to common questions about Hyderabad to Kadapa bike shipping.
        </p>
      </div>
      ...
      <div style="display: flex; flex-direction: column; gap: 20px;">
        ...
        <div style="background: #1c2541; padding: 24px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.08);">
          ...
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.7; margin: 0;">
            Charges range between ₹2,800 and ₹6,800 depending on bike displacement (100cc to 500cc+), packaging level, and specific delivery location in Kadapa.
          </p>
        </div>

        <div style="background: #1c2541; padding: 24px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.08);">
          <h3 style="font-size: 1.15rem; font-weight: 700; color: #f59e0b; margin-bottom: 10px;">Q2: What is the transit time from Hyderabad to Kadapa?</h3>
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.7; margin: 0;">
            The typical express transit duration for the 410+ km route is 24 to 48 hours using covered container trucks.
          </p>
        </div>
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Charges range between ₹2,800 and ₹6,800 depending on bike displacement (100cc to 500cc+), packaging level, and specific delivery location in Kadapa."
      }
    },
    {
      "@type": "Question",
      "name": "What is the transit time from Hyderabad to Kadapa?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The typical express transit duration for the 410+ km route is 24 to 48 hours using covered container trucks."
      }
    },
    {
      "@type": "Question",
