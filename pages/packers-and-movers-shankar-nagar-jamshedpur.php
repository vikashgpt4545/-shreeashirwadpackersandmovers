...
<main class="site-main">
  ...
  <section style="padding: 35px 0; background: #070d19; border-bottom: 1px solid rgba(245, 158, 11, 0.2);">
    <div class="container">
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 15px; text-align: center;">
        ...
        <div><h3 style="color: #f59e0b; font-size: 2rem; font-weight: 800;">2,550+</h3><p style="color: #cbd5e1; font-size: 0.85rem;">Shankar Nagar Relocations</p></div>
    ...
    <div class="container">
      <div style="text-align: center; max-width: 800px; margin: 0 auto 40px auto;">
        ...
        <h2 style="font-size: 2.1rem; color: #0b132b; font-weight: 800; margin-top: 5px;">
          Top Choice for <span style="color: #d32f2f;">Packers and Movers in Shankar Nagar</span>
        </h2>
      ...
      <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 25px;">
        <div style="background: #ffffff; padding: 25px; border-radius: 12px; border-top: 4px solid #d32f2f; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
          <h3 style="font-size: 1.15rem; color: #0b132b; margin-bottom: 8px; font-weight: 700;">Golmuri-Tinplate Access</h3>
  ...
  <section style="padding: 60px 0; background: #ffffff;">
    <div class="container">
      <div style="text-align: center; max-width: 800px; margin: 0 auto 40px auto;">
        <h2 style="font-size: 2.1rem; color: #0b132b; font-weight: 800;">Shifting Solutions in <span style="color: #d32f2f;">Shankar Nagar Jamshedpur</span></h2>
      </div>
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 25px;">
        <div style="background: #f8fafc; padding: 25px; border-radius: 10px; border: 1px solid #e2e8f0;">
          <h3 style="font-size: 1.2rem; color: #0b132b; margin-bottom: 10px;">🏡 Shankar Nagar Household Shifting</h3>
          <p style="color: #64748b; font-size: 0.9rem;">Complete house shifting services in Shankar Nagar covering furniture disassembly, fragile packing, loading, and unpacking.</p>
        </div>
        <div style="background: #f8fafc; padding: 25px; border-radius: 10px; border: 1px solid #e2e8f0;">
          <h3 style="font-size: 1.2rem; color: #0b132b; margin-bottom: 10px;">🏢 Shankar Nagar Office &amp; Commercial Moving</h3>
          <p style="color: #64748b; font-size: 0.9rem;">Fast office and retail shop relocation in Shankar Nagar with minimal interruption to business operations.</p>
        </div>
        <div style="background: #f8fafc; padding: 25px; border-radius: 10px; border: 1px solid #e2e8f0;">
          <h3 style="font-size: 1.2rem; color: #0b132b; margin-bottom: 10px;">🚗 Closed Car Carrier Transport</h3>
          <p style="color: #64748b; font-size: 0.9rem;">Enclosed car container trailers for safe door-to-door car transport from Shankar Nagar to any Indian city.</p>
        </div>
        <div style="background: #f8fafc; padding: 25px; border-radius: 10px; border: 1px solid #e2e8f0;">
          <h3 style="font-size: 1.2rem; color: #0b132b; margin-bottom: 10px;">🏍️ Two-Wheeler / Bike Shipping</h3>
          <p style="color: #64748b; font-size: 0.9rem;">Straw padding and corrugated box wrapping for scratch-free motorcycle transport from Shankar Nagar.</p>
        </div>
        <div style="background: #f8fafc; padding: 25px; border-radius: 10px; border: 1px solid #e2e8f0;">
          <h3 style="font-size: 1.2rem; color: #0b132b; margin-bottom: 10px;">📦 Custom Wooden Box Crating</h3>
          <p style="color: #64748b; font-size: 0.9rem;">Solid wooden crate framing for glass tops, mandirs, LED TVs, and valuable artifacts in Shankar Nagar.</p>
        </div>
        <div style="background: #f8fafc; padding: 25px; border-radius: 10px; border: 1px solid #e2e8f0;">
  ...
  <section style="padding: 50px 0; background: #070d19; color: #ffffff;">
    <div class="container">
      <div style="text-align: center; max-width: 800px; margin: 0 auto 35px auto;">
        <h2 style="font-size: 2rem; color: #ffffff; font-weight: 800;">7-Layer Safety Packaging for <span style="color: #f59e0b;">Shankar Nagar Moves</span></h2>
      </div>
    ...
    <div class="container">
      <div style="max-width: 900px; margin: 0 auto;">
        <h2 style="font-size: 2.1rem; color: #0b132b; font-weight: 800; text-align: center; margin-bottom: 20px;">
          Local Expertise in <span style="color: #d32f2f;">Shankar Nagar Jamshedpur Logistics</span>
        </h2>
        <p style="color: #475569; font-size: 1rem; line-height: 1.8; margin-bottom: 20px;">
          Shankar Nagar is located adjacent to Golmuri in Jamshedpur. It comprises independent residential homes, employee colonies, and neighborhood markets. Our moving team is experienced in executing efficient local house relocations across Shankar Nagar.
        </p>
        <p style="color: #475569; font-size: 1rem; line-height: 1.8; margin-bottom: 20px;">
          Direct connecting roads ensure swift transit to major highway corridors serving Ranchi, Dhanbad, Asansol, and Kolkata.
        </p>
      </div>
    </div>
  </section>
  ...
  <section style="padding: 50px 0; background: #ffffff;">
    <div class="container">
      ...
      <div style="max-width: 850px; margin: 0 auto; display: flex; flex-direction: column; gap: 12px;">
        <div style="background: #f8fafc; padding: 18px; border-radius: 8px; border: 1px solid #e2e8f0;"><h4 style="color: #0b132b;">Q1: Do you serve Shankar Nagar and Golmuri areas?</h4><p style="color: #64748b; font-size: 0.9rem;">Yes, we serve all sectors in Shankar Nagar including Golmuri border and Tuiladungri link.</p></div>
        ...
        <div style="background: #f8fafc; padding: 18px; border-radius: 8px; border: 1px solid #e2e8f0;"><h4 style="color: #0b132b;">Q3: How early should I schedule shifting in Shankar Nagar?</h4><p style="color: #64748b; font-size: 0.9rem;">Booking 2 to 3 days in advance ensures smooth vehicle scheduling.</p></div>
        <div style="background: #f8fafc; padding: 18px; border-radius: 8px; border: 1px solid #e2e8f0;"><h4 style="color: #0b132b;">Q4: Can you move houses in Shankar Nagar?</h4><p style="color: #64748b; font-size: 0.9rem;">Yes, our crew is equipped for house loading and unloading.</p></div>
        <div style="background: #f8fafc; padding: 18px; border-radius: 8px; border: 1px solid #e2e8f0;"><h4 style="color: #0b132b;">Q5: Is transit insurance provided for intercity routes from Shankar Nagar?</h4><p style="color: #64748b; font-size: 0.9rem;">Yes, full transit insurance coverage is available.</p></div>
        <div style="background: #f8fafc; padding: 18px; border-radius: 8px; border: 1px solid #e2e8f0;"><h4 style="color: #0b132b;">Q6: How do you transport bikes from Shankar Nagar?</h4><p style="color: #64748b; font-size: 0.9rem;">Motorcycles are wrapped in paddy straw and heavy corrugated sheets before loading.</p></div>
        ...
        <div style="background: #f8fafc; padding: 18px; border-radius: 8px; border: 1px solid #e2e8f0;"><h4 style="color: #0b132b;">Q10: How can I contact Shree Ashirwad Packers in Shankar Nagar?</h4><p style="color: #64748b; font-size: 0.9rem;">Call <strong>+91 8409531615</strong> or message us on WhatsApp for an immediate quote.</p></div>
      </div>
    </div>
  </section>
