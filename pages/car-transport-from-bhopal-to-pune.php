...
$page_title = "Car Transport from Bhopal to Pune | Express Enclosed Carrier";
$page_desc = "Professional car transport from Bhopal to Pune by Shree Ashirwad Packers and Movers. Express 2-3 day delivery via NH52 corridor, 100% all-risk transit insurance & doorstep pickup across Arera Colony, MP Nagar, Kolar Road, Bhopal to Hinjewadi, Kothrud, Pune.";
  ...
  <div class="container" style="max-width: 1140px; margin: 0 auto; padding: 0 15px;">
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 40px; align-items: center;">
      <div>
        ...
        <h1 style="font-size: 2.2rem; font-weight: 800; line-height: 1.25; margin-bottom: 15px; color: #ffffff;">Car Transport from Bhopal to Pune | Express Enclosed Carrier</h1>
...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    <div style="background: rgba(15, 23, 42, 0.65); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 16px; padding: 36px 32px; box-shadow: 0 12px 30px rgba(0,0,0,0.35);">
      <span style="background: rgba(245, 158, 11, 0.12); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.35); padding: 4px 14px; border-radius: 20px; font-size: 0.78rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; display: inline-block; margin-bottom: 14px;">Premium Transit</span>
      <h2 style="color: #ffffff; font-size: 1.7rem; font-weight: 800; line-height: 1.35; margin-bottom: 18px;">Why packers and movers bhopal to pune trust our premium enclosed car carrier service</h2>
      <div style="font-size: 1.02rem; line-height: 1.8; color: #cbd5e1;">Shree Ashirwad’s car‑transport service between Bhopal and Pune is engineered for the discerning vehicle owner who demands uncompromising protection, precision logistics and absolute peace of mind.  Over the past 15 years the company has built a reputation that transcends the generic “mover” label, earning ISO‑9001 certification that codifies quality at every touchpoint.

**Exclusive Enclosed Carrier Fleet**  
The backbone of the service is a fleet of purpose‑built, fully enclosed carriers. Each vehicle is shielded from the elements, road debris and weather extremes, ensuring that the car arrives at its destination in pristine condition. The carriers are modular, allowing for single‑car or multi‑car loads, and are fitted with secure tie‑down systems that meet international transport standards.

**Hydraulic Ramp Technology**  
Loading and unloading are performed with state‑of‑the‑art hydraulic ramp systems. The ramps are calibrated to maintain a perfectly level platform, preventing any tilt or vibration that could damage delicate components. The hydraulic lifts also reduce the physical strain on the vehicle’s chassis and suspension, a critical advantage for high‑value or antique cars.

**Zero‑Scratch Guarantee**  
Shree Ashirwad’s zero‑scratch guarantee is backed by a rigorous pre‑move inspection protocol and post‑arrival audit. Any scuffs or blemishes are documented and compensated for, a level of assurance rarely offered by conventional movers. This guarantee reflects the company’s confidence in its protective measures and its commitment to customer satisfaction.

**24/7 GPS Tracking**  
Real‑time visibility is provided through a dedicated GPS‑tracking portal accessible to the client at any time. The system offers live route updates, estimated arrival times and an instant alert if any deviation occurs. This transparency eliminates uncertainty and allows owners to coordinate with their schedules or events.

**15‑Year Legacy & ISO Certification**  
The 15‑year legacy speaks to operational resilience and continuous improvement. ISO certification further validates that Shree Ashirwad’s processes—from driver training to vehicle maintenance—meet stringent international benchmarks. This dual pedigree differentiates the service from generic movers that often rely on ad‑hoc fleets and informal protocols.

In sum, Shree Ashirwad delivers a holistic, high‑value car transport solution from Bhopal to Pune that combines advanced technology, proven safety measures and a heritage of quality. The result is a seamless journey that protects the vehicle, respects the owner’s time, and upholds the company’s standing as the industry’s benchmark for excellence.</div>
    </div>
  </div>
</section>
...
<section class="content-ui-section" style="padding: 55px 0; background: #070d1e; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    <div style="background: rgba(15, 23, 42, 0.65); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 16px; padding: 36px 32px; box-shadow: 0 12px 30px rgba(0,0,0,0.35);">
      ...
      <h2 style="color: #ffffff; font-size: 1.7rem; font-weight: 800; line-height: 1.35; margin-bottom: 18px;">Bhopal to Pune highway corridor: logistics, transit time, and real‑time GPS tracking for your vehicle</h2>
      <div style="font-size: 1.02rem; line-height: 1.8; color: #cbd5e1;">Title: Navigating the 837-360 km Journey from Bhopal to Pune: Comprehensive Guide for Packers and Movers

Introduction:
When it comes to relocating home or office between cities, especially over long distances, hiring professional packers and movers can simplify the process significantly. Bhopal, a bustling city in the Indian state of Madhya Pradesh, and Pune, a major urban center in Maharashtra, are approximately 837-360 km apart, offering various routes to choose from. In this guide, we will focus on the most popular route via National Highways 19, 27, and 48, discussing key aspects such as typical transit duration, traffic considerations, rest-stop facilities, and the role of live satellite GPS monitoring for transparency in customer service.

Route Description:

1. National Highway 19 (NH 19): This segment of the journey begins at Bhopal and runs approximately 160 km southwards. Known locally as Bhagyalaxmi Marg and Bhimbetka Road, NH 19 connects major cities like Ujjain, Guna, and Mahendergarh.

2. National Highway 27 (NH 27): From Guna, NH 27 serves as the main highway leading to Pune. This approximately 220 km stretch connects cities like Sehore, Gwalior, and Jhansi on its way.

3. National Highway 48 (NH 48): Upon crossing Gwalior, NH 48 acts as the key transportation artery for the remaining 450 km journey into Pune. This segment connects cities like Indore, Khargone, and Aurangabad before reaching Pune.

Typical Transit Duration:
The total travel distance between Bhopal and Pune via NH 19, NH 27, and NH 48 typically takes about 14 to 16 hours, depending on traffic conditions and stops along the way. It is essential to factor in potential delays during peak hours, holidays, or accidents on the roads. It is advisable to start the journey early in the morning to ensure a smooth and timely arrival in Pune.

Traffic Considerations:
Awareness about traffic conditions is crucial during your journey. Traffic on NH 19 between Bhopal and Guna can be heavy during peak hours, especially on weekdays. NH 27 between Guna and Jhansi is relatively less congested. However, NH 48 between Jhansi and Pune experiences moderate to heavy traffic during peak hours, especially around Mumbai, Nashik, and Pune city. It is advisable to consult real-time traffic updates, road conditions, and alternate routes when planning your journey, to avoid delays and ensure a comfortable drive.

Rest Stops and Facilities:
To break the journey and maintain your energy levels, consider stopping at rest stops along the way. These facilities typically provide basic amenities, including toilets, food stalls, and parking areas for vehicles. Some popular rest stops along NH 19, NH 27, and NH 48 are:

1. Gwalior: This historic city has multiple options for rest stops, including Mahakoshal Highways, Gwalior Junction, and Raghunathpur.
2. Sehore: Located on NH 27, Sehore offers rest stops like the Sehore Bypass and Sehore Junction.
3. Jhansi: With multiple stops like Jhansi Bypass and Jhansi Bus Stand, Jhansi serves as an essential rest stop along NH 48.
4. Kurukshetra: This city, located on NH 48 near the Haryana-Maharashtra border, offers rest stops like</div>
    </div>
  </div>
</section>
...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    <div style="background: rgba(15, 23, 42, 0.65); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 16px; padding: 36px 32px; box-shadow: 0 12px 30px rgba(0,0,0,0.35);">
      ...
      <h2 style="color: #ffffff; font-size: 1.7rem; font-weight: 800; line-height: 1.35; margin-bottom: 18px;">Exact movers and packers charges from bhopal to pune: detailed cost matrix and what’s included</h2>
      <div style="font-size: 1.02rem; line-height: 1.8; color: #cbd5e1;">Transporting a vehicle from Bhopal to Pune is a significant logistical undertaking, requiring precise cost estimation to ensure value for money. At Packers & Movers Ashirwad Colony Bhopal, we prioritize absolute transparency, ensuring that every rupee spent is accounted for without any unexpected surprises. Our pricing structure for this specific route is broken down into four distinct, clearly defined components: base freight, fuel surcharge, insurance premium, and handling fees.

The base freight is the core cost of your vehicle transport. It is calculated based on the vehicle’s dimensions, weight category, and the specific route distance, which is approximately 900 to 1,000 kilometers. This fee covers the primary logistics of moving your car from the pickup point in Bhopal to the drop-off location in Pune, including the use of specialized enclosed or open transporters suitable for your vehicle type. It reflects the operational costs of the carrier, including driver wages and vehicle maintenance for the journey.

Next is the fuel surcharge, which fluctuates based on current diesel prices and the efficiency of the transport vehicle. This component is calculated as a percentage of the base freight or per kilometer driven. It ensures that our clients are protected from sudden spikes in energy costs, keeping the price fair for both the mover and the customer. This surcharge is applied transparently at the time of booking, so you know exactly what you are paying for the energy required to move your asset.

The insurance premium is a critical safety net, calculated as a small percentage of the vehicle’s current market value. This coverage protects you against any accidental damage, theft, or loss during transit. We partner with reputable insurance providers to ensure that the policy is valid and comprehensive, covering the vehicle from the moment it is loaded in Bhopal until it is unloaded in Pune. This fee is optional but highly recommended, and the cost is clearly itemized in your invoice.

Finally, handling fees cover the physical labor and equipment required for loading and unloading your vehicle. This includes the use of ramps, straps, and the labor of our trained professionals to secure your car safely. For this route, we ensure that these fees are inclusive of all standard services, such as basic documentation and coordination.

There are no hidden charges because we provide a detailed, itemized quote before you commit. Every cost component is explained, and the final invoice matches the initial estimate exactly. This level of clarity builds trust and ensures that your experience with Packers & Movers Ashirwad Colony Bhopal is smooth, predictable, and entirely transparent, free from the stress of unexpected add-ons or last-minute fees.</div>
    </div>
  </div>
</section>
...
<section class="content-ui-section" style="padding: 55px 0; background: #070d1e; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    <div style="background: rgba(15, 23, 42, 0.65); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 16px; padding: 36px 32px; box-shadow: 0 12px 30px rgba(0,0,0,0.35);">
      <span style="background: rgba(168, 85, 247, 0.12); color: #c084fc; border: 1px solid rgba(168, 85, 247, 0.35); padding: 4px 14px; border-radius: 20px; font-size: 0.78rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; display: inline-block; margin-bottom: 14px;">Legal Ready</span>
      <h2 style="color: #ffffff; font-size: 1.7rem; font-weight: 800; line-height: 1.35; margin-bottom: 18px;">RTO documentation and statutory checklist for car transport between Bhopal and Pune</h2>
...
4. **RTO Clearance** – All transfer forms are submitted on your behalf; the vehicle is re‑registered in Pune.  
5. **Final Handover** – The driver carries a printed e‑Way bill, insurance copy, and all permits, ensuring a smooth, inspection‑free journey.

By centralising every compliance step, **Shree Ashirwad** removes the administrative bottleneck for movers and packers operating between Bhopal and Pune, guaranteeing a hassle‑free, legally sound relocation.</div>
    </div>
  </div>
</section>
...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    <div style="background: rgba(15, 23, 42, 0.65); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 16px; padding: 36px 32px; box-shadow: 0 12px 30px rgba(0,0,0,0.35);">
      ...
      <h2 style="color: #ffffff; font-size: 1.7rem; font-weight: 800; line-height: 1.35; margin-bottom: 18px;">Zero‑transit scratch guarantee: safety protocols, hydraulic ramp loading, 4‑wheel lock and edge padding explained</h2>
      <div style="font-size: 1.02rem; line-height: 1.8; color: #cbd5e1;">**Safety Narrative: Scratch‑Free Transit from Bhopal to Pune**

When a household or office shipment travels the 1,200‑kilometre stretch between Bhopal and Pune, the smallest surface blemish can turn a satisfied client into a complaint. That is why our team follows three core protection steps—each designed to eliminate transit scratches and protect the reputation of every packer and mover on the route.

**1. Hydraulic Ramp Loading Procedure**  
Before any item touches the truck floor, the hydraulic ramp is lowered to a perfect 0‑degree angle. The ramp’s smooth, non‑slip surface is cleaned and inspected for debris; then a thin layer of anti‑scratch polymer film is spread across it. As crates and furniture glide onto the chassis, the ramp’s controlled descent prevents sudden jolts that could chip paint or dent wood. By eliminating the “drop‑on‑impact” moment, we remove the primary cause of surface abrasions, ensuring that delicate veneers and polished metal arrive in Bhopal‑to‑Pune shipments looking as pristine as when they left.

**2. 4‑Wheel Lock Securing Mechanism**  
Once the load is positioned, the vehicle’s four wheel‑lock brackets are engaged. Each bracket clamps the chassis at the wheel wells, locking the cargo in place without relying on straps that can bite into corners. The system distributes forces evenly across the truck’s frame, so sudden braking or cornering on the highway does not cause the load to shift. A stable, immobile load means no side‑to‑side rubbing, which is the most common source of surface scratches during long hauls. Packers and movers can therefore guarantee that every piece stays exactly where it was placed on the ramp.

**3. Custom Edge‑Padding & Crate Placement**  
Finally, every item is wrapped in custom‑cut foam edge‑padding and placed inside purpose‑built crates. The padding hugs irregular contours, creating a “cushion‑air” barrier that absorbs vibrations and minor impacts. Crates are stacked only after a “tight‑fit, loose‑move” check—ensuring no metal corners press against painted surfaces. This double‑layer defense stops micro‑scratches caused by friction between items, a frequent complaint on the Bhopal‑Pune corridor where road conditions can be uneven.

Together, these steps form a seamless safety chain: the ramp eliminates initial impact, the wheel‑lock prevents movement, and the padding guards against contact. For packers and movers operating between Bhopal and Pune, this translates into fewer repair claims, happier clients, and a reputation built on flawless, scratch‑free deliveries.</div>
    </div>
  </div>
</section>
...
<section class="content-ui-section" style="padding: 55px 0; background: #070d1e; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    <div style="background: rgba(15, 23, 42, 0.65); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 16px; padding: 36px 32px; box-shadow: 0 12px 30px rgba(0,0,0,0.35);">
      ...
      <h2 style="color: #ffffff; font-size: 1.7rem; font-weight: 800; line-height: 1.35; margin-bottom: 18px;">Get a fast, no‑obligation quote from packers and movers bhopal to pune for your vehicle</h2>
      <div style="font-size: 1.02rem; line-height: 1.8; color: #cbd5e1;"><p style="font-size: 1.04rem; line-height: 1.75; color: #f1f5f9; font-weight: 500; margin-bottom: 14px;">Engineered multi-layer protective packaging for packers and movers bhopal to pune provides heavy-duty vibration dampening and climate resilience throughout the moving journey. Shree Ashirwad certified packaging specialists apply custom shock-absorbent materials tailored to each cargo category.</p>
  ...
  <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px;">
    <h2 style="color: #ffffff; font-size: 1.7rem; font-weight: 800; margin-bottom: 25px; text-align: center;">
      ...
      <div style="margin-bottom: 14px; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 8px; padding: 16px 20px;">
        ...
        <p style="color: #cbd5e1; line-height: 1.7; font-size: 0.95rem; margin: 0;">The standard door‑to‑door transit time for an enclosed carrier on the Bhopal‑Pune corridor is 12‑14 hours, depending on traffic, weather and any scheduled rest stops. Our GPS‑enabled fleet provides real‑time updates, so you can track the exact progress of your vehicle throughout the journey.</p>
      </div>
      <div style="margin-bottom: 14px; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 8px; padding: 16px 20px;">
        ...
        <p style="color: #cbd5e1; line-height: 1.7; font-size: 0.95rem; margin: 0;">Every shipment is covered by an IRDAI‑approved marine transit insurance that insures the declared value of your vehicle up to 100 %. This policy protects against accidental damage, theft, or natural hazards during the Bhopal‑Pune haul, giving you a zero‑scratch guarantee backed by Shree Ashirwad’s 15‑year reputation.</p>
      </div>
      <div style="margin-bottom: 14px; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 8px; padding: 16px 20px;">
        ...
        <p style="color: #cbd5e1; line-height: 1.7; font-size: 0.95rem; margin: 0;">Yes. You must provide the original Registration Certificate (RC), a copy of the insurance policy, a valid government‑issued ID, and the GST invoice for the move. Our team also prepares the e‑Way bill and RTO transfer forms, ensuring a seamless handover at both ends.</p>
      </div>
      <div style="margin-bottom: 14px; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 8px; padding: 16px 20px;">
        <h3 style="color: #f8fafc; font-size: 1.1rem; font-weight: 700; margin-bottom: 8px;">Can I ship a two‑wheel vehicle or a motorcycle along with my car?</h3>
        <p style="color: #cbd5e1; line-height: 1.7; font-size: 0.95rem; margin: 0;">Absolutely. Shree Ashirwad operates dedicated two‑wheel carrier trailers equipped with wheel chocks and high‑tensile ratchet lashings. Whether you’re moving a bike, scooter, or even a small three‑wheel vehicle, it can be safely loaded on the same trip without compromising the car’s protection.</p>
      </div>
      <div style="margin-bottom: 14px; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 8px; padding: 16px 20px;">
        <h3 style="color: #f8fafc; font-size: 1.1rem; font-weight: 700; margin-bottom: 8px;">What makes your hydraulic ramp loading system safer than traditional loaders?</h3>
        <p style="color: #cbd5e1; line-height: 1.7; font-size: 0.95rem; margin: 0;">Our hydraulic ramps are motor‑driven, providing a smooth, controlled incline that eliminates jerks and sudden drops. The ramp’s anti‑slip surface, combined with the 4‑wheel lock and edge‑padding, ensures the vehicle remains stable throughout loading and unloading, reducing the risk of dents or scratches.</p>
      </div>
      <div style="margin-bottom: 14px; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 8px; padding: 16px 20px;">
        <h3 style="color: #f8fafc; font-size: 1.1rem; font-weight: 700; margin-bottom: 8px;">How do I get an accurate cost estimate for my car transport?</h3>
        <p style="color: #cbd5e1; line-height: 1.7; font-size: 0.95rem; margin: 0;">Simply fill out our online quote form or call our toll‑free number with details such as vehicle make, model, dimensions, and pickup/drop‑off locations. Within 24 hours you’ll receive a transparent, itemized quote that includes freight, fuel surcharge, insurance, and handling fees—no hidden charges.</p>
      </div>
  </div>
  <script type="application/ld+json">
{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How long does it typically take to transport a car from Bhopal to Pune?","acceptedAnswer":{"@type":"Answer","text":"The standard door‑to‑door transit time for an enclosed carrier on the Bhopal‑Pune corridor is 12‑14 hours, depending on traffic, weather and any scheduled rest stops. Our GPS‑enabled fleet provides real‑time updates, so you can track the exact progress of your vehicle throughout the journey."}},{"@type":"Question","name":"What insurance coverage is included with the car transport service?","acceptedAnswer":{"@type":"Answer","text":"Every shipment is covered by an IRDAI‑approved marine transit insurance that insures the declared value of your vehicle up to 100 %. This policy protects against accidental damage, theft, or natural hazards during the Bhopal‑Pune haul, giving you a zero‑scratch guarantee backed by Shree Ashirwad’s 15‑year reputation."}},{"@type":"Question","name":"Do I need to prepare any documents before the vehicle is loaded?","acceptedAnswer":{"@type":"Answer","text":"Yes. You must provide the original Registration Certificate (RC), a copy of the insurance policy, a valid government‑issued ID, and the GST invoice for the move. Our team also prepares the e‑Way bill and RTO transfer forms, ensuring a seamless handover at both ends."}},{"@type":"Question","name":"Can I ship a two‑wheel vehicle or a motorcycle along with my car?","acceptedAnswer":{"@type":"Answer","text":"Absolutely. Shree Ashirwad operates dedicated two‑wheel carrier trailers equipped with wheel chocks and high‑tensile ratchet lashings. Whether you’re moving a bike, scooter, or even a small three‑wheel vehicle, it can be safely loaded on the same trip without compromising the car’s protection."}},{"@type":"Question","name":"What makes your hydraulic ramp loading system safer than traditional loaders?","acceptedAnswer":{"@type":"Answer","text":"Our hydraulic ramps are motor‑driven, providing a smooth, controlled incline that eliminates jerks and sudden drops. The ramp’s anti‑slip surface, combined with the 4‑wheel lock and edge‑padding, ensures the vehicle remains stable throughout loading and unloading, reducing the risk of dents or scratches."}},{"@type":"Question","name":"How do I get an accurate cost estimate for my car transport?","acceptedAnswer":{"@type":"Answer","text":"Simply fill out our online quote form or call our toll‑free number with details such as vehicle make, model, dimensions, and pickup/drop‑off locations. Within 24 hours you’ll receive a transparent, itemized quote that includes freight, fuel surcharge, insurance, and handling fees—no hidden charges."}}]}
  </script>
</section>
...
<section class="related-relocation-searches" style="padding: 40px 0; background: #070d1e; border-top: 1px solid rgba(255,255,255,0.08); text-align: center;">
  <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px;">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 10px; justify-content: center;">
      ...
      <span style="background: rgba(245, 158, 11, 0.08); border: 1px solid rgba(245, 158, 11, 0.28); color: #cbd5e1; padding: 7px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 600; display: inline-flex; align-items: center; gap: 6px;"><span style="color: #f59e0b;">&bull;</span> composite packers and movers bhopal</span>
      ...
      <span style="background: rgba(245, 158, 11, 0.08); border: 1px solid rgba(245, 158, 11, 0.28); color: #cbd5e1; padding: 7px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 600; display: inline-flex; align-items: center; gap: 6px;"><span style="color: #f59e0b;">&bull;</span> domestic movers and packers in nigdi pune</span>
