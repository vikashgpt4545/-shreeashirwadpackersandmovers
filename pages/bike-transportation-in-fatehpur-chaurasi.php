...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px; margin-top: 24px;">
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Make sure the original Registration Certificate (RC) is available and keep a self-attested photocopy with you.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Self-attestation ensures the authenticity of the photocopy, which is required while crossing border points or dealing with authorities.</p>
  </div>
</div>
...
<h3>Important Tips for Bike Transportation in Fatehpur Chaurasi

    Ensure your motorcycle is in proper working condition and undergoes a thorough check prior to transportation.
    Clean your bike thoroughly to avoid any potential damages during transportation.
    Collect all the necessary documents and keep them organized to avoid any delays or complications.
    Make sure you have a valid and updated registration document, insurance policy, and a valid driver&amp;#039;s license.


Contact Details for Bike Transportation Services in Fatehpur Chaurasi</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Important Tips for Bike Transportation in Fatehpur Chaurasi
...
Contact Details for Bike Transportation Services in Fatehpur Chaurasi ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
