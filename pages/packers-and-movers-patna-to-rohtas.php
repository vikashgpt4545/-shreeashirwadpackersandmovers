...
$page_title = "Packers and Movers Patna to Rohtas | Safe Intercity Relocation";
$page_desc = "Hire certified packers and movers from Patna to Rohtas (Sasaram / Dehri on Sone). Shree Ashirwad Packers offers safe household shifting, bike transport, and car carrier services via NH-19 with 100% IBA GST bills & insurance.";
$page_keywords = "packers and movers patna to rohtas, best packers and movers patna to rohtas, house shifting patna to rohtas, bike transport patna to rohtas, car carrier patna to rohtas, shree ashirwad packers rohtas sasaram";
...
$faq_list = [
    [
        'q' => 'What are the charges for packers and movers from Patna to Rohtas (Sasaram)?',
        'a' => 'Intercity shifting rates from Patna to Rohtas (Sasaram / Dehri) start from ₹7,000 to ₹12,000 for a 1 BHK, ₹12,000 to ₹17,500 for a 2 BHK, and ₹17,000 to ₹25,000 for a 3 BHK family house, depending on total weight and container type.'
    ],
    [
        'q' => 'How long does goods delivery take from Patna to Rohtas?',
        'a' => 'The distance between Patna and Sasaram / Dehri on Sone in Rohtas district is approximately 155 km via Arrah - Mohania / Bikramganj corridor. Delivery takes about 8 to 16 hours.'
    ],
    [
    ...
    [
        'q' => 'Is bike and car transport available from Patna to Rohtas?',
    ...
    [
        'q' => 'Do you cover shifting to Sasaram, Dehri on Sone, and Bikramganj near Rohtas?',
        'a' => 'Yes, we serve the entire Rohtas district including Sasaram, Dehri on Sone, Bikramganj, Chenari, and Nokha.'
    ],
    [
        'q' => 'Is transit insurance included with intercity shifting to Rohtas?',
    ...
    [
        'q' => 'How do I schedule a pre-move survey in Patna for Rohtas shifting?',
    ...
    [
        'q' => 'How can I book Packers and Movers Patna to Rohtas?',
...
<main class="site-main">
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            PATNA TO ROHTAS RELOCATION SPECIALISTS
          </span>
          ...
          <p style="font-size: 1.08rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Shree Ashirwad Packers and Movers provides certified doorstep household shifting, bike transport, and car carrier services from Patna to Rohtas (Sasaram / Dehri on Sone). 100% IBA-approved GST invoices & transit insurance included.
          </p>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20a%20shifting%20quote%20for%20Patna%20to%20Rohtas." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
          ...
          <div style="display: flex; gap: 20px; font-size: 0.9rem; color: #94a3b8;">
            ...
            <span><strong style="color: #f59e0b;">Sasaram & Dehri</strong> Coverage</span>
          </div>
        </div>

        <!-- Hero Lead Form Column -->
        <div class="hero-form-card" style="background: rgba(255, 255, 255, 0.05); backdrop-filter: blur(10px); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 16px; padding: 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
          <h2 style="font-size: 1.4rem; color: #ffffff; margin-bottom: 8px; font-weight: 700; text-align: center;">Get Rohtas Quote</h2>
          ...
          <form action="#" method="POST" onsubmit="sendHeroWhatsAppLead(event, this);">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 14px;">
              ...
              <input type="text" name="move_to" class="form-control" value="Rohtas (Sasaram)" required style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.3); color: #fff;">
            </div>
  ...
  <section style="background: #172a54; padding: 30px 0; border-top: 1px solid rgba(255,255,255,0.1); border-bottom: 1px solid rgba(255,255,255,0.1);">
    <div class="container">
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; text-align: center; color: #ffffff;">
        <div>
          <div style="font-size: 2.2rem; font-weight: 800; color: #f59e0b;">155 KM</div>
          <div style="font-size: 0.9rem; color: #cbd5e1;">Patna-Rohtas Route Distance</div>
        </div>
        <div>
          <div style="font-size: 2.2rem; font-weight: 800; color: #f59e0b;">8-16 HRS</div>
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #e2e8f0; line-height: 1.8;">
    <div class="container" style="max-width: 1000px;">
      ...
      <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">
        Seamless Express Relocation from <span style="color: #f59e0b;">Patna to Rohtas</span>
      </h2>
      <p style="font-size: 1.05rem; color: #cbd5e1; margin-bottom: 20px;">
        Rohtas district (headquartered at Sasaram with major industrial hub Dehri on Sone) is located ~155 km southwest of Patna. Intercity transit via Bikramganj or Arrah-NH19 requires well-planned routing for heavy goods trucks.
      </p>
      <p style="font-size: 1.05rem; color: #cbd5e1;">
        Shree Ashirwad Packers and Movers provides end-to-end relocation from Patna (Boring Road, Kankarbagh, Danapur, Bailey Road) to Sasaram, Dehri on Sone, Bikramganj, and Chenari.
      </p>
    </div>
  </section>
  ...
  <section style="padding: 60px 0; background: #070d1e; color: #e2e8f0;">
    <div class="container" style="max-width: 1000px;">
      <div style="text-align: center; margin-bottom: 40px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin-top: 10px;">Patna to Rohtas Shifting Rates</h2>
        ...
        <table style="width: 100%; border-collapse: collapse; background: #172a54; border-radius: 10px; overflow: hidden; border: 1px solid rgba(245, 158, 11, 0.3);">
          ...
          <tbody>
            ...
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.08);">
              ...
              <td style="padding: 12px 16px; color: #6ee7b7;">₹12,000 - ₹17,500</td>
            ...
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.08);">
              ...
              <td style="padding: 12px 16px; color: #6ee7b7;">₹2,200 - ₹3,800</td>
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #ffffff;">
    <div class="container" style="max-width: 1100px;">
      <div style="text-align: center; margin-bottom: 45px;">
        ...
        <p style="color: #94a3b8; font-size: 1rem;">Complete moving solutions from Patna to Rohtas</p>
      </div>
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 25px;">
        <div style="background: #101c40; padding: 25px; border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          ...
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.6;">Full household goods packing and covered container transit from Patna to Rohtas (Sasaram).</p>
        </div>
        ...
        <div style="background: #101c40; padding: 25px; border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          ...
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.6;">Enclosed car carriers and scratch-free bike transport to Sasaram & Dehri on Sone.</p>
        </div>

        <div style="background: #101c40; padding: 25px; border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.2);">
          <i class="fas fa-building" style="font-size: 2rem; color: #f59e0b; margin-bottom: 15px;"></i>
          <h3 style="font-size: 1.3rem; font-weight: 700; color: #ffffff; margin-bottom: 10px;">Govt & Industrial Shifting</h3>
          <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.6;">Specialized employee and industrial machinery relocation for Dehri and Sasaram sector.</p>
        </div>
  ...
  <section style="padding: 60px 0; background: #070d1e; color: #ffffff;">
    <div class="container" style="max-width: 1000px;">
      <div style="text-align: center; margin-bottom: 45px;">
        ...
        <p style="color: #94a3b8;">Systematic approach for stress-free Patna to Rohtas shifting</p>
      </div>
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 20px;">
        ...
        <div style="background: #101c40; padding: 20px; border-radius: 10px; border-left: 4px solid #f59e0b;">
          ...
          <h4 style="font-size: 1.8rem; font-weight: 800; color: #f59e0b;">NH Highway Transit</h4>
        ...
        <div style="background: #101c40; padding: 20px; border-radius: 10px; border-left: 4px solid #f59e0b;">
          ...
          <p style="color: #cbd5e1; font-size: 0.88rem;">Doorstep unloading in Sasaram/Dehri, furniture positioning, and cleanup.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #e2e8f0;">
    <div class="container" style="max-width: 1000px;">
      <div style="text-align: center; margin-bottom: 40px;">
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff;">Why Choose Shree Ashirwad for Rohtas Shifting?</h2>
      </div>
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px;">
        <div style="background: #172a54; padding: 20px; border-radius: 10px;">
          ...
          <p style="color: #cbd5e1; font-size: 0.92rem; margin: 0;">Weatherproof closed-body container trucks operating regularly on Patna-Rohtas route.</p>
        </div>
  ...
  <section class="faq-section" style="padding: 60px 0; background: #070d1e; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      <div style="text-align: center; margin-bottom: 40px;">
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff;">Frequently Asked Questions (Patna to Rohtas)</h2>
      </div>
  ...
  <section style="padding: 50px 0; background: linear-gradient(135deg, #d32f2f 0%, #1e3a8a 100%); color: #ffffff; text-align: center;">
    <div class="container" style="max-width: 800px;">
      <h2 style="font-size: 2.2rem; font-weight: 800; margin-bottom: 15px; color: #ffffff;">Moving from Patna to Rohtas?</h2>
      ...
      <div style="display: flex; gap: 15px; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20need%20moving%20services%20from%20Patna%20to%20Rohtas." title="WhatsApp Inquiry" target="_blank" style="padding: 14px 30px; background: #10b981; color: #ffffff; border-radius: 50px; font-weight: 700; text-decoration: none; font-size: 1rem;">
...
<script type="application/ld+json">
{
  ...
  "description": "Top-rated packers and movers from Patna to Rohtas (Sasaram / Dehri) offering doorstep house shifting and vehicle transport.",
  ...
  "areaServed": "Rohtas, Bihar",
  "priceRange": "₹2200 - ₹25000"
}
</script>
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers,\n\nI would like a Shifting Quote for Patna to Rohtas:\n- Name: " + name + "\n- Phone: " + phone + "\n- Moving From: " + moveFrom + "\n- Moving To: " + moveTo;
