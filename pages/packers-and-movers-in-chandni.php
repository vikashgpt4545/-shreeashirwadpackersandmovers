    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">As a senior logistics coordinator for Shree Ashirwad Packers and Movers, we specialize in efficient household shifting and relocation services for residents of Chandni Chowk. For a journey from Chandni to our Destination Hub, we recommend taking the National Highway Arterial Corridors and Multi-Axle Express Freight Highways, which cover a distance of approximately 850 km. Our experts will ensure a smooth transit by navigating through the interstate border checkposts, facilitating the automation of e-Way bill clearance, and maintaining speed-governed container transit. With our cutting-edge technology and experienced team, we guarantee a hassle-free experience for our customers.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For household items, we employ a meticulous packing process, utilizing reinforced boxes and bubble wrap to secure fragile items. Our skilledloading team ensures that your belongings are properly secured within the container, minimizing the risk of damage during transit. For vehicles, we provide specialized equipment, including tilt-trailers and side-loaders, to ensure safe transportation. To further protect your assets, we offer customized transit protection, including GPS tracking and real-time monitoring of the container&#039;s journey. With Shree Ashirwad Packers and Movers, you can trust that your belongings are in good hands, from packing to delivery.</p>
        </div>
      </div>
    </div>
  </section>
