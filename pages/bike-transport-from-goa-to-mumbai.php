...
$faq_list = [
    [
        'q' => 'How are relocation charges calculated for Bike Transport from Goa to Mumbai | Two-Wheeler Shifting Charges?',
    ...
    [
        'q' => 'How many days in advance should I confirm my booking for Bike Transport from Goa to Mumbai | Two-Wheeler Shifting Charges?',
        'a' => 'For regional moves within Goa, booking 2 to 3 days prior is recommended. For intercity transit to Mumbai, we advise confirming 4 to 7 days ahead to reserve dedicated weatherproof container trucks and preferred morning departure slots.'
    ],
    [
    ...
    [
        ...
        'a' => 'Our certified moving crews are equipped with heavy furniture lifter straps, hydraulic trolleys, and protective floor sheets. We coordinate smoothly with apartment society management in both Goa and Mumbai to ensure elevator compliance.'
    ],
];
...
<section class="content-ui-section" style="padding: 55px 0; background: #0b132b; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  ...
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    ...
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>These boxes provide robust and sturdy protection for your bike during the transportation process. They can bear a significant amount of weight and resist damage from accidental falls or bumps.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Bubble Cushioning:</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Bubble wrap plays a crucial role in absorbing shock and preventing scratches, dents, or other minor damages to your bike. Bubble cushioning ensures that your bike remains safe even during bumpy rides.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
	...
	<h3>Mumbai to Goa Transport
	
		Packers and Movers Mumbai to Goa Charges: The cost of bike transport depends on various factors, including the distance, transportation method, and the services provided by the moving company.
		For instance, road transportation might be the most affordable option, but sea or air transport can be more expensive due to additional safety measures and documentation requirements.
		It is advisable to get multiple quotes from reliable packing and moving companies to compare prices and select the best option for your budget and needs.
	

	Packers and Movers in Goa
	
		Packers and Movers in Goa: Ensure to choose a reputable and experienced moving company that specializes in bike transportation. They should provide comprehensive insurance coverage to protect your bike during transit.
		Home Shifting Services in Mumbai: Similarly, when choosing a packers and movers company in Mumbai, ensure they provide dedicated services for bike transport. Look for a company with a good track record and positive customer feedback.
		Packers and Movers in Mumbai Bhandup: Select a reliable packers and movers company in Bhandup, Mumbai, that offers premium packing materials for your bike transportation. This includes using strong cartons, protective foam, and wooden crates for an added layer of safety.
	

	Transportation Methods between Goa and Mumbai</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Mumbai to Goa Transport
	...
	Transportation Methods between Goa and Mumbai ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Goa to Mumbai corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
