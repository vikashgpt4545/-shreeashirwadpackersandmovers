...
<section class="content-ui-section" style="padding: 55px 0; background: #070d1e; color: #cbd5e1; border-bottom: 1px solid rgba(255,255,255,0.07);">
  <div class="container" style="max-width: 1060px; margin: 0 auto; padding: 0 15px;">
    <div style="background: rgba(15, 23, 42, 0.65); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 16px; padding: 36px 32px; box-shadow: 0 12px 30px rgba(0,0,0,0.35);">
      ...
      <div style="font-size: 1.02rem; line-height: 1.8; color: #cbd5e1;"><p>When moving a two-wheeler from Gunupur, selecting between an enclosed containerized carrier and an open carrier trailer is a primary safety decision. Enclosed container trucks provide a sealed environment that shields the motorcycle from flying highway stones, monsoonal rain, abrasive dust, and vandalism throughout the transit journey.</p>
<ul style="list-style: none; padding-left: 0; margin: 18px 0;">
  <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;"><i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i><span><strong>All-Weather Protection:</strong> Heavy-duty sealed container walls isolate vehicles from torrential highway downpours and environmental grit.</span></li>
  <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;"><i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i><span><strong>Debris & Road Shielding:</strong> High-speed projectile stones on interstate highways are completely deflected by the rigid exterior shell.</span></li>
  <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;"><i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i><span><strong>Pneumatic Wheel-Lock Stability:</strong> Interior wheel-chocks and high-tensile ratchet lashing prevent chassis shifting and perimeter friction.</span></li>
  <li style="margin-bottom: 10px; display: flex; align-items: flex-start; gap: 10px;"><i class="fas fa-check-circle" style="color: #10b981; margin-top: 5px; flex-shrink: 0; font-size: 0.95rem;"></i><span><strong>Lockable Cargo Security:</strong> Tamper-evident container sealing eliminates unauthorized access at transit checkpoints and wayside stops.</span></li>
</ul></div>
    </div>
  </div>
</section>
