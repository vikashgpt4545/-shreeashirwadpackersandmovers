        ...
        <div class="hero-text">
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            <a href="tel:<?php echo SITE_PHONE_RAW; ?>" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #d32f2f 0%, #f59e0b 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(211, 47, 47, 0.4);">
              📞 Call IBA Desk: <?php echo SITE_PHONE; ?>
            </a>
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20need%20IBA%20approved%20shifting%20bill%20and%20quote%20in%20Jamshedpur." target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
              💬 Chat on WhatsApp
            </a>
          </div>
        </div>
  ...
  <section style="padding: 35px 0; background: #070d19; border-bottom: 1px solid rgba(245, 158, 11, 0.2);">
    <div class="container">
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 15px; text-align: center;">
        <div><h3 style="color: #f59e0b; font-size: 2rem; font-weight: 800;">100%</h3><p style="color: #cbd5e1; font-size: 0.85rem;">IBA Code Compliant</p></div>
        <div><h3 style="color: #f59e0b; font-size: 2rem; font-weight: 800;">3,200+</h3><p style="color: #cbd5e1; font-size: 0.85rem;">Bank Staff Relocations</p></div>
        <div><h3 style="color: #f59e0b; font-size: 2rem; font-weight: 800;">Official</h3><p style="color: #cbd5e1; font-size: 0.85rem;">GST &amp; LR Receipts</p></div>
        <div><h3 style="color: #f59e0b; font-size: 2rem; font-weight: 800;">Guaranteed</h3><p style="color: #cbd5e1; font-size: 0.85rem;">Claim Approval Support</p></div>
      </div>
    </div>
  </section>

  <!-- Section 3: IBA Billing Set -->
  <section style="padding: 60px 0; background: #ffffff;">
    <div class="container">
      <div style="max-width: 900px; margin: 0 auto;">
        
        <h2 style="font-size: 2.1rem; color: #0b132b; font-weight: 800; margin-bottom: 20px;">
          Complete IBA Approved Billing Documentation Set Provided
        </h2>
        <p style="color: #475569; font-size: 1rem; line-height: 1.8; margin-bottom: 25px;">
          Public sector bank employees (SBI, PNB, Bank of Baroda, Canara Bank), defense personnel, and Tata company officers require standardized billing documents for employer claim submission. We supply complete 100% valid paperwork:
        </p>

        <div style="display: flex; flex-direction: column; gap: 25px;">
          
          <div style="background: #f8fafc; padding: 25px; border-radius: 12px; border-left: 5px solid #d32f2f;">
            <h3 style="font-size: 1.3rem; color: #0b132b; margin-bottom: 10px;">1. Official GST Invoice with Sac Code</h3>
            <p style="color: #64748b; font-size: 0.95rem; line-height: 1.7;">
              Itemized GST bill stamped with company registration details, SAC code 996511 (freight transport) and 996729 (storage &amp; packing).
            </p>
          </div>

          <div style="background: #f8fafc; padding: 25px; border-radius: 12px; border-left: 5px solid #f59e0b;">
            <h3 style="font-size: 1.3rem; color: #0b132b; margin-bottom: 10px;">2. Consignment Note (Lorry Receipt / LR Copy)</h3>
            <p style="color: #64748b; font-size: 0.95rem; line-height: 1.7;">
              Official 4-copy LR receipt detailing origin, destination, vehicle number, gross weight, and freight charges.
            </p>
          </div>

          <div style="background: #f8fafc; padding: 25px; border-radius: 12px; border-left: 5px solid #d32f2f;">
            <h3 style="font-size: 1.3rem; color: #0b132b; margin-bottom: 10px;">3. Itemized Packing List &amp; Money Receipt</h3>
            <p style="color: #64748b; font-size: 0.95rem; line-height: 1.7;">
              Numbered inventory sheet signed by crew supervisor alongside stamped payment money receipt acknowledging full settlement.
            </p>
          </div>

          <div style="background: #f8fafc; padding: 25px; border-radius: 12px; border-left: 5px solid #f59e0b;">
            <h3 style="font-size: 1.3rem; color: #0b132b; margin-bottom: 10px;">4. Transit Insurance Certificate</h3>
            <p style="color: #64748b; font-size: 0.95rem; line-height: 1.7;">
              Legitimate transit insurance policy copy issued by recognized insurance companies covering loss or damage in transit.
            </p>
          </div>
  ...
  <section style="padding: 50px 0; background: #f8fafc;">
    <div class="container">
      <div style="text-align: center; max-width: 800px; margin: 0 auto 30px auto;">
        <h3 style="font-size: 1.8rem; color: #0b132b; font-weight: 800;">Related <span style="color: #d32f2f;">IBA &amp; Shifting Services</span></h3>
      </div>
  ...
  <section style="padding: 50px 0; background: #ffffff;">
    <div class="container">
      ...
      <div style="max-width: 850px; margin: 0 auto; display: flex; flex-direction: column; gap: 12px;">
        <div style="background: #f8fafc; padding: 18px; border-radius: 8px; border: 1px solid #e2e8f0;"><h4 style="color: #0b132b;">Q1: Will bank management accept your shifting bills?</h4><p style="color: #64748b; font-size: 0.9rem;">Yes, 100% of our bills are formatted as per IBA and bank employee claim standards.</p></div>
        <div style="background: #f8fafc; padding: 18px; border-radius: 8px; border: 1px solid #e2e8f0;"><h4 style="color: #0b132b;">Q2: How long does it take to issue the final bill set?</h4><p style="color: #64748b; font-size: 0.9rem;">Original hard copies are handed over on moving day or dispatched via speed post within 24 hours.</p></div>
        <div style="background: #f8fafc; padding: 18px; border-radius: 8px; border: 1px solid #e2e8f0;"><h4 style="color: #0b132b;">Q3: How to request IBA shifting documents from Shree Ashirwad Packers?</h4><p style="color: #64748b; font-size: 0.9rem;">Call <strong>+91 8409531615</strong> or message us on WhatsApp for immediate IBA document generation.</p></div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div style="text-align: center; max-width: 800px; margin: 0 auto;">
        ...
        <div style="display: flex; gap: 15px; justify-content: center; flex-wrap: wrap;">
          ...
          <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20need%20IBA%20approved%20shifting%20quote%20in%20Jamshedpur." target="_blank" style="padding: 14px 32px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #fff; border-radius: 50px; font-weight: 700; text-decoration: none;">💬 WhatsApp Quote</a>
        </div>
      </div>
    </div>
  </section>
