...
<h3>1. Digital Condition Audit
    ...
    01
    Protocol 01</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Before transporting your motorcycle or two-wheeler, conduct a thorough digital condition audit using a smartphone or camera. This audit will help you document any existing damages, scratches, or defects on your vehicle.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Take high-quality photos or videos of all angles, including the engine, wheels, chassis, and other vital components.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #3b82f622; color: #3b82f6; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">03</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 03</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Upload the photos and videos to a secure platform or storage device for future reference.</p>
  </div>
</div>

<h3>2. Battery Terminal Checks

Inspect the battery terminals for any loose connections or corrosion.
If necessary, clean the terminals using a battery cleaner and apply a protective coating to prevent corrosion.
Reconnect the cables securely and ensure they are properly tightened.


3. Fuel Management

Fill your motorcycle or two-wheeler&amp;#039;s tank with one-quarter tank of fuel to avoid spillage during transportation.
Make sure the fuel tank cap is properly sealed to prevent any leakage.
Ensure the fuel level is within the recommended range of IRCTC (Indian Railway Catering and Tourism Corporation) guidelines.


4. FASTag Management

If you have a FASTag (Fastag), ensure it is properly attached to your vehicle.
Confirm that it is functional and in good condition before transport.
Ensure that the FASTag is registered under your name or the name of the person responsible for the bike transport.


5. EMI Installment Management

If you have any EMI installments on your two-wheeler, ensure that they are up-to-date before transport.
Properly document the EMI details to avoid any discrepancies during the transportation process.
Confirm that you have received written confirmation from the EMI provider regarding the current status of the EMI payments.


6. Vehicle Preparation

Ensure that your motorcycle or two-wheeler is properly cleaned and ready for transportation.
Clear all personal belongings from the vehicle to avoid any potential issues during loading or unloading procedures.
Make sure the vehicle is properly parked and securely tied down to prevent any movement during transport.


7. Documentation Check</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for 2. Battery Terminal Checks
...
7. Documentation Check ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
