...
$page_title = "Sindoor | Shree Ashirwad Packers & Movers";
...
$page_keywords = "house shifting services, courier services to transport furniture, courier rates from pune to mumbai, charges of movers and packers from one state to another, iba approved packers and movers in gurgaon, pack movers credit in gst, packing and storage services pune, safe express packers and movers gurgaon haryana, bengaluru to chennai packers and movers, mahalaxmi packers faridabad";
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello+Shree+Ashirwad+Packers+%26+Movers%2C+I+would+like+to+request+a+quotation+for+Sindoor+from+Origin+City+to+Major+Indian+City." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="text-align: center; margin-bottom: 40px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; margin-top: 8px;">
          Sindoor <span style="color: #f59e0b;">Cost Matrix &amp; Tariffs</span>
        </h2>
    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">We need 2 paragraphs, 150-220 words total. Provide freight advice for a house shifting service between origin and major Indian city. Provide exact freight highway route, interstate border checkposts, e-Way bill clearance, speed-governed container transit. Provide packing, loading, damage-free transit protection. Use primary keyword &quot;house shifting services&quot;. 150-220 words. Must be 100% unique. Let&#039;s craft 2 paragraphs, each about 75-110 words, total 150-220 words. Use authoritative tone.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">Let&#039;s choose route: from origin city (maybe Delhi) to major Indian city (Mumbai) via NH 44, NH 48, NH 48? Actually Delhi to Mumbai via NH 48 and NH 8? Let&#039;s choose typical: NH 44 to NH 48. Provide interstate border checkposts: Delhi- Haryana, Rajasthan? Actually Delhi to Mumbai passes through Haryana, Rajasthan, Gujarat? Let&#039;s pick route: Delhi -&gt; Panipat (Haryana) -&gt; Bhiwadi (Uttar Pradesh) -&gt; Ajmer (Rajasthan) -&gt; Udaipur (Rajasthan) -&gt; Ahmedabad (Gujarat) -&gt; Vadodara (Gujarat) -&gt; Surat (Gujarat) -&gt; Bharuch (Gujarat) -&gt; Mumbai</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px;">
      <div style="text-align: center; margin-bottom: 45px;">
        ...
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin-top: 10px;">
          Frequently Asked Questions About <span style="color: #f59e0b;">Sindoor</span>
        </h2>
      </div>
  ...
  <section style="padding: 60px 0; background: linear-gradient(135deg, #172a54 0%, #0b132b 100%); border-top: 1.5px solid rgba(245, 158, 11, 0.4); color: #ffffff;">
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 15px; text-align: center;">
      <h2 style="font-size: 2.3rem; font-weight: 800; margin-bottom: 16px;">
        Book Your <span style="color: #f59e0b;">Sindoor</span> Today!
      </h2>
      ...
      <div style="display: flex; gap: 16px; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="https://wa.me/918409531615?text=Hello+Shree+Ashirwad+Packers+%26+Movers%2C+I+would+like+to+request+a+quotation+for+Sindoor+from+Origin+City+to+Major+Indian+City." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 15px 32px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1.05rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
          <i class="fab fa-whatsapp" style="margin-right: 8px;"></i> Chat on WhatsApp
        </a>
      </div>
    </div>
  ...
  "@graph": [
    {
      ...
      "knowsAbout": ["house shifting services","courier services to transport furniture","courier rates from pune to mumbai","charges of movers and packers from one state to another","iba approved packers and movers in gurgaon","pack movers credit in gst","packing and storage services pune","safe express packers and movers gurgaon haryana","bengaluru to chennai packers and movers","mahalaxmi packers faridabad"],
