    ...
    <div class="container" style="max-width: 1100px; margin: 0 auto; padding: 0 15px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="grid-column: 1 / -1; margin-top: 25px; background: rgba(245, 158, 11, 0.06); border: 1.5px solid rgba(245, 158, 11, 0.3); border-radius: 14px; padding: 28px;">
          ...
          <p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">For relocation services from Chandigarh to our destination hub, our logistics experts have meticulously mapped the optimal route. The journey begins at the City Centre, Railway Station Road, Industrial Area in Chandigarh, where our team will carefully pack and load your household items or vehicles onto a multi-axle express freight container. The container will then be transported via National Highway Arterial Corridors and Multi-Axle Express Freight Highways, ensuring a smooth and efficient transit. Key transit points include the interstate border checkpost at Amritsar and the speed-governed container transit at the Panipat truck depot. Our team will facilitate automated e-Way bill clearance, ensuring a hassle-free experience for our clients.</p><p style="color: #cbd5e1; line-height: 1.85; margin-bottom: 15px; font-size: 0.96rem;">To ensure damage-free transit, our packing and loading experts will employ specialized techniques tailored to the specific requirements of household items or vehicles. Using high-quality packing materials, including specialized packaging nets in Chandigarh, our team will carefully wrap and secure each item to prevent movement during transit. We also utilize climate-controlled containers to safeguard sensitive items from extreme temperatures. To further ensure a seamless relocation experience, our team will provide real-time tracking and monitoring, allowing clients to stay updated on the status of their shipment. By leveraging our expertise and cutting-edge logistics solutions, we guarantee a safe,</p>
        </div>
      </div>
    </div>
  </section>
