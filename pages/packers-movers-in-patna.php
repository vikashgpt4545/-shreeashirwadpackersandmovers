...
$page_title = "Packers Movers in Patna | Top Shifting & Relocation Company";
$page_desc = "Looking for reliable packers movers in Patna? Shree Ashirwad Packers offers professional home shifting, office relocation, vehicle transport, 7-layer packaging, and IBA GST bills.";
$page_keywords = "packers movers in patna, packers and movers patna, home shifting patna, relocation service patna, local movers patna";
$canonical_url = "https://shreeashirwadpackersandmovers.com/pages/packers-movers-in-patna.php";

$page_city = "Patna, Bihar";

$faq_list = [
    [
        'q' => 'What services are offered by packers movers in Patna?',
        'a' => 'Services include local household shifting, intercity moving, corporate office relocation, car carrier transport, bike shipping, and secure warehouse storage.'
    ],
    [
        'q' => 'How much does local house shifting cost with packers movers in Patna?',
        'a' => 'Local 1BHK relocation starts from ₹4,200 to ₹6,500, 2BHK ranges between ₹6,500 and ₹9,500, while 3BHK household moving costs ₹9,500 to ₹14,500.'
    ],
    [
        'q' => 'Which areas in Patna do you cover for packing and moving?',
        'a' => 'Full packing and moving coverage is provided across Boring Road, Kankarbagh, Danapur, Bailey Road, Patliputra Colony, Ashiana Nagar, Exhibition Road, and Bihta.'
    ],
    [
        'q' => 'Is transit insurance available for household relocation in Patna?',
        'a' => 'Yes, 100% comprehensive transit insurance (1.5% declared value) protects your goods against accidental damages during road transport.'
    ],
    [
    ...
    [
        'q' => 'What type of packing material is used for fragile items?',
        'a' => 'We use 7-layer safety packaging including heavy-duty bubble wrap, corrugated sheets, foam corners, and wooden crates.'
    ],
    [
        'q' => 'How can I transport my bike or car along with house goods?',
        'a' => 'We offer integrated truck loads where your vehicle is securely locked in enclosed containers alongside your household items.'
    ],
    [
    ...
    [
        ...
        'a' => 'Yes, unpacking, furniture positioning, bed assembly, and appliance setup are fully included in our premium services.'
    ],
    [
        'q' => 'How do I book packers movers in Patna?',
        'a' => 'Call +91 8409531615 or submit your moving details on WhatsApp for an immediate price estimate.'
    ]
];
      ...
      <div class="hero-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center;">
        ...
        <div class="hero-text">
          <span class="section-tag" style="background: rgba(14, 165, 233, 0.15); color: #0ea5e9; border: 1px solid rgba(14, 165, 233, 0.4); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 15px;">
            PATNA RELOCATION EXPERTS
          </span>
          <h1 style="font-size: 2.7rem; font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #ffffff;">
            Reliable <span style="color: #0ea5e9;">Packers Movers in Patna</span>
          </h1>
          <p style="font-size: 1.12rem; color: #cbd5e1; line-height: 1.8; margin-bottom: 25px;">
            Shree Ashirwad Packers and Movers delivers hassle-free household shifting, office relocation, and vehicle shipping in Patna. Benefit from 7-layer packaging, zero-damage guarantees, and IBA-approved GST billing.
          </p>
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
            ...
            <a href="https://wa.me/918409531615?text=Hello%20Shree%20Ashirwad%20Packers,%20I%20want%20a%20Packers%20Movers%20quote%20for%20Patna." title="Chat on WhatsApp" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; padding: 14px 28px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; border-radius: 50px; font-weight: 700; font-size: 1rem; text-decoration: none; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);">
          ...
          <div style="display: flex; gap: 20px; font-size: 0.9rem; color: #94a3b8;">
            ...
            <span><strong style="color: #0ea5e9;">7-Layer</strong> Bubble Packaging</span>
  ...
  <section style="padding: 60px 0; background: #0b132b; color: #e2e8f0; line-height: 1.8;">
    <div class="container" style="max-width: 1000px;">
      ...
      <span class="section-tag" style="color: #0ea5e9; text-transform: uppercase; font-weight: 700; font-size: 0.85rem; letter-spacing: 1px;">
        FULL-SERVICE RELOCATION PATNA
      </span>
      <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff; margin: 10px 0 20px 0;">
        Professional Packers Movers in <span style="color: #0ea5e9;">Patna</span>
      </h2>
      
      <p style="font-size: 1.05rem; color: #cbd5e1; margin-bottom: 25px;">
        Whether moving locally within Patna or relocating interstate across India, Shree Ashirwad Packers and Movers provides end-to-end logistics solutions. We cover major localities including Boring Road, Kankarbagh, Danapur, Bailey Road, Patliputra Colony, Ashiana Nagar, Exhibition Road, and Bihta.
      </p>

      <!-- Rate Matrix Table -->
      <div style="overflow-x: auto; margin: 40px 0;">
        <h3 style="font-size: 1.5rem; color: #ffffff; font-weight: 700; margin-bottom: 15px;">
          Estimated Packing & Moving Charges in Patna
        </h3>
        <table style="width: 100%; border-collapse: collapse; background: #172a54; border-radius: 10px; overflow: hidden; border: 1px solid rgba(14, 165, 233, 0.3);">
          <thead>
            <tr style="background: #1e3a8a; color: #0ea5e9; text-align: left;">
              <th style="padding: 14px 16px;">Move Size</th>
  ...
  <section class="faq-section" style="padding: 60px 0; background: #070d1e; color: #ffffff;">
    <div class="container" style="max-width: 900px;">
      <div style="text-align: center; margin-bottom: 40px;">
        <h2 style="font-size: 2.2rem; font-weight: 800; color: #ffffff;">Frequently Asked Questions (Packers Movers Patna)</h2>
      </div>
...
<script type="application/ld+json">
{
  ...
  "description": "Packers movers in Patna offering full household relocation, 7-layer packaging, vehicle transport, and IBA GST bills.",
...
function sendHeroWhatsAppLead(event, form) {
  ...
  var message = "Hello Shree Ashirwad Packers,\n\nI would like a Packers Movers Quote for Patna:\n- Name: " + name + "\n- Phone: " + phone + "\n- Moving From: " + moveFrom + "\n- Moving To: " + moveTo;
