...
$faq_list = [
    ...
    [
        'q' => 'How are relocation charges calculated for Car Transport Delhi to Ranchi | Express Container Carrier?',
    ...
    [
        'q' => 'How many days in advance should I confirm my booking for Car Transport Delhi to Ranchi | Express Container Carrier?',
        'a' => 'For regional moves within Delhi, booking 2 to 3 days prior is recommended. For intercity transit to Ranchi, we advise confirming 4 to 7 days ahead to reserve dedicated weatherproof container trucks and preferred morning departure slots.'
    ],
    [
...
<h3>360-Degree Digital Condition Audit
    ...
    01
    Protocol 01</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Document the overall condition of your vehicle before transportation by taking detailed photos and videos, capturing all aspects such as exterior, interior, engine, wheels, and undercarriage.</p>
  </div>
  <div style="background: rgba(15, 23, 42, 0.75); border: 1.5px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 24px 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.35); transition: transform 0.2s ease, border-color 0.2s ease;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 10px; background: #10b98122; color: #10b981; font-weight: 800; font-size: 1.05rem; margin-bottom: 14px;">02</div>
    <h3 style="color: #ffffff; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; line-height: 1.4;">Protocol 02</h3>
    <p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0;'>Create a digital report using a cloud storage platform, ensuring a comprehensive overview of your vehicle&#039;s condition before transportation.</p>
  </div>
</div>
...
Carefully inspect the battery connections and tighten any loose screws to ensure a stable electrical connection during transportation.


One-Quarter Tank Fuel Regulation

Fill your car up to the one-quarter tank mark before transportation.
Fueling your vehicle beforehand ensures that it won&amp;#039;t require fuel during transit, reducing the risk of spills or leaks.


FASTag Management

If your vehicle has a FASTag (Fastag) attached, ensure it is properly installed and operational.
Disconnect the FASTag during transportation for a seamless journey with toll stations.


Residence Shifting Logistics in Delhi

Research and select a reliable and experienced packing and moving company in Delhi.
Engage a professional for packing of your belongings, ensuring safe transportation and minimal damage.


Professional Packers and Movers in Delhi

Hire a trustworthy packers and movers service provider in Delhi to handle the packing, loading, and transportation of your belongings.
Ensure they provide adequate packing materials and expertise to protect your valuables during transit.


Car Transport Services in Delhi

Ask your chosen transportation company to provide a detailed checklist for inspecting your vehicle before transportation.
Ensure they perform a 360-degree inspection to ensure your vehicle is in good condition and free from any defects.


Car Delivery Services in Delhi

Assign a reliable and experienced car delivery service to safely transport your vehicle.
Opt for insured car transportation services to secure your vehicle against potential damages during transit.


Fastag Management Services in Delhi</h3><p style='color: #94a3b8; font-size: 0.86rem; line-height: 1.6; margin: 0 0 12px 0;'>Our specialized transit protocols for Battery Terminal Checks
...
Fastag Management Services in Delhi ensure verified safety standards, continuous GPS route tracking, and express delivery scheduling across the Delhi to Ranchi corridor with scheduled highway transit stops.</p></div>
    </div>
  </div>
</section>
